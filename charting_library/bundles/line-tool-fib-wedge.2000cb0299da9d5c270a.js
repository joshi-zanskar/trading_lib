...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3314],
  {
    73174: (e, t, i) => {
      ...
      const p = -5e4,
        _ = 15e3,
        f = new o.TranslatedString('change price Y coordinate', r.t(null, void 0, i(11737))),
        v = new o.TranslatedString('change bar X coordinate', r.t(null, void 0, i(2066))),
      ...
      function m(e, t, i, n, r, o) {
        ...
        return (0, d.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, u.removeSpaces)(`${o}Coordinates${r}`), title: r, ...s.info, ...l.info },
        );
      }
      const T = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/;
      function x(e, t, i) {
              ...
              t.withMacro(g, () => {
                e.filter(e => !e.isSourceHidden()).forEach(e => {
                  ...
                  t.undoHistory().pushUndoCommand(
                    new a({ lineToolId: e.id(), chartModel: t.model(), newPositionPoints: r }),
                  );
                });
              });
            } finally {
    ...
    53749: (e, t, i) => {
      ...
      const l = new r.TranslatedString(
        ...
        a = new r.TranslatedString('change {toolName} line width', n.t(null, void 0, i(19541))),
        d = new r.TranslatedString('change {toolName} line style', n.t(null, void 0, i(66429))),
        c = new r.TranslatedString('change {toolName} line color', n.t(null, void 0, i(24059))),
        h = new r.TranslatedString(
          'change {toolName} line extending left',
          n.t(null, void 0, i(18773)),
        ),
        u = new r.TranslatedString('change {toolName} line left end', n.t(null, void 0, i(21474))),
        p = new r.TranslatedString(
          'change {toolName} line extending right',
          n.t(null, void 0, i(43823)),
        ),
        _ = new r.TranslatedString('change {toolName} line right end', n.t(null, void 0, i(54827))),
        f = n.t(null, void 0, i(3554)),
        v = n.t(null, void 0, i(61856)),
        g = n.t(null, void 0, i(87430));
      function y(e, t, i, n, r) {
        const y = {},
          P = { id: `${(0, s.removeSpaces)(i.originalText())}${n}`, title: (r && r.line) || f };
        return (
          void 0 !== t.showLine &&
      ...
      class f extends s.DefaultProperty {
        ...
        state(e, t, i) {
          ...
          return i
            ...
            : ((r = n),
              (o = this._map),
              (0, this._levelsIterator)(r, { tpl: h, fill: d, typecheck: o.typecheck.pack }, o));
          var r, o;
        }
        preferences() {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, s.extractState)(
              (0, r.default)((0, n.default)(t), _(e, this._map, this._levelsIterator)),
              this._allStateKeys,
        ...
        saveDefaults() {
          this._useUserPreferences && (0, l.saveDefaults)(this._defaultName, this.preferences());
        }
        clone() {
          return new f(this._options());
        }
        merge(e, t) {
          return super.merge(this._map ? _(e, this._map, this._levelsIterator) : e, t);
        }
        _options() {
          return {
            ...super._options(),
    ...
    72609: (e, t, i) => {
      i.d(t, { LineToolPaneViewFibWithLabels: () => h, labelEdgeOffset: () => c });
      var n = i(50151),
        r = i(17330),
        o = i(56468),
        s = i(74079),
          ...
          if (i && l && c) {
            for (let t = 1; t <= e.levelsCount(); t++) {
              const e = new o.HitTestResult(o.HitTarget.MovePoint, {
                ...(0, a.inplaceEditHandlers)(this._tryActivateEditMode.bind(this, t)),
                activeItem: t,
              });
          ...
          if (o) {
            a +=
              (r.coeffsAsPercents?.value() ?? !1)
                ? this._percentageFormatter.format(100 * l, { signPositive: !1, tailSize: 2 })
    ...
    90882: (e, t, i) => {
      ...
      class l extends o.InplaceTextLineDataSource {
        constructor() {
          super(...arguments), (this._hasEditableCoordinates = new s.WatchedValue(!1));
        }
        pointsCount() {
          return 3;
        }
          ...
          if ((super.setPoint(e, t), !this._recursiveGuard))
            try {
              if (((this._recursiveGuard = !0), 2 === e)) {
                const e = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[0]));
                let t = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[1]));
                const i = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[2]))
                  .subtract(e)
                  .length();
                let o = t.subtract(e);
                o.length() <= 0 && (o = new r.Point(1, 0)), (t = e.add(o.normalized().scaled(i)));
                const s = (0, n.ensureNotNull)(this.screenPointToPoint(t)),
                  l = this._pointsProperty.childs().points[1];
                l.childs().price.setValue(s.price), l.childs().bar.setValue(s.index);
              } else {
                const e = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[0])),
                  t = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[1]));
                let i = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[2]));
                const o = t.subtract(e).length();
                let s = i.subtract(e);
                s.length() <= 0 && (s = new r.Point(1, 0)), (i = e.add(s.normalized().scaled(o)));
        ...
        addPoint(e) {
          if (2 === this._points.length) {
            const t = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[0])),
            ...
            const l = (0, n.ensureNotNull)(this.ownerSource()),
              ...
              d = (0, n.ensureNotNull)(this.priceScale()).coordinateToPrice(r.y, a);
            e = { index: Math.round(this._model.timeScale().coordinateToIndex(r.x)), price: d };
          }
      ...
      class p extends s.LineToolPaneViewFibWithLabels {
        ...
        _updateRenderer(e = NaN, t = NaN) {
          ...
          const i = new d.CompositeRenderer(),
            ...
            [r, s] = this._points,
            l = n.trendline.childs().visible.value() ? n.trendline.childs().linewidth.value() : 0,
          ...
          for (let r = this._levels.length - 1; r >= 0; r--) {
            ...
            l.setData({
              ...
              l.setHitTest(new a.HitTestResult(a.HitTarget.MovePoint, void 0, s.index)),
              i.append(l);
    ...
    30051: (e, t, i) => {
      ...
      const f = new o.TranslatedString(
        ...
        v = new o.TranslatedString('change {title} levels visibility', r.t(null, void 0, i(54517))),
        ...
        m = new o.TranslatedString('change {title} all lines color', r.t(null, void 0, i(59577))),
        ...
        _stylePropertyDefinitions() {
          const e = [],
            ...
            a = (0, c.createLineStyleDefinition)(
              ...
              { showLine: l.visible, lineColor: l.color, lineWidth: l.linewidth },
              s,
              'TrendLine',
              { line: b },
            );
      ...
      var L = i(84417);
      const D = new o.TranslatedString('erase level line', r.t(null, void 0, i(77114)));
      var R;
      !(function (e) {
      ...
      class I extends s.LineToolFibWedgeBase {
        constructor(e, t, i, n) {
          super(e, t ?? I.createProperties(e.backgroundTheme().spawnOwnership()), i, n),
        ...
        processErase(e, t) {
          ...
          e.setProperty(i.childs().visible, !1, D, d.lineToolsDoNotAffectChartInvalidation);
        }
        ...
        _drawImpl(e) {
          ...
          if (
            ...
            if (
              ...
              e.addColorStop(0, (0, o.generateColor)(this._data.color1, this._data.transparency)),
                e.addColorStop(1, (0, o.generateColor)(this._data.color2, this._data.transparency)),
                (t.fillStyle = e);
            } else
              t.fillStyle = (0, o.generateColor)(this._data.color, this._data.transparency, !0);
            t.fill();
          }
        }
      }
