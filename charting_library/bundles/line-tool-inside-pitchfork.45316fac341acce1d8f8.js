  ...
  [8468, 5055],
  {
      ...
      class P extends o.DefaultProperty {
        ...
        state(e, t, i) {
          ...
          return i
            ...
            : ((s = r),
              (n = this._map),
              (0, this._levelsIterator)(s, { tpl: p, fill: c, typecheck: n.typecheck.pack }, n));
          var s, n;
        }
        preferences() {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, o.extractState)(
              (0, s.default)((0, r.default)(t), f(e, this._map, this._levelsIterator)),
              this._allStateKeys,
    ...
    20690: (e, t, i) => {
      ...
      class n extends s.LineToolPitchfork {
        constructor(e, t, i, r) {
          super(e, t ?? n.createProperties(e.backgroundTheme().spawnOwnership()), i, r);
        }
        name() {
    ...
    64002: (e, t, i) => {
      ...
      var r = i(50151),
        ...
        p = i(44672),
        d = i(96333);
      const u = new s.TranslatedString('erase level line', n.t(null, void 0, i(77114))),
        f = new s.TranslatedString('change {title} style', n.t(null, void 0, i(98463)));
      var P;
      !(function (e) {
      ...
      class m extends c.LineDataSource {
        constructor(e, t, i, r) {
          super(e, t ?? m.createProperties(e.backgroundTheme().spawnOwnership()), i, r),
            this._properties.childs().style.subscribe(this, this._recreatePaneView),
        ...
        async additionalActions(e) {
              ...
              options: {
                ...
                onExecute: () => {
                  e.setProperty(
                    ...
                    i,
                    f.format({ title: new s.TranslatedString(this.name(), this.translatedType()) }),
          ...
          return { actions: [t[0], t[3], t[1], t[2]], placement: 'CustomAction' };
        }
        processErase(e, t) {
          const i = 'level' + t,
              ...
              i === d.LineToolPitchforkStyle.Original
                ...
                : i === d.LineToolPitchforkStyle.Schiff
                  ...
                  : i === d.LineToolPitchforkStyle.Schiff2
                    ? (t = [new e.SchiffPitchfork2LinePaneView(this, this._model)])
                    : i === d.LineToolPitchforkStyle.Inside &&
                      (t = [new e.InsidePitchforkLinePaneView(this, this._model)]),
