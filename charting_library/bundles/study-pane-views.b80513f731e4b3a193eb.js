  ...
  [507],
  {
          ...
          try {
            ...
            if (
              ...
              if (this._data.leftend === a.LineEnd.Arrow) {
                ...
                (0, n.drawArrow)(t[0], t[1], e, e.lineWidth, p.dpr1PixelRatioInfo);
              }
    ...
    56208: (t, e, i) => {
          ...
          for (const s of i.histograms) {
            ...
            for (const a of s.bars) {
              ...
              const l = _(s.xRange, o, e.mediaSize.width),
                ...
                p = Math.max((o.percentWidth * u) / 100 - a.subBarValues.length, 0);
              let f = d;
              for (let e = 0; e < a.subBarValues.length; e++) {
                ...
                if (
                  ((f = o),
                  ((t.x >= n && t.x <= o) || (t.x >= o && t.x <= n)) && t.y >= i && t.y <= s)
                )
            ...
            i.histograms.forEach(a => {
              ...
              if (
                (a.bars.forEach(s => {
                  ...
                  const y = Math.max((h.percentWidth * m) / 100 - s.subBarValues.length, 0);
                  let x = p;
      ...
      function _(t, e, i) {
        ...
        var d;
        return { xBasePoint: l, sign: h, xRangeWidth: r ? i : (d = t).max - d.min };
      }
      function g(t, e) {
        return (
      ...
      function v(t, e, i, s, r, a) {
        const { fontSize: l, verticalOffset: h } = (function (t, e, i) {
          ...
          p = c + 3 * u,
          f = e + h;
        return { text: a, color: r.valuesColor, fontSize: l, align: d, point: new o.Point(p, f) };
      }
      function m(t, e, i) {
        ...
        (t.font = `${n}px ${c.CHART_FONT_FAMILY}`),
          (t.fillStyle = r),
          (t.textAlign = a),
          (0, l.drawScaled)(t, e.horizontalPixelRatio, e.verticalPixelRatio, () =>
      ...
      class w {
        ...
        _prepareStyles() {
          const t = (0, r.ensureDefined)(this._provider.graphicsInfo().hhists),
            e = Object.keys(t),
            i = (0, r.ensureDefined)(this._provider.properties().childs().graphics.childs().hhists),
            s =
              this._provider.properties().child('inputs')?.child('volume')?.value() ===
              n.HHistVolumeMode.Delta;
          for (const n of e) {
            ...
            if (s)
              ...
              const t = (0, x.generateColor)(e.colors[0].value(), e.transparencies[0].value()),
                i = e.colors[1]
        ...
        _updateViewInternal() {
          ...
          this._prepareStyles(),
            (0, r.ensureDefined)(i).forEach(i => {
              ...
              (!this._alwaysVisible && (r < n || s > a)) || this._updateDataForRenderers(i, t, e);
            });
        }
        _updateDataForRenderers(t, e, i) {
          ...
          const o =
            ...
            })(s, i, this._extendToBarsEndings, (0, r.ensureNotNull)(this._hhistFirstBarTime(s))),
            ...
            h.visible.value() &&
              i.forEach(i => {
                const r = i.startIndex ?? this._alternateStartIndex(),
                  l = i.endIndex;
                if (null === r) return;
                if ((!i.extendRight && Math.max(r, l) < a) || (!i.extendLeft && Math.min(r, l) > o))
                  return;
                let d, c;
                if (!i.extendLeft) {
