  ...
  [3945],
  {
      ...
      class x extends r.DefaultProperty {
        ...
        state(e, t, i) {
          ...
          return i
            ...
            : ((n = s),
              (o = this._map),
              (0, this._levelsIterator)(n, { tpl: h, fill: c, typecheck: o.typecheck.pack }, o));
          var n, o;
        }
        preferences() {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, r.extractState)(
              (0, n.default)((0, s.default)(t), _(e, this._map, this._levelsIterator)),
              this._allStateKeys,
        ...
        saveDefaults() {
          this._useUserPreferences && (0, a.saveDefaults)(this._defaultName, this.preferences());
        }
        clone() {
    ...
    90882: (e, t, i) => {
      ...
      class a extends o.InplaceTextLineDataSource {
        constructor() {
          super(...arguments), (this._hasEditableCoordinates = new r.WatchedValue(!1));
        }
        pointsCount() {
          return 3;
        }
          ...
          if ((super.setPoint(e, t), !this._recursiveGuard))
            try {
              if (((this._recursiveGuard = !0), 2 === e)) {
                const e = (0, s.ensureNotNull)(this.pointToScreenPoint(this._points[0]));
                let t = (0, s.ensureNotNull)(this.pointToScreenPoint(this._points[1]));
                const i = (0, s.ensureNotNull)(this.pointToScreenPoint(this._points[2]))
                  .subtract(e)
                  .length();
                let o = t.subtract(e);
                o.length() <= 0 && (o = new n.Point(1, 0)), (t = e.add(o.normalized().scaled(i)));
                const r = (0, s.ensureNotNull)(this.screenPointToPoint(t)),
                  a = this._pointsProperty.childs().points[1];
                a.childs().price.setValue(r.price), a.childs().bar.setValue(r.index);
              } else {
                const e = (0, s.ensureNotNull)(this.pointToScreenPoint(this._points[0])),
                  t = (0, s.ensureNotNull)(this.pointToScreenPoint(this._points[1]));
                let i = (0, s.ensureNotNull)(this.pointToScreenPoint(this._points[2]));
                const o = t.subtract(e).length();
                let r = i.subtract(e);
                r.length() <= 0 && (r = new n.Point(1, 0)), (i = e.add(r.normalized().scaled(o)));
                const a = (0, s.ensureNotNull)(this.screenPointToPoint(i)),
                  l = this._pointsProperty.childs().points[2];
                l.childs().price.setValue(a.price), l.childs().bar.setValue(a.index);
              }
            } finally {
        ...
        addPoint(e) {
          if (2 === this._points.length) {
            const t = (0, s.ensureNotNull)(this.pointToScreenPoint(this._points[0])),
            ...
            const a = (0, s.ensureNotNull)(this.ownerSource()),
              ...
              c = (0, s.ensureNotNull)(this.priceScale()).coordinateToPrice(n.y, l);
            e = { index: Math.round(this._model.timeScale().coordinateToIndex(n.x)), price: c };
          }
    ...
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => m, InplaceTextUndoCommand: () => T });
      var s = i(50279),
        n = i(50151),
        o = i(86441),
        r = i(19625),
      ...
      class T extends d.UndoCommand {
        constructor(e, t, s, n) {
          super(
            new c.TranslatedString('change {title} text', l.t(null, void 0, i(57122))).format({
            ...
            (this._oldValue = s),
            (this._newValue = n),
            (this._changeVisibility = !1 === t.editableTextProperties().textVisible?.value());
        }
        redo() {
          const e = this._source();
          this._textProperty(e).setValue(this._newValue),
            this._changeVisibility && this._textVisibilityProperty(e)?.setValue(!0);
        }
        undo() {
          const e = this._source();
          this._textProperty(e).setValue(this._oldValue),
            this._changeVisibility && this._textVisibilityProperty(e)?.setValue(!1);
        }
        _textProperty(e) {
        ...
        _source() {
          return (0, n.ensureNotNull)(this._model.dataSourceForId(this._sourceId));
        }
      }
      class m extends p.LineDataSource {
          ...
          super(e, t, s, n),
            ...
            (this._isDarkBackground = (0, u.combine)(
              (e, t) => {
                ...
                const i = (0, a.blendRgba)((0, a.parseRgba)(e), (0, a.parseRgba)(t));
                return 'black' === (0, a.rgbToBlackWhiteString)([i[0], i[1], i[2]], 150);
              },
            ...
            Promise.all([i.e(6290), i.e(9116), i.e(1200), i.e(1583)])
              .then(i.bind(i, 15852))
              .then(t => {
                (this._cursorPaneView = new t.InplaceTextCursorPaneView(this, e)),
        ...
        topPaneViews(e) {
          return e.hasDataSource(this) && !window.TradingView.printing && this._cursorPaneView
        ...
        onSelectionChange(e) {
          ...
          (0, s.default)(t, this._selectionData) ||
            ...
            this._paneViews.forEach(e => {
              e.forEach(e => {
                'setSelectionRange' in e && e.setSelectionRange(t.selectionRange);
              });
            }),
            this._cursorPaneView
        ...
        async _openTextEditor(e, t, s, r, a) {
          ...
          null === this._editingActivationTime && (this._editingActivationTime = performance.now()),
            (this._activateTextEditingEl = null),
            (this._cursorPosition = null),
          ...
          const { updateChartEditorText: l, closeChartEditorText: c } = await Promise.all([
            i.e(4556),
            i.e(2227),
            i.e(5592),
          ]).then(i.bind(i, 99514));
          ...
          const { text: u, textColor: h, wordWrap: d } = this.editableTextProperties(),
          ...
          const P = this.isFixed()
            ...
            g = {
              ...
              onClose: r,
              onSelectionChange: a,
              onContextMenu: this.onContextMenu ? this.onContextMenu.bind(this) : void 0,
            };
          l(this._container, g), this.updateAllViewsAndRedraw((0, _.sourceChangeEvent)(this.id()));
        }
        _closeTextEditor() {
    ...
    12120: (e, t, i) => {
      ...
      class a extends n.LineToolFibWedgeBase {
        constructor(e, t, s, n) {
          super(e, t ?? a.createProperties(e.backgroundTheme().spawnOwnership()), s, n),
            Promise.all([i.e(6290), i.e(9116), i.e(1200), i.e(1583)])
              .then(i.bind(i, 31869))
              .then(e => {
                this._setPaneViews([new e.ProjectionLinePaneView(this, this._model)]);
              });
        }
        levelsCount() {
          return 1;
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            e.addChild(
              'linesColors',
              new r.LineToolColorsProperty([e.childs().trendline.childs().color]),
            );
        }
      }
    },
