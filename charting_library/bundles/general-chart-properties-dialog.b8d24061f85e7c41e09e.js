  ...
  [7078],
  {
        ...
        return l.createElement(
          ...
          !C &&
            l.createElement(
              ...
              l.createElement('span', { className: o()(m.titleText, 'apply-overflow-tooltip') }, i),
              _ && !y && l.createElement(s.Icon, { className: m.nested, icon: c }),
            ),
        );
      }
      !(function (e) {
    ...
    56080: (e, t, i) => {
      ...
      var C = i(50655),
        ...
        M = i(58467);
      function P(e) {
        const { themeName: t, chartWidgetCollection: i, onRemove: n, manager: a } = e,
          [o, s] = (0, A.useHover)(),
          r = l.useCallback(
            () =>
              (function (e, t, i) {
      ...
      class W extends l.PureComponent {
                  ...
                  () =>
                    (async function (e, t, n) {
                      const [l, a] = await Promise.all([
                        Promise.all([i.e(1715), i.e(7648)]).then(i.bind(i, 57351)),
                        (0, y.getThemeNames)(),
                      ]);
                      l.showThemeSaveDialog(e, t, a, n);
                    })(e.model().template(), this._syncThemeList, this._handleRenameClose),
        ...
        _getPlaceHolderItem(e) {
          return e ? l.createElement(b.Icon, { className: M.themesButtonIcon, icon: D }) : I;
        }
        _getThemeItems(e) {
          const {
      ...
      class oe extends l.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._renderApplyToAllButton = () =>
              l.createElement(d.MatchMedia, { rule: j.DialogBreakpoints.TabletNormal }, e =>
        ...
        render() {
          ...
          return l.createElement(d.MatchMedia, { rule: j.DialogBreakpoints.TabletSmall }, r =>
            l.createElement(s.AdaptiveConfirmDialog, {
              ...
              additionalHeaderElement:
                null !== o && r ? l.createElement(ie, { onClick: this._handleBackClick }) : void 0,
            ...
            return l.createElement(
              ...
              l.createElement(
                ...
                l.createElement(
                  ...
                  n.map(e => l.createElement(o.Section, { key: e.id, definition: e })),
                ),
              ),
            );
          }
        ...
        _renderTabs(e) {
          ...
          return l.createElement(d.MatchMedia, { rule: j.DialogBreakpoints.TabletNormal }, e =>
            l.createElement(d.MatchMedia, { rule: j.DialogBreakpoints.TabletSmall }, t => {
    ...
    38068: (e, t, i) => {
      ...
      function h(e) {
        ...
        return n.createElement(
          ...
          n.createElement(r.RemoveButton, { ...u, isActive: l, title: '', icon: c }),
        );
      }
    },
    68648: e => {
