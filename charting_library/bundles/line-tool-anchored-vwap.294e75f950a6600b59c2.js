    ...
    13099: (e, t, s) => {
      ...
      class h extends d.StudyPriceAxisView {
        ...
        _showAxisLabel() {
          ...
          return this._visible() && 'VWAP' === this._data.plotIndex && e.showStudyLastValue.value();
        }
        _visible() {
          const e = this._source
            ...
            .display.value();
          return this._source.properties().childs().axisLabelVisible.value() && Boolean(4 & e);
        }
      }
      var c = s(78198);
      ...
      class I extends A.StudyLineDataSource {
        lastValueData(e, t, s) {
          ...
          const o = this.plots().search(a.lastBar(), b.PlotRowSearchMode.NearestLeft, 1);
          if (null === o) return r;
        ...
        isPlotVisibleAt(e, t) {
          return (
            (this._studyProps().childs().styles.childs()[e].childs().display.value() & t) === t
          );
        }
        _studyProps() {
      ...
      class L extends I {
        constructor(e, t, s, r, n) {
          s =
            s ||
            (0, i.ensureNotNull)(
              (0, V.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: g }),
            );
          const a = t ?? L.createProperties(e.backgroundTheme().spawnOwnership());
          ...
          o &&
            ...
            A.push(...this._priceAxisViews.map(e => new S.PanePriceAxisView(e, this, this._model))),
            ...
            e
              ...
              .showStudyLastValue.subscribe(this, this._onShowStudyLastValueChanged),
            a.onRestoreFactoryDefaults().subscribe(this, this._onRestoreFactoryDefaults),
            this._hasAlert.subscribe(this.processHibernate.bind(this), { callWithLast: !0 });
        }
        destroy() {
        ...
        updateAllViews(e) {
          super.updateAllViews(e), this._priceAxisViews.forEach(t => t.update(e));
        }
        firstValue() {
          return this._model.mainSeries().firstValue();
        }
        priceRange(e, t, s) {
          if (!this._isReady() || this.isSourceHidden() || s.targetPriceScale !== this.priceScale())
            return null;
        ...
        restoreData(e) {
          super.restoreData(e), void 0 !== e.data && (this._anchorPriceCalculated = !0);
        }
        properties() {
        ...
        inputsForAlertState() {
          return (
            null === this._inputs &&
              v.logWarn('Could not get inputsForAlertState if VWAP has no inputs'),
            { ...this.inputs() }
          );
        }
        inputs() {
        ...
        _studyInputs(e) {
          (0, i.assert)(1 === e.length, 'all the line tool points should be defined');
          const t = e[0],
            s = this._getPointTime(t, !1);
          return null === s
            ? (this._subscribeApplyInputsOnSeriesCompleted(), null)
            : { ...this.properties().childs().inputs.state(['start_time']), start_time: 1e3 * s };
        }
        _isReady() {
          return (
            super._isReady() &&
        ...
        _onInputsChanged() {
          if (
            (super._onInputsChanged(), this._updateAlertCreationAvailable(), null !== this._inputs)
          ) {
        ...
        _clearAllDataExceptPointsetPoints() {
          super._clearAllDataExceptPointsetPoints(), this._updateAlertCreationAvailable();
        }
        async _getPropertyDefinitionsViewModelClass() {
          return (
            await Promise.all([s.e(6406), s.e(3889), s.e(8009), s.e(8056), s.e(8537)]).then(
              s.bind(s, 27873),
            )
          ).AnchoredVWAPDefinitionsViewModel;
        }
        _updateAnchorsPrice(e) {
          if (!e && (this._anchorPriceCalculated || !this.isActualSymbol())) return;
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            e.hasChild('axisLabelVisible') || e.addChild('axisLabelVisible', new a.Property(C));
        ...
        _onInputsReady(e) {
          null !== this._inputs ? e(this._inputs) : this._onInputsReadyCallbacks.push(e);
        }
        _onShowStudyLastValueChanged() {
          this._priceAxisViews.forEach(e => e.update((0, f.sourceChangeEvent)(this.id()))),
