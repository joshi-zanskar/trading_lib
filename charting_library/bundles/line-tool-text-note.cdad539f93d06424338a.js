...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9123],
  {
    73174: (e, t, i) => {
      ...
      const g = -5e4,
        p = 15e3,
        f = new n.TranslatedString('change price Y coordinate', r.t(null, void 0, i(11737))),
        m = new n.TranslatedString('change bar X coordinate', r.t(null, void 0, i(2066))),
      ...
      function T(e, t, i, o, r, n) {
        ...
        return (0, d.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, u.removeSpaces)(`${n}Coordinates${r}`), title: r, ...l.info, ...a.info },
        );
      }
      const C = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/;
      function y(e, t, i) {
                ...
                e.filter(e => !e.isSourceHidden()).forEach(e => {
                  ...
                  switch (l) {
                    case '': {
                      ...
                      (n -= e.price),
                        (t -= e.index),
                        (r = i.map(e => ({ ...e, index: e.index + t, price: e.price + n })));
                      break;
                    }
                    case '-':
                    case '+': {
                  ...
                  t.undoHistory().pushUndoCommand(
                    new s({ lineToolId: e.id(), chartModel: t.model(), newPositionPoints: r }),
                  );
                });
              });
            } finally {
    ...
    91335: (e, t, i) => {
      ...
      const a = new r.TranslatedString(
        ...
        s = new r.TranslatedString('change {toolName} text color', o.t(null, void 0, i(64500))),
        d = new r.TranslatedString('change {toolName} text font size', o.t(null, void 0, i(21781))),
        c = new r.TranslatedString('change {toolName} text font bold', o.t(null, void 0, i(24701))),
        h = new r.TranslatedString(
          'change {toolName} text font italic',
          o.t(null, void 0, i(42694)),
        ),
        u = new r.TranslatedString('change {toolName} text', o.t(null, void 0, i(66668))),
        ...
        C = new r.TranslatedString('change {toolName} text wrap', o.t(null, void 0, i(39587))),
      ...
      function S(e, t, i, o) {
        ...
        if (
          ...
          void 0 !== t.fontSize &&
            (r.size = (0, n.convertToDefinitionProperty)(e, t.fontSize, d.format({ toolName: i }))),
          void 0 !== t.bold &&
            (r.bold = (0, n.convertToDefinitionProperty)(e, t.bold, c.format({ toolName: i }))),
          void 0 !== t.italic &&
            (r.italic = (0, n.convertToDefinitionProperty)(e, t.italic, h.format({ toolName: i }))),
          void 0 !== t.text &&
            ((r.text = (0, n.convertToDefinitionProperty)(e, t.text, u.format({ toolName: i }))),
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (S.backgroundTitle = (o.customTitles && o.customTitles.backgroundTitle) || y),
          ...
          (void 0 === t.borderVisible && void 0 === t.borderColor && void 0 === t.borderWidth) ||
            (S.borderTitle = (o.customTitles && o.customTitles.borderTitle) || _),
          void 0 !== t.wrap &&
            ((r.wrap = (0, n.convertToDefinitionProperty)(e, t.wrap, C.format({ toolName: i }))),
      ...
      class a extends l.DefaultProperty {
        constructor({ templateKeys: e, ...t }) {
          super({ ignoreAllowSavingDefaults: !0, saveNonDefaultUserPreferencesOnly: !0, ...t }),
            (this._templateKeys = (0, n.ensureDefined)(e || this._allDefaultsKeys));
        }
        template() {
        ...
        applyTemplate(e) {
          this.mergeAndFire(
            (0, l.extractState)(
              (0, r.default)((0, o.default)(this._factoryDefaultsSupplier()), e),
              this._templateKeys,
            ),
          );
        }
    ...
    46902: (e, t, i) => {
      ...
      const g = {
        ...
        m = (0, d.extractAllPropertiesKeys)((0, r.ensureDefined)(p.get(n.StdTheme.Light))),
        x = (0, d.extractAllPropertiesKeys)(g),
        v = [...new Set([...m, ...x, ...s.commonLineToolPropertiesStateKeys, 'text'])],
        b = [...new Set([...m, ...x, 'text'])];
      class T extends h.LineDataSourceProperty {
        constructor(e) {
          super(e),
            ...
            this.addChild(
              'linesColors',
              new u.LineToolColorsProperty([(0, r.ensureDefined)(this.child('lineColor'))]),
            ),
            this.addChild(
              'backgroundsColors',
              new u.LineToolColorsProperty([(0, r.ensureDefined)(this.child('backgroundColor'))]),
            ),
            this.addChild(
              'textsColors',
              new u.LineToolColorsProperty([(0, r.ensureDefined)(this.child('textColor'))]),
            );
        }
        static create(e, t) {
          return new this({
            defaultName: 'linetooltextnote',
            factoryDefaultsSupplier: () => (0, c.factoryDefaultsForCurrentTheme)(g, p),
      ...
      class O extends R.BitmapCoordinatesPaneRenderer {
        constructor(e) {
          super(),
            ...
            (this._textHitTest =
              e || new N.HitTestResult(N.HitTarget.MovePoint, { areaName: N.AreaName.Text })),
          ...
          this._textLabelRenderer.setData({
            ...
            boxShadow:
              e.drawBorder || e.drawBackground
                ? { shadowColor: e.shadowColor, shadowBlur: y.Blur, shadowOffsetY: y.ShadowOffsetY }
                : void 0,
        ...
        hitTest(e) {
          ...
          const i = (0, I.interactionTolerance)().line + 0.5,
            o = t.points[0],
            r = t.points[1];
          if ((0, V.distanceToSegment)(o, r, e).distance <= i) return this._lineHitTest;
          const n = this._textLabelRenderer.rect(),
            l = (0, k.box)((0, k.point)(n.x, n.y), (0, k.point)(n.x + n.width, n.y + n.height));
        ...
        getTextInfo() {
          const e = (0, r.ensureNotNull)(this._data),
            ...
            a = (0, r.ensureDefined)(this._textLabelRenderer.data()?.points?.[0]).add(
              (0, k.point)(0, 0.5 * -l.height),
            ),
        ...
        _drawImpl(e) {
          ...
          (i.strokeStyle = t.lineColor),
            ...
            i.beginPath();
          const [n, l] = (0, M.addPixelPerfectLineToPath)(i, o.x, o.y, r.x, r.y, e);
          i.stroke();
          ...
          (i.fillStyle = t.lineColor),
            ...
            (i.lineWidth = 1);
          const s = Math.round(
            y.CircleRadius * e.horizontalPixelRatio + 0.5 * e.horizontalPixelRatio,
          );
          i.arc(n, l, s, 0, 2 * Math.PI, !1), i.stroke(), this._textLabelRenderer.draw(i, e);
        }
        _calcTextSize() {
      ...
      var E = i(19063);
      const Y = (0, E.generateColor)((0, w.getHexColorByName)('color-black'), 80),
      ...
      class G extends P.InplaceTextLineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          if (null === (0, r.ensureNotNull)(this._source.ownerSource()).firstValue()) return;
          const o = this._source.properties().childs(),
            n = this._model.dark().value() ? l.colors.colorColdGray850 : l.colors.colorWhite,
            ...
            s = {
              textData: {
                ...
                selectionHighlight: this._inplaceTextHighlight().selectionHighlight,
              },
              shadowColor: a,
              points: i,
      ...
      var X = i(11542),
        ...
        q = i(32097),
        J = i(91682);
      const Q = new $.TranslatedString('change {title} line color', X.t(null, void 0, i(7455))),
        Z = new $.TranslatedString(
          'change {title} background visibility',
          X.t(null, void 0, i(30839)),
        ),
        ee = new $.TranslatedString('change {title} background color', X.t(null, void 0, i(49765))),
        te = new $.TranslatedString(
          'change {title} border visibility',
          X.t(null, void 0, i(19298)),
        ),
        ie = new $.TranslatedString('change {title} border color', X.t(null, void 0, i(69437))),
      ...
      class ae extends j.LineDataSourceDefinitionsViewModel {
        ...
        _textPropertyDefinitions() {
          const { backgroundColor: e, borderColor: t, ...i } = this._source.properties().childs();
          return {
            definitions: [
              (0, U.createTextStyleDefinition)(
                this._propertyApplier,
                { ...i, textColor: i.textColor, fontSize: i.fontSize },
                new $.TranslatedString(this._source.name(), this._source.translatedType()),
      ...
      class de {
        constructor(e, t) {
          (this._labelMovingDelta = null), (this._line = e), (this._itemIndex = t);
        }
        startMoving(e, t, i) {
          if (t === this._itemIndex) {
            ...
            return (
              (this._labelMovingDelta = { index: o.index - i.index, price: o.price - i.price }),
        ...
        move(e, t, i) {
          if (null !== this._labelMovingDelta) {
            ...
            return (
              ...
              this._line.updateAllViews((0, se.sourceChangeEvent)(this._line.id())),
              !0
            );
          }
          return !1;
      ...
      class ce extends _.InplaceTextLineDataSource {
        constructor(e, t, i, o) {
          super(e, t ?? ce.createProperties(e.backgroundTheme().spawnOwnership()), i, o),
        ...
        startMoving(e, t, i) {
          this._moveAsChangeBehavior.startMoving(e, t, i) || super.startMoving(e, t, i);
        }
        move(e, t, i) {
          this._moveAsChangeBehavior.move(e, t, i) || super.move(e, t, i);
        }
        endMoving(e, t, i) {
          return this._moveAsChangeBehavior.endMoving(e, t, i) ?? super.endMoving(e, t, i);
        }
