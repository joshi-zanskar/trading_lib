(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4411],
  {
    ...
    7567: e => {
      e.exports = { emojiSelect: 'emojiSelect-IY7RpEY6', placeholder: 'placeholder-IY7RpEY6' };
    },
    49128: e => {
    ...
    67248: (e, t, n) => {
      ...
      function g(e) {
        ...
        if (t && r && n)
          return c.createElement('span', { className: u(m().slot, m().startSlotWrap) }, t);
        const a = n && (t ?? r),
          l = !t && !r && !n && !o && s && i;
        return c.createElement(
          c.Fragment,
          null,
          t && c.createElement('span', { className: u(m().slot, m().startSlotWrap) }, t),
          o && !a && c.createElement('span', { className: m().content }, o),
          r && c.createElement('span', { className: u(m().slot, m().endSlotWrap) }, r),
          l &&
            !a &&
            (function (e) {
              return (
      ...
      function C(e) {
        ...
        return { ...p, ...(0, b.filterDataProps)(e), ...(0, b.filterAriaProps)(e) };
      }
      function x(e) {
        const {
            reference: t,
          ...
          m = f({ ...l, isGrouped: u, cellState: d, disablePositionAdjustment: p }),
          h =
            n ??
            (e.primaryText
      ...
      n(49406);
      function w(e) {
        const { intent: t, size: n, appearance: o, useFullWidth: r, icon: s, ...c } = e;
    ...
    66860: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        u = n.n(c);
      const d = e =>
        o.createElement(a.Icon, { className: r(u().caret, e && u().activeCaret), icon: l });
      function p(e) {
        const {
          showCaret: t,
          iconOnly: n,
        ...
        return o.createElement(
          o.Fragment,
          null,
          h && o.createElement('span', { className: r(u().slot, u().startSlot) }, h),
          !(0, i.isIconOnly)(p, n) &&
            o.createElement(
              'span',
              {
          ...
          m && o.createElement('span', { className: r(u().slot, u().endSlot) }, m),
          t && d(f),
        );
      }
    },
    15893: (e, t, n) => {
      ...
      function d(e) {
        const { isGrouped: t } = o.useContext(r.ControlGroupContext),
          ...
          N = w ? (D ?? 2) : 1,
          T = N > 0 ? { ...S, '--ui-lib-light-button-content-max-lines': N } : S;
        return o.createElement(
          'button',
          {
            ...k,
      ...
      function v(e, t) {
        const {
          ...
          T = (function (e, t = null, n) {
            ...
            return (0, o.useEffect)(() => ((s.current = [e, t, n]), i(), a), [e, t, n]), l;
          })('wheel', S, g),
          W = P;
        return o.createElement(
          W,
    ...
    31261: (e, t, n) => {
      ...
      function y(e) {
        ...
        const {
          ...
          E = t ? void 0 : y ? -1 : r,
          C = t ? void 0 : y ? r : -1,
          { isMouseDown: x, handleMouseDown: w, handleMouseUp: D } = (0, d.useIsMouseDown)(),
    ...
    26996: (e, t, n) => {
      ...
      var o,
        ...
        a = n.n(i);
      function l(e) {
        const { className: t, size: n = 'medium', staticPosition: o, color: i = 'black' } = e,
          l = s(a().item, a()[i], a()[n]);
    ...
    87896: (e, t, n) => {
      ...
      var o = n(50959),
        r = n(32227),
        s = n(4237);
      const i = (0, o.createContext)({ isOnMobileAppPage: () => !1, isRtl: !1, locale: 'en' });
      var a = n(84015),
        l = n(63273);
      const c = { iOs: 'old', android: 'new', old: 'old', new: 'new', any: 'any' };
      function u(e) {
    ...
    53680: (e, t, n) => {
          ...
          renderButton: e =>
            (function (e, t) {
              ...
              return s.createElement(b.LightButton, {
                ...
                startSlot:
                  o === x.EMPTY_EMOJI
                    ? s.createElement(y.Icon, { className: w.emptySelect, icon: D })
                    : s.createElement(E.EmojiItem, { className: w.emoji, emoji: o }),
              });
            })(e, l),
          canBeEmpty: !0,
        });
      ...
      function B(e) {
        const { value: t = '', onChange: n, reference: o = null, emojiPicker: r = !1, ...i } = e,
          { emoji: a, emojiLessString: l } = (0, s.useMemo)(() => (0, v.separateEmoji)(t), [t]),
        ...
        return P && r
          ? s.createElement(f.InputControl, {
              ...
              onKeyDown: function (t) {
                ...
                const { selectionStart: o, selectionEnd: r } = (0, p.ensureNotNull)(c.current);
                0 === o &&
                  0 === r &&
                  a &&
      ...
      class T extends s.PureComponent {
        constructor(e) {
          if (
            ...
            (this._handleOutsideClick = () => {
              ...
              e ? n && o !== t && n(o) : this.setState(this._valueToQuery(t)), this._close();
            }),
            (this._handleFocus = e => {
            ...
            (this._handleChange = e => {
              ...
              if (t && '' === e)
                this.setState({ queryValue: e, isOpened: !1, active: void 0 }), s && s();
              else {
            ...
            (this._handleKeyDown = e => {
              if (-1 === [o.DownArrow, o.UpArrow, o.Enter, o.Escape].indexOf(e.which)) return;
              const {
              ...
              switch (e.which) {
                ...
                case o.Enter:
                  let h = i;
                  t && (a && h ? this.setState(this._valueToQuery(h)) : (h = l)),
                    void 0 !== h &&
                      (this._close(),
                      a || this._blur(),
                      h !== n ? r && r(h) : this.setState(this._valueToQuery(h)));
              }
            }),
          ...
          this.state = {
            ...
            isOpened: !1,
            active: e.value,
            queryValue: W(e.source)[e.value] || (e.allowUserDefinedValues ? e.value : ''),
          };
        }
        componentDidMount() {
        ...
        render() {
          ...
          return s.createElement(
            ...
            t =>
              s.createElement(
                'div',
                { className: i(k.autocomplete, 'js-dialog-skip-escape'), ref: t },
                s.createElement(B, {
                  id: this.props.id,
                  ...
                  endSlot: Object.keys(this._suggestions(this.state.queryValue)).length
                    ? s.createElement(
                        ...
                        s.createElement(
                          'span',
                          { className: k.caret, onClick: this._handleCaretClick, tabIndex: -1 },
        ...
        _renderSuggestionsItems() {
          const e = this._suggestions(this.state.queryValue),
            ...
            o = s.createElement('li', { className: k.noResults }, r.t(null, void 0, n(85888)));
    ...
    16684: (e, t, n) => {
      ...
      function s() {
        ...
        return (
          (0, o.useLayoutEffect)(() => {
            r.CheckMobile.iOS() || (e.current && (e.current.focus(), e.current.select()));
          }, []),
          e
        );
      }
    ...
    82930: (e, t, n) => {
      ...
      var g = n(78135),
        ...
        E = n(10555);
      function C(e) {
        const { children: t, highlight: n, disabled: r, reference: s, ...i } = e,
          a = n ? 'primary' : 'default';
        return o.createElement(
          'div',
          {
          ...
          o.createElement('div', { className: b()(E.childrenContainer, r && E.disabled) }, t),
      ...
      function O(e) {
        const {
          ...
          { current: E } = (0, o.useRef)(
            ((C = t), r.getJSON('RecentlyUsedEmojis', [C]).filter(e => e !== x.EMPTY_EMOJI)),
          );
        var C;
        ...
        const _ = (0, o.useCallback)(
          ...
          L = (0, o.useMemo)(() => (m ? [x.EMPTY_EMOJI, ...N].slice(0, P) : N), [N, m]),
          A =
            ((F = L),
            (0, o.useMemo)(() => {
              ...
              o.createElement(
                ...
                e
                  ? o.createElement(
                      ...
                      o.createElement(s.EmojiList, { emojis: A, onSelect: _, height: R }),
                    )
                  : o.createElement(
                      l.PopupMenu,
                      {
                        ...
                        position: (0, g.getPopupPositioner)(b.current, {
                          horizontalDropDirection: g.HorizontalDropDirection.FromLeftToRight,
        ...
        function V(e) {
          27 === (0, p.hashFromEvent)(e) && (e.preventDefault(), e.stopPropagation(), z());
        }
        function I(e) {
          const t = e.target;
      ...
      function a(e) {
        const { text: t, textRender: n, firstSegmentOnly: a = !1 } = e,
          { leadingEmoji: l, processedText: c } = (0, o.useMemo)(
            () =>
              (0, r.processTextWithLeadingEmoji)({ text: t, textRender: n, firstSegmentOnly: a }),
            [t, n, a],
          );
        return l
          ? o.createElement(
    ...
    63472: (e, t, n) => {
      'use strict';
      n.d(t, { getLeadingEmojiHtml: () => d, processTextWithLeadingEmoji: () => u });
      var o = n(91682),
        r = n(173),
        s = n(88160),
        i = n(56570),
      ...
      function u(e) {
        const { text: t, textRender: n = e => e, firstSegmentOnly: i = !1 } = e,
          ...
          u = i ? a || '' : t;
        if (!c || l === s.EMPTY_EMOJI) return { leadingEmoji: '', processedText: n(u) };
    ...
    10381: (e, t, n) => {
      ...
      function l(e) {
        ...
        return o.createElement(s.Icon, { className: r(n, i.icon, { [i.dropped]: t }), icon: a });
      }
    },
    4237: (e, t, n) => {
      'use strict';
