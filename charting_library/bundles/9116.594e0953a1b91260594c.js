...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    32211: (e, t, i) => {
      i.d(t, { InplaceTextLineSourcePaneView: () => _, inplaceEditHandlers: () => u });
      var n = i(50151),
        o = i(11542),
        s = i(19063),
        r = i(91676),
      ...
      class _ extends a.LineSourcePaneView {
        constructor(e, t, i, n, o) {
          super(e, t),
            ...
            this._editableTextSpawn.subscribe(() => this._updateTextWasEditable());
        }
        destroy() {
        ...
        _placeHolderMode(e) {
          return (
            ...
            (!e || this._model.lastHittestData()?.areaName !== l.AreaName.AnchorPoint) &&
        ...
        _tryActivateEditMode(e, t) {
          const i = (0, n.ensureNotNull)(
            t.target instanceof HTMLElement ? t.target.closest('.chart-gui-wrapper') : null,
          );
        ...
        _activateEditMode(e) {
          this._showTextEditor?.(e, this._textInfo, c, this.closeTextEditor.bind(this), e =>
            this._onSelectionChangeCb?.(e),
          ),
    ...
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => b, InplaceTextUndoCommand: () => P });
      var n = i(50279),
        o = i(50151),
        s = i(86441),
        r = i(19625),
      ...
      class P extends u.UndoCommand {
        constructor(e, t, n, o) {
          super(
            new d.TranslatedString('change {title} text', l.t(null, void 0, i(57122))).format({
      ...
      class b extends _.LineDataSource {
        ...
        async _openTextEditor(e, t, n, r, a) {
          ...
          const { updateChartEditorText: l, closeChartEditorText: d } = await Promise.all([
            i.e(4556),
            i.e(2227),
            i.e(5592),
          ]).then(i.bind(i, 99514));
          ...
          const { text: h, textColor: c, wordWrap: u } = this.editableTextProperties(),
          ...
          l(this._container, T), this.updateAllViewsAndRedraw((0, p.sourceChangeEvent)(this.id()));
        }
        _closeTextEditor() {
    ...
    27916: (e, t, i) => {
      ...
      class x {
        ...
        addAnchors(e, t = {}) {
          ...
          const n = this._source.points(),
            o = i.map((e, t) => {
              ...
              return i && ((o.snappingPrice = i.price), (o.snappingIndex = i.index)), o;
            });
        ...
        _needLabelExclusionPath(e, t) {
          ...
          return 'middle' === (t ?? i.vertLabelsAlign.value()) && (0, h.needTextExclusionPath)(e);
        }
    ...
    36036: (e, t, i) => {
      ...
      class T extends c.BitmapCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, i, p, _), n.length && this._drawPoints(e, n, o, g, x);
        }
        _drawPoints(e, t, i, o, r) {
          const { context: l, horizontalPixelRatio: d, verticalPixelRatio: h } = e,
          ...
          for (let e = 0; e < t.length; ++e) {
            const s = t[e];
            if (!((0, a.isInteger)(s.pointIndex) && c.linePointBeingEdited === s.pointIndex)) {
              l.fillStyle = i[e];
              if (
                (o(
                  l,
                ...
                if (null !== c.hoveredPointIndex && s.pointIndex === c.hoveredPointIndex) {
