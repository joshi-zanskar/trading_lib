  ...
  [319],
  {
    73174: (e, t, i) => {
      ...
      class a extends s.UndoCommand {
        ...
        redo() {
          const e = (0, o.ensureNotNull)(this._model.dataSourceForId(this._lineToolId));
      ...
      const p = -5e4,
        m = 15e3,
        g = new r.TranslatedString('change price Y coordinate', n.t(null, void 0, i(11737))),
        x = new r.TranslatedString('change bar X coordinate', n.t(null, void 0, i(2066))),
      ...
      function b(e, t, i, o, n, r) {
        ...
        return (0, c.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, u.removeSpaces)(`${r}Coordinates${n}`), title: n, ...l.info, ...s.info },
        );
      }
      const C = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/;
      function v(e, t, i) {
                ...
                e.filter(e => !e.isSourceHidden()).forEach(e => {
                  ...
                  switch (l) {
                    case '': {
                      ...
                      (r -= e.price),
                        (t -= e.index),
                        (n = i.map(e => ({ ...e, index: e.index + t, price: e.price + r })));
                      break;
                    }
                    case '-':
                    case '+': {
                      ...
                      '-' === l && ((e *= -1), (t *= -1)),
                        (n = i.map(i => ({ ...i, index: i.index + e, price: i.price + t })));
                      break;
                    }
                    case '*': {
                  ...
                  t.undoHistory().pushUndoCommand(
                    new a({ lineToolId: e.id(), chartModel: t.model(), newPositionPoints: n }),
                  );
                });
              });
            } finally {
    ...
    91335: (e, t, i) => {
      ...
      const s = new n.TranslatedString(
        ...
        a = new n.TranslatedString('change {toolName} text color', o.t(null, void 0, i(64500))),
        c = new n.TranslatedString('change {toolName} text font size', o.t(null, void 0, i(21781))),
        h = new n.TranslatedString('change {toolName} text font bold', o.t(null, void 0, i(24701))),
        d = new n.TranslatedString(
          'change {toolName} text font italic',
          o.t(null, void 0, i(42694)),
        ),
        u = new n.TranslatedString('change {toolName} text', o.t(null, void 0, i(66668))),
        ...
        C = new n.TranslatedString('change {toolName} text wrap', o.t(null, void 0, i(39587))),
      ...
      function P(e, t, i, o) {
        ...
        if (
          ...
          void 0 !== t.fontSize &&
            (n.size = (0, r.convertToDefinitionProperty)(e, t.fontSize, c.format({ toolName: i }))),
          void 0 !== t.bold &&
            (n.bold = (0, r.convertToDefinitionProperty)(e, t.bold, h.format({ toolName: i }))),
          void 0 !== t.italic &&
            (n.italic = (0, r.convertToDefinitionProperty)(e, t.italic, d.format({ toolName: i }))),
          void 0 !== t.text &&
            ((n.text = (0, r.convertToDefinitionProperty)(e, t.text, u.format({ toolName: i }))),
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (P.backgroundTitle = (o.customTitles && o.customTitles.backgroundTitle) || v),
          ...
          (void 0 === t.borderVisible && void 0 === t.borderColor && void 0 === t.borderWidth) ||
            (P.borderTitle = (o.customTitles && o.customTitles.borderTitle) || y),
          void 0 !== t.wrap &&
            ((n.wrap = (0, r.convertToDefinitionProperty)(e, t.wrap, C.format({ toolName: i }))),
    ...
    23720: (e, t, i) => {
      ...
      const u = new r.TranslatedString(
        ...
        f = new r.TranslatedString('change {title} all lines color', n.t(null, void 0, i(59577))),
        ...
        b = new r.TranslatedString('change {title} labels visibility', n.t(null, void 0, i(93340))),
        C = new r.TranslatedString('change {title} labels alignment', n.t(null, void 0, i(55612))),
      ...
      class r extends n.Property {
        ...
        unsubscribe(e, t) {
          const i = (0, o.ensureDefined)(
            this._listenersMappers.find(i => i.obj === e && i.method === t)?.callback,
          );
    ...
    6590: (e, t, i) => {
      ...
      !(function (e) {
        ...
        (function (e) {
          (e.FloatingToolbarButton = 'FloatingToolbarButton'), (e.Default = 'Default');
        })(l || (l = {}));
    },
    38039: (e, t, i) => {
      ...
      class s extends l.DefaultProperty {
        constructor({ templateKeys: e, ...t }) {
          super({ ignoreAllowSavingDefaults: !0, saveNonDefaultUserPreferencesOnly: !0, ...t }),
            (this._templateKeys = (0, r.ensureDefined)(e || this._allDefaultsKeys));
        }
        template() {
        ...
        applyTemplate(e) {
          this.mergeAndFire(
            (0, l.extractState)(
              (0, n.default)((0, o.default)(this._factoryDefaultsSupplier()), e),
              this._templateKeys,
            ),
          );
        }
    ...
    56176: (e, t, i) => {
      ...
      class y {
        ...
        setFont(e) {
          (this._fontSize = e), (this._font = (0, C.makeFont)(e, v.CHART_FONT_FAMILY));
        }
        font() {
          return this._font;
        }
      ...
      function S(e, t, i) {
        const o = (0, w.wordWrap)(e, i.font(), i.textWidthCache(), !0, t).length,
          n = i.getSymbolHeight();
      ...
      const {
        ...
        z = new Map([
          [h.StdTheme.Light, { backgroundColor: A, borderColor: R, textColor: W }],
          [h.StdTheme.Dark, { backgroundColor: W, borderColor: H, textColor: R }],
        ]),
        L = (0, d.extractThemedColors)(
          (0, o.ensureDefined)(z.get(h.StdTheme.Light)),
          (0, o.ensureDefined)(z.get(h.StdTheme.Dark)),
        ),
        M = (0, d.extractAllPropertiesKeys)((0, o.ensureDefined)(z.get(h.StdTheme.Light))),
      ...
      class F extends g.LineDataSourceProperty {
        constructor(e) {
          ...
          this.addChild(
            'linesColors',
            new _.LineToolColorsProperty([(0, o.ensureDefined)(this.child('borderColor'))]),
          ),
            this.addChild(
              'textsColors',
              new _.LineToolColorsProperty([(0, o.ensureDefined)(this.child('textColor'))]),
            ),
            this.addChild(
              'backgroundsColors',
              new _.LineToolColorsProperty([(0, o.ensureDefined)(this.child('backgroundColor'))]),
            ),
            this.addChild('editableText', new f.Property(''));
        }
        recreateCellsPropsByState(e) {
          const { cells: t, colsCount: i, rowsCount: o, columnWidths: n, rowHeights: r } = e;
        ...
        setColumnWidthValues(e) {
          ...
          for (let n = 0; n < i; n++) t.columnWidths.childs()[n].setValue(Math.max(e[n], o));
        }
        setRowHeightValues(e) {
          const t = this.childs(),
            i = t.rowsCount.value(),
            o = V(this._tableTextCache);
          for (let n = 0; n < i; n++) t.rowHeights.childs()[n].setValue(Math.max(e[n], o));
        }
        cellsValues() {
          const { rowsCount: e, colsCount: t, cells: i } = this.childs(),
            o = i.childs();
          return Array.from({ length: e.value() }, (e, i) =>
            Array.from({ length: t.value() }, (e, t) => o[i].childs()[t].value()),
          );
        }
        static create(e, t) {
          return new this({
            defaultName: 'linetooltable',
            factoryDefaultsSupplier: () => (0, u.factoryDefaultsForCurrentTheme)(E, z),
      ...
      class se extends ee.BitmapCoordinatesPaneRenderer {
        constructor() {
          super(...arguments), (this._data = null), (this._cellsHitTestData = []);
        }
        setData(e) {
          this._data = e;
        }
        ...
        hitTest(e, t) {
          ...
          const { horizontalPixelRatio: i, verticalPixelRatio: r } = t,
            { activeEdge: l, changeSize: s, changeOnlyActiveEdge: a, cells: c } = this._data,
            { x: h, y: d } = c.topLeft,
          ...
          for (const t of c.cells)
            for (const o of t) {
              const { left: t, right: l, top: s, bottom: a, rowIndex: c, columnIndex: h } = o,
                d = s / r,
                u = t / i,
                p = a / r,
                m = l / i;
              if ((0, Q.pointInBox)(e, (0, n.box)((0, n.point)(u, d), (0, n.point)(m, p))))
                return new $.HitTestResult($.HitTarget.MovePoint, {
                  ...this._cellsHitTestData[c]?.[h],
                  activeItem: { rowIndex: c, columnIndex: h },
                });
            }
          return (0, Q.pointInBox)(e, (0, n.box)((0, n.point)(g, m), (0, n.point)(f, x)))
          ...
          !(function (e, t) {
            ...
            (function (e, t) {
              ...
              for (const c of t.cells.cells)
                for (const h of c) {
                  const { left: c, right: d, top: u, bottom: p, columnIndex: m, rowIndex: g } = h;
                  if (
            ...
            (function (e, t, i) {
              if (null === t.activeEdge.row && null === t.activeEdge.column) return;
              const o = Math.max(1, Math.round(7 * i.horizontalPixelRatio));
              if (((e.strokeStyle = re), (e.lineWidth = o), null !== t.activeEdge.column)) {
                const i = t.cells.cells[0][t.activeEdge.column];
                (0, te.drawVerticalLine)(e, i.right, t.cells.topLeft.y, t.cells.bottomRight.y);
              }
              if (null !== t.activeEdge.row) {
                const i = t.cells.cells[t.activeEdge.row][0];
                (0, te.drawHorizontalLine)(e, i.bottom, t.cells.topLeft.x, t.cells.bottomRight.x);
              }
            })(t, i, e);
        }
      }
      class ae extends X.InplaceTextLineSourcePaneView {
          ...
          super(e, t, o, r, l),
            ...
            this._source.setAdditionalCursorData(
              () => {
                ...
                return e
                  ? { color: this._source.editableTextStyle().cursorColor, ...e.getTextInfo() }
                  : {
              ...
              e => {
                ...
                return t ? t.positionToCoordinate(e) : { x: 0, y: 0, lineNumber: 0 };
              },
            );
        }
        renderer(e) {
          return (
            (this._lastRenderingInfo = e), this._invalidated && this._updateImpl(e), this._renderer
          );
        }
        lastRenderingInfo() {
        ...
        _updateImpl(e) {
          ...
          if (!this._points || (this._source.isFixed() && void 0 === this._source.fixedPoint()))
            return;
          ...
          this._tableRenderer.setData({
            ...
            this._cellsTextRenderers.forEach(e => e.forEach(e => this._renderer.append(e)));
          ...
          (this._anchorPoints[O.TopLeft].point = (0, n.point)(_, T)),
            ...
            this._renderer.append(
              this.createLineAnchor(
                { points: this._anchorPoints, clickHandler: this._anchorClickHandler },
                0,
              ),
            ),
            this._model.selection().isSelected(this._source) ||
              (this.closeTextEditor(), this._source.setInplaceEditableCellIndexes([-1, -1]));
        }
        _activateEditMode(e) {
          super._activateEditMode(e);
          const t = this._getTextEditableRenderer();
          null !== t &&
            (t.setCursorType(this._textCursorType()), this._updateInplaceText(t.getTextInfo()));
        }
        _textColorForCell([e, t]) {
          const i = this._source.properties().childs().textColor.value();
          let o;
          return (
            (o = this._isEditableCell([e, t]) ? this._text() : this._source.cellText(e, t)),
        ...
        _updateTextRenderers(e, t) {
          if (t)
            if (
                      ...
                      new q.LineToolTextRenderer(
                        {
                          ...
                          wordWrapWidth: P(t.columnWidths[e], this._tableTextCache),
                          offsetX: 1,
                          offsetY: 1,
                          boxPadding: 8,
                        },
              ...
              (this._cellsTextRenderers = e), this._tableRenderer.setCellsHitTestData(i);
            } else {
              ...
              t.texts.forEach((e, l) => {
                e.forEach((e, s) => {
                  ...
                  r === a &&
                    ((c = { ...c, ...this._inplaceTextHighlight(), text: this._text() }),
                    a.isOutOfScreen(n, i)
                      ? this.closeTextEditor()
        ...
        _setTextRendererPositions(e, t) {
          ...
          this._cellsTextRenderers.forEach((t, l) => {
            t.forEach((t, s) => {
              ...
              t.setPoint(
                (0, n.point)(
                  (a + ('right' === i ? c - a : 'center' === i ? (c - a) / 2 : 0)) / o,
                  h / r,
                ),
              );
              const u = t.data();
        ...
        _getTextEditableCellIndexes() {
          return this._isTextEditMode() ? this._getSelectableCellIndexes() : [-1, -1];
        }
      ...
      const fe = new he.TranslatedString(
        ...
        _e = new he.TranslatedString('change {title} border color', ce.t(null, void 0, i(69437))),
            ...
            definitions: [
              ...
              (0, pe.createOptionsPropertyDefinition)(
                ...
                },
                {
                  id: `${i}TextAlignment`,
                  title: ye,
                  options: new ge.WatchedValue(xe.availableAlignmentHorizontalItems),
                },
              ),
            ],
          };
      ...
      class Ie extends a.InplaceTextUndoCommand {
        constructor(e, t, i, o, n) {
          super(e, t, i, o), (this._cellIndexes = [-1, -1]), (this._cellIndexes = n);
        }
        _textProperty(e) {
      ...
      var De = i(60265),
        Ae = i(85719);
      const Re = new he.TranslatedString('add column to right', r.t(null, void 0, i(48499))),
        He = new he.TranslatedString('add row below', r.t(null, void 0, i(48407))),
        We = new he.TranslatedString('remove column', r.t(null, void 0, i(80240))),
      ...
      class ze extends De.UndoCommand {
        ...
        _source() {
          return (0, o.ensureNotNull)(this._model.dataSourceForId(this._sourceId));
        }
      }
      class Le extends ze {
        constructor(e, t, i) {
        ...
        redo() {
          this._source().insertCells(this._operationType, this._inplaceEditCellIndexes);
        }
      }
      class Me extends ze {
        constructor(e, t, i) {
        ...
        redo() {
          this._source().removeCells(this._operationType, this._inplaceEditCellIndexes);
        }
      }
      function Ne(e, t, i) {
        let o = (0, Pe.sum)(e);
        ...
        let r = Math.max(i, n);
        if (o === r) return [...e];
        if (r < o) for (let i = 0; i < e.length; i++) e[i] === t[i] && ((o -= e[i]), (r -= e[i]));
        const l = r / o,
          s = e.map((e, i) => Math.max(t[i], e * l));
        return (0, Pe.sum)(s) > r + 0.01 ? Ne(s, t, i) : s;
      }
      const ke = new he.TranslatedString('change the column width', r.t(null, void 0, i(26391))),
        Be = new he.TranslatedString('change the row height', r.t(null, void 0, i(21863))),
        Fe = new he.TranslatedString('resize the cell', r.t(null, void 0, i(24849)));
      class Oe extends a.InplaceTextLineDataSource {
        constructor(e, t, i, o) {
          const n = t ?? Oe.createProperties(e.backgroundTheme().spawnOwnership());
          super(e, n, i, o),
            ...
            (this._tableTextCache = new y(this._properties.childs().fontSize.value())),
            this._properties.childs().fontSize.subscribe(this, e => {
              this._tableTextCache.setFont(e.value()),
                this._properties.setColumnWidthValues(this._properties.columnWidthValues()),
            ...
            n.childs().anchored.subscribe(this, this._onAnchoredChange.bind(this));
        }
        destroy() {
        ...
        insertCells(e, t) {
          ...
          let [a, c] = t ?? this._inplaceEditCellIndexes,
            h = !1;
          switch ((-1 === a && -1 === c && ((h = !0), (a = o - 1), (c = n - 1)), e)) {
            case 0:
              const e = a + 1,
                t = new Array(n).fill('');
        ...
        async additionalActions(e, t = 'Default') {
          ...
          return (
            'Default' === t &&
              (o = (await Promise.all([i.e(1629), i.e(620)]).then(i.bind(i, 99758))).tableActions(
                this,
                e,
              )),
        ...
        cellText(e, t) {
          return this.properties().childs().cells.childs()[e].childs()[t].value();
        }
        ...
        setPoint(e, t, i, r) {
          ...
          const R = this.isFixed(),
            H = C && !R ? Math.floor(l.coordinateToFloatIndex(D)) : l.coordinateToFloatIndex(D);
          ...
          switch (e) {
            ...
            case O.BottomLeft:
              R
                ...
                : this._setPoint(0, { ...t, index: H, price: T.price, interval: c }),
                r ||
                  (this._properties.setColumnWidthValues(
                    this._correctColumnWidths(Ne(g, x, p + E), h),
                  ),
            ...
            case O.TopRight:
              R
                ...
                : this._setPoint(0, { ...t, price: W, index: T.index, interval: c }),
                r ||
          ...
          if (e >= O.ResizeVirtualAnchorBase) {
            ...
            if (null !== i) {
              ...
              for (let e = 0; e < g.length; e++)
                t = Math.max(
                  t,
                  S(this.cellText(i, e), P(g[e], this._tableTextCache), this._tableTextCache),
                );
          ...
          const t = this.properties().rowHeightValues(),
            ...
            n = t.map((t, n) => {
              let r = V(this._tableTextCache),
                l = Math.max(t, r);
              for (let e = 0; e < this.properties().childs().colsCount.value(); e++) {
                const t = S(
                  this.cellText(n, e),
        ...
        removeCellsUndoCommand(e) {
          return this.isRemoveCellsAvailable(e) ? new Me(this.model(), this, e) : null;
        }
        ...
        _topLeftPoint() {
          return this.isFixed()
            ? (0, o.ensureNotNull)(
                this.screenPointToPoint((0, o.ensureDefined)(this._fixedPoint), !0),
              )
            : this._points[0];
        }
        _correctColumnWidths(e, t) {
          const i = (this._tablePaneView?.lastRenderingInfo() ?? Ve.dpr1PixelRatioInfo)
              .horizontalPixelRatio,
            n = (0, o.ensureNotNull)(this.pointToScreenPoint(t.topLeftPoint)).x,
            [, r] = D(n, t.columnWidths, t.columnMinWidths.length - 1, i),
            l = (0, o.ensureNotNull)(this.pointToScreenPoint(this._topLeftPoint())).x,
            s = (0, Pe.sum)(e),
            a = r / i - l;
