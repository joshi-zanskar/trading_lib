(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [207],
  {
        ...
        return (
          ...
          (e.prototype._notifyListeners = function () {
            for (var e, t, n = 0, r = this._listeners; n < r.length; n++) {
              var o = r[n];
              if (
                ((o.once || (null === (e = o.signal) || void 0 === e ? void 0 : e.aborted)) &&
    ...
    34026: (e, t, n) => {
      ...
      (t.pointInHalfplane = function (e, t) {
        ...
        (t.pointInPolygon = function (e, t) {
          for (var n = t.length - 1, r = !1, o = e.x, i = e.y, a = 0; a < t.length; a++) {
            var s = t[a],
              u = t[n];
    ...
    5531: (e, t, n) => {
      ...
      function l(e, t) {
        return (
          !(e.length > 0 && (o.equalPoints(e[e.length - 1], t) || o.equalPoints(e[0], t))) &&
          (e.push(t), !0)
        );
      }
      function f(e, t) {
        for (var n = [], r = 0; r < e.length; ++r) {
          ...
          if (a.pointInHalfplane(i, t)) {
            if ((l(n, i), !a.pointInHalfplane(u, t))) null !== (f = s(c, t.edge)) && l(n, f);
      ...
      (t.intersectLineSegmentAndBox = function (e, t) {
        ...
        function f(e, t, n, r, o, i) {
          var a = 0;
          return e < n ? (a |= 1) : e > o && (a |= 2), t < r ? (a |= 4) : t > i && (a |= 8), a;
        }
        for (var d = f(n, r, s, u, c, l), _ = f(i, a, s, u, c, l), h = !1, p = 0; ; ) {
          ...
          8 & b
            ...
            : 4 & b
              ...
              : 2 & b
                ? ((g = r + ((a - r) * (c - n)) / (i - n)), (v = c))
                : ((g = r + ((a - r) * (s - n)) / (i - n)), (v = s)),
            b === d ? (d = f((n = v), (r = g), s, u, c, l)) : (_ = f((i = v), (a = g), s, u, c, l));
        }
        return h
        ...
        (t.intersectLineAndBox = function (e, t) {
          ...
          if (0 === e.A) {
            var u = -e.C / e.B;
            return i <= u && u <= s ? o.lineSegment(o.point(n, u), o.point(a, u)) : null;
          }
          if (0 === e.B) {
            var l = -e.C / e.A;
            return n <= l && l <= a ? o.lineSegment(o.point(l, i), o.point(l, s)) : null;
          }
          var f = [],
            d = function (t) {
              var n = (function (e, t) {
    ...
    24377: (e, t, n) => {
      ...
      function v(e) {
        ...
        if (0 === i) t = n = r = c;
          ...
          var l = c < 0.5 ? c * (1 + i) : c + i - c * i,
            f = 2 * c - l;
          (t = b(f, l, o + 1 / 3)), (n = b(f, l, o)), (r = b(f, l, o - 1 / 3));
        }
      ...
      !(function (e) {
        (e.re = /^rgb\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*\)$/),
          (e.parse = function (e) {
            return [a(parseInt(e[1], 10)), s(parseInt(e[2], 10)), u(parseInt(e[3], 10))];
          });
      })(x || (x = {})),
        (function (e) {
          (e.re = /^#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/),
            (e.parse = function (e) {
              return [a(parseInt(e[1], 16)), s(parseInt(e[2], 16)), u(parseInt(e[3], 16))];
            });
        })(j || (j = {})),
      ...
      !(function () {
        ...
        function p(e, t, n, r) {
          ...
          if (t < 1)
            ...
            if (
              ((r =
                (1 === n && o[t] >= 5) ||
                (2 === n && (o[t] > 5 || (5 === o[t] && (r || o[t + 1] !== _ || 1 & o[t - 1])))) ||
                (3 === n && (r || !!o[0]))),
              (o.length = t--),
              r)
            )
        ...
        function b(e, t, n) {
          var r = e.e,
            o = e.c.join(''),
            i = o.length;
          if (t) o = o.charAt(0) + (i > 1 ? '.' + o.slice(1) : '') + (r < 0 ? 'e' : 'e+') + r;
          else if (r < 0) {
            for (; ++r; ) o = '0' + o;
            o = '0.' + o;
          } else if (r > 0)
        ...
        (d.abs = function () {
          ...
          (d.div = function (e) {
            ...
            do {
              ...
              (j[E++] = h ? d : ++d), y[0] && h ? (y[w] = r[g] || 0) : (y = [r[g]]);
            } while ((g++ < m || y[0] !== _) && a--);
          ...
          (d.minus = d.sub =
            function (e) {
              ...
              var c = i.c.slice(),
                ...
                f = e.c,
                d = e.e;
              if (!c[0] || !f[0]) return f[0] ? (e.s = -u) : c[0] ? (e = new a(i)) : (e.s = 1), e;
              if ((s = l - d)) {
                for (
                  (o = s < 0) ? ((s = -s), (r = c)) : ((d = l), (r = f)), r.reverse(), u = s;
                  u--;
                ...
                for (n = ((o = c.length < f.length) ? c : f).length, s = u = 0; u < n; u++)
                  if (c[u] != f[u]) {
                    o = c[u] < f[u];
                    break;
                  }
          ...
          (d.plus = d.add =
            function (e) {
              ...
              if (((s = s.slice()), (t = a - u))) {
                for (t > 0 ? ((u = a), (r = c)) : ((t = -t), (r = s)), r.reverse(); t--; )
                  r.push(0);
                r.reverse();
              }
              for (
                s.length - c.length < 0 && ((r = c), (c = s), (s = r)), t = c.length, n = 0;
                t;
                s[t] %= 10
              )
                n = ((s[--t] = s[t] + c[t] + n) / 10) | 0;
              for (n && (s.unshift(n), ++u), t = s.length; 0 === s[--t]; ) s.pop();
          ...
          (d.times = d.mul =
            function (e) {
              ...
              for (u = s; u--; ) {
                for (s = 0, c = a + u; c > u; )
                  (s = t[c] + i[u] * o[c - u - 1] + s), (t[c--] = s % 10), (s = (s / 10) | 0);
                t[c] = s;
              }
          ...
          (i.manipulateListeners = function (e, t, n) {
            ...
            if ('object' != typeof t || t instanceof RegExp)
              ...
              for (r in t)
                t.hasOwnProperty(r) &&
                  (o = t[r]) &&
                  ('function' == typeof o ? i.call(this, r, o) : a.call(this, r, o));
            return this;
          }),
    ...
    27714: (e, t, n) => {
      ...
      var a = (function () {
        function e(e, t, n) {
          ...
          (this._canvasElement = null),
            ...
            (this._allowResizeObserver =
              null === (o = null == n ? void 0 : n.allowResizeObserver) || void 0 === o || o),
        ...
        return (
          ...
          (e.prototype._suggestNewBitmapSize = function (e) {
            ...
            (null === t && null === i) ||
              (null !== t && null !== i && o(t, i)) ||
              ((this._suggestedBitmapSize = i), this._emitSuggestedBitmapSizeChanged(t, i));
          }),
      ...
      function s(e, t) {
        if ('device-pixel-content-box' === t.type) return new a(e, t.transform, t.options);
    ...
    75440: (e, t, n) => {
      ...
      const p = function () {
        (this.size = 0),
          (this.__data__ = { hash: new d(), map: new (h.default || _.default)(), string: new d() });
      };
      const b = function (e) {
        var t = typeof e;
    ...
    87593: (e, t, n) => {
      ...
      const l = function (e, t) {
        ...
        if (n instanceof r.default) {
          var o = n.__data__;
          if (!u.default || o.length < 199) return o.push([e, t]), (this.size = ++n.size), this;
    ...
    49084: (e, t, n) => {
      ...
      var r = n(31434),
        o = n(13383);
      const i = function (e, t) {
        for (var n = 0, i = (t = (0, r.default)(t, e)).length; null != e && n < i; )
          e = e[(0, o.default)(t[n++])];
    ...
    12189: (e, t, n) => {
      ...
      const m = function (e, t, n, r, o, i, a) {
        switch (n) {
          ...
          case '[object ArrayBuffer]':
            return !(e.byteLength != t.byteLength || !i(new _.default(e), new _.default(t)));
          case '[object Boolean]':
          case '[object Date]':
          case '[object Number]':
      ...
      const R = function (e, t, n, o, i, a) {
        ...
        if (h && !d)
          return (
            a || (a = new r.default()),
            s || (0, O.default)(e) ? f(e, t, n, o, i, a) : m(e, t, c, n, o, i, a)
          );
        if (!(1 & n)) {
    ...
    52949: (e, t, n) => {
      ...
      const i = function (e, t, n, i) {
        ...
        for (var s = -1, u = t.length; ++s < u; ) {
          ...
          void 0 === l && (l = e[c]), a ? (0, o.default)(n, c, l) : (0, r.default)(n, c, l);
        }
        return n;
      };
    },
    ...
    52494: (e, t, n) => {
      ...
      const b = function (e) {
        return !(!(0, u.default)(e) || s(e)) && ((0, r.default)(e) ? p : l).test((0, c.default)(e));
      };
      const v = function (e, t) {
    ...
    85146: (e, t, n) => {
      ...
      var a = n(10964),
        s = n(5196);
      const u = function (e) {
        return 'function' != typeof e.constructor || (0, s.default)(e) ? {} : i((0, a.default)(e));
      };
    },
    99313: (e, t, n) => {
      'use strict';
    ...
    90484: (e, t, n) => {
      ...
      const c = function (e, t, n) {
        ...
        return (
          ...
          (0, r.default)(n) &&
            ((p = !!n.leading),
            (l = (b = 'maxWait' in n) ? s((0, a.default)(n.maxWait) || 0, t) : l),
            (v = 'trailing' in n ? !!n.trailing : v)),
          (x.cancel = function () {
            void 0 !== d && clearTimeout(d), (h = 0), (o = _ = c = d = void 0);
          }),
          (x.flush = function () {
    ...
    54404: (e, t, n) => {
      ...
      const c = i(
        ...
        ? i
        : function (e) {
            return (0, o.default)(e) && s.call(e, 'callee') && !u.call(e, 'callee');
          };
    },
    56052: (e, t, n) => {
      'use strict';
    ...
    83350: (e, t, n) => {
      ...
      const i = function (e) {
        return (
          !0 === e || !1 === e || ((0, o.default)(e) && '[object Boolean]' == (0, r.default)(e))
        );
      };
    },
    32437: (e, t, n) => {
    ...
    69708: (e, t, n) => {
      ...
      const i = function (e) {
        return (
          'number' == typeof e || ((0, o.default)(e) && '[object Number]' == (0, r.default)(e))
        );
      };
    },
    82433: (e, t, n) => {
    ...
    83873: (e, t, n) => {
      ...
      const a = function (e) {
        return (
          'string' == typeof e ||
          (!(0, o.default)(e) && (0, i.default)(e) && '[object String]' == (0, r.default)(e))
        );
      };
    },
    98111: (e, t, n) => {
      ...
      const i = function (e) {
        return (
          'symbol' == typeof e || ((0, o.default)(e) && '[object Symbol]' == (0, r.default)(e))
        );
      };
    },
    9125: (e, t, n) => {
      ...
      (a['[object Float32Array]'] =
        ...
        (a['[object Arguments]'] =
          ...
          a['[object WeakMap]'] =
            !1);
      const s = function (e) {
        return (0, i.default)(e) && (0, o.default)(e.length) && !!a[(0, r.default)(e)];
      };
      var u = n(5467),
        c = n(92350),
    ...
    16738: (e, t, n) => {
      ...
      var r = n(87593),
        ...
        i = n(54523);
      const a = function (e, t, n) {
        ((void 0 !== n && !(0, i.default)(e[t], n)) || (void 0 === n && !(t in e))) &&
          (0, o.default)(e, t, n);
      };
      var s = n(76507),
        u = n(14054),
      ...
      const N = function e(t, n, o, i, u) {
        t !== n &&
          (0, s.default)(
            n,
            function (s, c) {
              if ((u || (u = new r.default()), (0, m.default)(s))) C(t, n, c, o, e, i, u);
              else {
      ...
      const I = function (e, t, n) {
        return (
          ...
          function () {
            for (var r = arguments, o = -1, i = M(r.length - t, 0), a = Array(i); ++o < i; )
              a[o] = r[t + o];
            o = -1;
        ...
        return U(function (t, n) {
          ...
          for (
            i = e.length > 3 && 'function' == typeof i ? (o--, i) : void 0,
              a && (0, W.default)(n[0], n[1], a) && ((i = o < 3 ? void 0 : i), (o = 1)),
              t = Object(t);
            ++r < o;
    ...
    39852: (e, t, n) => {
      ...
      var m = n(31434),
        ...
        E = n(13383);
      const S = function (e, t, n) {
        for (var r = -1, o = (t = (0, m.default)(t, e)).length, i = !1; ++r < o; ) {
      ...
      const A = function (e, t) {
        return (0, z.default)(e) && _(t)
          ...
          : function (n) {
              ...
              return void 0 === r && r === t ? O(n, e) : (0, l.default)(t, r, 3);
            };
      };
      var P = n(76402);
      const k = function (e) {
