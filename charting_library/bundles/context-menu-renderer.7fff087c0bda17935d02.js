          ...
          for (var t = [], e = 0; e < arguments.length; e++) {
            ...
            if (n) {
              ...
              if ('string' === i || 'number' === i) t.push(n);
                ...
                s && t.push(s);
              } else if ('object' === i) for (var u in n) r.call(n, u) && n[u] && t.push(u);
            }
          }
          return t.join(' ');
        }
      ...
      function i(t) {
        ...
        return (
          ...
          (0, o.useIsomorphicLayoutEffect)(() => {
            if (null !== e.current) return u.current(e.current), () => u.current(null);
          }, [t]),
          e
        );
      }
      ...
      function i(t, e) {
        return class extends r.PureComponent {
          render() {
            ...
            return 'parent' === i ? s : r.createElement(o.Portal, { shouldTrapFocus: e }, s);
          }
        };
      }
    },
          ...
          this._onShow && this._onShow(),
            ...
            this._render({
              ...
              position: e => {
                ...
                'auto-strict' === f && (f = i < u.y + u.h + c + r ? 'bottom' : 'top');
                let m = u.y;
                switch (f) {
                  case 'top':
                    ...
                    break;
                  case 'bottom':
                    (m = Math.max(0, u.y - c - r)), (d = 0 === m ? u.y - c : void 0);
                }
