  ...
  [7271],
  {
    ...
    56217: (e, t, s) => {
      ...
      const u = (0, d.getExchanges)(),
        m = {};
      for (const e of u) m[e.value] = { country: e.country, providerId: e.providerId };
      var y = s(88145);
      function S(e) {
      ...
      class v {
          ...
          (() => {
            ...
            Promise.all([this._getResolveSymbolPromise(e), r]).then(t =>
              this._handleApplyProcess(
                ...
                (e, t, s) => ('symbol_resolved' === e.method ? _(e.params[1], !0, s) : p(t, !0, s)),
              ),
            ),
              g.emit('add_compare');
          })();
        ...
        _handleInitProcess(e, t, s, o) {
          ...
          for (const r of e) {
            ...
            if (void 0 === a || c) this._recentSymbolsEnabled && n.push(o(e, i, !1));
            else for (const t of a) n.push(o(e, i, !0, this._idToStudyMap.get(t)));
          }
        ...
        _saveRecent(e) {
          ...
          t.has(e) && t.delete(e),
            t.add(e),
            f.setJSON('CompareDialog.recent', Array.from(t).slice(-this._recentLength));
        }
