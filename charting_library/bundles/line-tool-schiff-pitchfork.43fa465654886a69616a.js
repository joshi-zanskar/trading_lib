  ...
  [7175, 5055],
  {
    15399: (e, t, i) => {
      ...
      class P extends o.DefaultProperty {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, o.extractState)(
              (0, s.default)((0, r.default)(t), u(e, this._map, this._levelsIterator)),
              this._allStateKeys,
        ...
        merge(e, t) {
          return super.merge(this._map ? u(e, this._map, this._levelsIterator) : e, t);
        }
        _options() {
          return {
            ...super._options(),
    ...
    64002: (e, t, i) => {
      ...
      var r = i(50151),
        ...
        p = i(44672),
        d = i(96333);
      const f = new s.TranslatedString('erase level line', n.t(null, void 0, i(77114))),
        u = new s.TranslatedString('change {title} style', n.t(null, void 0, i(98463)));
      var P;
      !(function (e) {
