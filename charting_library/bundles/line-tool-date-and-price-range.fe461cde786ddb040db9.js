  ...
  [1455],
  {
    76607: (e, t, i) => {
        ...
        d = new Map([
          ...
          [
            r.StdTheme.Dark,
            {
              ...
              labelBackgroundColor: (0, s.getHexColorByName)('color-cold-gray-800'),
              linecolor: u,
              backgroundColor: (0, o.generateColor)(u, 85),
      ...
      class y extends n.LineDataSourceProperty {
        constructor({ nonThemedDefaultsKeys: e, themedDefaultsKeys: t, state: i, ...s }) {
          super({
    ...
    70791: (e, t, i) => {
      ...
      const m = (0, a.getHexColorByName)('color-tv-blue-500'),
        h = { ...d.nonThemedFactoryDefaultsBase, drawBorder: !1, borderWidth: 1 },
        y = new Map([
          [
            l.StdTheme.Light,
            { ...d.themedFactoryDefaultsBase.get(l.StdTheme.Light), borderColor: m },
          ],
          [
            l.StdTheme.Dark,
            { ...d.themedFactoryDefaultsBase.get(l.StdTheme.Dark), borderColor: m },
          ],
        ]),
        ...
        f = (0, n.extractAllPropertiesKeys)((0, s.ensureDefined)(y.get(l.StdTheme.Light))),
      ...
      class v extends d.DateAndPriceBaseProperties {
        static create(e, t) {
          return new this({
            ...
            factoryDefaultsSupplier: () => (0, u.factoryDefaultsForCurrentTheme)(h, y),
      ...
      class T extends r.LineDataSource {
        constructor(e, t, s, r) {
          super(e, t ?? T.createProperties(e.backgroundTheme().spawnOwnership()), s, r),
    ...
    38039: (e, t, i) => {
      ...
      class l extends a.DefaultProperty {
        ...
        applyTemplate(e) {
          this.mergeAndFire(
            (0, a.extractState)(
              (0, r.default)((0, s.default)(this._factoryDefaultsSupplier()), e),
              this._templateKeys,
            ),
          );
        }
