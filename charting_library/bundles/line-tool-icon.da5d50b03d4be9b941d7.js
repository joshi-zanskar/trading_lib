  ...
  [7806],
  {
    ...
    15510: (e, t, i) => {
      ...
      const p = (0, c.getHexColorByName)('color-tv-blue-500'),
        f = { intervalsVisibilities: { ...h.intervalsVisibilitiesDefaults }, color: p, size: 40 },
      ...
      class V extends u.LineDataSourceProperty {
        constructor(e) {
          super(e),
            this.addChild('backgroundsColors', new v.LineToolColorsProperty([this.childs().color]));
        }
        static create(e, t, i) {
          return new this({
      ...
      class _ extends o.LineToolSvgIconBase {
        constructor(e, t, i, n) {
          super(e, t ?? _.createProperties(e.backgroundTheme().spawnOwnership()), i, n),
            (this.version = 1),
            this._loadViews();
        }
        name() {
        ...
        async _loadViews() {
          const [{ getSvgContentForCharCode: e, getSvgRenderer: t }, { IconPaneView: n }] =
            await Promise.all([
              i.e(7987).then(i.bind(i, 25482)),
              Promise.all([i.e(6290), i.e(9116), i.e(1200), i.e(1583)]).then(i.bind(i, 11735)),
            ]);
          if (!this._isDestroyed) {
            const i = this._properties.childs().icon.value();
            (this._svgContent = e(i)), this._onIconChanged.fire();
            const o = t(s.svgRenderer, i);
            null === o && S.logWarn(`Couldn't create svg renderer for icon ${i}`),
    ...
    38039: (e, t, i) => {
      ...
      class a extends r.DefaultProperty {
        ...
        applyTemplate(e) {
          this.mergeAndFire(
            (0, r.extractState)(
              (0, s.default)((0, n.default)(this._factoryDefaultsSupplier()), e),
              this._templateKeys,
            ),
          );
        }
    ...
    22329: (e, t, i) => {
      ...
      class u extends l.LineDataSource {
        ...
        startChanging(e, t) {
          const i = (0, s.ensureNotNull)(this.pointToScreenPoint(this._points[0])),
          ...
          (this._changePointData = { centerPoint: i, initialLength: c, initialSize: a }),
