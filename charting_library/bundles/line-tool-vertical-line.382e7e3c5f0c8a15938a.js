...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => P, InplaceTextUndoCommand: () => g });
      var n = i(50279),
        s = i(50151),
        r = i(86441),
        o = i(19625),
      ...
      class P extends _.LineDataSource {
        ...
        async _openTextEditor(e, t, n, o, a) {
          ...
          const { text: h, textColor: u, wordWrap: c } = this.editableTextProperties(),
          ...
          l(this._container, V), this.updateAllViewsAndRedraw((0, p.sourceChangeEvent)(this.id()));
        }
        _closeTextEditor() {
    ...
    56096: (e, t, i) => {
      ...
      class d extends a.InplaceTextLineDataSource {
        constructor(e, t, n, s) {
          super(e, t ?? d.createProperties(e.backgroundTheme().spawnOwnership()), n, s),
        ...
        paneViews(e) {
          if (
            ...
            return null;
          if (null === this._getPaneViews(e) && null !== this._paneViewFactory) {
            const t = this._paneViewFactory(e);
            this._verticalLinePaneViews.set(e, t), this._setPaneViews([t], e, !0);
          }
        ...
        static createProperties(e, t) {
          ...
          const i = new r.DefaultProperty({ defaultName: 'linetoolvertline', state: t, theme: e });
        ...
        _additionalCursorData() {
          return (0, n.ensureDefined)(
            this._verticalLinePaneViews.get((0, n.ensureNotNull)(this._model.paneForSource(this))),
