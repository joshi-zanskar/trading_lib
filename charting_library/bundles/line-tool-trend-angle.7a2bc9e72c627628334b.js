...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => T, InplaceTextUndoCommand: () => w });
      var n = i(50279),
        s = i(50151),
        o = i(86441),
        r = i(19625),
      ...
      class T extends _.LineDataSource {
        ...
        async _openTextEditor(e, t, n, r, a) {
          ...
          l(this._container, x), this.updateAllViewsAndRedraw((0, g.sourceChangeEvent)(this.id()));
        }
        _closeTextEditor() {
    ...
    83776: (e, t, i) => {
      ...
      class h extends a.Property {
        ...
        value() {
          return Math.round((100 * this._lineSource.angle() * 180) / Math.PI) / 100;
        }
        setValue(e) {
          ...
          u.updateSource(this._lineSource),
            this._lineSource.updateAllViews((0, l.sourceChangeEvent)(this._lineSource.id())),
            u.updateSource(this._lineSource);
        }
        notifyChanged() {
      ...
      class c extends r.InplaceTextLineDataSource {
        constructor(e, t, n, s) {
          const o = t ?? c.createProperties(e.backgroundTheme().spawnOwnership());
          super(e, o, n, s),
            (this._angle = 0),
            (this._distance = 0),
        ...
        _calculateAngle() {
          const e = (0, s.ensureNotNull)(this.pointToScreenPoint(this.points()[0]));
          let t = (0, s.ensureNotNull)(this.pointToScreenPoint(this.points()[1])).subtract(e);
          const i = t.length();
          i > 0
            ? ((t = t.normalized()),
