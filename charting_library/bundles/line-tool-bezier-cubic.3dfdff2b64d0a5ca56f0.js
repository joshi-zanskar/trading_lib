  ...
  [9014],
  {
    73174: (e, t, n) => {
      ...
      class l extends a.UndoCommand {
        ...
        redo() {
          const e = (0, i.ensureNotNull)(this._model.dataSourceForId(this._lineToolId));
      ...
      const p = -5e4,
        g = 15e3,
        _ = new r.TranslatedString('change price Y coordinate', o.t(null, void 0, n(11737))),
        f = new r.TranslatedString('change bar X coordinate', o.t(null, void 0, n(2066))),
      ...
      function S(e, t, n, i, o, r) {
        ...
        return (0, d.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, u.removeSpaces)(`${r}Coordinates${o}`), title: o, ...s.info, ...a.info },
        );
      }
      const v = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/;
      function y(e, t, n) {
                ...
                e.filter(e => !e.isSourceHidden()).forEach(e => {
                  ...
                  switch (s) {
                    case '': {
                      ...
                      (r -= e.price),
                        (t -= e.index),
                        (o = n.map(e => ({ ...e, index: e.index + t, price: e.price + r })));
                      break;
                    }
                    case '-':
                    case '+': {
                      ...
                      '-' === s && ((e *= -1), (t *= -1)),
                        (o = n.map(n => ({ ...n, index: n.index + e, price: n.price + t })));
                      break;
                    }
                    case '*': {
    ...
    53749: (e, t, n) => {
      ...
      const a = new o.TranslatedString(
        ...
        l = new o.TranslatedString('change {toolName} line width', i.t(null, void 0, n(19541))),
        d = new o.TranslatedString('change {toolName} line style', i.t(null, void 0, n(66429))),
        c = new o.TranslatedString('change {toolName} line color', i.t(null, void 0, n(24059))),
        h = new o.TranslatedString(
          'change {toolName} line extending left',
          i.t(null, void 0, n(18773)),
        ),
        u = new o.TranslatedString('change {toolName} line left end', i.t(null, void 0, n(21474))),
        p = new o.TranslatedString(
          'change {toolName} line extending right',
          i.t(null, void 0, n(43823)),
        ),
        g = new o.TranslatedString('change {toolName} line right end', i.t(null, void 0, n(54827))),
        _ = i.t(null, void 0, n(3554)),
        f = i.t(null, void 0, n(61856)),
        x = i.t(null, void 0, n(87430));
      function m(e, t, n, i, o) {
        const m = {},
          P = { id: `${(0, s.removeSpaces)(n.originalText())}${i}`, title: (o && o.line) || _ };
        return (
          void 0 !== t.showLine &&
    ...
    86622: (e, t, n) => {
      ...
      const d = new o.TranslatedString(
        ...
        c = new o.TranslatedString('change {title} background color', i.t(null, void 0, n(49765))),
    ...
    54696: (e, t, n) => {
      ...
      class m extends d.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          if (4 === t.points.length) {
            ...
            return null === x && (x = (0, _.hitTestExtendedPoints)(e, n, t.extendRightPoints)), x;
          }
          return null;
        }
        _drawImpl(e) {
      ...
      class v extends l.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          if (4 === this._source.points().length) {
            const r = (0, i.ensureNotNull)(
              ...
              s = (0, i.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[1])),
              a = (0, i.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[2])),
              l = (0, i.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[3])),
              d = l.subtract(r),
            ...
            t.extendLeft.value() && (n = this._extendSegmentLeft(a, r, c, p, g)),
              t.extendRight.value() && (o = this._extendSegmentRight(l, s, u, p, g));
          }
          const r = this._points.slice(),
            s = this._source.controlPoints();
          null !== s &&
            (r.push((0, i.ensureNotNull)(this._source.pointToScreenPoint(s[0]))),
          ...
          const l = {
            ...
            backColor: (0, a.generateColor)(t.backgroundColor.value(), t.transparency.value()),
            extendLeftPoints: n,
            extendRightPoints: o,
          };
        ...
        _extendSegmentLeft(e, t, n, o, r) {
          return (
            (0, S.cacheIsValid)(this._extendedSegmentLeftCache, e, t, n, o, r) ||
        ...
        _extendSegmentRight(e, t, n, o, r) {
          return (
            (0, S.cacheIsValid)(this._extendedSegmentRightCache, e, t, n, o, r) ||
      ...
      class y extends r.LineDataSource {
        constructor(e, t, n, i) {
          super(e, t ?? y.createProperties(e.backgroundTheme().spawnOwnership()), n, i),
        ...
        restorePoints(e, t, n) {
          super.restorePoints(e, t, n), this._createPointProperty(2), this._createPointProperty(3);
        }
        controlPoints() {
        ...
        _calculateControlPoints() {
          const e = (0, i.ensureNotNull)(this.pointToScreenPoint(this.points()[0])),
      ...
      class c extends r.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          if (3 === this._source.points().length) {
            ...
            t.extendLeft.value() && (n = this._extendSegmentLeft(a, o, d, h, u)),
              t.extendRight.value() && (r = this._extendSegmentRight(a, s, c, h, u));
          }
          const a = this._points.slice(),
            l = this._source.controlPoint();
          null !== l && a.push((0, i.ensureNotNull)(this._source.pointToScreenPoint(l)));
          const d = {
            points: a,
            color: t.linecolor.value(),
            lineWidth: t.linewidth.value(),
            ...
            rightEnd: t.rightEnd.value(),
            fillBack: t.fillBackground.value(),
            backColor: (0, o.generateColor)(t.backgroundColor.value(), t.transparency.value()),
      ...
      class g extends o.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          if (null !== this._data && 3 === this._data.points.length) {
            ...
            return null === h && (h = u(e, t, this._data.extendRightSegments)), h;
          }
          return null;
        }
        _drawImpl(e) {
    ...
    27916: (e, t, n) => {
      ...
      class _ {
        ...
        addAnchors(e, t = {}) {
          ...
          this._model.lineBeingCreated() === this._source && (n = n.slice(0, -1));
          const i = this._source.points(),
            o = n.map((e, t) => {
              const n = i[t],
                o = (0, l.lineSourcePaneViewPointToLineAnchorPoint)(e);
              return n && ((o.snappingPrice = n.price), (o.snappingIndex = n.index)), o;
            });
        ...
        createLineAnchor(e, t) {
          ...
          const i = (0, r.lastMouseOrTouchEventInfo)().isTouch,
            ...
            a = this.isHoveredSource() ? (this._model.lastHittestData()?.pointIndex ?? null) : null;
          return (
            o.setData({
              ...e,
        ...
        _needLabelExclusionPath(e, t) {
          ...
          return 'middle' === (t ?? n.vertLabelsAlign.value()) && (0, c.needTextExclusionPath)(e);
        }
        _addAlertRenderer(e, t, n = this._source.properties().linecolor.value()) {}
        _getAlertRenderer(e, t = this._source.properties().linecolor.value(), n) {
          return null;
        }
    ...
    66825: (e, t, n) => {
      ...
      function l(e, t, n, i, r, s) {
        const l = t.subtract(e).length() + n.subtract(t).length() + i.subtract(n).length(),
          d = Math.max(3 / l, 0.02);
        let c;
        for (let l = 0; ; l += d) {
          const d = a(e, t, n, i, l);
      ...
      function c(e, t, n, i) {
        ...
        if (Math.abs(r) > 1e-8) {
          const e = s * s - 4 * r * a;
          e >= 0 && (o.push((-s + Math.sqrt(e)) / (2 * r)), o.push((-s - Math.sqrt(e)) / (2 * r)));
        } else o.push(-a / s);
        return o;
      }
      function h(e, t, n, i) {
    ...
    36036: (e, t, n) => {
      ...
      class x extends h.BitmapCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          for (const t of n) {
            if (t.point.subtract(e).length() <= i)
              return new l.HitTestResult(t.hitTarget ?? l.HitTarget.ChangePoint, {
        ...
        doesIntersectWithBox(e) {
          return null !== this._data && this._data.points.some(t => (0, o.pointInBox)(t.point, e));
        }
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, n, g, p), i.length && this._drawPoints(e, i, o, f, _);
        }
        _drawPoints(e, t, n, o, s) {
          ...
          for (let e = 0; e < t.length; ++e) {
            const r = t[e];
            if (!((0, a.isInteger)(r.pointIndex) && h.linePointBeingEdited === r.pointIndex)) {
              l.fillStyle = n[e];
              if (
                (o(
                  l,
                ...
                if (null !== h.hoveredPointIndex && r.pointIndex === h.hoveredPointIndex) {
