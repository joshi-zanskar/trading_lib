...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    98653: (e, t, i) => {
      i.r(t), i.d(t, { SavingLineToolsError: () => o, SavingLineToolsLibraryError: () => s });
    ...
    40076: (e, t, i) => {
      ...
      class V {
        ...
        resetInvalidated(e, t, i, o) {
          ...
          const { groups: n, sources: r, lineToolsToValidate: a, groupsToValidate: l } = t,
            d = N(this._invalidatedLineToolsAndStudyStubs, e, new Set(a ?? r.keys()));
          ...
          const h = N(this._invalidatedLineToolGroups, e, new Set(l ?? n.keys()));
          d.validated.forEach(
            s.bind(
              this,
            ...
            Array.from(r.keys()).forEach(e => {
              ...
              t &&
                (void 0 !== o
                  ...
                  : null === t.serverUpdateTime() && t.setServerUpdateTime(new Date().valueOf()));
            }),
            this._recalculateHasChanges();
        }
        ...
        _processLineToolsGroupModelChanged(e, t) {
          ...
          this._invalidateLineToolGroup(e, i),
            t &&
              (t.affectedLineTools || []).forEach(e => this._invalidateLineToolOrStudyStub(e, i));
        }
          ...
          this._withoutInvalidating(() => {
            this._chartModel.bulkActionMacro(() => {
              o.forEach(e => {
                ...
                const t = (0, c.ensureNotNull)(this._chartModel.paneForSource(e));
                this._chartModel.removeSource(e);
                (this._allLineToolsAndStudyStubs.get(t.id()) ?? new Map()).delete(e.id());
              }),
        ...
        _unloadLinesOnSeries(e, t, i) {
          ...
          this._unloadLineTools(s, e => e.boundToSymbol() && e.ownerSource() === o, t);
        }
        _isAutosaveEnabled() {
          return !1;
        }
        ...
        async _makeLoadRequestAndMerge(e, t, i) {
          ...
          return this._savePromise('mainSeriesLineTools' === e.requestType)
            .catch(() => {})
            .then(() => n.loadLineToolsAndGroups(this._origin.layoutId, this._origin.chartId, e, i))
            .catch(() => null)
            .then(async i => {
          ...
          return (
            (t.groups || new Map()).forEach((t, n) => {
              ...
              if (null === t) {
                if (r) {
                  const e =
                    o && o.layoutId === this._origin.layoutId && o.chartId === this._origin.chartId;
        ...
        _createNewLineTool(e) {
          ...
          if (null !== s) {
            ...
            e.set(s.id(), s.linkKey().value()), this._allLineToolsAndStudyStubs.set(i.id(), e);
          }
          return s;
        }
        ...
        _restoreLineTool(e, t, i, o) {
          if ((t.state.points ?? []).some(e => !(0, v.isNumber)(e.time_t))) return null;
          ...
          if (
            r &&
            (n && this._invalidateLineToolOrStudyStub(t.id, performance.now(), !0),
        ...
        async _applyLineToolsAndGroupsDTO(e, t, i) {
          const o = this._chartModel.chartSaveTime(),
            s = this._withoutInvalidating(() => this._restoreGroups(o, e, t, i)),
                ...
                this._chartModel.bulkActionMacro(() => {
                  (e.sources || new Map()).forEach((e, n) => {
                    try {
                      ...
                      G.logError(`Error restoring line tool ${n} (${e?.state.type}): ${t}`),
                        e?.state.type &&
                          !r.has(e.state.type) &&
                          G.logError(`Line tool ${e.state.type} may need to be initialised first`);
                    }
                  }),
        ...
        _invalidateLineToolOrStudyStub(e, t, i) {
          ...
          const o = this._invalidatedLineToolsAndStudyStubs.get(e)?.invalidatedViaSyncOnly,
        ...
        _prepareDTOItem(e, t, i = !1) {
          ...
          return (
            this._invalidatedLineToolsAndStudyStubs.forEach((r, a) => {
              ...
              if (!A(l))
                if (null === l) {
                  (this._originalLineToolSharingMode.get(a) === t || i) && o.set(a, null);
                } else {
                  if (
                  ...
                  if (r) {
                    ...
                    if (d)
                      ...
                      i === t && o.set(a, null), null !== e && i === t && s.set(e.id, null);
                    }
                  }
                }
            }),
            this._invalidatedLineToolGroups.forEach((e, i) => {
              if (0 !== t && e.invalidatedViaSyncOnly) r.push(i);
                ...
                if (null === e) {
                  this._originalLineToolGroupsSharingMode.get(i) === t && s.set(i, null);
                } else e.sharingMode().value() === t && s.set(i, D(e, this._chartModel));
              }
            }),
            {
              sources: o,
