...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4201],
  {
    36590: (e, t, i) => {
      ...
      class r extends s.PriceAxisView {
        ...
        _updateRendererData(e, t, i) {
          ...
          if (null === l) return;
          const h = (0, n.resetTransparency)(this._source.properties().linecolor.value());
          (i.background = h),
    ...
    43636: (e, t, i) => {
      ...
      class a extends r.InplaceTextLineDataSource {
        ...
        static createProperties(e, t) {
          const i = new n.DefaultProperty({ defaultName: 'linetoolhorzline', state: t, theme: e });
    ...
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => P, InplaceTextUndoCommand: () => m });
      var s = i(50279),
        n = i(50151),
        r = i(86441),
        o = i(19625),
