  ...
  [2816],
  {
      ...
      class x extends o.DefaultProperty {
        ...
        state(e, t, i) {
          ...
          return i
            ...
            : ((n = s),
              (r = this._map),
              (0, this._levelsIterator)(n, { tpl: d, fill: h, typecheck: r.typecheck.pack }, r));
          var n, r;
        }
        preferences() {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, o.extractState)(
              (0, n.default)((0, s.default)(t), p(e, this._map, this._levelsIterator)),
              this._allStateKeys,
        ...
        merge(e, t) {
          return super.merge(this._map ? p(e, this._map, this._levelsIterator) : e, t);
        }
        _options() {
          return {
            ...super._options(),
    ...
    57994: (e, t, i) => {
      ...
      var s = i(50151),
        ...
        l = i(85719),
        h = i(24362);
      const c = new r.TranslatedString('erase level line', n.t(null, void 0, i(77114)));
      var d;
      !(function (e) {
      ...
      class u extends h.InplaceTextLineDataSource {
        constructor(e, t, s, n) {
          super(e, t ?? u.createProperties(e.backgroundTheme().spawnOwnership()), s, n),
            Promise.all([i.e(6290), i.e(9116), i.e(1200), i.e(1583)])
              .then(i.bind(i, 83201))
              .then(e => {
                this._setPaneViews([new e.FibCirclesPaneView(this, this._model)]);
              });
        }
        levelsCount() {
          return 11;
        ...
        static _configureProperties(e) {
          ...
          for (let t = 1; t <= 11; t++)
            i.push((0, s.ensureDefined)(e.child('level' + t)?.child('linewidth'))),
    ...
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => v, InplaceTextUndoCommand: () => m });
      var s = i(50279),
        n = i(50151),
        r = i(86441),
        o = i(19625),
