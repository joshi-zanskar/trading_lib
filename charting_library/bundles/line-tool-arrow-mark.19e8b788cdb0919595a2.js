    ...
    27621: (e, r, t) => {
      ...
      class l extends i.LineDataSource {
        constructor(e, r, o, n, i) {
          super(e, r ?? l.createProperties(e.backgroundTheme().spawnOwnership(), null, o), n, i),
        ...
        paneViews(e) {
          ...
          return null !== r && this._textPaneView && r.push(this._textPaneView), r;
        }
        pointsCount() {
          return 1;
        }
        ...
        _normalizePoint(e, r) {
          return super._normalizePointWithoutOffset(e) ?? super._normalizePoint(e, r);
        }
        _getPropertyDefinitionsViewModelClass() {
          return Promise.all([t.e(6406), t.e(3889), t.e(8009), t.e(8056), t.e(8537)])
            .then(t.bind(t, 67675))
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            e.addChild('linesColors', new a.LineToolColorsProperty([e.childs().arrowColor])),
            e.addChild('textsColors', new a.LineToolColorsProperty([e.childs().color])),
