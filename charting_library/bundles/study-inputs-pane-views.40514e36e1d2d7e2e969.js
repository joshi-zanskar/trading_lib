    ...
    36036: (e, t, i) => {
      ...
      class I extends c.BitmapCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, i, _, p), n.length && this._drawPoints(e, n, o, g, P);
        }
        _drawPoints(e, t, i, o, s) {
          const { context: l, horizontalPixelRatio: d, verticalPixelRatio: u } = e,
          ...
          for (let e = 0; e < t.length; ++e) {
            const r = t[e];
            if (!((0, a.isInteger)(r.pointIndex) && c.linePointBeingEdited === r.pointIndex)) {
              l.fillStyle = i[e];
              if (
                (o(
                  l,
    ...
    99549: (e, t, i) => {
      ...
      class h extends d.StudyInputsPaneView {
        ...
        _fillInformationAboutPointsAndCursors(e, t) {
          if (
            ((this._points = []), this._inputs.find(e => Array.isArray(e) || 'price' === e.type))
          ) {
        ...
        _studyAnchorColors(e, t) {
          return e.map(e => this._model.backgroundColorAtYPercentFromTop(e.point.y / t));
        }
          ...
          this._inputs.forEach(e => {
            if (Array.isArray(e)) {
              ...
              if (null !== n && null !== o) {
                ...
                null !== e && null !== r && (this._renderer.append(e), this._renderer.append(r));
              }
            } else {
    ...
    50546: (e, t, i) => {
      ...
      class r {
        ...
        renderer(e) {
          return (
            this._invalidated &&
              (this._updateImpl(e.mediaSize.height, e.mediaSize.width), (this._invalidated = !1)),
            this._renderer
          );
        }
        _updateImpl(e, t) {
