(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1702],
  {
    ...
    64530: (e, t, n) => {
      ...
      function m(e) {
        ...
        return i.createElement(
          ...
          i.createElement(
            'div',
            { id: N, role: 'cell', className: a()(u.itemInfo, !p && u.itemInfoWithPadding) },
            i.createElement(
              'div',
              {
            ...
            i.createElement('div', { className: a()(u.details, g && u.active, C && u.mobile) }, n),
          ),
    ...
    11386: (e, t, n) => {
        ...
        return (
          ...
          i.useEffect(() => {
            if (null !== t) {
              ...
              return d([...e.value()]), e.subscribe(() => d([...e.value()])), () => e?.destroy();
            }
          }, [t]),
          i.useMemo(
            () => ({
      ...
      function _(e) {
        const { isMobile: t, isSmallWidth: n, chartWidget: o, onClose: a, onInitialized: r } = e,
          {
            currentSymbol: c,
          ...
          [b, C] = i.useMemo(() => {
            if (null !== c && null !== d) {
              const e = [];
              let t = g;
              if (null === t) for (t = 2; t > 0 && !((d[t].get(c)?.size || 0) > 0); ) t--;
              return (
                d[t].forEach((t, n) => {
                  h.includes(n) ||
                    e.push({
        ...
        return (
          ...
          i.createElement(
            ...
            0 === b.length
              ...
              : b.map(({ symbol: e, drawingsCount: n, onRemove: o, onClick: a }, l) =>
