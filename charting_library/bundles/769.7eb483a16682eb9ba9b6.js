(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [769],
  {
    59142: function (d, e) {
      ...
      (t = [e]),
        (u = function (d) {
          ...
          function e(d) {
            if (Array.isArray(d)) {
              for (var e = 0, u = Array(d.length); e < d.length; e++) u[e] = d[e];
              return u;
            }
            return Array.from(d);
          }
          ...
          var n =
            ...
            i = function (d) {
              return c.some(function (e) {
                return !(!e.options.allowTouchMove || !e.options.allowTouchMove(d));
              });
            },
            l = function (d) {
              ...
              if (
                ...
                (c = [].concat(e(c), [s])),
                  (d.ontouchstart = function (d) {
                    1 === d.targetTouches.length && (r = d.targetTouches[0].clientY);
                  }),
                  (d.ontouchmove = function (e) {
                    ...
                    1 === e.targetTouches.length &&
                      ...
                      !i(u.target) &&
                        ((t && 0 === t.scrollTop && 0 < c) ||
                        ((n = t) && n.scrollHeight - n.scrollTop <= n.clientHeight && c < 0)
                          ? l(u)
                          : u.stopPropagation()));
                  }),
                  o ||
                    (document.addEventListener('touchmove', l, u ? { passive: !1 } : void 0),
                    (o = !0));
              }
            } else {
              (v = t),
            ...
            (d.clearAllBodyScrollLocks = function () {
              n
                ? (c.forEach(function (d) {
                    (d.targetElement.ontouchstart = null), (d.targetElement.ontouchmove = null);
                  }),
                  o &&
                    (document.removeEventListener('touchmove', l, u ? { passive: !1 } : void 0),
                    (o = !1)),
                  (c = []),
                  (r = -1))
                : (s(), (c = []));
        ...
        void 0 === (n = 'function' == typeof u ? u.apply(e, t) : u) || (d.exports = n);
    },
    36718: d => {
      d.exports = {
    ...
    13996: d => {
      d.exports = { emoji: 'emoji-BsERGcZ1', clearButton: 'clearButton-BsERGcZ1' };
    },
    84660: d => {
        ...
        return (
          (0, t.useLayoutEffect)(() => {
            const d = (0, n.ensureNotNull)(e.current),
              u = () => {
                const u = (0, c.queryTabbableElements)(d).sort(c.navigationOrderComparator);
                if (
                  0 === u.length ||
                  (u[0].parentElement && !m(u[0].parentElement, (0, n.ensureNotNull)(e.current)))
                ) {
                  const t = (function (d) {
          ...
          [
            ...
            function (e) {
              ...
              if (d) {
                ...
                (r = ((m = n),
                Array.from(
                  m.querySelectorAll('button:not([disabled]):not([aria-disabled])'),
              ...
              switch (h) {
                ...
                case 'blockNext':
                  (u => {
                    ...
                    if (!c) return;
                    const o = Array.from(c.children).indexOf(document.activeElement);
                    if (-1 === o) return;
                    const r = t['blockNext' === u ? t.indexOf(c) + 1 : t.indexOf(c) - 1];
                    if (!r) return;
                    e.preventDefault();
    ...
    47291: (d, e, u) => {
      ...
      function b(d) {
        ...
        const g = (0, t.useCallback)(d => ('title' === c[d].type ? v : o), [c, o]),
          w = (0, t.useCallback)(
            ({ visibleStartIndex: d }) => {
        ...
        return t.createElement(
          ...
          {
            value: (0, t.useMemo)(
              () => ({ size: o, onSelect: r, ItemComponent: f, RowComponent: i }),
              [o, r, f, i],
            ),
          },
      ...
      const p = t.memo(d => {
        ...
        return 'title' === c.type
          ? t.createElement('div', { style: e }, t.createElement(a, { title: c.relatedTitle }))
          : t.createElement(
              'div',
              { style: e },
              t.createElement(s, {
    ...
    38297: (d, e, u) => {
      ...
      function v(d) {
                ...
                return (
                  d.forEach(({ title: d, emojis: t }) => {
                    ...
                    for (const c of t)
                      n.length < e
                        ? n.push(c)
                        : (u.push({ type: 'emojiRow', relatedTitle: d, content: n }), (n = [c]));
                    n.length && u.push({ type: 'emojiRow', relatedTitle: d, content: n });
                  }),
                  u
                );
              })(u, C),
        ...
        return t.createElement(
          ...
          t.createElement(r.GroupTabs, {
            ...
            onTabClick: function (d) {
              ...
              I(
                (function (d) {
                  return N.findIndex(({ relatedTitle: e, type: u }) => 'title' === u && e === d);
                })(d),
              );
            },
          }),
        ...
        function I(d) {
          f.CheckMobile.iOS() && x.current && (x.current.style.overflow = 'hidden'),
            (E.current = !0),
            w.current?.scrollToItem(d, 'start'),
            requestAnimationFrame(() => {
              w.current?.scrollToItem(d, 'start'),
                f.CheckMobile.iOS() && x.current && (x.current.style.overflow = 'auto'),
                (E.current = !1);
            });
        }
      }
    ...
    26601: (d, e, u) => {
      ...
      var t = u(50959),
        ...
        r = u(34314);
      const a = t.memo(d => {
        const { emojis: e, itemSize: u, onEmojiClick: n, ItemComponent: a, className: f } = d;
        return t.createElement(
          'div',
    ...
    85034: (d, e, u) => {
      ...
      var t = u(50959),
        ...
        a = u(25474);
      function f(d) {
        const { tab: e, isActive: u, onTabClick: n, children: o, className: f } = d,
      ...
      var i = u(7110);
      function l(d) {
        const { activeTab: e, tabs: u, onTabClick: n, className: r, tabClassName: a } = d;
        return t.createElement(
          o.Toolbar,
          { orientation: 'horizontal', className: c()(i.wrapper, r), blurOnEscKeydown: !1 },
          u.map(({ title: d, content: u }) =>
            t.createElement(
              f,
              { key: d, tab: d, className: a, isActive: e === d, onTabClick: n },
              u,
            ),
          ),
        );
    ...
    86656: (d, e, u) => {
              ...
              return (
                ...
                null !== f.current &&
                  (r
                    ...
                    : (0, n.disableBodyScroll)(f.current, { allowTouchMove: i(f) })),
                () => {
                  a--,
                    null !== f.current &&
                      (r
      ...
      function i(d) {
        return e => {
          ...
          return !u.contains(e) || (null !== t && u.contains(t) && t.contains(e));
        };
      }
    },
    40173: (d, e, u) => {
        ...
        return (
          (0, t.useLayoutEffect)(() => {
            const d = (0, n.ensureNotNull)(h.current),
              e = () => {
                const e = (0, r.queryTabbableElements)(d).sort(r.navigationOrderComparator);
                if (0 === e.length) {
                  const [e] = (0, r.queryFocusableElements)(d).sort(r.navigationOrderComparator);
                  if (void 0 === e) return;
          ...
          t.createElement('div', {
            ...
            onKeyDown: (0, c.createSafeMulticastEventHandler)(function (d) {
              ...
              if (s && 27 === e) return d.preventDefault(), void document.activeElement.blur();
              if ('vertical' !== l && 37 !== e && 39 !== e) return;
              if ('vertical' === l && 38 !== e && 40 !== e) return;
              const u = d.currentTarget,
                t = (0, r.queryFocusableElements)(u).sort(r.navigationOrderComparator);
              ...
              const c = () => {
                  ...
                  (0, a.becomeSecondaryElement)(t[n]), (0, a.becomeMainElement)(t[d]), t[d].focus();
                },
                f = () => {
                  const d = (n + t.length + 1) % t.length;
                  (0, a.becomeSecondaryElement)(t[n]), (0, a.becomeMainElement)(t[d]), t[d].focus();
    ...
    19365: (d, e, u) => {
      ...
      function n(d, e) {
        ...
        return (
          t.default.parse(
            d,
            d => ((u = t.default.base + ('svg' === e ? `svg/${d}.svg` : `72x72/${d}.png`)), !1),
          ),
          u
        );
      }
      ...
      const t = (function () {
        var d = {
            ...
            parse: function (e, u) {
              ...
              return ('string' == typeof e ? v : m)(e, {
                ...
                ext: u.ext || d.ext,
                size: u.folder || ((t = u.size || d.size), 'number' == typeof t ? t + 'x' + t : t),
        ...
        function l(d, e) {
          for (var u, t, n = d.childNodes, c = n.length; c--; )
            3 === (t = (u = n[c]).nodeType)
              ? e.push(u)
              : 1 !== t || 'ownerSVGElement' in u || o.test(u.nodeName.toLowerCase()) || l(u, e);
          return e;
        }
        function s(d) {
        ...
        function m(d, e) {
          for (var t, n, c, o, r, f, i, m, v, h, b, p, g, w = l(d, []), E = w.length; E--; ) {
            for (
              c = !1, o = document.createDocumentFragment(), f = (r = w[E]).nodeValue, m = 0;
              (i = u.exec(f));
              ...
              if (
                ...
                (h.className = e.className), (h.alt = b), (h.src = g), (c = !0), o.appendChild(h);
              }
              h || o.appendChild(a(b, !1)), (h = null);
            }
            c &&
              (m < f.length && o.appendChild(a(f.slice(m), !0)), r.parentNode.replaceChild(o, r));
          }
          return d;
        }
        function v(d, e) {
        ...
        function g(d, e) {
          for (var u = [], t = 0, n = 0, c = 0; c < d.length; )
            (t = d.charCodeAt(c++)),
              n
                ? (u.push((65536 + ((n - 55296) << 10) + (t - 56320)).toString(16)), (n = 0))
                : 55296 <= t && t <= 56319
                  ? (n = t)
