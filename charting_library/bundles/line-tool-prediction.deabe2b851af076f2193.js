  ...
  [9534],
  {
    ...
    29356: (t, e, i) => {
      ...
      class u extends a.LineDataSource {
        constructor(t, e, s, r) {
          super(t, e ?? u.createProperties(t.backgroundTheme().spawnOwnership()), s, r),
          ...
          n
            ...
            n.dataEvents().dataUpdated().subscribe(this, this.recalculateStateByData),
        ...
        dataAndViewsReady() {
          return (
            ...
            Boolean(this._predictionPaneView && this._predictionPaneView.iconsReady())
          );
        }
        cloneable() {
          return !1;
        ...
        recalculateStateByData() {
          ...
          if (this.status())
            return void (
              t.index > this._model.timeScale().baseIndex() && this.setStatus(o.AlertStatus.Waiting)
            );
          ...
          if (i === o.Direction.Up && (0, s.ensure)(e[2]) >= t.price)
            ...
            const e = (0, s.ensureNotNull)(this._model.mainSeries().bars().lastIndex());
        ...
        endChanging(t, e) {
          ...
          return this.setStatus(o.AlertStatus.Waiting), this.recalculateStateByData(), i;
        }
        onData(t) {
        ...
        endMoving(t, e, i) {
          ...
          return this.setStatus(o.AlertStatus.Waiting), this.recalculateStateByData(), s;
        }
        direction() {
          if (this._points.length < 2) return o.Direction.Up;
          const t = this._points[0];
          return this._points[1].price > t.price ? o.Direction.Up : o.Direction.Down;
        }
        ...
        _ignoreSourceEvent(t) {
          return super._ignoreSourceEvent(t) && t.sourceId !== this._model.mainSeries().id();
        }
        ...
        static _configureProperties(t) {
          super._configureProperties(t),
            t.hasChild('status') || t.addChild('status', new n.Property(o.AlertStatus.Waiting));
        }
      }
    },
  },
