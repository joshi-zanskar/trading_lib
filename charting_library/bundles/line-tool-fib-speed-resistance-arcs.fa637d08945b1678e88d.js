...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3710],
  {
    73174: (e, t, i) => {
      ...
      const p = -5e4,
        f = 15e3,
        v = new o.TranslatedString('change price Y coordinate', r.t(null, void 0, i(11737))),
        _ = new o.TranslatedString('change bar X coordinate', r.t(null, void 0, i(2066))),
      ...
      function P(e, t, i, n, r, o) {
        ...
        return (0, c.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, h.removeSpaces)(`${o}Coordinates${r}`), title: r, ...l.info, ...s.info },
        );
      }
      const x = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/;
      function T(e, t, i) {
    ...
    53749: (e, t, i) => {
      ...
      const s = new r.TranslatedString(
        ...
        c = new r.TranslatedString('change {toolName} line style', n.t(null, void 0, i(66429))),
        d = new r.TranslatedString('change {toolName} line color', n.t(null, void 0, i(24059))),
        u = new r.TranslatedString(
          'change {toolName} line extending left',
          n.t(null, void 0, i(18773)),
        ),
        h = new r.TranslatedString('change {toolName} line left end', n.t(null, void 0, i(21474))),
        p = new r.TranslatedString(
          'change {toolName} line extending right',
          n.t(null, void 0, i(43823)),
        ),
        f = new r.TranslatedString('change {toolName} line right end', n.t(null, void 0, i(54827))),
        v = n.t(null, void 0, i(3554)),
        _ = n.t(null, void 0, i(61856)),
        g = n.t(null, void 0, i(87430));
      function y(e, t, i, n, r) {
        const y = {},
          m = { id: `${(0, l.removeSpaces)(i.originalText())}${n}`, title: (r && r.line) || v };
        return (
          void 0 !== t.showLine &&
      ...
      class v extends l.DefaultProperty {
        ...
        state(e, t, i) {
          ...
          return i
            ...
            : ((r = n),
              (o = this._map),
              (0, this._levelsIterator)(r, { tpl: u, fill: c, typecheck: o.typecheck.pack }, o));
          var r, o;
        }
        preferences() {
        ...
        saveDefaults() {
          this._useUserPreferences && (0, s.saveDefaults)(this._defaultName, this.preferences());
        }
        clone() {
    ...
    72609: (e, t, i) => {
      i.d(t, { LineToolPaneViewFibWithLabels: () => u, labelEdgeOffset: () => d });
      var n = i(50151),
        r = i(17330),
        o = i(56468),
        l = i(74079),
          ...
          if (o) {
            a +=
              (r.coeffsAsPercents?.value() ?? !1)
                ? this._percentageFormatter.format(100 * s, { signPositive: !1, tailSize: 2 })
    ...
    49145: (e, t, i) => {
      ...
      const v = new o.TranslatedString(
        ...
        _ = new o.TranslatedString('change {title} levels visibility', r.t(null, void 0, i(54517))),
        ...
        P = new o.TranslatedString('change {title} all lines color', r.t(null, void 0, i(59577))),
      ...
      class z extends $.MediaCoordinatesPaneRenderer {
        constructor(e, t, i) {
          super(),
            ...
            (this._backHittest = i || new M.HitTestResult(M.HitTarget.MovePointBackground));
        }
        hitTest(e) {
          const t = this._data;
      ...
      class B extends F.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e) {
          ...
          if (h.visible.value()) {
            ...
            this._trendLineRenderer.setData(e), c.append(this._trendLineRenderer);
          }
          this.addAnchors(c), (this._renderer = c);
        }
      }
      const X = new o.TranslatedString('erase level line', r.t(null, void 0, i(77114)));
      var O;
      !(function (e) {
      ...
      class Y extends c.InplaceTextLineDataSource {
        constructor(e, t, i, n) {
          super(e, t ?? Y.createProperties(e.backgroundTheme().spawnOwnership()), i, n),
        ...
        processErase(e, t) {
          const i = (0, n.ensureDefined)(this.properties().child(`level${t}`)).childs().visible;
