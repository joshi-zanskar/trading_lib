  ...
  [2544],
  {
    ...
    36383: (e, t, s) => {
      ...
      var n = s(50959),
        ...
        o = s(27267);
      function r(e) {
        const { click: t, mouseDown: s, touchEnd: r, touchStart: l, handler: a, reference: u } = e,
          c = (0, n.useRef)(null),
          d = (0, n.useRef)(
    ...
    9745: (e, t, s) => {
      ...
      const i = n.forwardRef((e, t) => {
        const { icon: s = '', title: i, ariaLabel: o, ariaLabelledby: r, ariaHidden: l, ...a } = e,
          u = !!(i || o || r);
      ...
      function u(e) {
        ...
        if (e && 1 == ++l) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (i(s, 'right', `${n()}px`), (t.style.paddingRight = `${l + n()}px`), (a = !0)),
          ...
          super(e),
            ...
            (this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
              ...
              const { width: h, height: p } = i,
                ...
                _ = a - (m.overrideWidth ?? h) - (m?.indentFromWindow?.right ?? 0),
                g = (0, l.clamp)(m.x, f, Math.max(f, _)),
                v = (m?.indentFromWindow?.top ?? 0) + u,
                y = o - (m.overrideHeight ?? p) - (m?.indentFromWindow?.bottom ?? 0);
              let b = (0, l.clamp)(m.y, v, Math.max(v, y));
              if (
                (m.forbidCorrectYCoord && b < m.y && ((c -= m.y - b), (b = m.y)),
                t &&
