  ...
  [5695],
  {
    25937: (e, t, o) => {
      ...
      var i = o(50151),
        ...
        d = o(16638),
        u = o(15491);
      const h = (0, i.ensureDefined)(u.lineToolsStudyIds.LineToolFixedRangeVolumeProfile);
      class p extends s.LineToolVbPFixed {
        constructor(e, t, o, i, s) {
          super(
            e,
            t,
            o || (0, d.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: h }),
            i,
            s,
          );
        }
        ...
        static createProperties(e, t) {
          const o = r.StudyMetaInfo.getStudyPropertyRootNameById(h),
            s = (0, i.ensureNotNull)(
              (0, d.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: h }),
            ),
        ...
        static createPropertiesFromStudyMetaInfoAndState(e, t, o, i, s) {
          const r = (0, c.prepareStudyPropertiesForLoadChart)(e, t, o, i, void 0, s);
    ...
    71131: (e, t, o) => {
      ...
      function m(e, t, o, i) {
        return (
          t.styles &&
            (_(t.styles.developingPoc), _(t.styles.developingVAHigh), _(t.styles.developingVALow)),
          t
        );
      }
      function _(e) {
      ...
      class P extends n.StudyLineDataSource {
        constructor(e, t, o, i, s) {
          super(
            e,
            o || (0, y.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: f }),
            'vbpfixed_',
            ...
            this._createPaneViews().then(e => {
              this._setPaneViews(e),
                e.forEach(e =>
                  e.update((0, c.sourceChangeEvent)({ sourceId: this.id(), clearData: !0 })),
                );
            }),
            this.clearData();
        }
        ...
        isPlotVisibleAt(e, t) {
          return (this.properties().childs().styles.childs()[e].childs().display.value() & t) === t;
        }
        preferredZOrder() {
          return 0;
        }
        static createProperties(e, t) {
          const o = r.StudyMetaInfo.getStudyPropertyRootNameById(f),
            i = (0, s.ensureNotNull)(
              (0, y.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: f }),
            ),
        ...
        _studyInputs(e) {
          (0, s.assert)(2 === e.length, 'all the line tool points should be defined');
          const [t, o] = e,
          ...
          if (null === a || null === c) return this._subscribeApplyInputsOnSeriesCompleted(), null;
          return {
        ...
        async _getPropertyDefinitionsViewModelClass() {
          return (
            await Promise.all([o.e(1190), o.e(3889), o.e(8009), o.e(4482), o.e(607)]).then(
              o.bind(o, 31507),
            )
        ...
        _updateAnchors() {
          ...
          this._timePoint.length &&
            ...
            this._points.length && ((this._points[0].price = t), (this._points[1].price = o));
        }
        _calculateAnchors() {
          let e = null,
            t = null,
          ...
          if (
            (this.graphics()
              ...
              .forEach(i => {
                i.forEach(i => {
                  const { priceLow: r, priceHigh: n, firstBarTime: l, lastBarTime: a } = i;
                  (null === e || r < e) && (e = r),
                    (null === t || n > t) && (t = n),
        ...
        async _createPaneViews() {
          ...
          if (t.hhists) {
            const { HHistPaneView: e } = await o.e(507).then(o.bind(o, 56208)),
              t = this.properties().childs().graphics.childs().polygons?.childs();
            i.push(new e(this, this._model, void 0, t?.histBoxBg, s, () => this._getLeftIndex()));
          }
          if (t.horizlines) {
            const { HorizLinePaneView: e } = await o.e(507).then(o.bind(o, 95258));
            i.push(new e(this, this._model, void 0, s, () => this._getLeftIndex()));
          }
          return (
            e.plots.length > 0 && i.push(this._createStudyPlotPaneView(e.plots[0].id, s)),
            e.plots.length > 1 && i.push(this._createStudyPlotPaneView(e.plots[1].id, s)),
            e.plots.length > 2 && i.push(this._createStudyPlotPaneView(e.plots[2].id, s)),
            i
          );
        }
        _createStudyPlotPaneView(e, t) {
          return new a.StudyPlotPaneView(this, this._model.mainSeries(), this._model, e, t);
        }
    ...
    47988: (e, t, o) => {
      ...
      function p(e) {
        ...
        return (
          e && i.push({ path: 'graphics.polygons.histBoxBg.color', colors: h.histogramBoxColor }), i
        );
      }
    },
  },
