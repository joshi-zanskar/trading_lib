  ...
  [4389],
  {
    7960: (e, t, n) => {
      ...
      function d(e, t = {}) {
        return new Promise((n, a) => {
          !(async function (e, t, n, a = {}) {
            ...
            if (void 0 !== a.previews) for (const e of a.previews) o.append('previews[]', e);
            ...
            const s = r.model().model().timezoneExceptExchange().value() ?? 'exchange';
            o.append('timezone', s), o.append('symbol', r.model().mainSeries().symbol());
            const d = await e.clientSnapshot({ showHeaderMainSymbol: a.showHeaderMainSymbol }),
      ...
      const p = (0, a.getLogger)('Platform.TakeChartImage'),
        w = new o.DateTimeFormatter({ dateTimeSeparator: '_', timeFormat: '%h-%m-%s' });
      async function m(e, t) {
        const n = 'text/plain',
          a = d(e, t),
          o = a.then(e => (t.snapshotUrl ? e : (0, s.convertImageNameToUrl)(e))),
      ...
      async function g(e) {
        ...
        try {
          ...
          const n = window.open();
          throw (n && n.document.write(`<img width="100%" src="${(await t).toDataURL()}"/>`), e);
        }
      }
      async function u(e) {
