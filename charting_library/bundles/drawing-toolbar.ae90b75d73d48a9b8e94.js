(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2878],
  {
    ...
    71402: (e, t, o) => {
      ...
      const l = { [n.Add]: i.t(null, void 0, o(69207)), [n.Remove]: i.t(null, void 0, o(85106)) };
    },
    36189: (e, t, o) => {
      'use strict';
      ...
      var n = o(50959),
        ...
        d = o(22413);
      function h(e) {
        const { className: t, isFilled: o, isActive: i, onClick: h, title: m, ...v } = e,
    ...
    20243: (e, t, o) => {
      ...
      function c(e) {
        ...
        switch ((0, n.mapKeyCodeToDirection)(t)) {
          case 'inlinePrev':
            if (!u.length) return;
            e.preventDefault(), b(0 === p ? s[c] : g ? d(u, p, -1) : u[u.length - 1]);
            break;
          case 'inlineNext':
            if (!u.length) return;
            e.preventDefault(), p === u.length - 1 ? b(s[c]) : b(g ? d(u, p, 1) : u[0]);
            break;
          case 'blockPrev': {
            e.preventDefault();
            const t = d(s, c, -1);
      ...
      function u(e) {
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(a.FavoriteButton, { ...u, isFilled: o, isActive: i, title: '' }),
          )
        );
      }
    },
    ...
    37159: (e, t, o) => {
            ...
            n.createElement(
              ...
              i &&
                n.createElement(
                  'div',
                  {
                    className: a()(E.scrollTop, { [E.isVisible]: d && r > c }),
              ...
              i &&
                n.createElement(
                  'div',
                  {
                    className: a()(E.scrollBot, { [E.isVisible]: u && r > c }),
      ...
      const se = [
        ...
        re = [
          { title: W.Emojis, content: n.createElement(j, { text: B.t(null, void 0, o(16290)) }) },
          { title: W.Stickers, content: n.createElement(j, { text: B.t(null, void 0, o(50428)) }) },
          { title: W.Icons, content: n.createElement(j, { text: B.t(null, void 0, o(73829)) }) },
        ];
      var ce = o(3343),
        ue = o(20520),
        de = o(27317),
      ...
      const be = o(77020),
        fe = (0, n.forwardRef)((e, t) => {
          const {
            ...
            F = (0, ve.mergeThemes)(de.DEFAULT_MENU_THEME, { menuBox: b.menuBox }),
            [k, S] = (0, n.useState)(!1),
            [y, M] = (0, n.useState)(!1),
            I = (0, n.useRef)(null),
            W = (0, n.useRef)(null),
          ...
          return (
            ...
            n.createElement(
              ...
              {
                ...E,
                className: s(b.dropdown, { [b.isGrayed]: m, [b.isActive]: h, [b.isOpened]: k }),
                onClick: m ? v : void 0,
              ...
              n.createElement(
                ...
                !m &&
                  ...
                  n.createElement(
                    ...
                    n.createElement(C.Icon, { className: b.arrowIcon, icon: ge }),
                  ),
              ),
              !m &&
                (g
          ...
          function U() {
            if (r.mobiletouch && !p) !N.current && f && f();
              ...
              if (D.current) return clearTimeout(D.current), (D.current = 0), void P(!0);
          ...
          function Z() {
            clearTimeout(N.current), (N.current = 0), clearTimeout(D.current), (D.current = 0);
          }
          function G(e) {
          ...
          function K() {
            N.current &&
              ...
              (N.current = 0),
              k ? P(!1) : p || k || r.mobiletouch || (!h && !w) ? !D.current && f && f() : P(!0));
          }
        });
      var Te = o(38297),
        Ce = o(85034),
      ...
      function ke(e) {
        ...
        return n.createElement(n.Suspense, { fallback: t ?? null }, n.createElement(Se, { ...o }));
      }
      const Se = n.lazy(async () => {
        ...
        return {
          default: t => {
            const { charCode: o } = t,
              i = e(o) ?? void 0;
            return n.createElement(C.Icon, { icon: i, className: Fe.iconContainer });
          },
        };
      });
      var ye = o(74099);
      ...
      const Ne = [
          ...
          { title: 'TradingView', emojis: Ie, content: n.createElement(P.IconItem, { icon: Be }) },
        ],
        Re = new xe(
      ...
      const Ue = {
        ...
        [W.Stickers]: {
          ...
          RowComponent: function (e) {
            return n.createElement(Oe.EmojisRow, { ...e, className: je.stickerRow });
          },
          icons: Ne,
          onEmojiSelect: e => {
      ...
      const $e = {
        ...
        Xe = (0, ve.mergeThemes)(be, { menuBox: Ye.menuBox, drawer: Ye.drawer }),
        ...
        return n.createElement(
          fe,
          {
            ...
            onMenuKeyDown: function (e) {
              ...
              (9 !== t && t !== Je.Modifiers.Shift + 9) || (0, qe.updateTabIndexes)();
            },
            ...i,
          },
          n.createElement(Ge, {
      ...
      function ot(e) {
        ...
        e.target === t &&
          ...
          setTimeout(() => {
            ...
            const [e] = (0, qe.queryTabbableElements)(t).sort(qe.navigationOrderComparator);
            e && e.focus();
          }));
      }
      var nt = o(32679);
      ...
      class gt extends n.PureComponent {
            ...
            n.createElement(
              ...
              s.map((s, a) => {
                ...
                return n.createElement(dt.AccessibleMenuItem, {
                  ...
                  isActive: o && e === u,
                  appearAsDisabled: m,
                  label: n.createElement('div', { className: vt.label }, h.localizedName, !1),
        ...
        _getActiveToolName() {
          return this.props.lineTools.find(e => pt(e) && e.name === d.tool.value())?.name;
        }
        async _selectTool(e) {
        ...
        _composeFavState() {
          ...
          return (
            this.props.lineTools.forEach(t => {
              pt(t) && (e[t.name] = rt.LinetoolsFavoritesStore.isFavorite(t.name));
            }),
            e
          );
        }
      ...
      class _t extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._getActualState = () => {
              ...
              return {
                removeAllDrawingsLabel: e.paneRemoveAllDrawingTools.getState().label,
                removeAllStudiesLabel: e.paneRemoveAllStudies.getState().label,
                removeAllLabel: e.paneRemoveAllStudiesDrawingTools.getState().label,
              };
            }),
        ...
        render() {
          const e = this.props.isSmallTablet ? Ct : void 0,
            { removeAllDrawingsLabel: t, removeAllStudiesLabel: i, removeAllLabel: l } = this.state;
          return n.createElement(
            fe,
            {
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            Array.from((0, kt.getHideOptions)()).map(([e, o]) =>
              n.createElement(Lt, { key: e, hideMode: e, option: o, isSmallTablet: t, onClick: v }),
            ),
          ),
        );
        function v(e, t) {
          It((0, l.ensureDefined)((0, kt.getHideOptions)().get(e)).trackLabel, t);
        }
      }
      function It(e, t) {
      ...
      function jt(e) {
        const { isSmallTablet: t } = e,
          i = (0, Vt.useWatchedValueReadonly)({ watchedValue: (0, zt.magnetEnabled)() }),
          l = (0, Vt.useWatchedValueReadonly)({ watchedValue: (0, zt.magnetMode)() });
        return n.createElement(
          'div',
          ...
          n.createElement(
            ...
            Object.values(Ot).map(({ id: e, name: o, localizedName: a, icon: r }) =>
              n.createElement(dt.AccessibleMenuItem, {
                key: e,
      ...
      const no = (0, ve.mergeThemes)(Yt, oo),
        io = { hide: B.t(null, void 0, o(99838)), show: B.t(null, void 0, o(32579)) },
        lo = (0, n.forwardRef)((e, t) => {
          ...
          return n.createElement(
            ...
            n.createElement(Xt, { direction: o ? 'left' : 'right', theme: o ? void 0 : no }),
          );
        });
      var so = o(37558),
        ao = o(24437),
      ...
      class To extends n.PureComponent {
          ...
          super(e),
            ...
            (this._filteredLineTools = f.lineTools.reduce((e, t) => {
              const { id: o, title: n, trackLabel: i } = t,
                l = e => this._toolsFilter.isToolEnabled(g.lineToolsInfo[e.name].localizedName),
                s = [];
              return (
        ...
        componentDidMount() {
          T.isDrawingToolbarVisible.subscribe(this._handleChangeVisibility),
            ...
            this.props.widgetbarSettled &&
              ...
              v.CheckMobile.any() &&
                window.widgetbar?.visible().subscribe(this._handleWidgetbarVisible));
        }
        componentWillUnmount() {
        ...
        render() {
          ...
          const h = () =>
            !!this._features.tools && !(!u.enabled('show_object_tree') || (vo && !mo));
          return n.createElement(
            uo.RegistryProvider,
            ...
            n.createElement(
              ...
              n.createElement(
                so.DrawerManager,
                null,
                n.createElement(ro.MatchMedia, { rule: ao.DialogBreakpoints.TabletSmall }, e =>
                  n.createElement(
                    Jt.Toolbar,
                    {
                      id: 'drawing-toolbar',
                      ...
                      n.createElement(
                        ...
                        !o &&
                          n.createElement(
                            ...
                            this._features.tools && n.createElement(Mt, { isSmallTablet: e }),
                            !1,
                          ),
                        !o &&
                          this._features.tools &&
                        ...
                        n.createElement('div', { className: ho.fill, style: a }),
                        !o &&
                          (this._features.tools || !1) &&
                          n.createElement(
                            'div',
                            { className: s(ho.group, ho.lastGroup), style: a },
                            !1,
                            this._features.tools &&
                              this._features.favoriting &&
                              n.createElement(Rt, { id: Ut.FavoriteDrawings }),
                            h() &&
                              n.createElement(I, {
                                id: Ut.ObjectTree,
      ...
      class wo {
        constructor(e, t) {
          (this._component = null),
            ...
            (this._container = e),
            i.render(n.createElement(To, { ...t, ref: this._handleRef }), this._container);
        }
        destroy() {
