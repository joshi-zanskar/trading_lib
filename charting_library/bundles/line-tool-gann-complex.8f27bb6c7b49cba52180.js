  ...
  [1963],
  {
      ...
      class _ extends l.DefaultProperty {
        ...
        state(e, t, s) {
          ...
          return s
            ...
            : ((r = i),
              (n = this._map),
              (0, this._levelsIterator)(r, { tpl: u, fill: a, typecheck: n.typecheck.pack }, n));
          var r, n;
        }
        preferences() {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, l.extractState)(
              (0, r.default)((0, i.default)(t), f(e, this._map, this._levelsIterator)),
              this._allStateKeys,
    ...
    99083: (e, t, s) => {
      ...
      class p extends o.LineDataSource {
        constructor(e, t, i, r) {
          super(e, t ?? p.createProperties(e.backgroundTheme().spawnOwnership()), i, r),
            (this.version = 2),
          ...
          this._adjustScaleRatio(n),
            ...
            n.onRestoreFactoryDefaults().subscribe(this, this._handleRestoringFactoryDefaults),
        ...
        addPoint(e, t, s) {
          ...
          const i = super.addPoint(e, t, s),
            r = this.priceScale();
          return !(0, n.ensureNotNull)(r).isLog() && i && this._correctFirstPoint(), i;
        }
        setPoint(e, t, s) {
          super.setPoint(e, t, s),
            void 0 !== s && s.shift() ? this._correctPoint(e) : this._correctScaleRatio();
        }
        setLastPoint(e, t) {
        ...
        _getPropertyDefinitionsViewModelClass() {
          return Promise.all([s.e(6406), s.e(3889), s.e(8009), s.e(8056), s.e(8537)])
            .then(s.bind(s, 53894))
        ...
        _correctPoint(e) {
          ...
          if (null !== s) {
            const i = this._points[e],
              ...
              l = i.index - r.index > 0;
            let o = (n && !l) || (!n && l) ? -1 : 1;
            0 === e && (o = -o), (i.price = r.price + o * t * s), this._pointChanged.fire(e);
          }
