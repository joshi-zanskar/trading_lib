  ...
  [607],
  {
    73174: (e, t, i) => {
      ...
      const y = -5e4,
        ...
        v = new r.TranslatedString('change bar X coordinate', o.t(null, void 0, i(2066))),
      ...
      function m(e, t, i, n, o, r) {
        ...
        return (0, u.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, c.removeSpaces)(`${r}Coordinates${o}`), title: o, ...s.info, ...l.info },
        );
      }
      const g = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/;
      function b(e, t, i) {
    ...
    42838: (e, t, i) => {
      ...
      const u = new o.TranslatedString(
        ...
        d = new o.TranslatedString('change {title} base line width', n.t(null, void 0, i(17926))),
        c = new o.TranslatedString('change {title} base line style', n.t(null, void 0, i(27864))),
        ...
        P = new o.TranslatedString('change {title} down line width', n.t(null, void 0, i(64615))),
        m = new o.TranslatedString('change {title} down line style', n.t(null, void 0, i(51842))),
    ...
    15306: (e, t, i) => {
      i.r(t), i.d(t, { StudyOverlayDefinitionsViewModel: () => z });
      var n = i(11542),
        o = i(45126),
        r = i(56570),
        s = i(50151),
        ...
        d = i(56530),
        c = i(91682);
      const y = new o.TranslatedString('change {inputName} property', n.t(null, void 0, i(66110)));
      function h(e, t) {
        const i = e.id;
        return (
      ...
      const b = n.t(null, void 0, i(92516)),
        ...
        I = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M'].map(
          e => ({ value: e, title: (0, S.getTranslatedResolutionModel)(e).hint }),
        );
      class T {
        constructor(e, t) {
        ...
        _inputsPropertyDefinitions() {
          ...
          return (
            null !== this._sourceInput &&
              (this._inputSourceItems = new p.WatchedValue(this._getInputSourceItems())),
            (function (e, t, i, n, r) {
              const a = [];
              for (const u of t) {
                if (!h(u, n)) continue;
                ...
                if ('resolution' === u.type)
                  S = (0, l.createOptionsPropertyDefinition)(
                    ...
                    { id: c, title: v, options: new p.WatchedValue(r.resolutionItems) },
                  );
      ...
      var C = i(18653),
        V = i(64482),
        x = i(68805);
      const M = new o.TranslatedString('change study overlay style', n.t(null, void 0, i(82924))),
        k = new o.TranslatedString('change price line visibility', n.t(null, void 0, i(8662))),
        L = new o.TranslatedString('change study overlay min tick', n.t(null, void 0, i(91109))),
        ...
        H = n.t(null, void 0, i(92516)),
        U = n.t(null, void 0, i(72926)),
        G = n.t(null, void 0, i(64075)),
        j = [
          { title: A, value: 0 },
          { title: N, value: 1 },
          { title: W, value: 9 },
      ...
      r.enabled('chart_style_hilo') && j.push({ title: X, value: 12 });
      class z extends T {
        constructor(e, t) {
          super(e, t),
        ...
        _stylePropertyDefinitions() {
          ...
          const e = this._source.properties().childs(),
            t = (0, l.createOptionsPropertyDefinition)(
              { option: (0, l.convertToDefinitionProperty)(this._undoModel, e.style, M) },
              { id: 'StudyOverlayStyle', title: H, options: this._availableStylesWV },
            ),
            i = (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._undoModel, e.showPriceLine, k) },
              { id: 'StudyOverlayPriceLine', title: U },
            ),
            n = (0, l.createOptionsPropertyDefinition)(
              { option: (0, l.convertToDefinitionProperty)(this._undoModel, e.minTick, L) },
              {
          ...
          return j.map(t =>
            t.readonly
              ...
              : {
                  ...
                  title: t.title,
                  disabled:
                    (0, x.isCloseBasedSymbol)(e) && !(0, x.isSingleValueBasedStyle)(t.value),
                },
          );
        }
      }
