  ...
  [6477],
  {
    ...
    23234: (e, t, i) => {
      ...
      var s = i(29875),
        ...
        n = i(76607),
        c = i(6590);
      const u = { ...n.nonThemedFactoryDefaultsBase, extendLeft: !1, extendRight: !1 },
        ...
        m = (0, a.extractAllPropertiesKeys)((0, r.ensureDefined)(d.get(o.StdTheme.Light))),
      ...
      class p extends n.DateAndPriceBaseProperties {
        static create(e, t) {
          return new this({
            ...
            factoryDefaultsSupplier: () => (0, l.factoryDefaultsForCurrentTheme)(u, d),
      ...
      class b extends s.LineDataSource {
        constructor(e, t, s, r) {
          super(e, t ?? b.createProperties(e.backgroundTheme().spawnOwnership()), s, r),
