...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8422],
  {
    ...
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => g, InplaceTextUndoCommand: () => P });
      var s = i(50279),
        n = i(50151),
        o = i(86441),
        r = i(19625),
      ...
      class g extends p.LineDataSource {
        ...
        async _openTextEditor(e, t, s, r, a) {
          ...
          const { text: h, textColor: d, wordWrap: u } = this.editableTextProperties(),
          ...
          l(this._container, b), this.updateAllViewsAndRedraw((0, _.sourceChangeEvent)(this.id()));
        }
        _closeTextEditor() {
      ...
      class a extends r.DefaultProperty {
        constructor({ templateKeys: e, ...t }) {
          super({ ignoreAllowSavingDefaults: !0, saveNonDefaultUserPreferencesOnly: !0, ...t }),
            (this._templateKeys = (0, o.ensureDefined)(e || this._allDefaultsKeys));
        }
        template() {
        ...
        applyTemplate(e) {
          this.mergeAndFire(
            (0, r.extractState)(
              (0, n.default)((0, s.default)(this._factoryDefaultsSupplier()), e),
              this._templateKeys,
            ),
          );
        }
    ...
    63397: (e, t, i) => {
      ...
      const m = {
        ...
        f = (0, u.extractAllPropertiesKeys)((0, s.ensureDefined)(y.get(h.StdTheme.Light))),
        C = (0, u.extractAllPropertiesKeys)(m),
        v = [...new Set([...f, ...C, ...b.commonLineToolPropertiesStateKeys, 'text'])],
        V = [...new Set([...f, ...C, 'text'])];
      class S extends P.LineDataSourceProperty {
        ...
        static create(e, t, i) {
          return new this({
            ...
            factoryDefaultsSupplier: () => (0, p.factoryDefaultsForCurrentTheme)(m, y),
      ...
      class D extends l.InplaceTextLineDataSource {
        constructor(e, t, s, n) {
          super(e, t ?? D.createProperties(e.backgroundTheme().spawnOwnership()), s, n),
            Promise.all([i.e(6290), i.e(9116), i.e(1200), i.e(1583)])
              .then(i.bind(i, 41883))
        ...
        setPoint(e, t, i) {
          ...
          if (this._snapTo45DegreesApplicable(i)) {
            ...
            if (e >= 4) return this._correctMiddlePoints(e, t, i), void this._normalizePoints();
        ...
        editableTextProperties() {
          ...
          return { text: e.text, textColor: e.textColor, textVisible: e.showLabel };
        }
        ...
        _correctRightLeftMiddlePoint(e, t, i) {
          ...
          switch (((c *= h), e)) {
            case 4: {
              const e = l.y - (d * c) / 2,
                t = (0, s.ensureNotNull)(this.screenPointToPoint(new n.Point(l.x, e)));
              this._points[1].price = t.price;
              const i = (0, s.ensureNotNull)(
                this.screenPointToPoint(new n.Point(a.x + h * c, a.y + (d * c) / 2)),
              );
            ...
            case 5: {
              const e = a.y - (d * c) / 2,
                t = (0, s.ensureNotNull)(this.screenPointToPoint(new n.Point(a.x, e)));
              this._points[0].price = t.price;
              const i = (0, s.ensureNotNull)(
                this.screenPointToPoint(new n.Point(l.x + h * c, l.y + (d * c) / 2)),
              );
          ...
          switch (e) {
            case 6: {
              const e = Math.floor(u.x - (x * p) / 2),
                t = (0, s.ensureNotNull)(this.screenPointToPoint(new n.Point(e, u.y))),
                i = Math.abs(this._points[1].index - t.index),
                r = x * T * _ * Math.ceil(i / 2);
              if (0 === r) return;
              this._points[1].index = this._points[1].index - r;
              const c = _ * Math.abs(a.indexToCoordinate(this._points[1].index) - u.x);
            ...
            case 7: {
              const e = Math.floor(d.x - (x * p) / 2),
                t = (0, s.ensureNotNull)(this.screenPointToPoint(new n.Point(e, d.y))),
                i = Math.abs(this._points[0].index - t.index),
                r = x * T * _ * Math.ceil(i / 2);
              if (0 === r) return;
              this._points[0].index = this._points[0].index - r;
              const c = _ * Math.abs(a.indexToCoordinate(this._points[0].index) - d.x);
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            ...
            e.addChild('linesColors', new c.LineToolColorsProperty([e.childs().color])),
            e.addChild(
              'textsColors',
              new c.LineToolColorsProperty([e.childs().textColor], e.childs().showLabel),
            ),
