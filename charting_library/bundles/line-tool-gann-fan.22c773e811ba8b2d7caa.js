...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4981],
  {
      ...
      class v extends a.DefaultProperty {
        ...
        state(e, t, s) {
          ...
          return s
            ...
            : ((n = r),
              (i = this._map),
              (0, this._levelsIterator)(n, { tpl: p, fill: c, typecheck: i.typecheck.pack }, i));
          var n, i;
        }
        preferences() {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, a.extractState)(
              (0, n.default)((0, r.default)(t), d(e, this._map, this._levelsIterator)),
              this._allStateKeys,
    ...
    85259: (e, t, s) => {
      ...
      const p = new l.TranslatedString('erase level line', i.t(null, void 0, s(77114)));
      class h extends u.LineDataSource {
        constructor(e, t, r, n) {
          super(e, t ?? h.createProperties(e.backgroundTheme().spawnOwnership()), r, n),
        ...
        processErase(e, t) {
          const s = 'level' + t,
            r = (0, n.ensureDefined)(this.properties().child(s)).childs().visible;
