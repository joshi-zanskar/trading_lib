  ...
  [8890],
  {
    ...
    64388: (e, t, n) => {
      ...
      function r(e) {
        ...
        return i.createElement(
          ...
          i.createElement(s.Icon, { icon: n, className: a.icon, 'aria-hidden': !0 }),
    ...
    70493: (e, t, n) => {
      ...
      var i = n(50959),
        ...
        _ = n(76974),
        v = n(50655);
      const y = i.createContext({ isSmallTablet: !1, dialogCloseHandler: () => {} });
      var E = n(33233);
      function x(e) {
        const {
            disabled: t,
      ...
      function S(e) {
        ...
        return (
          ...
          i.createElement(u.MatchMedia, { rule: h.DialogBreakpoints.TabletSmall }, l =>
            i.createElement(
              y.Provider,
              ...
              i.createElement(
                ...
                i.createElement(
                  ...
                  i.createElement(
                    'div',
                    { className: s(D.main, !S && D.marginWithoutCloseButton, l && D.small) },
                    t && i.createElement('div', { className: s(D.title, l && D.small) }, t),
                    (function (t) {
                      if ('html' in e)
      ...
      function k(e) {
        ...
        return i.createElement(
          ...
          null,
          (function () {
            if ('content' in e) return i.createElement('div', { className: T.label }, e.content);
            if ('html' in e)
      ...
      const z = function (e) {
            ...
            actions: [
              {
                ...
                handler: ({ dialogClose: e, innerManager: t }) =>
                  p({ newValue: y, focusInput: w, dialogClose: e, innerManager: t }),
              },
              {
                name: 'cancel',
                type: 'button',
        ...
        L = function (e) {
          const { title: t, closeOnOutsideClick: s, onClose: a = () => {}, backdrop: l } = e,
            r = b(e);
          return i.createElement(S, {
            ...r,
        ...
        U = function (e, t, n) {
          const { title: o } = e;
          let s = `${o}_`;
          if (((s += 'text' in e ? e.text : 'html' in e ? e.html : e.id), A.isOpened(s)))
    ...
    82206: (e, t, n) => {
        ...
        recalculateBounds() {
          ...
          if (this._isFullscreen) {
            ...
            (this._dialog.style.top = '0px'),
              ...
              (this._dialog.style.height = o < i.height ? o + 'px' : this._initialHeight);
          }
        }
        destroy() {
      ...
      class P extends i.PureComponent {
        ...
        componentDidMount() {
          ...
          if ((this._eventDispatcher.dispatch('dialog-open'), e)) {
            ...
            if (e && e instanceof HTMLElement) {
              const o = new E(i, e, { boundByScreen: Boolean(t), onDragStart: n });
              this._cleanUpFunctions.push(() => o.destroy()), (this._drag = o);
            }
          }
          this.props.autofocus && !i.contains(document.activeElement) && i.focus(),
            (this._isFullScreen() || this.props.fixedBody) && (0, b.setFixedBodyState)(!0);
        ...
        componentWillUnmount() {
          ...
          (this._isFullScreen() || this.props.fixedBody) && (0, b.setFixedBodyState)(!1),
