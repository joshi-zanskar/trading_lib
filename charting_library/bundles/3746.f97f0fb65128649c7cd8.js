          ...
          for (var e = [], t = 0; t < arguments.length; t++) {
            ...
            if (i) {
              ...
              if ('string' === s || 'number' === s) e.push(i);
                ...
                o && e.push(o);
              } else if ('object' === s) for (var l in i) n.call(i, l) && i[l] && e.push(l);
            }
          }
          return e.join(' ');
        }
          ...
          (l = function () {}),
            ...
            (t = (function (e) {
              ...
              function r(e, i) {
                ...
                if (
                  ...
                  (n = null != (o = r.optionsForElement(this.element)) ? o : {}),
                ...
                this.options.acceptedMimeTypes &&
                  ...
                  (s = this.getExistingFallback()) && s.parentNode && s.parentNode.removeChild(s),
              ...
              return (
                ...
                (r.prototype.defaultOptions = {
                  ...
                  fallback: function () {
                    ...
                    for (
                      this.element.className = this.element.className + ' dz-browser-not-supported',
                        n = 0,
                        s = (o = this.element.getElementsByTagName('div')).length;
                      n < s;
                      n++
                    )
                      (e = o[n]),
                    ...
                    return (
                      t ||
                        ((t = r.createElement('<div class="dz-message"><span></span></div>')),
                  ...
                  addedfile: function (e) {
                    ...
                    if (
                      ...
                      for (
                        e.previewElement = r.createElement(this.options.previewTemplate.trim()),
                      ...
                      for (
                        s = 0, a = (d = e.previewElement.querySelectorAll('[data-dz-size]')).length;
                        s < a;
                        s++
                      )
                          ...
                          t = function (t) {
                            return (
                              ...
                              e.status === r.UPLOADING
                                ? r.confirm(m.options.dictCancelUploadConfirmation, function () {
                                    return m.removeFile(e);
                                  })
                                : m.options.dictRemoveFileConfirmation
                                  ? r.confirm(m.options.dictRemoveFileConfirmation, function () {
                                      return m.removeFile(e);
                                    })
                                  : m.removeFile(e)
                            );
                    ...
                    if (e.previewElement) {
                      for (
                        e.previewElement.classList.remove('dz-file-preview'),
                          n = 0,
                          r = (s = e.previewElement.querySelectorAll('[data-dz-thumbnail]')).length;
                        n < r;
                        n++
                      )
                    ...
                    if (e.previewElement) {
                      for (
                        e.previewElement.classList.add('dz-error'),
                          ...
                          o = [],
                          n = 0,
                          r = (s = e.previewElement.querySelectorAll('[data-dz-errormessage]'))
                            .length;
                        n < r;
                        n++
                      )
                  ...
                  uploadprogress: function (e, t, i) {
                    ...
                    if (e.previewElement) {
                      for (
                        l = [],
                          r = 0,
                          s = (o = e.previewElement.querySelectorAll('[data-dz-uploadprogress]'))
                            .length;
                        r < s;
                        r++
                      )
                  ...
                  complete: function (e) {
                    if (
                      (e._removeLink && (e._removeLink.textContent = this.options.dictRemoveFile),
                      e.previewElement)
                    )
                ...
                (t = function () {
                  ...
                  for (
                    n = arguments[0],
                      s = 0,
                      o = (i = 2 <= arguments.length ? u.call(arguments, 1) : []).length;
                    s < o;
                    s++
                  )
                ...
                (r.prototype.getActiveFiles = function () {
                  ...
                  for (s = [], t = 0, i = (n = this.files).length; t < i; t++)
                    ((e = n[t]).status !== r.UPLOADING && e.status !== r.QUEUED) || s.push(e);
                  return s;
                }),
                          ...
                          return (
                            ...
                            a.hiddenFileInput.addEventListener('change', function () {
                              ...
                              if ((t = a.hiddenFileInput.files).length)
                                for (n = 0, r = t.length; n < r; n++) (e = t[n]), a.addFile(e);
                              return i();
                            })
                          );
                        }),
                            ...
                            events: {
                              click: function (i) {
                                if (
                                  t !== e.element ||
                                  i.target === e.element ||
                                  r.elementInside(i.target, e.element.querySelector('.dz-message'))
                                )
                ...
                (r.prototype.updateTotalUploadProgress = function () {
                  ...
                  if (((i = 0), (t = 0), this.getActiveFiles().length)) {
                    for (r = 0, s = (o = this.getActiveFiles()).length; r < s; r++)
                ...
                (r.prototype.setupEventListeners = function () {
                  var e, t, i, n, r, s, o;
                  for (o = [], n = 0, r = (s = this.listeners).length; n < r; n++)
                    (e = s[n]),
                      o.push(
                        (function () {
                          var n, r;
                ...
                (r.prototype.filesize = function (e) {
                  var t, i, n, r, s, o, l;
                  for (
                    i = n = null, t = o = 0, l = (s = ['TB', 'GB', 'MB', 'KB', 'b']).length;
                    o < l;
                    t = ++o
                  )
                    if (((r = s[t]), e >= Math.pow(this.options.filesizeBase, 4 - t) / 10)) {
                      (i = e / Math.pow(this.options.filesizeBase, 4 - t)), (n = r);
                      break;
                    }
                  ...
                  return (
                    ...
                    (n = function (e) {
                      ...
                      for (n = 0, s = e.length; n < s; n++)
                        (i = e[n]).isFile
                          ? i.file(function (e) {
                              if (!r.options.ignoreHiddenFiles || '.' !== e.name.substring(0, 1))
                                return (e.fullPath = t + '/' + e.name), r.addFile(e);
                            })
                          : i.isDirectory && r._addFilesFromDirectory(i, t + '/' + i.name);
                    }),
                ...
                (r.prototype.removeAllFiles = function (e) {
                  var t, i, n, s;
                  for (
                    null == e && (e = !1), i = 0, n = (s = this.files.slice()).length;
                    i < n;
                    i++
                  )
                    ((t = s[i]).status !== r.UPLOADING || e) && this.removeFile(t);
                  return null;
                }),
                    ...
                    ((n = document.createElement('img')).onload =
                      ...
                      function () {
                        ...
                        if (
                          ...
                          (s = (t = document.createElement('canvas')).getContext('2d')),
                          (t.width = l.trgWidth),
                ...
                (r.prototype.uploadFiles = function (e) {
                  var i,
                    ...
                    R,
                    P;
                  for (b = new XMLHttpRequest(), C = 0, x = e.length; C < x; C++)
                    (i = e[C]).xhr = b;
                  ...
                  (F = (function (t) {
                    return function (n) {
                      ...
                      if (null != n)
                        for (s = (100 * n.loaded) / n.total, o = 0, u = e.length; o < u; o++)
                          (i = e[o]).upload = { progress: s, total: n.total, bytesSent: n.loaded };
                      else {
                      ...
                      for (c = [], a = 0, d = e.length; a < d; a++)
                        (i = e[a]), c.push(t.emit('uploadprogress', i, s, i.upload.bytesSent));
                      return c;
                    };
                  })(this)),
                  (b.onload = (function (t) {
                  ...
                  if (((s = new FormData()), this.options.params))
                    for (m in (M = this.options.params)) (E = M[m]), s.append(m, E);
                  for (k = 0, A = e.length; k < A; k++) (i = e[k]), this.emit('sending', i, b, s);
                  if (
                    (this.options.uploadMultiple && this.emit('sendingmultiple', e, b, s),
                    'FORM' === this.element.tagName)
                  )
                    for (
                      z = 0,
                        T = (U = this.element.querySelectorAll('input, textarea, select, button'))
                          .length;
                      z < T;
                      z++
                    )
                      if (
                        ...
                        (!h ||
                          ('checkbox' !== (I = h.toLowerCase()) && 'radio' !== I) ||
                          d.checked) &&
                          s.append(c, d.value);
                  for (
                    p = S = 0, R = e.length - 1;
            ...
            (t.discover = function () {
              ...
              for (
                ...
                (i = n[r]), !1 !== t.optionsForElement(i) ? o.push(new t(i)) : o.push(void 0);
              return o;
            }),
            ...
            (t.isBrowserSupported = function () {
              ...
              if (
                ...
                if ('classList' in document.createElement('a'))
                  for (i = 0, n = (r = t.blacklistedBrowsers).length; i < n; i++)
            ...
            (t.getElements = function (e, t) {
              ...
              if (e instanceof Array) {
                ...
                for (n = [], s = 0, l = (a = document.querySelectorAll(e)).length; s < l; s++)
                  (i = a[s]), n.push(i);
            ...
            (t.isValidFile = function (e, t) {
              ...
              if (!t) return !0;
              for (
                t = t.split(','), i = (n = e.type).replace(/\/.*$/, ''), s = 0, o = t.length;
                s < o;
                s++
              )
                if ('.' === (r = (r = t[s]).trim()).charAt(0)) {
                  if (
                    -1 !== e.name.toLowerCase().indexOf(r.toLowerCase(), e.name.length - r.length)
                  )
                    return !0;
                } else if (/\/\*$/.test(r)) {
