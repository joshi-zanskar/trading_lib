  ...
  [1200],
  {
    ...
    6590: (d, u, e) => {
      ...
      !(function (d) {
        ...
        (function (d) {
          (d.FloatingToolbarButton = 'FloatingToolbarButton'), (d.Default = 'Default');
        })(i || (i = {}));
    },
    38039: (d, u, e) => {
      ...
      class a extends i.DefaultProperty {
        constructor({ templateKeys: d, ...u }) {
          super({ ignoreAllowSavingDefaults: !0, saveNonDefaultUserPreferencesOnly: !0, ...u }),
            (this._templateKeys = (0, t.ensureDefined)(d || this._allDefaultsKeys));
        }
        template() {
        ...
        applyTemplate(d) {
          this.mergeAndFire(
            (0, i.extractState)(
              (0, c.default)((0, f.default)(this._factoryDefaultsSupplier()), d),
              this._templateKeys,
            ),
          );
        }
    ...
    68498: (d, u, e) => {
      ...
      class p extends r.LineSourcePaneView {
        ...
        _updateImpl(d) {
          if ((super._updateImpl(d), this._renderer.clear(), this._points.length < 1)) return;
          ...
          this._iconRenderer.isOutOfScreen(n, i) || this._renderer.append(this._iconRenderer);
        ...
        _calculateBackgroundColor() {
          return (0, i.generateColor)(
            this._model.backgroundColorAtYPercentFromTop(
              this._points[0].y /
                (0, t.ensureNotNull)(this._model.paneForSource(this._source)).height(),
            ),
            60,
            !0,
          );
    ...
    19365: (d, u, e) => {
      ...
      function c(d, u) {
        ...
        return (
          f.default.parse(
            d,
            d => ((e = f.default.base + ('svg' === u ? `svg/${d}.svg` : `72x72/${d}.png`)), !1),
          ),
          e
        );
      }
    ...
    18438: (d, u, e) => {
      ...
      const f = (function () {
        var d = {
            ...
            onerror: function () {
              this.parentNode && this.parentNode.replaceChild(n(this.alt, !1), this);
            },
            parse: function (u, e) {
              (e && 'function' != typeof e) || (e = { callback: e });
              return ('string' == typeof u ? b : l)(u, {
                callback: e.callback || r,
                attributes: 'function' == typeof e.attributes ? e.attributes : p,
                base: 'string' == typeof e.base ? e.base : d.base,
                ext: e.ext || d.ext,
                size: e.folder || ((f = e.size || d.size), 'number' == typeof f ? f + 'x' + f : f),
        ...
        function s(d, u) {
          for (var e, f, c = d.childNodes, t = c.length; t--; )
            3 === (f = (e = c[t]).nodeType)
              ? u.push(e)
              : 1 !== f || 'ownerSVGElement' in e || i.test(e.nodeName.toLowerCase()) || s(e, u);
          return u;
        }
        function o(d) {
        ...
        function l(d, u) {
          for (var f, c, t, i, a, r, l, b, h, p, v, m, g, x = s(d, []), y = x.length; y--; ) {
            for (
              t = !1, i = document.createDocumentFragment(), r = (a = x[y]).nodeValue, b = 0;
              (l = e.exec(r));
              ...
              if (
                ...
                (p.className = u.className), (p.alt = v), (p.src = g), (t = !0), i.appendChild(p);
              }
              p || i.appendChild(n(v, !1)), (p = null);
            }
            t &&
              (b < r.length && i.appendChild(n(r.slice(b), !0)), a.parentNode.replaceChild(i, a));
          }
          return d;
        }
        function b(d, u) {
        ...
        function m(d, u) {
          for (var e = [], f = 0, c = 0, t = 0; t < d.length; )
            (f = d.charCodeAt(t++)),
              c
                ? (e.push((65536 + ((c - 55296) << 10) + (f - 56320)).toString(16)), (c = 0))
                : 55296 <= f && f <= 56319
                  ? (c = f)
