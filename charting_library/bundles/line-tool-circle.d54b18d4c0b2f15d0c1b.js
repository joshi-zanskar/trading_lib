  ...
  [6748],
  {
    17333: (e, t, i) => {
      ...
      class d extends l.InplaceTextLineDataSource {
        constructor(e, t, s, o) {
          super(e, t ?? d.createProperties(e.backgroundTheme().spawnOwnership()), s, o),
        ...
        static createProperties(e, t) {
          const i = new o.DefaultProperty({ defaultName: 'linetoolcircle', state: t, theme: e });
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            ...
            e.addChild('linesColors', new a.LineToolColorsProperty([e.childs().color])),
            e.addChild('linesWidths', new a.LineToolWidthsProperty([e.childs().linewidth])),
            e.addChild(
              'backgroundsColors',
            ...
            e.addChild(
              'textsColors',
              new a.LineToolColorsProperty([e.childs().textColor], e.childs().showLabel),
            ),
    ...
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => T, InplaceTextUndoCommand: () => g });
      var s = i(50279),
        o = i(50151),
        n = i(86441),
        r = i(19625),
