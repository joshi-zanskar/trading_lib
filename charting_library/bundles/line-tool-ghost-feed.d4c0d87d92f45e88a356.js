    ...
    37968: (e, t, s) => {
      ...
      class o {
        ...
        generate() {
          ...
          for (let e = i; e !== s.index; e += r) this._bars.push(this._createBar());
        }
        bars() {
          return this._bars;
        }
        setSize(e) {
          ...
          else for (; this._bars.length < e; ) this._bars.push(this._createBar());
        }
        _createBar() {
      ...
      class l extends r.LineDataSource {
        constructor(e, t, i, r) {
          const n = t ?? l.createProperties(e.backgroundTheme().spawnOwnership());
          if (
            (super(e, n, i, r),
            (this._segments = []),
            (this._finished = !1),
        ...
        propertiesChanged() {
          super.propertiesChanged(),
            (this._currentAverageHL === this.properties().childs().averageHL.value() &&
              this._currentVariance === this.properties().childs().variance.value()) ||
              this._regenerate();
        }
        pointsCount() {
          return -1;
        ...
        addPoint(e, t, s) {
          ...
          if (this._points.length > 0) {
            ...
            if (!t?.isApiEvent() && s.index === e.index) {
              (this._lastPoint = null), this._normalizePoints(), this.createServerPoints();
              for (let e = 0; e < this._points.length; e++) this._createPointProperty(e);
              return !0;
            }
          }
          const i = super.addPoint(e, t, s);
          return this._points.length > 1 && this.generateBars(this._points.length - 2), i;
        }
        finish() {
          (this._finished = !0),
        ...
        state(e) {
          ...
          return (t.segments = this._segments.map(e => ({ bars: [...e.bars()] }))), t;
        }
        restoreData(e) {
          e.segments && (this._segments = e.segments.map((e, t) => new o(this, t, e.bars))),
            (this._currentAverageHL = this.properties().childs().averageHL.value()),
            (this._currentVariance = this.properties().childs().variance.value());
        }
        onData(e) {
          ...
          this._currentInterval !== this._model.mainSeries().interval() &&
            (this._regenerate(), (this._currentInterval = this._model.mainSeries().interval()));
        }
        cloneData(e) {
        ...
        static createProperties(e, t) {
          const s = new i.DefaultProperty({ defaultName: 'linetoolghostfeed', state: t, theme: e });
        ...
        _restoreSegmentsFromPixels() {
          const e = this.priceScale(),
            t = this.ownerSource()?.firstValue() ?? null;
          if (null === e || null === t || null === this._segmentsPixelsWhileMoving) return;
          const s = this.points();
