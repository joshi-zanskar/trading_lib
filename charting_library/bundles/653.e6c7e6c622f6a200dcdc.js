  ...
  [653],
  {
    ...
    26996: (e, t, o) => {
      ...
      var r,
        ...
        s = o.n(i);
      function c(e) {
        const { className: t, size: o = 'medium', staticPosition: r, color: i = 'black' } = e,
          c = a(s().item, s()[i], s()[o]);
    ...
    10381: (e, t, o) => {
      ...
      function c(e) {
        ...
        return r.createElement(a.Icon, { className: n(o, i.icon, { [i.dropped]: t }), icon: s });
      }
    },
    86656: (e, t, o) => {
      'use strict';
              ...
              return (
                ...
                null !== l.current &&
                  (s
                    ...
                    : (0, n.disableBodyScroll)(l.current, { allowTouchMove: d(l) })),
                () => {
                  c--,
                    null !== l.current &&
                      (s
          ...
          const {
            ...
            C =
              ...
              ('string' == typeof s
                ...
                : r.cloneElement(s, { className: n(b.icon, s.props.className) }));
          return 'button' === o
            ? r.createElement(
                'button',
                {
                ...
                v && g && r.createElement('div', { className: n('js-button-text', b.text) }, g),
                C,
                !v && g && r.createElement('div', { className: n('js-button-text', b.text) }, g),
              )
            : r.createElement(
    ...
    16829: (e, t, o) => {
      ...
      var r = o(50959),
        ...
        a = o(55973);
      function i(e) {
        return r.createElement('div', { className: n(e.className, a.title) }, e.children);
      }
    },
    20626: (e, t, o) => {
      'use strict';
              ...
              if (e.currentTarget.contains(e.target))
                ...
                switch (o) {
                  case 27: {
                    ...
                    this._handleToggleDropdown(!1), t && o && this._wrapperRef?.focus();
                    break;
                  }
                }
              }
        ...
        render() {
          ...
          return 'button' === e
            ? r.createElement(
                ...
                this.state.isOpened &&
                  (g
                    ? r.createElement(h.MatchMedia, { rule: g }, e => this._renderContent(e))
