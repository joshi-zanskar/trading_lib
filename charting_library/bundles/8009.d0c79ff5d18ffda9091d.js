  ...
  [8009],
  {
    26434: (e, t, i) => {
      ...
      const p = new n.TranslatedString(
        ...
        h = new n.TranslatedString('change {title} seconds from', r.t(null, void 0, i(86780))),
        y = new n.TranslatedString('change {title} seconds to', r.t(null, void 0, i(6573))),
        P = new n.TranslatedString(
          'change {title} visibility on minutes',
          r.t(null, void 0, i(78219)),
        ),
        w = new n.TranslatedString('change {title} minutes from', r.t(null, void 0, i(59820))),
        g = new n.TranslatedString('change {title} minutes to', r.t(null, void 0, i(38011))),
        f = new n.TranslatedString(
          'change {title} visibility on hours',
          r.t(null, void 0, i(68715)),
        ),
        v = new n.TranslatedString('change {title} hours from', r.t(null, void 0, i(8306))),
        m = new n.TranslatedString('change {title} hours to', r.t(null, void 0, i(67233))),
        b = new n.TranslatedString(
          'change {title} visibility on days',
          r.t(null, void 0, i(56402)),
        ),
        T = new n.TranslatedString('change {title} days from', r.t(null, void 0, i(91201))),
        _ = new n.TranslatedString('change {title} days to', r.t(null, void 0, i(96135))),
        S = new n.TranslatedString(
          'change {title} visibility on weeks',
          r.t(null, void 0, i(71084)),
        ),
        C = new n.TranslatedString('change {title} weeks from', r.t(null, void 0, i(32481))),
        V = new n.TranslatedString('change {title} weeks to', r.t(null, void 0, i(18678))),
        D = new n.TranslatedString(
          'change {title} visibility on months',
          r.t(null, void 0, i(67583)),
        ),
        W = new n.TranslatedString('change {title} months from', r.t(null, void 0, i(99122))),
        k = new n.TranslatedString('change {title} months to', r.t(null, void 0, i(10518))),
        U =
      ...
      function ae(e, t, i) {
        ...
        if ((0, a.isTicksEnabled)()) {
          const n = (0, o.createCheckablePropertyDefinition)(
            { checked: (0, o.convertToDefinitionProperty)(e, t.ticks, p.format({ title: i })) },
        ...
        if ((0, l.isSecondsEnabled)()) {
          const n = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.seconds, u.format({ title: i })),
              from: (0, o.convertToDefinitionProperty)(e, t.secondsFrom, h.format({ title: i })),
              to: (0, o.convertToDefinitionProperty)(e, t.secondsTo, y.format({ title: i })),
            },
            {
        ...
        const n = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.minutes, P.format({ title: i })),
              from: (0, o.convertToDefinitionProperty)(e, t.minutesFrom, w.format({ title: i })),
              to: (0, o.convertToDefinitionProperty)(e, t.minutesTo, g.format({ title: i })),
            },
            {
          ...
          c = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.hours, f.format({ title: i })),
              from: (0, o.convertToDefinitionProperty)(e, t.hoursFrom, v.format({ title: i })),
              to: (0, o.convertToDefinitionProperty)(e, t.hoursTo, m.format({ title: i })),
            },
            {
          ...
          d = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.days, b.format({ title: i })),
              from: (0, o.convertToDefinitionProperty)(e, t.daysFrom, T.format({ title: i })),
              to: (0, o.convertToDefinitionProperty)(e, t.daysTo, _.format({ title: i })),
            },
            {
        ...
        const F = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.weeks, S.format({ title: i })),
              from: (0, o.convertToDefinitionProperty)(e, t.weeksFrom, C.format({ title: i })),
              to: (0, o.convertToDefinitionProperty)(e, t.weeksTo, V.format({ title: i })),
            },
            {
          ...
          N = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(e, t.months, D.format({ title: i })),
              from: (0, o.convertToDefinitionProperty)(e, t.monthsFrom, W.format({ title: i })),
              to: (0, o.convertToDefinitionProperty)(e, t.monthsTo, k.format({ title: i })),
            },
            {
    ...
    18009: (e, t, i) => {
      ...
      class m {
        ...
        _createPropertyRages() {
          ...
          null !== r &&
            ((r.visible = this._source.hasEditableCoordinates()), this._propertyPages.push(r));
    ...
    35923: (e, t, i) => {
      ...
      class n {
        ...
        setProperty(e, t, i) {
          this._undoModelSupplier().setProperty(e, t, i, r.lineToolsDoNotAffectChartInvalidation);
        }
        beginUndoMacro(e) {
