  ...
  [961],
  {
    14150: (e, i, t) => {
      ...
      class d extends a.LineDataSource {
        constructor(e, i, n, s) {
          super(e, i ?? d.createProperties(e.backgroundTheme().spawnOwnership()), n, s),
        ...
        static createProperties(e, i) {
          const t = new r.DefaultProperty({ defaultName: 'linetoolpath', state: i, theme: e });
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            e.addChild(
              'linesWidths',
              new h.LineToolWidthsProperty([(0, n.ensureDefined)(e.child('lineWidth'))]),
            ),
