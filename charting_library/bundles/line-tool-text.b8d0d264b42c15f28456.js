...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => T, InplaceTextUndoCommand: () => P });
      var n = i(50279),
        s = i(50151),
        o = i(86441),
        r = i(19625),
      ...
      class P extends u.UndoCommand {
        ...
        _source() {
          return (0, s.ensureNotNull)(this._model.dataSourceForId(this._sourceId));
        }
      }
      class T extends _.LineDataSource {
        ...
        async _openTextEditor(e, t, n, r, a) {
          ...
          l(this._container, w), this.updateAllViewsAndRedraw((0, p.sourceChangeEvent)(this.id()));
        }
        _closeTextEditor() {
    ...
    424: (e, t, i) => {
      ...
      class p extends _.InplaceTextLineDataSource {
        constructor(e, t, n, s) {
          const o = t ?? p.createProperties(e.backgroundTheme().spawnOwnership());
          super(e, o, n, s),
            ...
            o.childs().anchored.subscribe(this, this._onAnchoredChange.bind(this));
        }
        centerPosition() {
        ...
        setPoint(e, t, i) {
          ...
          if (n.wordWrapWidth.value()) {
            ...
            const i = e.indexToCoordinate(t.index) - o - ~~(n.fontsize.value() / 6);
        ...
        state(e) {
          ...
          return e && (t.state.barSpacing = this._model.timeScale().barSpacing()), t;
        }
        ...
        static createProperties(e, t) {
          const i = new h.DefaultProperty({ defaultName: this._defaultName(), state: t, theme: e });
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            ...
            e.hasChild('anchored') ||
              e.addChild('anchored', new d.Property(this._anchoredDefaultValue())),
            e.addChild('linesColors', new c.LineToolColorsProperty([e.childs().borderColor])),
        ...
        _recalculateCenterPosition(e, t) {
          ...
          this.setPoints([{ ...r, interval: this._model.mainSeries().interval() }]),
      ...
      class x extends p {
        constructor(e, t, i, n) {
          super(e, t ?? x.createProperties(e.backgroundTheme().spawnOwnership()), i, n);
        }
        name() {
