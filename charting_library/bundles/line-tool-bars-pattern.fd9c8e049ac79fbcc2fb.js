...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5206],
  {
    81756: (t, e, i) => {
      ...
      const P = new o.TranslatedString('mirror bars pattern', n.t(null, void 0, i(20965))),
        m = new o.TranslatedString('flip bars pattern', n.t(null, void 0, i(92479))),
      ...
      class w extends p.LineDataSource {
        constructor(t, e = w.createProperties(t.backgroundTheme().spawnOwnership()), s, r) {
          super(t, e, s, r),
        ...
        restoreData(t) {
          ...
          (this._pattern = e), (this._scale = i), (this._pointsCoordinatePricesDiff = s);
        }
        name() {
          return 'Bars Pattern';
        }
          ...
          if (s) {
            ...
            (this._pattern = this._createPattern(s, n)),
              this._pattern.length > 0 &&
                ...
                (this._points[1].price = this._points[0].price + this._patternPriceDiff()),
        ...
        setPoint(t, e, i, s) {
          1 === t && e.index <= this._points[0].index && (e.index = this._points[0].index + 1),
            0 === t && e.index >= this._points[1].index && (e.index = this._points[1].index - 1),
        ...
        migrateVersion(t, e, i) {
          if (1 === t && this._pattern.length > 0) {
            ...
            2 === this._timePoint.length &&
              ...
              2 === this._points.length && (this._points[1].price = this._points[0].price + t);
          }
        }
        getScale() {
        ...
        _preparePoint(t, e) {
          ...
          this.properties().childs().mode.value() === d.LineToolBarsPatternMode.Bars
          ...
          return (i.price = o.coordinateToPrice(l, a)), super._preparePoint(i, e);
        }
        ...
        _calculatePatternCoordinatePricesDiff() {
          return this._pattern.length > 0
            ? (this._priceCoordinateDiff([this.firstPatternPrice(), this.lastPatternPrice()]) ??
                null)
            : null;
        }
        ...
        _createPattern(t, e) {
          const i = this._model.mainSeries().data(),
            s = [];
          for (let n = t; n <= e; n++) s.push((0, a.clone)((0, r.ensureNotNull)(i.valueAt(n))));
          return s;
        }
        _switchPointsPrice() {
        ...
        _mirror() {
          ...
          for (let s = 1; s < t.length; s++) (e = Math.min(e, t[s][3])), (i = Math.max(i, t[s][2]));
          if (e < i) {
            const s = (e + i) / 2,
              r = t => s - (t - s);
          ...
          this._switchPointsPrice(), this.updateAllViews((0, u.sourceChangeEvent)(this.id()));
        }
        _flip() {
          const t = this._pattern,
            e = t.length;
        ...
        _calculateScale() {
          ...
          if (2 === this._points.length) {
            ...
            if (
              (e && null !== i && (t = +(i / e).toFixed(8)), this._pointsCoordinatePricesDiff !== i)
            ) {
