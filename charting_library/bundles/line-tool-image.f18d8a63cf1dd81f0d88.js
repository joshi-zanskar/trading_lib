  ...
  [5231],
  {
    18181: (e, t, i) => {
      ...
      function I(e) {
        ...
        s
          ...
          .pasteImageAsLineTool(
            e.url,
            e.blobUrl,
            (0, n.ensureNotNull)(s.model().model().paneForSource(s.model().mainSeries())),
            e.transparency,
          ),
          r &&
            ((o = t.getContainer()),
              ...
              Promise.all([i.e(1737), i.e(2227), i.e(6166)])
                ...
                .then(e => {
                  const t = new e.ChartEventHintRenderer(o),
                    i = b.format({ shortcut: (0, m.humanReadableHash)(m.Modifiers.Mod + 86) });
                  let n = null;
                  t.show(i, () => {
                    null !== n &&
                      (clearTimeout(n), (n = null), h.setValue(a, !0, { forceFlush: !0 }));
                  }),
                    (n = setTimeout(() => {
                      (n = null), t.hide();
                    }, 5e3));
      ...
      class O extends l.LineDataSource {
        constructor(e, t, n, r) {
          super(e, t || O.createProperties(e.backgroundTheme().spawnOwnership()), n, r),
        ...
        pointToScreenPoint({ index: e, price: t }, i = 0) {
          const s = this._model.timeScale(),
            ...
            a = (0, n.ensureNotNull)((0, n.ensureNotNull)(this.ownerSource()).firstValue()),
        ...
        setPoint(e, t, i) {
          ...
          const { width: r, height: s } = this._image,
            ...
            a = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[0], this.dOffsetX())),
            l = Math.max(Math.abs(a.x - o.x) / r, Math.abs(a.y - o.y) / s),
            u = Math.round(r * l),
            h = Math.round(s * l),
            c = this.properties().childs();
          c.cssWidth.setValue(u), c.cssHeight.setValue(h), this.propertiesChanged();
        }
        startChanging(e, t) {
          super.startChanging(e, t), this._changeOriginPoint(O._oppositePoints[e]);
        }
        endChanging(e, t) {
        ...
        static createProperties(e, t) {
          const i = new o.DefaultProperty({ defaultName: 'linetoolimage', state: t, theme: e });
        ...
        _changeOriginPoint(e) {
          ...
          (this._dOffsetX =
            4 === t ? u.x - (0, n.ensureNotNull)(this.pointToScreenPoint(h)).x : void 0),
            (a.index = h.index),
            (a.price = h.price),
            (this._originPoint = e);
        }
