  ...
  [9748],
  {
    10986: (e, t, n) => {
      ...
      var i = n(50151),
        ...
        h = n(16638),
        c = n(15491);
      const _ = (0, i.ensureDefined)(c.lineToolsStudyIds.LineToolRegressionTrend);
      function p(e) {
        return void 0 !== e.startPrice && void 0 !== e.endPrice;
      }
      function D(e, t, n, i) {
        return t.styles && (y(t.styles.baseLine), y(t.styles.downLine), y(t.styles.upLine)), t;
      }
      function y(e) {
        void 0 !== e &&
          void 0 !== e.visible &&
      ...
      class f extends a.StudyLineDataSource {
        constructor(e, t, s, r, a) {
          super(
            ...
            (s =
              s ??
              (0, i.ensureNotNull)(
                (0, h.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: _ }),
              )),
            'linreg_',
            ...
            Promise.all([n.e(6290), n.e(9116), n.e(1200), n.e(1583)])
              .then(n.bind(n, 90185))
              .then(e => {
                this._setPaneViews([new e.RegressionTrendPaneView(this, this._model)]);
              });
        }
        formatter() {
        ...
        startIndex() {
          ...
          if (e.every(e => e !== s.INVALID_TIME_POINT_INDEX)) return e[this._trendData.startIndex];
        ...
        endIndex() {
          const e = this._indexes;
          if (null === this._trendData || null === e) return null;
          if (e.every(e => e !== s.INVALID_TIME_POINT_INDEX)) return e[this._trendData.endIndex];
          const t = this._getPointsetPoints();
        ...
        static createRegressionTrendPropertiesFromStudyMetaInfoAndState(e, t, n, i, s) {
        ...
        _studyInputs(e) {
          (0, i.assert)(2 === e.length, 'all the line tool points should be defined');
          const t = !0,
        ...
        async _getPropertyDefinitionsViewModelClass() {
          return (
            await Promise.all([n.e(1190), n.e(3889), n.e(8009), n.e(4482), n.e(607)]).then(
              n.bind(n, 42838),
            )
