  ...
  [5529],
  {
    73174: (e, t, n) => {
      ...
      const p = -5e4,
        ...
        P = new r.TranslatedString('change bar X coordinate', o.t(null, void 0, n(2066))),
    ...
    39374: (e, t, n) => {
      ...
      var i = n(19365),
        ...
        p = n(32679),
        g = n(6590);
      const _ = { intervalsVisibilities: { ...u.intervalsVisibilitiesDefaults }, size: 40 },
      ...
      class I extends l.LineToolSvgIconBase {
        constructor(e, t, n, i) {
          super(e, t ?? I.createProperties(e.backgroundTheme().spawnOwnership()), n, i),
            (this.version = 1),
            this._loadViews();
        }
        name() {
        ...
        async _loadViews() {
          ...
          try {
            ...
            if (!this._isDestroyed) {
              ...
              null === t && y.logWarn(`Couldn't create svg renderer for emoji ${e}`),
    ...
    27916: (e, t, n) => {
      ...
      class _ {
        ...
        _needLabelExclusionPath(e, t) {
          ...
          return 'middle' === (t ?? n.vertLabelsAlign.value()) && (0, h.needTextExclusionPath)(e);
        }
    ...
    22329: (e, t, n) => {
      ...
      class h extends l.LineDataSource {
        ...
        startChanging(e, t) {
          const n = (0, o.ensureNotNull)(this.pointToScreenPoint(this._points[0])),
          ...
          (this._changePointData = { centerPoint: n, initialLength: c, initialSize: a }),
    ...
    36036: (e, t, n) => {
      ...
      class m extends d.BitmapCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, n, g, p), i.length && this._drawPoints(e, i, o, P, _);
        }
        _drawPoints(e, t, n, o, s) {
          const { context: l, horizontalPixelRatio: c, verticalPixelRatio: h } = e,
          ...
          for (let e = 0; e < t.length; ++e) {
            const r = t[e];
            if (!((0, a.isInteger)(r.pointIndex) && d.linePointBeingEdited === r.pointIndex)) {
              l.fillStyle = n[e];
              if (
                (o(
                  l,
                ...
                if (null !== d.hoveredPointIndex && r.pointIndex === d.hoveredPointIndex) {
