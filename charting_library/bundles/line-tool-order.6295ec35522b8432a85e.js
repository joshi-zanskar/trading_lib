  ...
  [2232],
  {
    ...
    64732: (t, e, i) => {
      ...
      class d {
        ...
        setMode(t) {
          return (this._mode = t), this._line.updateAllViewsAndRedraw(u(this._line.id())), this;
        }
        setDirection(t) {
          return (
            (this._direction = t), this._line.updateAllViewsAndRedraw(u(this._line.id())), this
          );
        }
        setActive(t) {
          return (this._active = t), this._line.updateAllViewsAndRedraw(u(this._line.id())), this;
        }
        setEditable(t) {
          return (this._editable = t), this._line.updateAllViewsAndRedraw(u(this._line.id())), this;
        }
        getEditable() {
        ...
        setCancellable(t) {
          return (
            (this._cancellable = t), this._line.updateAllViewsAndRedraw(u(this._line.id())), this
          );
        }
        getCancellable() {
        ...
        getExtendLeft() {
          ...
          return 'inherit' === t
            ? this._line._model.properties().tradingProperties.extendLeft.value()
            : t;
        }
        setExtendLeft(t) {
        ...
        getLineLength() {
          ...
          return 'inherit' === t
            ? this._line._model.properties().tradingProperties.lineLength.value()
            : t;
        }
        ...
        setBodyBorderActiveBuyColor(t) {
          return this._line.properties().bodyBorderActiveBuyColor.setValue(t), this;
        }
        setBodyBorderInactiveBuyColor(t) {
          return this._line.properties().bodyBorderInactiveBuyColor.setValue(t), this;
        }
        setBodyBorderActiveSellColor(t) {
          return this._line.properties().bodyBorderActiveSellColor.setValue(t), this;
        }
        setBodyBorderInactiveSellColor(t) {
          return this._line.properties().bodyBorderInactiveSellColor.setValue(t), this;
        }
        ...
        setBodyTextInactiveLimitColor(t) {
          return this._line.properties().bodyTextInactiveLimitColor.setValue(t), this;
        }
        setBodyTextActiveLimitColor(t) {
          return this._line.properties().bodyTextActiveLimitColor.setValue(t), this;
        }
        setBodyTextInactiveStopColor(t) {
          return this._line.properties().bodyTextInactiveStopColor.setValue(t), this;
        }
        setBodyTextActiveStopColor(t) {
          return this._line.properties().bodyTextActiveStopColor.setValue(t), this;
        }
        setBodyTextInactiveBuyColor(t) {
          return this._line.properties().bodyTextInactiveBuyColor.setValue(t), this;
        }
        setBodyTextActiveBuyColor(t) {
          return this._line.properties().bodyTextActiveBuyColor.setValue(t), this;
        }
        setBodyTextInactiveSellColor(t) {
          return this._line.properties().bodyTextInactiveSellColor.setValue(t), this;
        }
        setBodyTextActiveSellColor(t) {
          return this._line.properties().bodyTextActiveSellColor.setValue(t), this;
        }
        getBodyFont() {
        ...
        setQuantityBorderActiveBuyColor(t) {
          return this._line.properties().quantityBorderActiveBuyColor.setValue(t), this;
        }
        setQuantityBorderInactiveBuyColor(t) {
          return this._line.properties().quantityBorderInactiveBuyColor.setValue(t), this;
        }
        setQuantityBorderActiveSellColor(t) {
          return this._line.properties().quantityBorderActiveSellColor.setValue(t), this;
        }
        setQuantityBorderInactiveSellColor(t) {
          return this._line.properties().quantityBorderInactiveSellColor.setValue(t), this;
        }
        ...
        setQuantityBackgroundActiveBuyColor(t) {
          return this._line.properties().quantityBackgroundActiveBuyColor.setValue(t), this;
        }
        setQuantityBackgroundInactiveBuyColor(t) {
          return this._line.properties().quantityBackgroundInactiveBuyColor.setValue(t), this;
        }
        setQuantityBackgroundActiveSellColor(t) {
          return this._line.properties().quantityBackgroundActiveSellColor.setValue(t), this;
        }
        setQuantityBackgroundInactiveSellColor(t) {
          return this._line.properties().quantityBackgroundInactiveSellColor.setValue(t), this;
        }
        ...
        setCancelButtonBorderActiveBuyColor(t) {
          return this._line.properties().cancelButtonBorderActiveBuyColor.setValue(t), this;
        }
        setCancelButtonBorderInactiveBuyColor(t) {
          return this._line.properties().cancelButtonBorderInactiveBuyColor.setValue(t), this;
        }
        setCancelButtonBorderActiveSellColor(t) {
          return this._line.properties().cancelButtonBorderActiveSellColor.setValue(t), this;
        }
        setCancelButtonBorderInactiveSellColor(t) {
          return this._line.properties().cancelButtonBorderInactiveSellColor.setValue(t), this;
        }
        ...
        setCancelButtonIconActiveBuyColor(t) {
          return this._line.properties().cancelButtonIconActiveBuyColor.setValue(t), this;
        }
        setCancelButtonIconInactiveBuyColor(t) {
          return this._line.properties().cancelButtonIconInactiveBuyColor.setValue(t), this;
        }
        setCancelButtonIconActiveSellColor(t) {
          return this._line.properties().cancelButtonIconActiveSellColor.setValue(t), this;
        }
        setCancelButtonIconInactiveSellColor(t) {
          return this._line.properties().cancelButtonIconInactiveSellColor.setValue(t), this;
        }
        block() {
          (this._blocked = !0), this._line.updateAllViewsAndRedraw(u(this._line.id()));
        }
        unblock() {
          (this._blocked = !1), this._line.updateAllViewsAndRedraw(u(this._line.id()));
        }
        getBlocked() {
        ...
        onCancel(t, e) {
          return (
            e
              ? this.isFunction(e) && ((this._onCancelData = t), (this._onCancelCallback = e))
        ...
        onModify(t, e) {
          return (
            e
              ? this.isFunction(e) && ((this._onModifyData = t), (this._onModifyCallback = e))
        ...
        onMove(t, e) {
          return (
            e
              ? this.isFunction(e) && ((this._onMoveData = t), (this._onMoveCallback = e))
        ...
        onMoving(t, e) {
          return (
            e
              ? this.isFunction(e) && ((this._onMovingData = t), (this._onMovingCallback = e))
        ...
        onContextMenu(t, e) {
          return (
            e
              ? this.isFunction(e) &&
                ((this._onContextMenuData = t), (this._onContextMenuCallback = e))
      ...
      class p extends o {
        ...
        move(t, e, i, o) {
          var r =
            ...
            this._startMovingPoint.logical.price !== this._currentMovingPoint.logical.price;
        ...
        createPriceAxisView(t) {
          var e = { pointIndex: t, backgroundPropertyGetter: () => this._adapter.getLineColor() };
