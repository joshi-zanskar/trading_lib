      ...
      class c extends h.LineSourcePaneView {
        ...
        _updateImpl(t) {
          ...
          if (
            ...
            if (t > 0) {
              const e = 1 !== t ? [o.points[0], o.points[t - 1]] : [o.points[0]],
    ...
    13506: (t, e, i) => {
      ...
      class h extends r.LineToolBrushBase {
        ...
        animationProgress() {
          ...
          const t = (performance.now() - this._creationTime) / this._visibilityTime;
          return Math.min(1, t);
        }
        ...
        _ignoreSourceEvent(t) {
          return (
            'data-source-change' === t.type && t.sourceId !== this.model().crosshairSource().id()
          );
        }
      }
    },
    27916: (t, e, i) => {
      ...
      !(function (t) {
        (t[(t.RegularAnchorRadius = 6)] = 'RegularAnchorRadius'),
          ...
          (t[(t.RegularSelectedStrokeWidth = 3)] = 'RegularSelectedStrokeWidth'),
      ...
      class g {
        ...
        _lineAnchorColors(t) {
          const e = (0, o.ensureNotNull)(this._model.paneForSource(this._source)).height();
        ...
        _needLabelExclusionPath(t, e) {
          ...
          return 'middle' === (e ?? i.vertLabelsAlign.value()) && (0, c.needTextExclusionPath)(t);
        }
        _addAlertRenderer(t, e, i = this._source.properties().linecolor.value()) {}
        _getAlertRenderer(t, e = this._source.properties().linecolor.value(), i) {
          return null;
        }
    ...
    36036: (t, e, i) => {
      ...
      class f extends d.BitmapCoordinatesPaneRenderer {
        ...
        hitTest(t) {
          ...
          for (const e of i) {
            if (e.point.subtract(t).length() <= n)
              return new l.HitTestResult(e.hitTarget ?? l.HitTarget.ChangePoint, {
        ...
        doesIntersectWithBox(t) {
          return null !== this._data && this._data.points.some(e => (0, o.pointInBox)(e.point, t));
        }
        _drawImpl(t) {
          ...
          e.length && this._drawPoints(t, e, i, p, _), n.length && this._drawPoints(t, n, o, P, g);
        }
        _drawPoints(t, e, i, o, s) {
          const { context: l, horizontalPixelRatio: h, verticalPixelRatio: c } = t,
    ...
    74011: (t, e, i) => {
      ...
      class p extends h.MediaCoordinatesPaneRenderer {
        ...
        hitTest(t) {
          ...
          for (let n = 1; n < i; n++) {
            const i = this._points[n - 1],
              r = this._points[n];
            if ((0, o.distanceToSegment)(i, r, t).distance <= e) return this._hittest;
          }
          if (this._data.filled && this._data.fillBackground && i > 0) {
            const n = this._points[0],
              r = this._points[i - 1];
            if ((0, o.distanceToSegment)(n, r, t).distance <= e) return this._hittest;
          }
        ...
        _drawImpl(t) {
          ...
          try {
            if (
              (void 0 !== this._data.globalAlpha && (e.globalAlpha = this._data.globalAlpha),
              1 === i)
            )
            ...
            e.beginPath();
            const t = this._data.linestyle === u.LINESTYLE_SOLID ? 'round' : 'butt',
            ...
            if (
              ...
              if (this._data.leftend === s.LineEnd.Arrow) {
                ...
                (0, r.drawArrow)(t[0], t[1], e, e.lineWidth, _.dpr1PixelRatioInfo);
              }
