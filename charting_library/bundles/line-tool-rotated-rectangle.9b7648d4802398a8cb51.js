  ...
  [4015],
  {
    23550: (e, t, n) => {
      ...
      class c extends r.LineDataSource {
        constructor(e, t, i, s) {
          super(e, t ?? c.createProperties(e.backgroundTheme().spawnOwnership()), i, s),
        ...
        setPoint(e, t, n, s) {
          if ((super.setPoint(e, t, n), 0 === e || 1 === e)) {
            const e = this._points,
              t = (0, o.ensureNotNull)(this.pointToScreenPoint(e[0])),
              n = (0, o.ensureNotNull)(this.pointToScreenPoint(e[1])).subtract(t),
              s = new i.Point(n.y, -n.x).normalized().scaled((0, o.ensureNotNull)(this._distance)),
              r = t.add(s),
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            e.addChild('linesColors', new l.LineToolColorsProperty([e.childs().color]));
        }
      }
    },
  },
