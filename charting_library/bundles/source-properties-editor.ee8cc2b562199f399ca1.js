(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6780],
  {
    ...
    78890: (e, t, i) => {
      ...
      class p extends s.PureComponent {
        ...
        _getPlaceHolderItem(e) {
          return e
            ? s.createElement(o.Icon, { className: d.defaultsButtonIcon, icon: u })
            : m.defaults;
        }
      }
    },
    48531: (e, t, i) => {
      ...
      function d(e) {
        return s.createElement(l.MatchMedia, { rule: '(max-width: 768px)' }, t =>
          s.createElement(
            o.ControlDisclosure,
            {
          ...
          s.createElement(
            ...
            t &&
              s.createElement(
                ...
                t.definitions
                  .value()
                  .map(e => s.createElement(r.Section, { key: e.id, definition: e })),
              ),
          ),
        );
      }
      ...
      class P extends s.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._getTranslatedStringForSource = e =>
              new S.TranslatedString(e.name(), e.title(g.TitleDisplayTarget.StatusLine))),
            (this._setTitle = e => {
        ...
        render() {
          const { onCancel: e, source: t } = this.props,
            ...
            n = t.properties().title?.value() || t.title(g.TitleDisplayTarget.StatusLine),
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            const { pages: i, source: a } = this.props,
              ...
              r = n.map(({ title: e, id: t }) => ({ label: e, id: t, dataId: `${l}-${t}` }));
            return s.createElement(
              s.Fragment,
              null,
              ...
              p &&
                s.createElement(
                  ...
                  s.createElement(o.Icon, {
                    ...
                    icon: u,
                    onClick: function () {
                      (0, c.trackEvent)('GUI', 'Rename', 'Drawing settings'), f(v), i(!0);
                    },
                    'data-name': 'edit',
                    'data-role': 'button',
                  }),
                  s.createElement('div', { className: a(d.empty, !t && d.hideEmpty) }),
                ),
            ),
            p &&
              s.createElement(
                ...
                s.createElement(n.InputControl, {
                  ...
                  onKeyDown: function (e) {
                    27 === (0, r.hashFromEvent)(e) && (e.preventDefault(), f(h), i(!1));
      ...
      function b(e) {
        const {
          ...
          S = !!(
            ...
            x &&
            o &&
            f.every(e => x?.id === v.model().lineToolsGroupModel().groupForLineTool(e)?.id)
          ),
          [T, y] = (0, s.useState)(_),
          [w, I] = (0, s.useState)(!1),
        ...
        return s.createElement(r.AdaptiveConfirmDialog, {
          ...
          footerLeftRenderer: function () {
            return s.createElement(c.FooterMenu, { sources: f, chartUndoModel: v });
          },
          render: function () {
    ...
    86720: (e, t, i) => {
      ...
      const p = (0, a.createContext)({ size: 'small', overflowBehaviour: void 0 });
      var g = i(17946),
        b = i(56406);
      function f(e) {
        const {
      ...
      const v = (0, a.forwardRef)((e, t) => {
        ...
        return a.createElement(
          ...
          m && 'string' == typeof h
            ? a.createElement(
                'span',
                { className: o()(b['ellipsis-children'], 'apply-overflow-tooltip') },
                h,
              )
            : h,
        );
      ...
      const C = (0, a.forwardRef)((e, t) => {
        ...
        return a.createElement(v, { ...r, id: i.id, onClick: c, ref: u }, i.label);
      });
      ...
      function X(e) {
        ...
        return n(L['scroll-wrap'], L[`size-${t}`], 'scroll' === i && L['enable-scroll'], s);
      }
      function j() {
      ...
      function J(e) {
        ...
        return a.createElement(
          'div',
          {
            ...
            style: { transform: `translateX(${i}px) scaleX(${o})`, transitionDuration: `${s}ms` },
          },
          a.createElement('div', {
            className: V().corner,
      ...
      function U(e) {
        const {
          ...
          M = j(),
          F = (function (e) {
            const t = (0, Y.useSafeMatchMedia)(H['media-mf-phone-landscape'], !0),
              i = j();
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              ne.map(e =>
                a.createElement(C, { ...Se(e), ref: se(V(e)), key: e.id, item: e, fake: !0 }),
              ),
              'collapse' === F &&
                a.createElement(R, {
                  size: v,
              ...
              Ee ? a.createElement(J, { ...Ee, disabled: b }) : a.createElement('div', null),
            ),
          ),
        );
      }
