  ...
  [2077],
  {
          ...
          for (var e = [], t = 0; t < arguments.length; t++) {
            ...
            if (n) {
              ...
              if ('string' === s || 'number' === s) e.push(n);
                ...
                r && e.push(r);
              } else if ('object' === s) for (var a in n) o.call(n, a) && n[a] && e.push(a);
            }
          }
          return e.join(' ');
        }
      ...
      function _(e, t) {
        const {
          ...
          N = (function (e, t = null, n) {
            ...
            return (0, o.useEffect)(() => ((s.current = [e, t, n]), r(), a), [e, t, n]), l;
          })('wheel', C, f),
          A = R;
    ...
    78274: (e, t, n) => {
      ...
      function a(e) {
        ...
        return o.createElement(
          'span',
          { className: i(r()['inner-slot'], n && r().interactive, s && r().icon, t) },
          a,
        );
      }
      function l(e) {
      ...
      function u(e) {
        const { className: t, children: n } = e;
        return o.createElement('span', { className: i(r()['after-slot'], t) }, n);
      }
    },
    31261: (e, t, n) => {
      'use strict';
    ...
    48027: (e, t, n) => {
      ...
      var o = n(47201),
        i = n(29202);
      function s(e) {
        const { onFocus: t, onBlur: n, intent: s, highlight: r, disabled: a } = e,
    ...
    36383: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        s = n(27267);
      function r(e) {
        const { click: t, mouseDown: n, touchEnd: r, touchStart: a, handler: l, reference: c } = e,
          u = (0, o.useRef)(null),
          d = (0, o.useRef)(
    ...
    9745: (e, t, n) => {
      ...
      const i = o.forwardRef((e, t) => {
        const { icon: n = '', title: i, ariaLabel: s, ariaLabelledby: r, ariaHidden: a, ...l } = e,
          c = !!(i || s || r);
    ...
    87896: (e, t, n) => {
      ...
      var o = n(50959),
        i = n(32227),
        s = n(4237);
      const r = (0, o.createContext)({ isOnMobileAppPage: () => !1, isRtl: !1, locale: 'en' });
      var a = n(84015),
        l = n(63273);
    ...
    82206: (e, t, n) => {
      ...
      class u extends o.PureComponent {
        ...
        render() {
          const {
            ...
            h = i(a, c.dialog, e && c.rounded, t && c.shadowed, n && c.fullscreen, s && c.darker),
        ...
        _createStyles() {
          ...
          return { bottom: e, left: t, right: o, top: i, zIndex: s, maxWidth: n, height: r };
        }
      }
      var d,
        h = n(86431),
      ...
      const N = class {
        ...
        updateOptions(e) {
          (this._guard = e.guard || w), (this._calculateDialogPosition = e.calculateDialogPosition);
        }
        setFullscreen(e) {
        ...
        componentDidMount() {
          ...
          if ((this._eventDispatcher.dispatch('dialog-open'), e)) {
            ...
            if (e && e instanceof HTMLElement) {
              const i = new D(o, e, { boundByScreen: Boolean(t), onDragStart: n });
      ...
      function s(e, t) {
        return class extends o.PureComponent {
          render() {
            ...
            return 'parent' === s ? r : o.createElement(i.Portal, { shouldTrapFocus: t }, r);
          }
        };
      }
    },
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement('div', { className: v.title }, r.t(null, void 0, n(2569))),
                o.createElement(m, {
      ...
      function x(e) {
        ...
        const t = document.createElement('div'),
          ...
          r = o.createElement(D, {
            ...
            selectOnInit: i,
            onClose: function () {
              a.unmount(), w.dialogsOpenerManager.setAsClosed('ChangeIntervalDialog'), s?.();
            },
          }),
