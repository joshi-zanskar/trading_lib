    ...
    90921: (e, t, i) => {
      ...
      class l extends s.LineDataSource {
        constructor(e, t, s, n) {
          super(e, t ?? l.createProperties(e.backgroundTheme().spawnOwnership()), s, n),
            ...
            Promise.all([i.e(6290), i.e(9116), i.e(1200), i.e(1583)])
              .then(i.bind(i, 73050))
              .then(e => {
                this._setPaneViews([new e.FlatBottomPaneView(this, this._model)]);
              });
        }
        pointsCount() {
          return 3;
        ...
        setPoint(e, t, i, s) {
          ...
          if (2 === e) (this._points[1].index = t.index), (this._points[1].interval = n);
          else if (3 === e)
            return (
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            e.hasChild('labelText') || e.addChild('labelText', new o.Property('')),
