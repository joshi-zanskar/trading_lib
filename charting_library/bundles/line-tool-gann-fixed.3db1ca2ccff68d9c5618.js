  ...
  [6336],
  {
      ...
      class v extends l.DefaultProperty {
        ...
        state(e, t, s) {
          ...
          return s
            ...
            : ((i = r),
              (n = this._map),
              (0, this._levelsIterator)(i, { tpl: u, fill: a, typecheck: n.typecheck.pack }, n));
          var i, n;
        }
        preferences() {
    ...
    8308: (e, t, s) => {
      ...
      class c extends n.LineDataSource {
        constructor(e, t, r, i) {
          super(e, t ?? c.createProperties(e.backgroundTheme().spawnOwnership()), r, i),
        ...
        _reversePoints() {
          ...
          (this._points[0] = t), (this._points[1] = e), this._normalizePoints(), this.restart();
        }
      }
    },
  },
