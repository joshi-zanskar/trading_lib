  ...
  [1506],
  {
      ...
      class v extends n.DefaultProperty {
        ...
        state(e, t, s) {
          ...
          return s
            ...
            : ((i = r),
              (l = this._map),
              (0, this._levelsIterator)(i, { tpl: h, fill: c, typecheck: l.typecheck.pack }, l));
          var i, l;
        }
        preferences() {
    ...
    8532: (e, t, s) => {
      ...
      !(function (e) {
        ...
        (function (e) {
          (e[(e.LevelsCount = 11)] = 'LevelsCount'), (e[(e.PointsCount = 2)] = 'PointsCount');
        })(h || (h = {})),
        (function (e) {
      ...
      class d extends a.LineDataSource {
        ...
        migrateVersion(e, t, s) {
          if (1 === e) {
            ...
            for (let t = 2; t <= 11; t++) e['level' + t].childs().color.setValue(i);
            for (let t = 1; t <= 11; t++)
