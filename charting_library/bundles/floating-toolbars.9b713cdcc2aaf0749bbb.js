  ...
  [2306],
  {
          ...
          for (var t = [], e = 0; e < arguments.length; e++) {
            ...
            if (o) {
              ...
              if ('string' === r || 'number' === r) t.push(o);
                ...
                s && t.push(s);
              } else if ('object' === r) for (var a in o) i.call(o, a) && o[a] && t.push(a);
            }
          }
          return t.join(' ');
        }
    ...
    67248: (t, e, o) => {
      ...
      function _(t) {
        ...
        if (e && n && o)
          return c.createElement('span', { className: h(u().slot, u().startSlotWrap) }, e);
        const a = o && (e ?? n),
          l = !e && !n && !o && !i && r && s;
        return c.createElement(
          c.Fragment,
          null,
          e && c.createElement('span', { className: h(u().slot, u().startSlotWrap) }, e),
          i && !a && c.createElement('span', { className: u().content }, i),
          n && c.createElement('span', { className: h(u().slot, u().endSlotWrap) }, n),
          l &&
            !a &&
            (function (t) {
              return (
                ...
                c.createElement(
                  ...
                  c.createElement('span', { className: u().primaryText }, ' ', t.primaryText, ' '),
      ...
      function w(t) {
        ...
        return { ...p, ...(0, y.filterDataProps)(t), ...(0, y.filterAriaProps)(t) };
      }
      function C(t) {
        const {
            reference: e,
          ...
          u = g({ ...l, isGrouped: h, cellState: d, disablePositionAdjustment: p }),
          m =
            o ??
            (t.primaryText
            ...
            content: i.createElement(
              ...
              w
                ...
                : i.createElement(
                    ...
                    i.createElement('div', { className: n(!g && v.buttonLabel) }, `${b}px`),
                  ),
            ),
          },
        ...
        return (
          (0, i.useLayoutEffect)(() => {
            const t = (0, n.ensureNotNull)(e.current),
              o = () => {
                const o = (0, r.queryTabbableElements)(t).sort(r.navigationOrderComparator);
                if (
                  0 === o.length ||
                  (o[0].parentElement && !u(o[0].parentElement, (0, n.ensureNotNull)(e.current)))
                ) {
                  const i = (function (t) {
              ...
              switch (g) {
                ...
                case 'blockNext':
                  (o => {
                    ...
                    if (-1 === s) return;
                    const a = i['blockNext' === o ? i.indexOf(r) + 1 : i.indexOf(r) - 1];
                    if (!a) return;
                    e.preventDefault();
    ...
    16697: (t, e, o) => {
          ...
          C &&
            i.createElement(
              p.PopupMenu,
              {
                ...
                onClose: T,
                position: function () {
                  const t = (0, h.ensureNotNull)(b.current).getBoundingClientRect();
            ...
            i.createElement(
              ...
              t.map((t, o) =>
                i.createElement(y, {
                  key: String(t) + o,
                  color: t,
                  selected: a && (0, c.areEqualRgb)(a, (0, c.parseRgb)(String(t))),
                  onSelect: d,
                  onSwatchRemove: s
                    ? () =>
                        (function (t, e) {
      ...
      class L extends i.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._handlePosition = t => {
              ...
              if (!o) return;
              const i = (0, h.ensureNotNull)(this._container).getBoundingClientRect(),
                n = t.clientX - i.left,
                r = t.clientY - i.top;
              o({
                h: e,
            ...
            (this._handleKeyDown = t => {
              ...
              if (37 === r || 39 === r) {
                return void n({ h: e, s: (0, P.clamp)(37 === r ? o - W : o + W, 0, 1), v: i });
              }
        ...
        render() {
          ...
          return i.createElement(
            'div',
            { tabIndex: 0, className: r()(B.accessible, t), onKeyDown: this._handleKeyDown },
            i.createElement(
              'div',
              {
      ...
      class N extends i.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._handlePosition = t => {
              ...
              if (!i) return;
              const n = (0, h.ensureNotNull)(this._container).getBoundingClientRect(),
                r = t.clientY - n.top;
            ...
            (this._handleKeyDown = t => {
              ...
              n({ h: (0, P.clamp)(38 === r ? e - 0.01 : e + 0.01, 0, 1), s: o, v: i });
            }),
            (this._mouseDown = t => {
              window.addEventListener('mouseup', this._mouseUp),
                window.addEventListener('mousemove', this._mouseMove);
        ...
        render() {
          ...
          return i.createElement(
            'div',
            { className: r()(k.hue, k.accessible, t), tabIndex: 0, onKeyDown: this._handleKeyDown },
            i.createElement(
              'div',
              {
              ...
              i.createElement('div', { className: k.pointer, style: { top: 100 * e + '%' } }),
            ),
          );
        }
      }
        ...
        constructor(t) {
          super(t),
            ...
            (this._handleHSV = t => {
              ...
              this.setState({ color: e, inputColor: F(e), hsv: t }), this.props.onSelect(e);
            }),
            (this._handleInput = t => {
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              { className: M.form },
              i.createElement('div', {
                className: r()(M.swatch, String(t).toLowerCase() === m.white && M.white),
              ...
              i.createElement(
                ...
                i.createElement(T.Button, { size: 's', onClick: this._handleAddColor }, R),
              ),
            ),
            i.createElement(
              'div',
              { className: M.hueSaturationWrap },
              i.createElement(L, { className: M.saturation, hsv: e, onChange: this._handleHSV }),
              i.createElement(N, { className: M.hue, hsv: e, onChange: this._handleHSV }),
            ),
          );
        }
      }
          ...
          u
            ...
            : i.createElement(
                ...
                i.createElement(
                  'div',
                  { ref: v, onKeyDown: f },
                  i.createElement(w, { colors: m.basic, color: e, onSelect: y }),
                  i.createElement(w, { colors: m.extended, color: e, onSelect: y }),
                      ...
                      i.createElement(
                        ...
                        l?.length
                          ? i.createElement('button', {
                              title: O,
                              onClick: b,
                              className: r()(V.customButton, V.accessible, 'apply-common-tooltip'),
                              tabIndex: -1,
                            })
                          : i.createElement(
                              'div',
          ...
          const {
            ...
            P =
              ...
              ('string' == typeof a
                ...
                : i.cloneElement(a, { className: n(y.icon, a.props.className) }));
          return 'button' === o
            ? i.createElement(
                'button',
                {
                ...
                v && _ && i.createElement('div', { className: n('js-button-text', y.text) }, _),
                P,
                !v && _ && i.createElement('div', { className: n('js-button-text', y.text) }, _),
              )
            : i.createElement(
      ...
      class f extends i.PureComponent {
        constructor(t) {
          super(t),
            ...
            (this._handleClick = t => {
              (m.enabled('skip_event_target_check') || t.target instanceof Node) &&
            ...
            (this._handleKeyDown = t => {
              ...
              if (t.currentTarget.contains(t.target))
                ...
                switch (o) {
                  case 27: {
                    t.preventDefault();
                    const { shouldReturnFocus: e, isOpenedByButton: o } = this.state;
                    this._handleToggleDropdown(!1), e && o && this._wrapperRef?.focus();
                    break;
                  }
                }
              }
        ...
        render() {
          ...
          return 'button' === t
            ? i.createElement(
                ...
                this.state.isOpened &&
                  (_
                    ? i.createElement(u.MatchMedia, { rule: _ }, t => this._renderContent(t))
    ...
    17815: (t, e, o) => {
      ...
      class P extends s.FloatingToolbar {
        ...
        showAndSaveSettingsValue() {
          this._canBeShownValue.value() &&
            (m.TVLocalStorage.setItem('ChartFavoriteDrawingToolbarWidget.visible', 'true'),
            this.show());
        }
        hideAndSaveSettingsValue() {
          m.TVLocalStorage.setItem('ChartFavoriteDrawingToolbarWidget.visible', 'false'),
            this.hide();
        }
        canBeShown() {
        ...
        _renderWidgetPlug() {
          n.render(
            i.createElement('div', { className: 'tv-favorited-drawings-toolbar__widget' }),
            this._reactContainer,
          );
        }
        _renderReactContent() {
        ...
        _attachHandlers() {
          a.LinetoolsFavoritesStore.favoriteAdded.subscribe(this, this._onFavoriteAdded),
            ...
            this.onSortableStart().subscribe(this, t => {
              ...
              o.classList.add('clicked'), (0, _.hide)(), (o.style.pointerEvents = 'none');
            }),
        ...
        _loadVisibilityState() {
          ...
          void 0 !== i
            ...
            : (o =
                'false' !== m.TVLocalStorage.getItem('ChartFavoriteDrawingToolbarWidget.visible')),
    ...
    10540: (t, e, o) => {
      'use strict';
      o.d(e, { FLOATING_TOOLBAR_REACT_WIDGETS_CLASS: () => T, FloatingToolbar: () => S });
      var i = o(59064),
        n = o(32563),
        r = o(78871),
        s = o(56840),
      ...
      class m {
        constructor(t) {
          (this._helper = null),
            ...
            (this._handleDragMove = t => {
              ...
              if (s) {
                ...
                isFinite(t) && (this._helper.nextTop = e.clientY - o.clientY + t);
              }
              const a = 'x' === this._axis || !1 === this._axis || 0 !== e.movementY;
              if (a) {
                const t = this._helper.startLeft;
                isFinite(t) && (this._helper.nextLeft = e.clientX - o.clientX + t);
              }
          ...
          const o = (this._handle = (t.handle ? e.querySelector(t.handle) : null) ?? e);
        ...
        constructor(t) {
          (this._pointerStarted = !1),
            ...
            (this._handlePointerDown = t => {
              ...
              if (
                ((this._initial = t),
                !this._distance && (this._pointerStart(), !this._pointerStarted))
              )
                return;
              t.preventDefault();
      ...
      class y {
          ...
          (this._items = []),
            ...
            (this._handleDragStart = t => {
              ...
              (this._helper = {
                ...
                draggableIndex: t,
                leftBorder: n.left + b(o, 'padding-left') + b(o, 'border-left-width') - i.left - 1,
                rightBorder:
                  n.right - b(o, 'padding-right') - b(o, 'border-right-width') - i.right + 1,
                topBorder: n.top + b(o, 'padding-top') + b(o, 'border-top-width') - i.top - 1,
                bottomBorder:
                  n.bottom - b(o, 'padding-bottom') - b(o, 'border-bottom-width') - i.bottom + 1,
              }),
            ...
            (this._handleDragStop = () => {
              ...
              this._cleanup(), this._initBackends(), null !== t && this._options.stop?.(t);
            }),
            (this._options = t),
            this._initBackends();
        }
        ...
        _getAllItems() {
          return (
            this._items?.length || (this._items = Array.from(this._options.source.children)),
            this._items
          );
        }
      ...
      class S {
        constructor(t) {
          (this._widget = document.createElement('div')),
            ...
            (this._reactWidgetsContainer = this._widget.getElementsByClassName(T).item(0)),
          ...
          this.isVisible() ||
            ...
            this._widget.classList.contains('i-hidden')
              ? (this._widget.classList.remove('i-hidden'),
                setTimeout(() => {
                  this.isVisible() && (t?.(), this._widget.classList.remove('i-closed'));
                }))
        ...
        addWidget(t, e = {}) {
          ...
          this._content.insertBefore(i, n), this._onWindowResize(), this._sortable?.updateList();
        }
        ...
        removeWidget(t) {
          ...
          e && (this._content.removeChild(e), this._onWindowResize(), this._sortable?.updateList());
        }
        widgetsCount() {
        ...
        _getSavedPosition() {
          ...
          if ('device' === this._options.positionStorageType) {
            const e = d.TVLocalStorage.getItem(this._options.positionSettingsKey);
    ...
    46675: (t, e, o) => {
      ...
      class g extends m.Property {
        ...
        unsubscribe(t, e) {
          const o = (0, u.ensureDefined)(
            this._listenersMappers.find(o => o.obj === t && o.method === e)?.callback,
          );
      ...
      function V(t) {
        const { activeChartWidget: e, className: n } = t,
          ...
          l = (0, B.useProperty)(a?.properties().anchored ?? new m.Property(!1)),
          c = I(
            () =>
              new A.ActionsProvider(e).actionForLineTools(s, 'Chart.SelectedObject.ToggleAnchored'),
            t => t?.destroy(),
            [e, l],
          );
        return c
      ...
      function j(t) {
        ...
        return i.createElement(L, {
          ...
          isActive: Boolean(l),
          onClick: function () {
            (0, x.trackEvent)('GUI', 'Context action on drawings', 'Align to 45 degrees');
            const t = (0, h.alignTo45Degrees)().value();
            (0, h.alignTo45Degrees)().setValue(!t), t || e.model().alignToolTo45Degrees(a);
          },
          'data-name': Boolean(l) ? 'disable-align-to-45-degrees' : 'enable-align-to-45-degrees',
          ...c,
        });
      }
      var G = o(98486);
      function $(t) {
        ...
        return i.createElement(S.ToolWidgetIconButton, {
          ...
          onClick: function () {
            (0, x.trackEvent)('GUI', 'Context action on drawings', 'Cancel Drawing'),
              o.resetDrawingState();
          },
        });
      }
      ...
      async function it(t, e) {
          ...
          n = (function (t, e) {
              ...
              i.push(
                new ot.Action({
                  ...
                  options: {
                    name: 'clone',
                    icon: o(36296),
                    shortcutHint: tt.humanReadableModifiers(et.Modifiers.Mod) + n + ' Drag',
            ...
            if (a.length > 0) {
              const e = {
                ...
                shortcutHint: tt.humanReadableModifiers(et.Modifiers.Mod) + n + ' C',
                onExecute: () => {
        ...
        if ((n.length && i.push(new ot.Separator(), ...n), e.some(t => t.isSynchronizable()))) {
          const o = (0, A.createSyncDrawingActions)(t, e);
          o.length && i.push(new ot.Separator(), ...o);
        }
        if (1 === e.length && e[0].additionalActions) {
          const o = await e[0].additionalActions(t.model(), 'FloatingToolbarButton');
          o.actions.length && (i.push(new ot.Separator()), i.push(...o.actions));
        }
        return i.push(new ot.Separator(), (0, A.createActionToggleVisibilityDataSources)(t, e)), i;
      }
      var nt = o(44996);
      function rt(t) {
          ...
          g = (0, i.useCallback)(
            t => {
              n &&
                p().then(e => {
                  const o = st(e);
                  window.matchMedia(w.DialogBreakpoints.TabletSmall).matches || !q.isAnyMobile
                    ? J.ContextMenuManager.showMenu(
                        o,
                        t,
                        { mode: q.isAnyMobile ? 'drawer' : 'menu', 'data-name': 'more-menu' },
      ...
      function ut(t) {
        ...
        return i.createElement(
          Q.ToolWidgetMenu,
          {
            ...
            'data-name': t['data-name'],
            menuDataName: `${t['data-name']}-menu`,
            verticalDropDirection: l ? lt.VerticalDropDirection.FromBottomToTop : void 0,
            horizontalDropDirection: l ? lt.HorizontalDropDirection.FromRightToLeft : void 0,
      ...
      function _t(t) {
        ...
        return i.createElement(
          Q.ToolWidgetMenu,
          {
            ...
            className: a,
            title: n,
            verticalDropDirection: s ? lt.VerticalDropDirection.FromBottomToTop : void 0,
            horizontalDropDirection: s ? lt.HorizontalDropDirection.FromRightToLeft : void 0,
      ...
      const Lt = new s.TranslatedString(
        ...
        kt = new s.TranslatedString('change line tool(s) line style', r.t(null, void 0, o(13423))),
        Nt = new s.TranslatedString('change line tool(s) line width', r.t(null, void 0, o(81303))),
      ...
      class Gt {
        ...
        selectedSources() {
          return this._chartWidgetCollection.selectedSources.value().filter(ft.isLineTool);
        }
        hide() {
        ...
        async _onSourceChanged(t) {
          ...
          if (
            (await Promise.all(t.map(async t => (0, yt.ensureLineToolLoaded)(t.toolname))),
        ...
        _createHighlighterWidthsButton(t, e) {
          if (
            (this._highlighterWidthsProperty &&
              (this._highlighterWidthsProperty.destroy(), (this._highlighterWidthsProperty = null)),
            (this._highlighterWidthsProperty = this._createProperty(t, e, 'widths', Nt) || null),
            !this._highlighterWidthsProperty)
          )
            return !0;
          const o =
            e && 1 !== this.selectedSources().filter(t => t.properties().widths).length ? Ut : Ht;
          return (
            this._addPropertyButton({
              component: Dt,
              props: {
        ...
        _createProperty(t, e, o, i) {
          if (e) {
            ...
            return this._isWidthProperty(t[0])
              ? new g(new p.MultipleLineWidthsProperty(t), this._propertyApplierImpl(), i)
          ...
          if (t && t.visible())
            return this._isWidthProperty(t)
              ...
              : new _.CollectibleColorPropertyDirectWrapper(new p.MultipleLineColorsProperty([t]));
        }
      ...
      class D extends n {
        ...
        showPropertiesOf(t, e, o) {
          ...
          if ((this._clearProperties(), (this._propertiesVisible = !1), i.length)) {
            for (var n = {}, s = 0; s < i.length; s++) {
              for (var a = i[s], l = e, c = a.name.split('.'), h = 0; h < c.length; ++h)
                l = l && l[c[h]];
              var d = a.showIf;
        ...
        _createToolExceptionCases() {
          return {
            ...
            LineToolHighlighter: D.prototype._highlighterPropertiesExceptionCase(),
          };
        }
    ...
    82665: (t, e, o) => {
      ...
      const l = function (t, e, o) {
        e = (o ? (0, n.default)(t, e, o) : void 0 === e) ? 1 : a((0, r.default)(e), 0);
