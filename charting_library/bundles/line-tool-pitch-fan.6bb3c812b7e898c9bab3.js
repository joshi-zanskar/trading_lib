    ...
    43176: (e, t, n) => {
      ...
      class v extends f.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          if (
            ((this._medianPoint = (0, _.lineSourcePaneViewPointToLineAnchorPoint)(
              3 === t
          ...
          if ((this._medianRenderer.setData(s), i.append(this._medianRenderer), t < 3))
          ...
          for (let e = 0; e <= 8; e++) {
            ...
            if (o?.childs().visible.value()) {
              const t = this._medianPoint.point.addScaled(d, o.childs().coeff.value()),
                r = this._medianPoint.point.addScaled(d, -o.childs().coeff.value());
              if (h) {
                {
                  const e = {
                      p1: n,
              ...
              a = o.childs().coeff.value();
              {
                ...
                s.setData(r),
                  s.setHitTest(new c.HitTestResult(c.HitTarget.MovePoint, void 0, e)),
                  i.append(s);
              }
              {
                const t = {
      ...
      const m = new s.TranslatedString('erase level line', o.t(null, void 0, n(77114)));
      var S;
      !(function (e) {
      ...
      class w extends a.LineDataSource {
        constructor(e, t, n, i) {
          super(e, t ?? w.createProperties(e.backgroundTheme().spawnOwnership()), n, i),
        ...
        processErase(e, t) {
          const n = 'level' + t,
            o = (0, i.ensureDefined)(this.properties().child(n)).childs().visible;
    ...
    36036: (e, t, n) => {
      ...
      class f extends c.BitmapCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, n, _, p), i.length && this._drawPoints(e, i, o, P, g);
        }
        _drawPoints(e, t, n, o, s) {
          const { context: a, horizontalPixelRatio: d, verticalPixelRatio: h } = e,
          ...
          for (let e = 0; e < t.length; ++e) {
            const r = t[e];
            if (!((0, l.isInteger)(r.pointIndex) && c.linePointBeingEdited === r.pointIndex)) {
              a.fillStyle = n[e];
              if (
                (o(
                  a,
                ...
                if (null !== c.hoveredPointIndex && r.pointIndex === c.hoveredPointIndex) {
