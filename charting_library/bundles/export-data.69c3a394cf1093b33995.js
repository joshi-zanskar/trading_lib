    ...
    99992: (e, l, t) => {
      ...
      function m(e, l = {}) {
        const t = Object.assign({}, p, l),
          ...
          V = !l.includeOHLCValuesForSingleValuePlots && (0, d.isCloseBasedSymbol)(N),
          I = (function (e, l) {
          ...
          const o = (0, i.ensureNotNull)(e.range().value(), 'time scale points range'),
            d = (function (e, l, t, s) {
              const n = s.from,
                ...
                d = e.range().value(),
                r = (0, i.ensureNotNull)(
                  void 0 !== n ? e.indexOf(n, !0) : (0, i.ensureNotNull)(d).firstIndex,
                ),
                c = (0, i.ensureNotNull)(
                  void 0 !== o ? e.indexOf(o, !0) : (0, i.ensureNotNull)(d).lastIndex,
                );
              let h = c,
                p = r;
              for (let e = 0; e < l.length; e++) {
                const i = l[e],
                  n = s.includeOffsetStudyValues ? (0, f.max)(t[e]?.fieldPlotOffsets ?? [0]) : 0,
              ...
              return (
                (0, i.assert)(h <= p, 'Range must contain at least 1 time point'),
                new u.BarsRange(h, p)
              );
            })(e, l, t, n),
            r = d.firstBar(),
        ...
        for (let e = 0; e < I.length; ++e) {
          ...
          (0, o.isOverlayStudy)(n) &&
            ((a = n.barFunction()),
            (r =
              !l.includeOHLCValuesForSingleValuePlots && (0, d.isCloseBasedSymbol)(n.symbolInfo())),
            (f =
          ...
          for (let e = 0; e < u.fields.length; ++e) {
            ...
            n.data()
              ...
              .each((e, l) => {
                ...
                let u;
                return (
                  (u = r ? x(l[4]) : f ? (0, i.ensureDefined)(a)(l) : x(l[h])),
                  (n[g] = u),
