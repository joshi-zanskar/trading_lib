(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2704],
  {
          ...
          for (var e = [], t = 0; t < arguments.length; t++) {
            ...
            if (n) {
              ...
              if ('string' === i || 'number' === i) e.push(n);
                ...
                s && e.push(s);
              } else if ('object' === i) for (var a in n) o.call(n, a) && n[a] && e.push(a);
            }
          }
          return e.join(' ');
        }
    ...
    53885: (e, t, n) => {
      ...
      function a(e, t = 2, n) {
        return o(
          ...
          s()[e],
          n,
          0 === t || 1 === t ? o(r.skeletonTheme.wrapper, s().skeleton) : s().letter,
    ...
    87896: (e, t, n) => {
      ...
      var a = n(84015),
        c = n(63273);
      const l = { iOs: 'old', android: 'new', old: 'old', new: 'new', any: 'any' };
      function u(e) {
    ...
    69654: (e, t, n) => {
      ...
      function d(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            'div',
            { className: i()(u.inputContainer, r && u.mobile, v, h && u.withCancel) },
            d || o.createElement(m, { isMobile: r, ...C }),
          ),
          t,
          o.createElement(a.Icon, { className: i()(u.icon, r && u.mobile, f), icon: r ? l : c }),
          h &&
            (!r || '' !== C.value) &&
    ...
    28587: (e, t, n) => {
      ...
      const S = o.memo(
        function (e) {
          ...
          return o.createElement(
            'div',
            {
              className: p()(M.action, l && M.active, E, h && M.withDescription, d && M.selected),
              onClick: C,
              ref: m,
            },
            v &&
            ...
            o.createElement(
              ...
              h && o.createElement('span', { className: p()(M.description, E) }, s ? x(s) : ''),
            ),
            void 0 !== f &&
              o.createElement(
                'div',
                { className: p()(M.action__favoriteIcon, f && M.action__favoriteIcon_active) },
      ...
      function N(e) {
        const {
          ...
          [y, A] = (0, o.useState)(() => r.reduce((e, t, n) => (t.name && (e[t.id] = !0), e), {}));
        function b(e) {
          const { id: t, ...n } = e;
                ...
                c
                  ...
                  : i.map((e, t) =>
                      o.createElement(
                        o.Fragment,
                        { key: e.id },
                        e.name && o.createElement('div', { className: T.section }, e.name),
                        e.actions.map((n, l) => {
                          const { id: u, ...m } = n,
                          ...
                          return o.createElement(
                            ...
                            !f && v && o.createElement('div', { className: T.separator }),
                          );
                        }),
                      ),
                    ),
      ...
      function O(e) {
        const { element: t, ...n } = e,
          ...
          { activeIdx: f, setActiveIdx: g } = (function (e, t, n, r = 'keydown') {
            ...
            return (
              ...
              (0, o.useEffect)(() => {
                if (!e || !n) return;
                const o = e => {
                  e.repeat || (13 === (0, u.hashFromEvent)(e) && n(t[i] ?? null, e));
                };
                return (
        ...
        return o.createElement(c.MatchMedia, { rule: d.DialogBreakpoints.TabletSmall }, e =>
          e
      ...
      class U {
        constructor(e, t, n, o) {
          (this._rootInstance = null),
            ...
            this._render(),
            a.favoriteCurrencyUnitConversionService.getOnChange().subscribe(this, this._render),
        ...
        destroy() {
          s.unsubscribe(r.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._close, this),
            a.favoriteCurrencyUnitConversionService.getOnChange().unsubscribeAll(this),
    ...
    36189: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        d = n(22413);
      function m(e) {
        const { className: t, isFilled: n, isActive: r, onClick: m, title: h, ...p } = e,
    ...
    97006: (e, t, n) => {
      'use strict';
      n.d(t, { createRegExpList: () => a, getHighlightedChars: () => c, rankedSearch: () => s });
      var o = n(37265);
      function r(e) {
        return e.replace(/[!-/[-^{-}?]/g, '\\$&');
      }
          ...
          .map(e => {
            ...
            return (
              n.forEach(e => {
                ...
                if (
                  ((n.lastIndex = 0),
                  (0, o.isString)(t) && t && t.toLowerCase() === r.toLowerCase())
                )
                  return (m = 4), void (d = t.match(s)?.index);
                if ((0, o.isString)(t) && s.test(t)) return (m = 3), void (d = t.match(s)?.index);
                if ((0, o.isString)(i) && s.test(i)) return (m = 2), void (d = i.match(s)?.index);
                if ((0, o.isString)(i) && n.test(i)) return (m = 2), void (d = i.match(n)?.index);
                if (Array.isArray(u))
    ...
    24637: (e, t, n) => {
      ...
      function a(e) {
        const { queryString: t, rules: n, text: a, className: c } = e,
          l = (0, o.useMemo)(() => (0, i.getHighlightedChars)(t, a, n), [t, n, a]);
        return o.createElement(
          o.Fragment,
          null,
          l.length
            ? a
                ...
                .map((e, t) =>
                  o.createElement(
                    ...
                    { key: t },
                    l[t]
                      ? o.createElement('span', { className: r(s.highlighted, c) }, e)
      ...
      const c = (0, o.forwardRef)(function (e, t) {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            r,
            o.createElement(s.ToolWidgetCaret, { className: a.caret, dropped: Boolean(n) }),
          ),
          n && c,
        );
      });
    ...
    75556: (e, t, n) => {
      ...
      function a(e, t, a) {
        ...
        return (
          (x.length > 0 || E.length > 0) && c.push({ id: 'second_section', actions: E.concat(x) }),
          c
        );
      }
    },
