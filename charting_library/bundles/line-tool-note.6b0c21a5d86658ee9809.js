(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3248],
  {
    73174: (e, t, o) => {
      ...
      const p = -5e4,
        g = 15e3,
        f = new n.TranslatedString('change price Y coordinate', r.t(null, void 0, o(11737))),
        m = new n.TranslatedString('change bar X coordinate', r.t(null, void 0, o(2066))),
      ...
      function v(e, t, o, i, r, n) {
        ...
        return (0, d.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, u.removeSpaces)(`${n}Coordinates${r}`), title: r, ...a.info, ...l.info },
        );
      }
      const y = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/;
      function w(e, t, o) {
                ...
                e.filter(e => !e.isSourceHidden()).forEach(e => {
                  ...
                  switch (a) {
                    case '': {
                      ...
                      (n -= e.price),
                        (t -= e.index),
                        (r = o.map(e => ({ ...e, index: e.index + t, price: e.price + n })));
                      break;
                    }
                    case '-':
                    case '+': {
                      ...
                      '-' === a && ((e *= -1), (t *= -1)),
                        (r = o.map(o => ({ ...o, index: o.index + e, price: o.price + t })));
                      break;
                    }
                    case '*': {
    ...
    91335: (e, t, o) => {
      ...
      const l = new r.TranslatedString(
        ...
        s = new r.TranslatedString('change {toolName} text color', i.t(null, void 0, o(64500))),
        d = new r.TranslatedString('change {toolName} text font size', i.t(null, void 0, o(21781))),
        c = new r.TranslatedString('change {toolName} text font bold', i.t(null, void 0, o(24701))),
        h = new r.TranslatedString(
          'change {toolName} text font italic',
          i.t(null, void 0, o(42694)),
        ),
        u = new r.TranslatedString('change {toolName} text', i.t(null, void 0, o(66668))),
        ...
        y = new r.TranslatedString('change {toolName} text wrap', i.t(null, void 0, o(39587))),
      ...
      function P(e, t, o, i) {
        ...
        if (
          ...
          void 0 !== t.fontSize &&
            (r.size = (0, n.convertToDefinitionProperty)(e, t.fontSize, d.format({ toolName: o }))),
          void 0 !== t.bold &&
            (r.bold = (0, n.convertToDefinitionProperty)(e, t.bold, c.format({ toolName: o }))),
          void 0 !== t.italic &&
            (r.italic = (0, n.convertToDefinitionProperty)(e, t.italic, h.format({ toolName: o }))),
          void 0 !== t.text &&
            ((r.text = (0, n.convertToDefinitionProperty)(e, t.text, u.format({ toolName: o }))),
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (P.backgroundTitle = (i.customTitles && i.customTitles.backgroundTitle) || w),
          ...
          (void 0 === t.borderVisible && void 0 === t.borderColor && void 0 === t.borderWidth) ||
            (P.borderTitle = (i.customTitles && i.customTitles.borderTitle) || C),
          void 0 !== t.wrap &&
            ((r.wrap = (0, n.convertToDefinitionProperty)(e, t.wrap, y.format({ toolName: o }))),
    ...
    38039: (e, t, o) => {
      ...
      class l extends a.DefaultProperty {
        ...
        applyTemplate(e) {
          this.mergeAndFire(
            (0, a.extractState)(
              (0, r.default)((0, i.default)(this._factoryDefaultsSupplier()), e),
              this._templateKeys,
            ),
          );
        }
    ...
    40258: (e, t, o) => {
          ...
          return {
            definitions: [
              (0, a.createTextStyleDefinition)(
                ...
                new n.TranslatedString(this._source.name(), this._source.translatedType()),
      ...
      function B(e) {
        const {
          ...
          P = 4 * Math.sin(C),
          _ = 4 * c;
        if ((t.beginPath(), t.moveTo(f, m + _), t.arcTo(f, m, f + _, m, _), 'top' === s)) {
          const e = m,
            o = m - v;
          t.lineTo(y - _, e),
        ...
        t.lineTo(f + _, m + T), t.arcTo(f, m + T, f, m + T - _, _), t.closePath();
      }
      !(function (e) {
      ...
      class H {
        ...
        hitTest(e, t) {
          if (null !== this._data) {
            ...
            if ((0, k.pointInBox)(e, c)) return new y.HitTestResult(y.HitTarget.MovePoint);
            if (a) {
              const t = (0, D.box)((0, D.point)(o, i), (0, D.point)(o + r, i + n));
              ...
              const a = t.min.y < c.min.y ? t.max.y : c.max.y,
                ...
                s = (0, D.box)((0, D.point)(c.min.x - 8, a), (0, D.point)(c.max.x + 8, l));
              if ((0, k.pointInBox)(e, s)) return new y.HitTestResult(y.HitTarget.MovePoint);
            }
          }
          return null;
        }
      ...
      const R = (0, T.generateColor)((0, m.getHexColorByName)('color-black'), 80),
      ...
      class F extends _.InplaceTextLineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          const o = this._source.isFixed() ? [(0, f.ensureDefined)(t.fixedPoint())] : this._points;
          ...
          const d = Math.min(236, e.mediaSize.width),
            ...
            h = o[0],
            { mediaSize: u } = e,
            p = (0, C.wordWrap)(this._textData(), a, this._textWidthCache, !1, c),
          ...
          k < 10 ? (k = h.y + 13) : V || (N = 'bottom'),
            ...
            this._noteRenderer.setData({
              ...
              backgroundColor: l,
              boxShadowColor: s,
              borderColor: n.drawBorder.value() ? n.borderColor.value() : void 0,
      ...
      const q = {
        ...
        ee = (0, U.extractAllPropertiesKeys)((0, f.ensureDefined)(J.get(Y.StdTheme.Light))),
        te = (0, U.extractAllPropertiesKeys)(q),
        oe = [
          ...new Set([...ee, ...te, ...Z.commonLineToolPropertiesStateKeys, 'text', 'anchored']),
        ],
      ...
      class re extends j.LineDataSourceProperty {
        ...
        static create(e, t, o, i) {
          return new this(t, {
            defaultName: e,
            factoryDefaultsSupplier: () => (0, G.factoryDefaultsForCurrentTheme)(q, J),
      ...
      class ae extends X.InplaceTextLineDataSource {
        constructor(e, t, o, i) {
          const r = t ?? ae.createProperties(e.backgroundTheme().spawnOwnership());
          super(e, r, o, i),
            (this.version = 1),
            this._setPaneViews([
              new F(
            ...
            r.childs().anchored.subscribe(this, this._onAnchoredChange.bind(this)),
            (this._hasEditableCoordinates = (0, K.combine)(
              e => !e,
              (0, E.createWVFromProperty)(this.properties().childs().anchored).ownership(),
            ));
        }
        destroy() {
        ...
        static createProperties(e, t) {
          ...
          const o = re.create(this._defaultsKey(), this._anchoredDefaultValue(), e, t);
          return this._configureProperties(o), o;
        }
        _normalizePoint(e, t) {
          return super._normalizePointWithoutOffset(e) ?? super._normalizePoint(e, t);
        }
        ...
        _createDataSourceBackgroundColorWV() {
          const e = (0, i.generateColorCached)(),
            { backgroundColor: t, backgroundTransparency: o } = this.properties().childs();
          return (0, K.combine)(
            () => e(t.value(), o.value()),
      ...
      class le extends ae {
        constructor(e, t, o, i) {
          super(e, t ?? le.createProperties(e.backgroundTheme().spawnOwnership()), o, i);
        }
        name() {
