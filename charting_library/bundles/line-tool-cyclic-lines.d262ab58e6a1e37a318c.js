...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9445],
  {
    73174: (e, t, i) => {
      ...
      const p = -5e4,
        _ = 15e3,
        f = new r.TranslatedString('change price Y coordinate', o.t(null, void 0, i(11737))),
        m = new r.TranslatedString('change bar X coordinate', o.t(null, void 0, i(2066))),
              ...
              t.withMacro(g, () => {
                e.filter(e => !e.isSourceHidden()).forEach(e => {
                  ...
                  t.undoHistory().pushUndoCommand(
                    new a({ lineToolId: e.id(), chartModel: t.model(), newPositionPoints: o }),
                  );
                });
              });
            } finally {
    ...
    53749: (e, t, i) => {
      ...
      const l = new o.TranslatedString(
        ...
        d = new o.TranslatedString('change {toolName} line style', n.t(null, void 0, i(66429))),
        c = new o.TranslatedString('change {toolName} line color', n.t(null, void 0, i(24059))),
        ...
        _ = new o.TranslatedString('change {toolName} line right end', n.t(null, void 0, i(54827))),
        f = n.t(null, void 0, i(3554)),
        m = n.t(null, void 0, i(61856)),
        g = n.t(null, void 0, i(87430));
      function S(e, t, i, n, o) {
        const S = {},
          v = { id: `${(0, s.removeSpaces)(i.originalText())}${n}`, title: (o && o.line) || f };
        return (
          void 0 !== t.showLine &&
    ...
    9093: (e, t, i) => {
      ...
      class p extends a.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          if (2 === this._source.points().length) {
            const e = this._points.map(e => ({ point: e, pointIndex: e.pointIndex }));
      ...
      const x = {
        ...
        L = (0, v.extractAllPropertiesKeys)((0, f.ensureDefined)(b.get(m.StdTheme.Light))),
      ...
      class I extends y.LineDataSourceProperty {
        constructor(e) {
          super(e),
            this.addChild(
              'linesColors',
              new T.LineToolColorsProperty([(0, f.ensureDefined)(this.child('linecolor'))]),
            ),
            this.addChild(
              'linesWidths',
              new T.LineToolWidthsProperty([(0, f.ensureDefined)(this.child('linewidth'))]),
            );
        }
        static create(e, t) {
          return new this({
            defaultName: 'linetoolcirclelines',
            factoryDefaultsSupplier: () => (0, P.factoryDefaultsForCurrentTheme)(x, b),
      ...
      class A extends n.LineDataSource {
        constructor(e, t, i, n) {
          super(e, t ?? A.createProperties(e.backgroundTheme().spawnOwnership()), i, n),
    ...
    27916: (e, t, i) => {
      ...
      class f {
        ...
        _needLabelExclusionPath(e, t) {
          ...
          return 'middle' === (t ?? i.vertLabelsAlign.value()) && (0, c.needTextExclusionPath)(e);
        }
    ...
    38039: (e, t, i) => {
      ...
      class l extends s.DefaultProperty {
        ...
        applyTemplate(e) {
          this.mergeAndFire(
            (0, s.extractState)(
              (0, o.default)((0, n.default)(this._factoryDefaultsSupplier()), e),
              this._templateKeys,
            ),
          );
        }
    ...
    36036: (e, t, i) => {
      ...
      class g extends h.BitmapCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, i, _, p), n.length && this._drawPoints(e, n, o, m, f);
        }
        _drawPoints(e, t, i, o, s) {
          const { context: a, horizontalPixelRatio: d, verticalPixelRatio: c } = e,
          ...
          for (let e = 0; e < t.length; ++e) {
            const r = t[e];
            if (!((0, l.isInteger)(r.pointIndex) && h.linePointBeingEdited === r.pointIndex)) {
              a.fillStyle = i[e];
              if (
                (o(
                  a,
