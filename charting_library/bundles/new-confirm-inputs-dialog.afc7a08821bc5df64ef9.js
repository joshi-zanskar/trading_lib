(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3030],
  {
    ...
    5305: e => {
      e.exports = { separator: 'separator-EI7Qsb2Q', scrollable: 'scrollable-EI7Qsb2Q' };
    },
    50238: (e, t, n) => {
      'use strict';
    ...
    59369: (e, t, n) => {
          ...
          (0, o.useLayoutEffect)(() => {
            const e = (0, r.ensureNotNull)(t.current),
              n = () => {
                ...
                if (
                  0 === n.length ||
                  (n[0].parentElement && !m(n[0].parentElement, (0, r.ensureNotNull)(t.current)))
                ) {
                  const o = (function (e) {
              ...
              switch (v) {
                ...
                case 'blockNext':
                  (n => {
                    ...
                    if (!i) return;
                    const l = Array.from(i.children).indexOf(document.activeElement);
                    if (-1 === l) return;
                    const s = o['blockNext' === n ? o.indexOf(i) + 1 : o.indexOf(i) - 1];
                    if (!s) return;
                    t.preventDefault();
      ...
      function p(e) {
        document.activeElement && (0, s.becomeSecondaryElement)(document.activeElement),
    ...
    29638: (e, t, n) => {
      ...
      function f(e) {
        ...
        function M() {
          ...
          for (const t of f) if ('symbol' === t.type && !t.optional && '' === e[t.id]) return !0;
          return !1;
        }
        function N(e, t) {
          E?.(e, t), _(M());
      ...
      class v extends m.DialogRenderer {
        constructor(e, t, n, o, r, i, l, s, c) {
          super(),
            (this._handleClose = () => {
              this._rootInstance?.unmount(), this._setVisibility(!1), this._onClose();
            }),
            (this._title = e),
      ...
      async function c(e, t, r, c, a) {
              ...
              if (t) {
                const { time: o, price: r } = t,
                  l = o.inline
                    ? i.t(
                        null,
                        { replace: { inputInline: o.inline, studyShortDescription: c } },
                        n(10679),
                      )
                    : i.t(null, { replace: { studyShortDescription: c } }, n(92229)),
                  s = h(e.id);
          ...
          const t = 'time' === e.type,
            ...
            r = (function () {
              ...
              const o = e.name
                  ? i.t(
                      null,
                      { replace: { inputTitle: e.name, studyShortDescription: c } },
                      n(59451),
                    )
                  : i.t(null, { replace: { studyShortDescription: c } }, n(60935)),
                r = e.name
                  ? i.t(
                      null,
                      { replace: { inputTitle: e.name, studyShortDescription: c } },
                  ...
                  : i.t(null, { replace: { studyShortDescription: c } }, n(24404));
              return t ? o : r;
            })(),
            l = t ? e.id : void 0,
            s = t ? void 0 : e.id;
        ...
        async function v(t, n, i, l, c) {
          const a = await e.requestSelectPoint(
            { pointType: n, pane: u, lineColor: void 0, selectPointMode: s.SelectPointMode.Study },
            i,
          );
          void 0 === u && (u = a.pane);
          const d = r.childs().inputs;
          d &&
            (l && (0, o.ensureDefined)(d.child(l)).setValue(1e3 * (a.point.time || 0)),
              ...
              return (
                ...
                null !== a.current &&
                  (s
                    ...
                    : (0, r.disableBodyScroll)(a.current, { allowTouchMove: u(a) })),
                () => {
                  c--,
                    null !== a.current &&
                      (s
