    ...
    3606: (e, t, n) => {
      ...
      class C extends a.PureComponent {
        ...
        render() {
          ...
          return a.createElement(p.AdaptiveConfirmDialog, {
            ...
            submitButtonText: a.createElement(g, { isLoading: this.state.isLoading }),
      ...
      function E(e) {
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement('div', { className: o(x.indicators, S && x.withSuggestions) }, i),
          ),
        );
      }
      function T(e) {
        ...
        return a.createElement(
          ...
          a.createElement(
            'button',
            {
              ...
              'aria-label': n,
              'data-tooltip': n,
              className: o(x.hintLabel, 'apply-common-tooltip', x.accessibleLabel),
              title: n,
              onFocus: () => (0, u.showOnElement)((0, s.ensureNotNull)(i.current)),
              onBlur: () => (0, u.hide)(),
            },
      ...
      class P {
        constructor(e) {
          (this._container = document.createElement('div')),
            ...
            (this.unmount = () => {
              B.unsubscribe(I.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null),
      ...
      class J {
        ...
        _doSave(e, t, n) {
          ...
          if (!s) return;
          const o = n.manager() || void 0,
            l = (0, R.getStudyTemplateSaveData)(s, this._controller.model(), i, a);
          if (e.find(e => e.name === s)) {
            const e = e => {
              e ? K(l, this._onSave) : (n.focus(), n.dropLoading());
            };
            (function (e, t) {
        ...
        _getActualTemplateList() {
          return A.backend.invalidateStudyTemplatesList(), A.backend.getStudyTemplatesList();
        }
        _showTemplateSaveRenameDialog(e, t, n, s) {
          ...
          (this._dialog = new P({
            ...
            saveIntervalHintText: j.format({ interval: (0, M.translatedIntervalString)(n) }),
