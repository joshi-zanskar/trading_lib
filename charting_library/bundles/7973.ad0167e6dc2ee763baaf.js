(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7973],
  {
          ...
          for (var e = [], t = 0; t < arguments.length; t++) {
            ...
            if (n) {
              ...
              if ('string' === i || 'number' === i) e.push(n);
                ...
                a && e.push(a);
              } else if ('object' === i) for (var o in n) s.call(n, o) && n[o] && e.push(o);
            }
          }
          return e.join(' ');
        }
    ...
    75725: (e, t, n) => {
      ...
      const c = new WeakMap();
      function d(e) {
        return c.has(e) || c.set(e, (0, u.randomHash)()), (0, i.ensureDefined)(c.get(e));
      }
      const f = new Map([
          [0, l.green],
          [1, l.orange],
      ...
      function h(e) {
        const { segment: t, forceStart: n, forceEnd: i } = e,
          ...
          o = a < 0.03,
          u = { left: 100 * t.start.value + '%', width: `calc(${100 * a}% + ${o ? 2 : 0}px)` },
          c = r(
            l.segment,
            f.get(t.type),
        ...
        return s.createElement('div', { className: c, style: u, 'data-tooltip': d });
      }
      function D(e) {
      ...
      function p(e) {
        ...
        !u.start.isFirstOrLastPoint && u.showStartForLastEntry
          ...
          : i.push(u.start);
        const c = !u.end.isFirstOrLastPoint && u.showEndForFirstEntry ? o.entries[0].end : u.end;
        if ((i[0].value !== c.value && i.push(c), 0 === i.length)) return null;
        i.sort((e, t) => e.value - t.value);
        const f = i.map(e => s.createElement('div', { key: d(e), className: l.timeMark }, e.title)),
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            s.createElement(
              'div',
              { className: m, style: { left: 100 * i[0].value + '%', width: `${v}%` } },
              f,
            ),
          ),
        );
          ...
          s.createElement(
            ...
            i
              ? s.createElement(
                  s.Fragment,
                  null,
                  Object.values(u).map((e, t) => s.createElement(D, { key: t, sessionDay: e })),
                )
              : s.createElement(D, { sessionDay: d }),
            s.createElement(
              'div',
              { className: l.nowWrapper },
              s.createElement('div', { className: l.now, style: { left: 100 * c + '%' } }),
            ),
          ),
    ...
    53350: (e, t, n) => {
      ...
      const h = [d.SUNDAY, d.MONDAY, d.TUESDAY, d.WEDNESDAY, d.THURSDAY, d.FRIDAY, d.SATURDAY];
      function D(e, t) {
        return ((e + t + 6) % 7) + 1;
      }
      function p(e) {
      ...
      function k(e) {
        for (
          (0, m.assert)(Number.isInteger(e), 'timeMinutes expected to be integer number');
          e > i.minutesPerDay;
      ...
      function _(e, t, n, s = t) {
        const r = n(t),
          i = e[r];
        return r !== s && 0 === i.entries.length ? _(e, r, n, s) : N(r, e[r].entries);
      }
      function L(e) {
        return (t, n) => _(t, n, e);
      }
      ...
      function z(e, t) {
        const n = { thisDay: N(e, t[e].entries), prevDay: x(t, e), nextDay: I(t, e) };
        return (
          (function ({ thisDay: e, prevDay: t, nextDay: n }) {
            if (0 === e.entries.length)
              return [
                B((0, v.default)(t.entries), t.dayIndex, c(n.entries), n.dayIndex, e.dayIndex),
              ];
          })(n) ??
          (function ({ thisDay: e, prevDay: t, nextDay: n }) {
            const s = e.dayIndex;
          ...
          (function (e) {
            return [...V(e.thisDay, e.prevDay), ...C(e.thisDay), ...$(e.thisDay, e.nextDay)];
          })(n)
        );
      }
      function H(e, t, n, s) {
      ...
      function ne(e, t) {
        const n = (function (e) {
          ...
          if (void 0 === e.subsessions)
            return new Map([
              [0, new j.SessionsSpec(e.timezone, e.session, e.session_holidays, e.corrections)],
            ]);
          const t = 'regular',
            n = 'premarket',
            s = 'postmarket',
        ...
        t = t ?? (0, i.utc_to_cal)((0, i.get_timezone)(e?.timezone ?? 'Etc/UTC'), Date.now());
        ...
        return (
          ...
          (function (e) {
            for (const t of h) {
              ...
              te(r, (0, m.ensureDefined)(c(e[A(t)].entries))) && (r.end.isFirstOrLastPoint = !1);
            }
          })(r),
          (function (e) {
            for (const t of h) {
              ...
              a.start.isFirstOrLastPoint || (a.showStartForLastEntry = K(n, e[s].entries)),
                i.end.isFirstOrLastPoint || (i.showEndForFirstEntry = q(n, e[r].entries));
            }
          })(r),
      ...
      class ie {
        ...
        _updateEntriesBySubSessions(e) {
          ...
          const { newSessionsDays: t, newTodaySession: n } = ne(e, null === e ? null : re(e));
