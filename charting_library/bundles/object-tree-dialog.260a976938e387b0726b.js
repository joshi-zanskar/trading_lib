  ...
  [4862, 2544],
  {
    ...
    31261: (e, t, n) => {
      ...
      function b(e) {
        ...
        const {
          ...
          y = t ? void 0 : b ? -1 : r,
          S = t ? void 0 : b ? r : -1,
          { isMouseDown: w, handleMouseDown: C, handleMouseUp: E } = (0, d.useIsMouseDown)(),
    ...
    36383: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        i = n(27267);
      function s(e) {
        const { click: t, mouseDown: n, touchEnd: s, touchStart: a, handler: l, reference: c } = e,
          u = (0, o.useRef)(null),
          d = (0, o.useRef)(
            'undefined' == typeof window ? 0 : new window.CustomEvent('timestamp').timeStamp,
          );
        return (
    ...
    9745: (e, t, n) => {
      ...
      const r = o.forwardRef((e, t) => {
        const { icon: n = '', title: r, ariaLabel: i, ariaLabelledby: s, ariaHidden: a, ...l } = e,
          c = !!(r || i || s);
            ...
            const c = { ...('numeric' === n.dateStyle ? i : r), ...s },
              ...
              d = {
                ...
                fractionalSecondDigits:
                  void 0 === u ? void 0 : Math.floor(Math.min(Math.max(1, u), 3)),
                timeZone: n.timeZone,
          ...
          if (this.getZindex(e) !== this._index) {
            ...
            this._windows.forEach((e, n) => {
              e.hasAttribute(r.FOCUS_TRAP_DATA_ATTRIBUTE) &&
                e.setAttribute(r.FOCUS_TRAP_DATA_ATTRIBUTE, e === t ? 'true' : 'false');
            }),
    ...
    64530: (e, t, n) => {
      ...
      function h(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            'div',
            { id: N, role: 'cell', className: i()(d.itemInfo, !y && d.itemInfoWithPadding) },
            o.createElement(
              'div',
              {
            ...
            o.createElement('div', { className: i()(d.details, g && d.active, _ && d.mobile) }, n),
          ),
      ...
      function p(e) {
        ...
        (0, o.useEffect)(() => {
          ...
          return (
            y
              ? (f && f(),
                e && (e.addEventListener('mousemove', F), e.addEventListener('mouseup', z)))
              : g && g(),
            () => {
        ...
        return o.createElement(
          'div',
          {
            ...
            onMouseDown: function (e) {
              ...
              const i = H(L);
              r < 0 ? ((r = 0), (w.current = t)) : r > i && ((r = i), (w.current = t - n * i));
              u(j(n * r)), S(!0);
            },
          },
          o.createElement(
            'div',
            {
              ...
              onMouseDown: function (e) {
                e.preventDefault(),
                  (w.current = W(e.nativeEvent, (0, a.ensureNotNull)(_.current))),
                  S(!0);
              },
            },
            o.createElement('div', { className: i()(m.barInner, C && m['barInner--horizontal']) }),
          ),
        );
        function F(e) {
    ...
    37404: (e, t, n) => {
      ...
      let o = null;
      function r(e) {
        return Promise.all([n.e(4166), n.e(8692), n.e(3693), n.e(7159), n.e(1702)])
          .then(n.bind(n, 41662))
          .then(t => {
    ...
    11386: (e, t, n) => {
        ...
        return (
          ...
          o.useEffect(() => {
            if (null !== t) {
              ...
              return u([...e.value()]), e.subscribe(() => u([...e.value()])), () => e?.destroy();
            }
          }, [t]),
          o.useMemo(
            () => ({
      ...
      function k(e) {
        const { isMobile: t, isSmallWidth: n, chartWidget: r, onClose: i, onInitialized: l } = e,
          {
            currentSymbol: c,
          ...
          [b, _] = o.useMemo(() => {
            if (null !== c && null !== u) {
              const e = [];
              let t = g;
              if (null === t) for (t = 2; t > 0 && !((u[t].get(c)?.size || 0) > 0); ) t--;
              return (
                u[t].forEach((t, n) => {
                  m.includes(n) ||
                    e.push({
        ...
        return (
          ...
          o.createElement(
            ...
            0 === b.length
              ...
              : b.map(({ symbol: e, drawingsCount: n, onRemove: r, onClick: i }, s) =>
    ...
    34489: (e, t, n) => {
      ...
      const Oe = e => e.nodes,
        ...
        Ye = (0, Le.createSelector)(Oe, e => Object.values(e).filter(e => 0 === e.level)),
      ...
      function* it(e, t) {
        for (;;) {
          ...
          const a = r.findIndex(e => e.id === s),
            ...
            c = dt(o, l, r, a),
            { id: u } = c;
          e ? e([u], l) : yield (0, E.put)(Ee([u])), t && t(u), yield (0, E.put)(De(u));
        }
      }
      function* st(e, t = () => !0) {
        for (;;) {
      ...
      function* at(e = () => !0, t) {
        ...
        u.map(e => e.id).includes(d.id)
          ...
          : h &&
            e(u, d, o) &&
            (yield (0, E.put)(
              ((e, t, n) => ({ type: ae, node: e, dropType: t, boundBox: n }))(d, o, i),
            ));
      }
      function* lt(e) {
      ...
      function dt(e, t, n, o) {
        ...
        for (
          ;
          !i || (Math.abs(s) < r && (a = i).level > 1 && !Ve(e, (0, M.ensureDefined)(a.parentId)));
            ...
            case ge: {
              ...
              for (const t of n) {
                ...
                if (n.parentId) {
                  ...
                  a[n.parentId] = { ...o, children: o.children.filter(e => e !== t) };
                }
      ...
      class Lt extends o.PureComponent {
          ...
          super(...arguments),
            ...
            (this._handleRef = e => {
              ...
              (0, M.ensureDefined)(n)(this._ref),
                ...
                (0, M.ensureDefined)(o)((0, It.getEmptyImage)(), { captureDraggingState: !0 });
            }),
        ...
        render() {
          return o.createElement(Ot, { ...this.props, reference: this._handleRef });
        }
        getNode() {
      ...
      const Ot = e => {
          const {
            ...
            S = (0, o.useRef)(null),
            w = (0, Mt.createSafeMulticastEventHandler)(e => (S.current = e), h);
            ...
            hover: (n, o) => {
              ...
              if ('last' === e.type) {
                const t = r.x - s.left < 48,
                  n = i[i.length - 1],
                  o =
                    t && 2 === n.level ? (0, M.ensureDefined)(i.find(e => e.id === n.parentId)) : n,
                  l = {
                    top: s.top - a.top,
                    left: s.left - a.left,
                    bottom: s.top - a.top,
      ...
      const rn = (0, V.connect)(
        ...
        return Gt(function () {
          ...
          const a = { [tn.dropTarget]: 'inside' !== t, [tn.dropTargetInside]: 'inside' === t },
            { width: l, height: c } = n,
            [u, d] = s(e),
      ...
      const un = o.forwardRef((e, t) => {
        ...
        return o.createElement(
          ...
          r?.id
            ? o.createElement(
                'div',
                { className: f()(cn().sticky, !r.isShowStuck && cn().hideSticky) },
                o.createElement(i, {
                  id: r.id,
                  key: r.id,
                  isStuckNode: !0,
      ...
      const fn = o.forwardRef(function (e, t) {
        ...
        (0, o.useEffect)(() => {
          ...
          (0, o.useEffect)(() => {
            const e = e => {
                [I.Modifiers.Mod, I.Modifiers.Shift].includes((0, I.modifiersFromEvent)(e)) && s();
              },
              t = e => {
                a &&
                  ![I.Modifiers.Mod, I.Modifiers.Shift].includes((0, I.modifiersFromEvent)(e)) &&
                  i();
              };
            return (
        ...
        const V = (0, o.useCallback)(() => (0, M.ensureNotNull)(oe.current), []),
        ...
        const Q = (0, o.useCallback)(e => {
            ...
            return (
              ...
              'isSticky' in r &&
                ...
                (t = {
                  ...t,
                  zIndex: ee.current?.scrollTop && t.top && +t.top <= ee.current?.scrollTop ? 2 : 5,
                }),
          ...
          $ = (0, o.useMemo)(
            () =>
              null === v ? { index: -1 } : { index: Z.current.findIndex(e => e.node.key === v.id) },
            [v],
          );
        d(H);
        const [J, X, ee, te] = (0, $t.useOverlayScroll)(),
          ne = (0, o.useRef)(null);
        (0, o.useEffect)(() => (0, M.ensureNotNull)(ne.current).resetAfterIndex(0, !0), [U]),
          (0, o.useEffect)(() => {
            let e = $.index;
            const t = Z.current[$.index];
            L && e <= L && t && 'stickyNodeId' in t && t.stickyNodeId && (e -= 1),
        ...
        const oe = (0, o.useRef)(null),
          ...
          ae = (0, o.useRef)({
            startScroll(e) {
              const t = () => {
                null !== ee.current &&
                  ((se.current = requestAnimationFrame(t)), ee.current.scrollBy({ top: e }));
              };
              this.stopScroll(), t();
            },
            stopScroll() {
              null !== se.current && (cancelAnimationFrame(se.current), (se.current = null));
            },
        ...
        return (
          ...
          (0, o.useEffect)(() => {
            ...
            function e(e) {
              ...
              const { viewModel: n } = W,
                o = n.selection();
              e.defaultPrevented || e.currentTarget !== e.target || o.selected().length || S();
            }
            const t = H.current;
            return (
                    ...
                    if (i) {
                      ...
                      switch (t) {
                        ...
                        case 36:
                          ...
                          break;
                        case 33:
                          0 !== o && (e.preventDefault(), le(Math.max(0, o - n)));
                          break;
                        case 34:
      ...
      const gn = (0, V.connect)(
          ...
          return o.createElement(fn, { ...e, isOver: n, connectDropTarget: r, ref: t });
        }),
      ...
      function bn(e) {
        ...
        return (
          ...
          null === g ? null : o.createElement(_n, { store: g, scrollToId: m, ...f })
        );
      }
      const _n = o.memo(function (e) {
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(V.Provider, { store: t, context: At }, o.createElement(gn, { ...r })),
          )
        );
      });
      function yn(e, t) {
      ...
      function Bn(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(
              'div',
              { className: kn.wrap, onContextMenu: xn.preventDefaultForContextMenu },
              ...
              o.createElement(
                'div',
                {
                  ...
                  onClick: function (e) {
                    if (e.defaultPrevented) return;
                    if (!(e.target instanceof Element) || null === a.current) return;
      ...
      function Wn(e) {
        ...
        return o.createElement(D.Icon, { className: f()(zn.button, n && zn.disabled, t), ...r });
      }
      var Hn = n(77975);
      ...
      function so(e) {
        const {
          ...
          [z, W] = (0, o.useState)(!1),
          [H, j] =
            ((0, Hn.useWatchedValueReadonly)({ watchedValue: f.getChartLayout() }),
            (0, o.useState)(!1)),
          V = (0, o.useRef)(null);
        (0, o.useEffect)(() => {
          const e = {};
          ...
          t.subscribe(e => w(e)),
            u.onIsActualIntervalChange().subscribe(e, () => L(u.isActualInterval())),
            u.onSyncStateChanged().subscribe(e, () => A(u.getDrawingSyncState())),
            u.modificationDateChanged().subscribe(e, () => F(u.getModificationDate()));
          ...
          (0, o.useEffect)(() => {
            b && y.current && (y.current.focus(), y.current.setSelectionRange(0, S.length));
          }, [b]),
          (0, o.useEffect)(() => {
            const e = {};
            return (
          ...
          (0, o.useEffect)(() => {
            !s && V.current && (clearTimeout(V.current), (V.current = null)), _(!1);
          }, [s]);
        const G = {};
        if (c) {
          const e = f.entity(c);
        ...
        const U = Pn.enabled('test_show_object_tree_debug')
          ...
          q = !!g && g.isDialog,
          Y = B && N ? eo : to,
          $ = u.hasChildren() ? p.t(null, void 0, n(40983)) : p.t(null, void 0, n(80014));
        let J = null;
        return (
          C &&
            C.type === On.Svg &&
            (J = o.createElement(D.Icon, { icon: C.content || '', className: no.icon })),
          o.createElement(
            'span',
            {
              className: m(
                ...
                z && !i && !s && !a && no.hover,
                q && !i && !s && !a && no.dialog,
                q && !i && !s && !a && (0, Yn.isOnMobileAppPage)('any') && no.mobile,
                !!P && ['apply-common-tooltip', 'common-tooltip-vertical'],
              ),
              onMouseDown: function (e) {
                b && !(0, M.ensureNotNull)(y.current).contains(e.target) && j(!0);
              },
              onClick:
                1 === v
                  ? X
                ...
                o.createElement(
                  ...
                  u.canBeLocked() &&
                    o.createElement(Wn, {
                      title: T ? Gn : Un,
                      icon: T ? Jn : Xn,
                      className: m(no.button, (K || T) && no.visible, 'apply-common-tooltip'),
                      onClick: function (e) {
                        if (e.defaultPrevented) return;
                  ...
                  o.createElement(Wn, {
                    ...
                    onClick: B
                      ...
                      : function (e) {
                          if (e.defaultPrevented) return;
                          e.preventDefault(), f.openProperties(u, qn.TabNames.visibility);
                        },
                    title: (function () {
                      if (!B) return $;
                      return N ? Kn : Zn;
                  ...
                  u.canBeRemoved() &&
                    o.createElement(Wn, {
                      title: Qn,
                      icon: $n,
                      className: m(no.button, (Q || K) && no.visible, 'apply-common-tooltip'),
                      onClick: function (e) {
                        if (e.defaultPrevented) return;
              ...
              o.createElement(Fn.InputControl, {
                ...
                onKeyDown: function (e) {
                  27 === (0, I.hashFromEvent)(e)
                    ...
                    : 13 === (0, I.hashFromEvent)(e) && (e.preventDefault(), ee());
                },
        ...
        function X(e) {
          e.defaultPrevented ||
            b ||
            !u.fullyConstructed() ||
            (e.preventDefault(), e.persist(), f.openContextMenu(u, () => _(!0), e));
        }
        function ee() {
      ...
      function co(e) {
        ...
        return (
          ...
          o.createElement(
            o.Fragment,
            null,
            o.createElement(y.MatchMedia, { rule: w.DialogBreakpoints.TabletSmall }, e =>
              o.createElement(S.AdaptivePopupDialog, {
                ...
                onClose: r,
                ref: h,
                render: () => o.createElement(uo, { isSmallTablet: e, viewModel: t }),
            ...
            o.createElement(
              ...
              s &&
                o.createElement(
                  ...
                  o.createElement(C.ManageDrawings, { onClose: M, chartWidget: i, isMobile: !0 }),
                ),
            ),
          )
        );
        function I() {
          s && !window.matchMedia(w.DialogBreakpoints.TabletSmall).matches && a(!1);
        }
        function M() {
          a(!1);
        }
      ...
      function uo(e) {
        ...
        return o.createElement(
          xt.Provider,
          { value: r },
          o.createElement(Bn, { nodeRenderer: oo, showHeader: !1, viewModel: n, isDialog: !0 }),
        );
      }
      var ho = n(16216),
        po = n(77788),
      ...
      class bo {
        constructor(e) {
          (this._onChange = new mo.Delegate()),
            (this._recalculate = () => {
              const e = this._groupModel.groups().map(e => go(e.id, e.instanceId())),
            ...
            for (const n of this._groupModel.groups()) {
              ...
              if (r.pane() === t) {
                const o = [...n.lineTools()]
                  ...
                  .map(e => go(e.id(), e.instanceId()));
                (e[r.id()] = yo(r.id(), 1, t.id(), o)), e[t.id()].children.push(r.id());
      ...
      var So = n(58653),
        ...
        Ao = n(28824),
        Po = n(57674);
      const Fo = new wo.TranslatedString('show {title}', p.t(null, void 0, n(51382))),
        zo = new wo.TranslatedString('hide {title}', p.t(null, void 0, n(13017))),
        Wo = new wo.TranslatedString('lock {title}', p.t(null, void 0, n(76104))),
        Ho = new wo.TranslatedString('unlock {title}', p.t(null, void 0, n(12525))),
        jo = new wo.TranslatedString(
          'change {sourceTitle} title to {newSourceTitle}',
          p.t(null, void 0, n(23687)),
        ),
        Vo = new wo.TranslatedString('insert source(s) after', p.t(null, void 0, n(10370)));
      function Go(e, t) {
      ...
      function Ko(e) {
        return new wo.TranslatedString(e.name(), e.title(Lo.TitleDisplayTarget.DataWindow));
      }
      ...
      class Yo {
        constructor(e, t) {
          (this._syncStateChanged = new mo.Delegate()),
            ...
            (this._undoModel = e),
            (this._dataSource = t),
            (this._isWidgetPane = e.model().paneForSource(t)?.mode() === Io.PaneMode.Widget),
            (0, Eo.isLineTool)(t)
        ...
        canBeLocked() {
          return (0, Eo.isLineTool)(this._dataSource) && this._dataSource.userEditEnabled();
        }
        canBeRemoved() {
          return (
        ...
        isActualInterval() {
          return (
            (!(0, Eo.isLineTool)(this._dataSource) && !(0, To.isStudy)(this._dataSource)) ||
            this._dataSource.isActualInterval()
          );
        }
        onIsActualIntervalChange() {
          return (0, Eo.isLineTool)(this._dataSource) || (0, To.isStudy)(this._dataSource)
            ? this._dataSource.onIsActualIntervalChange()
            : Zo;
        }
        isLocked() {
          return (
            !!(0, Eo.isLineTool)(this._dataSource) && this._dataSource.properties().frozen.value()
          );
        }
        onVisibilityChanged() {
        ...
        getIcon() {
          ...
          if (e && t)
            ...
            } else 'svgContent' === t.type && (o = { type: On.Svg, content: t.content });
          return o;
        }
        onIconChanged() {
        ...
        setVisible(e) {
          ...
          this._undoModel.setProperty(
            ...
            e,
            t,
            xo.lineToolsDoNotAffectChartInvalidation && (0, Eo.isLineTool)(this._dataSource),
          );
        }
        setLocked(e) {
        ...
        setName(e) {
          if ((0, Eo.isLineTool)(this._dataSource)) {
            const t = jo.format({
              sourceTitle: this._dataSource.properties().title.value() || Ko(this._dataSource),
              newSourceTitle: e,
            });
            this._undoModel.setProperty(
        ...
        canBeAddedToGroup() {
          return (0, Eo.isLineTool)(this._dataSource) && this._dataSource.boundToSymbol();
        }
        ...
        canBeSyncedInLayout() {
          return (0, Eo.isLineTool)(this._dataSource) && this._dataSource.isSynchronizable();
        }
        onSyncStateChanged() {
          ...
          if ((0, Eo.isLineTool)(this._dataSource)) {
            ...
            null !== t
              ? ((0, M.assert)(!e.some(e => e.hasChildren())),
                i.forEach(e => {
                  (0, Eo.isLineTool)(e) && (t.containsLineTool(e) || o.addLineToolToGroup(t, e));
                }))
              : r();
          } else r();
        ...
        constructor(e, t) {
          ...
          const n = () => {
            this._lineTools.forEach(e => {
              e.properties().visible.subscribe(this, () => this._onVisibilityChanged.fire()),
                e.properties().frozen.subscribe(this, () => this._onLockChanged.fire()),
                e
                  .onIsActualIntervalChange()
      ...
      class Jo {
        ...
        invalidateCache(e) {
          Array.from(this._entitiesCache.keys()).forEach(t => {
            e.has(t) || (this._entitiesCache.get(t)?.destroy(), this._entitiesCache.delete(t));
          });
        }
        canBeGroupped(e) {
      ...
      function er(e) {
        ...
        return {
          promise: new Promise((n, o) => {
            e.then(e => (t ? o(new Xo()) : n(e))), e.catch(e => o(t ? new Xo() : e));
          }),
          cancel() {
            t = !0;
          },
      ...
      const mr = new wo.TranslatedString('move objects', p.t(null, void 0, n(36044))),
        fr = new wo.TranslatedString('lock objects', p.t(null, void 0, n(18942))),
        gr = new wo.TranslatedString('unlock objects', p.t(null, void 0, n(23230))),
        vr = new wo.TranslatedString('show objects', p.t(null, void 0, n(23771))),
        br = new wo.TranslatedString('hide objects', p.t(null, void 0, n(93277))),
        _r = new wo.TranslatedString('remove objects', p.t(null, void 0, n(79688)));
      class yr {
        constructor(e) {
          (this._nodes = {}),
            (this._onChange = new mo.Delegate()),
        ...
        canSelectionBeUnmerged() {
          const e = this._getSelectedEntities();
          return 1 === e.length && this.canNodeWithIdBeUnmerged(vo(e[0].id()).persistentId);
        }
        canNodeWithIdBeUnmerged(e) {
          const t = this._model.dataSourceForId(e);
          return (
            null !== t && (0, tr.isPriceDataSource)(t) && this._model.isUnmergeAvailableForSource(t)
          );
        }
        unmergeSelectionUp() {
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map(e =>
              (0, M.ensureNotNull)(this._model.dataSourceForId(vo(e.id()).persistentId)),
            );
          this._chart.value().chartWidgetCollection().clipboard.uiRequestCopy(t), yn('Copy', Sn(e));
        }
        cloneSelection() {
          const e = this._getSelectedEntities(),
            t = e.map(e =>
        ...
        rename(e, t) {
          ...
          1 === n.length && n.some(e => e.canBeRenamed()) && (t(), yn('Rename', Sn(n)));
        }
        async openContextMenu(e, t, n) {
          this._objects = this._getObjectsToModify(e.id());
          const o = this._facade.canBeGroupped(this._objects);
          let r;
          if (this._objects.some(e => e.hasChildren())) r = this._getActionsForGroupItem(e, t, o);
          else {
            ...
            const n = r.findIndex(e => 'Clone' === e.id),
              i = r[n];
            if ((-1 !== n && 'action' === i.type && i.update({ shortcutHint: void 0 }), o)) {
          ...
          if (r.length > 0) {
            ...
            (a = i
              ...
              nr.ContextMenuManager.showMenu(r, n, { takeFocus: !0, returnFocus: !0 }, a, () => {
        ...
        getNextNodeIdAfterRemove(e) {
          ...
          if (r.pane().mainDataSource()?.id() === n && !this.canNodeWithIdBeUnmerged(n)) {
          ...
          const i = (0, M.ensureDefined)(t.find(e => e.id === o.parentId)).children;
          return 1 === i.length
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          const r = [];
          1 === this._objects.length && r.unshift(this._getRenameAction(t), new or.Separator()),
            n && r.unshift(this._getGroupAction(), new or.Separator());
          const i = (0, Ro.createSyncDrawingActions)(this._chart.value(), o.filter(Eo.isLineTool));
        ...
        _unmergeSelection(e) {
          ...
          const n = t[0],
            o = (0, M.ensureNotNull)(this._model.dataSourceForId(vo(n.id()).persistentId));
          if (!(0, tr.isPriceDataSource)(o)) throw new Error('Entity is not IPriceDataSource');
    ...
    71402: (e, t, n) => {
      ...
      const i = { [o.Add]: r.t(null, void 0, n(69207)), [o.Remove]: r.t(null, void 0, n(85106)) };
    },
    36189: (e, t, n) => {
      'use strict';
      ...
      var o = n(50959),
        ...
        d = n(22413);
      function h(e) {
        const { className: t, isFilled: n, isActive: r, onClick: h, title: p, ...m } = e,
        ...
        const n = (0, o.useRef)(null),
          ...
          [d, h] = (0, o.useState)({
            ...
            onVerticalChange: function (e) {
              h(t => ({ ...t, scrollPosTop: e })), ((0, r.ensureNotNull)(l.current).scrollTop = e);
            },
        ...
        constructor(e) {
          super(e),
            ...
            (this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
              ...
              const d = r.height > u;
              if (d) {
                ((0, s.ensureNotNull)(this._scrollWrapRef).style.overflowY = 'scroll'),
              ...
              const { width: h, height: p } = r,
                ...
                _ = i - (m.overrideHeight ?? p) - (m?.indentFromWindow?.bottom ?? 0);
              let y = (0, a.clamp)(m.y, b, Math.max(b, _));
              if (
                (m.forbidCorrectYCoord && y < m.y && ((u -= m.y - y), (y = m.y)),
                t &&
                ...
                o.createElement(
                  ...
                  o.createElement(
                    'div',
                    {
                      ...
                      style: { overflowY: void 0 !== I ? 'scroll' : 'auto', maxHeight: y },
    ...
    47308: (e, t, n) => {
        ...
        const {
          ...
          P = (function () {
            ...
            return (
              ...
              (0, o.useCallback)(() => {
                (t[n.current].isReady = !0), e(Object.values(t).every(e => e.isReady));
              }, [t, e])
            );
          })(),
          {
      ...
      function x(e) {
        const { startIcon: t, endIcon: n, showCaret: i, iconOnly: s, children: a } = e;
        return o.createElement(
          o.Fragment,
          null,
          t && o.createElement(C.Icon, { icon: t, className: T.startIconWrap, 'aria-hidden': !0 }),
          a && o.createElement('span', { className: r(T.content, s && T.visuallyHidden) }, a),
      ...
      const k = (0, o.forwardRef)((e, t) => {
        ...
        return o.createElement(
          ...
          o.createElement(x, { startIcon: l, endIcon: c, showCaret: u, iconOnly: d }, h),
        );
      });
      ...
      function W(e) {
        ...
        return o.createElement(O.PopupMenuDisclosureView, {
          ...
          popupChildren: o.createElement(
            o.Fragment,
            null,
            'meatballs' === c && o.createElement(A.ToolWidgetMenuSummary, null, l),
            a.map(e =>
              o.createElement(L.PopupMenuItem, {
                ...
                label: o.createElement(
                  H,
                  { isHighlighted: f(e), size: d, variant: h, disabled: e.disabled },
                  e.children,
                ),
                ...
                icon: e.startIcon,
                toolbox: e.endIcon && o.createElement(C.Icon, { icon: e.endIcon }),
      ...
      function H(e) {
        const { isHighlighted: t, size: n, variant: r, children: i, disabled: s } = e,
          a = {
            size: n ?? I,
            variant: r ?? M,
            isHighlighted: t,
      ...
      function Z(e) {
        ...
        return r(K.scrollWrap, 'scroll' === t && K.overflowScroll, 'wrap' === t && K.overflowWrap);
      }
      function Q(e) {
    ...
    10381: (e, t, n) => {
      ...
      function l(e) {
        ...
        return o.createElement(i.Icon, { className: r(n, s.icon, { [s.dropped]: t }), icon: a });
      }
    },
    86656: (e, t, n) => {
      'use strict';
    ...
    20243: (e, t, n) => {
      ...
      function c(e) {
        ...
        const l =
          ...
          document.activeElement.parentElement?.querySelector('[data-role="menuitem"]');
        ...
        switch ((0, o.mapKeyCodeToDirection)(t)) {
          case 'inlinePrev':
            if (!u.length) return;
            e.preventDefault(), v(0 === f ? s[c] : g ? d(u, f, -1) : u[u.length - 1]);
            break;
          case 'inlineNext':
            if (!u.length) return;
            e.preventDefault(), f === u.length - 1 ? v(s[c]) : v(g ? d(u, f, 1) : u[0]);
            break;
          case 'blockPrev': {
            e.preventDefault();
            const t = d(s, c, -1);
      ...
      function u(e) {
        ...
        return o.createElement(l.PopupMenuItem, {
          ...
          onKeyDown: function (e) {
            ...
            (13 !== t && 32 !== t) ||
              (e.preventDefault(), r.current instanceof HTMLElement && r.current.click());
          },
          'data-role': 'menuitem',
          ...
          const {
            ...
            M =
              ...
              ('string' == typeof a
                ...
                : o.cloneElement(a, { className: r(_.icon, a.props.className) }));
          return 'button' === n
            ? o.createElement(
                'button',
                {
                ...
                v && g && o.createElement('div', { className: r('js-button-text', _.text) }, g),
                M,
                !v && g && o.createElement('div', { className: r('js-button-text', _.text) }, g),
              )
            : o.createElement(
    ...
    16829: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        i = n(55973);
      function s(e) {
        return o.createElement('div', { className: r(e.className, i.title) }, e.children);
      }
    },
    20626: (e, t, n) => {
      'use strict';
      ...
      class b extends o.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleClick = e => {
              (m.enabled('skip_event_target_check') || e.target instanceof Node) &&
            ...
            (this._handleKeyDown = e => {
              ...
              if (e.currentTarget.contains(e.target))
                ...
                switch (n) {
                  case 27: {
                    e.preventDefault();
                    const { shouldReturnFocus: t, isOpenedByButton: n } = this.state;
                    this._handleToggleDropdown(!1), t && n && this._wrapperRef?.focus();
                    break;
                  }
                }
              }
        ...
        render() {
          ...
          return 'button' === e
            ? o.createElement(
                ...
                this.state.isOpened &&
                  (g
                    ? o.createElement(p.MatchMedia, { rule: g }, e => this._renderContent(e))
        ...
        return (
          (0, o.useLayoutEffect)(() => {
            const e = (0, r.ensureNotNull)(f.current),
              t = () => {
                const t = (0, a.queryTabbableElements)(e).sort(a.navigationOrderComparator);
                if (0 === t.length) {
                  const [t] = (0, a.queryFocusableElements)(e).sort(a.navigationOrderComparator);
                  if (void 0 === t) return;
          ...
          o.createElement('div', {
            ...
            onKeyDown: (0, i.createSafeMulticastEventHandler)(function (e) {
              ...
              const n = e.currentTarget,
                o = (0, a.queryFocusableElements)(n).sort(a.navigationOrderComparator);
