    ...
    57897: (e, t, i) => {
      ...
      class l extends s.LineDataSource {
        constructor(e, t, s, n) {
          super(e, t ?? l.createProperties(e.backgroundTheme().spawnOwnership()), s, n),
            ...
            Promise.all([i.e(6290), i.e(9116), i.e(1200), i.e(1583)])
              .then(i.bind(i, 41376))
              .then(e => {
                this._setPaneViews([new e.DisjointChannelPaneView(this, this._model)]);
              });
        }
        pointsCount() {
          return 3;
        ...
        addPoint(e, t, i) {
          return (
            this._snapTo45DegreesApplicable(t) &&
              ...
              this.snapPoint45Degree(e, this.points()[this.points().length - 2]),
            super.addPoint(e)
          );
        }
        setLastPoint(e, t) {
        ...
        getPoint(e) {
          ...
          return { index: this._points[0].index, price: this._points[1].price - t };
        }
        canHasAlert() {
          return !0;
        }
        ...
        _getAlertPlots() {
          ...
          const n = { price: s.price + (t.price - e.price), time: e.time, index: e.index },
            p = [];
          let o, l, a, h;
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            e.hasChild('labelText') || e.addChild('labelText', new p.Property('')),
