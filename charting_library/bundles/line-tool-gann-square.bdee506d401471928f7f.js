  ...
  [9478],
  {
      ...
      class _ extends o.DefaultProperty {
        ...
        state(e, t, n) {
          ...
          return n
            ...
            : ((i = s),
              (r = this._map),
              (0, this._levelsIterator)(i, { tpl: h, fill: c, typecheck: r.typecheck.pack }, r));
          var i, r;
        }
        preferences() {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, o.extractState)(
              (0, i.default)((0, s.default)(t), d(e, this._map, this._levelsIterator)),
              this._allStateKeys,
        ...
        merge(e, t) {
          return super.merge(this._map ? d(e, this._map, this._levelsIterator) : e, t);
        }
        _options() {
          return {
            ...super._options(),
    ...
    9770: (e, t, n) => {
      ...
      class p extends r.LineDataSource {
        constructor(e, t, s, i) {
          super(e, t ?? p.createProperties(e.backgroundTheme().spawnOwnership()), s, i),
          ...
          switch (e) {
            ...
            case 3:
              ...
              if (n.length === this.pointsCount()) {
                let s = n[0].index,
                  i = n[1].price;
                3 === e && ((s = n[1].index), (i = n[0].price)), (t = { index: s, price: i });
              }
          }
          return t;
        }
        ...
        _alignPriceOnPattern(e, t) {
          ...
          let r = 1;
          const o = Math.abs(n);
          for (; o < s * r || i * r < o; ) o < s * r ? (r *= 0.1) : i * r < o && (r *= 10);
          let l = i * r;
          for (let e = a.length - 2; e >= 0 && !(a[e] * r < o); --e) l = a[e] * r;
        ...
        async _getPropertyDefinitionsViewModelClass() {
          return (
            await Promise.all([n.e(6406), n.e(3889), n.e(8009), n.e(8056), n.e(8537)]).then(
              n.bind(n, 27340),
            )
