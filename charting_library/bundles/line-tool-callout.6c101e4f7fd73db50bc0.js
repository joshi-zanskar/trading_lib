  ...
  [688],
  {
    62828: (t, e, i) => {
      ...
      class c extends d.InplaceTextLineDataSource {
        constructor(t, e, s, n) {
          super(t, e || c.createProperties(t.backgroundTheme().spawnOwnership()), s, n),
            (this._barOffset = 0),
        ...
        setPoint(t, e) {
          switch (t) {
            ...
            case 1:
              ...
              (s[1] = { ...e, interval: o }), this._calculateBarOffset(), this._normalizePoints();
          }
        }
        setPoints(t) {
          super.setPoints(t);
          ...
          if ((this._calculateBarOffset(), this._normalizePoints(), isFinite(i) && isFinite(s))) {
            const t =
        ...
        restoreData(t) {
          t.barOffset ? (this._barOffset = t.barOffset) : this._calculateBarOffset(),
        ...
        static createProperties(t, e) {
          const i = new a.DefaultProperty({ defaultName: 'linetoolcallout', state: e, theme: t });
          return this._configureProperties(i), i;
        }
        _applyTemplateImpl(t) {
          this.properties().childs().text.setValue(t.text), super._applyTemplateImpl(t);
        }
        _correctPoints(t, e) {
          if (
          ...
          const i = this._currentMovingPoint.logical.index - this._startMovingPoint.logical.index,
            s = this._currentMovingPoint.logical.price - this._startMovingPoint.logical.price,
            n = t[1];
        ...
        _normalizePoint(t, e) {
          return 0 === e
            ? (super._normalizePointWithoutOffset(t) ?? super._normalizePoint(t, e))
        ...
        static _configureProperties(t) {
          super._configureProperties(t),
            ...
            t.addChild('textsColors', new h.LineToolColorsProperty([t.childs().color]));
        }
        _calculateBarOffset() {
    ...
    24362: (t, e, i) => {
      i.d(e, { InplaceTextLineDataSource: () => f, InplaceTextUndoCommand: () => m });
      var s = i(50279),
        n = i(50151),
        r = i(86441),
        o = i(19625),
      ...
      class f extends _.LineDataSource {
        ...
        async _openTextEditor(t, e, s, o, a) {
          ...
          const { text: d, textColor: c, wordWrap: u } = this.editableTextProperties(),
          ...
          l(this._container, P), this.updateAllViewsAndRedraw((0, p.sourceChangeEvent)(this.id()));
        }
        _closeTextEditor() {
