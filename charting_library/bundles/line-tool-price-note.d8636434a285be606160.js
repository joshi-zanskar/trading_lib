...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [380],
  {
    73174: (e, t, i) => {
      ...
      const p = -5e4,
        g = 15e3,
        m = new r.TranslatedString('change price Y coordinate', n.t(null, void 0, i(11737))),
        f = new r.TranslatedString('change bar X coordinate', n.t(null, void 0, i(2066))),
      ...
      function T(e, t, i, o, n, r) {
        ...
        return (0, c.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, h.removeSpaces)(`${r}Coordinates${n}`), title: n, ...l.info, ...s.info },
        );
      }
      const S = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/;
      function x(e, t, i) {
    ...
    91335: (e, t, i) => {
      ...
      const s = new n.TranslatedString(
        ...
        d = new n.TranslatedString('change {toolName} text font bold', o.t(null, void 0, i(24701))),
        u = new n.TranslatedString(
          'change {toolName} text font italic',
          o.t(null, void 0, i(42694)),
        ),
        h = new n.TranslatedString('change {toolName} text', o.t(null, void 0, i(66668))),
        ...
        S = new n.TranslatedString('change {toolName} text wrap', o.t(null, void 0, i(39587))),
      ...
      function C(e, t, i, o) {
        ...
        if (
          ...
          void 0 !== t.bold &&
            (n.bold = (0, r.convertToDefinitionProperty)(e, t.bold, d.format({ toolName: i }))),
          void 0 !== t.italic &&
            (n.italic = (0, r.convertToDefinitionProperty)(e, t.italic, u.format({ toolName: i }))),
          void 0 !== t.text &&
            ((n.text = (0, r.convertToDefinitionProperty)(e, t.text, h.format({ toolName: i }))),
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (C.backgroundTitle = (o.customTitles && o.customTitles.backgroundTitle) || x),
          ...
          (void 0 === t.borderVisible && void 0 === t.borderColor && void 0 === t.borderWidth) ||
            (C.borderTitle = (o.customTitles && o.customTitles.borderTitle) || P),
          void 0 !== t.wrap &&
            ((n.wrap = (0, r.convertToDefinitionProperty)(e, t.wrap, S.format({ toolName: i }))),
      ...
      class m {
        ...
        addAnchors(e, t = {}) {
          ...
          const o = this._source.points(),
            n = i.map((e, t) => {
              ...
              return i && ((n.snappingPrice = i.price), (n.snappingIndex = i.index)), n;
            });
        ...
        createLineAnchor(e, t) {
          ...
          const o = (0, r.lastMouseOrTouchEventInfo)().isTouch,
            ...
            s = this.isHoveredSource() ? (this._model.lastHittestData()?.pointIndex ?? null) : null;
          return (
            n.setData({
              ...e,
              ...
              selectedStrokeWidth: o ? h.TouchSelectedStrokeWidth : h.RegularSelectedStrokeWidth,
              visible: this.areAnchorsVisible(),
        ...
        _needLabelExclusionPath(e, t) {
          ...
          return 'middle' === (t ?? i.vertLabelsAlign.value()) && (0, d.needTextExclusionPath)(e);
        }
        _addAlertRenderer(e, t, i = this._source.properties().linecolor.value()) {}
    ...
    36875: (e, t, i) => {
      ...
      const g = {
        ...
        _ = (0, u.extractAllPropertiesKeys)((0, o.ensureDefined)(b.get(l.StdTheme.Light))),
        T = (0, u.extractAllPropertiesKeys)(g),
        S = [...new Set([..._, ...T, ...a.commonLineToolPropertiesStateKeys, 'text'])],
        x = [...new Set([..._, ...T, 'text'])];
      class P extends p.LineDataSourceProperty {
        constructor(e) {
          super(e),
            ...
            this.addChild(
              'linesColors',
              new c.LineToolColorsProperty([(0, o.ensureDefined)(this.child('lineColor'))]),
            ),
            this.addChild(
              'backgroundsColors',
        ...
        static create(e, t) {
          return new this({
            ...
            factoryDefaultsSupplier: () => (0, h.factoryDefaultsForCurrentTheme)(g, b),
      ...
      class F {
        ...
        hitTest(e) {
          ...
          return (0, M.distanceToSegment)(t.points[0], t.points[1], e).distance <= i
            ? this._hittest
      ...
      class O extends k.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          const n = (0, o.ensureNotNull)(this._source.ownerSource()).firstValue();
          if (null === n) return;
          ...
          if (l.showLabel && l.showLabel.value()) {
            ...
            if (
              ...
              d.excludeBoundaries =
                (0, D.getTextBoundaries)(this._customLabelRenderer, t, i) ?? void 0;
            }
          }
      ...
      var K = i(11542),
        ...
        U = i(32097),
        q = i(91682);
      const G = new Y.TranslatedString('change {title} line color', K.t(null, void 0, i(7455))),
            ...
            definitions: [
              (0, X.createTextStyleDefinition)(
                ...
                o,
                {
                  isEditable: !1,
                  isMultiLine: !1,
                  customTitles: { text: j, borderTitle: Z, backgroundTitle: ee },
                },
              ),
              n,
            ],
          ...
          return {
            definitions: [
              (0, X.createTextStyleDefinition)(
                ...
                new Y.TranslatedString(this._source.name(), this._source.translatedType()),
      ...
      class ie extends n.LineDataSource {
        constructor(e, t, i, o) {
          super(e, t ?? ie.createProperties(e.backgroundTheme().spawnOwnership()), i, o),
        ...
        startMoving(e, t, i) {
          if (1 === t) {
            ...
            const i = (0, o.ensureDefined)(e.logical),
              n = this.points()[1];
            (this._labelMovingDelta = { index: n.index - i.index, price: n.price - i.price }),
        ...
        move(e, t, i) {
          if (null !== this._labelMovingDelta) {
            ...
            this.setPoint(1, n, i), this.updateAllViews((0, w.sourceChangeEvent)(this.id()));
    ...
    36036: (e, t, i) => {
      ...
      class b extends u.BitmapCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          for (const t of i) {
            if (t.point.subtract(e).length() <= o)
              return new a.HitTestResult(t.hitTarget ?? a.HitTarget.ChangePoint, {
        ...
        doesIntersectWithBox(e) {
          return null !== this._data && this._data.points.some(t => (0, n.pointInBox)(t.point, e));
        }
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, i, g, p), o.length && this._drawPoints(e, o, n, f, m);
        }
        _drawPoints(e, t, i, n, l) {
          const { context: a, horizontalPixelRatio: c, verticalPixelRatio: d } = e,
          ...
          for (let e = 0; e < t.length; ++e) {
            const r = t[e];
            if (!((0, s.isInteger)(r.pointIndex) && u.linePointBeingEdited === r.pointIndex)) {
              a.fillStyle = i[e];
              if (
                (n(
                  a,
                ...
                if (null !== u.hoveredPointIndex && r.pointIndex === u.hoveredPointIndex) {
