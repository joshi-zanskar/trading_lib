  ...
  [4273],
  {
    76607: (e, t, s) => {
        ...
        m = new Map([
          ...
          [
            r.StdTheme.Dark,
            {
              ...
              labelBackgroundColor: (0, i.getHexColorByName)('color-cold-gray-800'),
              linecolor: u,
              backgroundColor: (0, o.generateColor)(u, 85),
      ...
      class y extends n.LineDataSourceProperty {
        constructor({ nonThemedDefaultsKeys: e, themedDefaultsKeys: t, state: s, ...i }) {
          super({
    ...
    42214: (e, t, s) => {
      ...
      var i = s(50151),
        ...
        u = s(76607),
        c = s(6590);
      const m = { ...u.nonThemedFactoryDefaultsBase, extendTop: !1, extendBottom: !1 },
        ...
        y = (0, a.extractAllPropertiesKeys)((0, i.ensureDefined)(d.get(l.StdTheme.Light))),
      ...
      class v extends u.DateAndPriceBaseProperties {
        static create(e, t) {
          return new this({
            ...
            factoryDefaultsSupplier: () => (0, n.factoryDefaultsForCurrentTheme)(m, d),
      ...
      class b extends r.LineDataSource {
        constructor(e, t, i, r) {
          super(e, t ?? b.createProperties(e.backgroundTheme().spawnOwnership()), i, r),
