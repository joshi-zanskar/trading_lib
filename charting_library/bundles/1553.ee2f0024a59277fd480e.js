  ...
  [1553],
  {
    11553: (t, e, i) => {
      ...
      !(function (r, s, o, a) {
        ...
        function vt(t, e) {
          1 & t
            ? ((this.primaryTouch = e.changedPointers[0].identifier), dt.call(this, e))
            : 12 & t && dt.call(this, e);
        }
        function dt(t) {
        ...
        St.prototype = {
          set: function (t) {
            t == yt && (t = this.compute()),
              Tt && this.manager.element.style && _t[t] && (this.manager.element.style[gt] = t),
        ...
        function kt(t, e) {
          return ((e = e || {}).recognizers = C(e.recognizers, kt.defaults.preset)), new Wt(t, e);
        }
        (Dt.prototype = {
          defaults: {},
          set: function (t) {
        ...
        function Wt(t, e) {
          ...
          (this.options = h({}, kt.defaults, e || {})),
            ...
            (this.oldCssProps = {}),
            (this.element = t),
            (this.input = new ((i = this).options.inputClass || (X ? st : Y ? lt : N ? ft : tt))(
              i,
              U,
            )),
        ...
        (Wt.prototype = {
          ...
          ((void 0 !== r ? r : 'undefined' != typeof self ? self : {}).Hammer = kt),
          (n = function () {
            return kt;
