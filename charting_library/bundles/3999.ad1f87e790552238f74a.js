(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3999],
  {
    ...
    13996: e => {
      e.exports = { emoji: 'emoji-BsERGcZ1', clearButton: 'clearButton-BsERGcZ1' };
    },
    80859: e => {
    ...
    53885: (e, t, n) => {
      ...
      function i(e, t = 2, n) {
        return o(
          ...
          a()[e],
          n,
          0 === t || 1 === t ? o(r.skeletonTheme.wrapper, a().skeleton) : a().letter,
      ...
      function i(e) {
        const { text: t, textRender: n, firstSegmentOnly: i = !1 } = e,
          { leadingEmoji: c, processedText: s } = (0, o.useMemo)(
            () =>
              (0, r.processTextWithLeadingEmoji)({ text: t, textRender: n, firstSegmentOnly: i }),
            [t, n, i],
          );
        return c
          ? o.createElement(
    ...
    63472: (e, t, n) => {
      'use strict';
      n.d(t, { getLeadingEmojiHtml: () => m, processTextWithLeadingEmoji: () => u });
      var o = n(91682),
        r = n(173),
        l = n(88160),
        a = n(56570),
      ...
      function u(e) {
        const { text: t, textRender: n = e => e, firstSegmentOnly: a = !1 } = e,
          ...
          u = a ? i || '' : t;
        if (!s || c === l.EMPTY_EMOJI) return { leadingEmoji: '', processedText: n(u) };
    ...
    71402: (e, t, n) => {
      ...
      const l = { [o.Add]: r.t(null, void 0, n(69207)), [o.Remove]: r.t(null, void 0, n(85106)) };
    },
    36189: (e, t, n) => {
      'use strict';
      ...
      var o = n(50959),
        ...
        m = n(22413);
      function d(e) {
        const { className: t, isFilled: n, isActive: r, onClick: d, title: v, ...h } = e,
    ...
    70412: (e, t, n) => {
      'use strict';
      n.d(t, { hoverMouseEventFilter: () => l, useAccurateHover: () => a, useHover: () => r });
      var o = n(50959);
      function r() {
              ...
              J ||
                (e.currentTarget.dispatchEvent(
                  new CustomEvent('popup-menu-close-event', {
                    bubbles: !0,
                    detail: { clickType: (0, c.isKeyboardClick)(e) ? 'keyboard' : 'mouse' },
                  }),
                ),
                (0, a.globalCloseMenu)());
            },
            onContextMenu: function (e) {
              W && Y && (0, l.trackEvent)(W.category, W.event, `${W.label}_rightClick`);
            },
            onMouseUp: function (e) {
              if (1 === e.button && z && W) {
                let e = W.label;
                K && (e += '_mouseWheelClick'), (0, l.trackEvent)(W.category, W.event, e);
              }
            },
            onMouseOver: I,
            onMouseOut: O,
          ...
          void 0 !== y &&
            o.createElement(
              'span',
              {
                role: T,
                onClick: Q ? m : void 0,
                className: r(p, S.toolbox, { [S.showOnHover]: L, [S.showOnFocus]: k }),
              },
              y,
            ),
        );
    ...
    20243: (e, t, n) => {
      ...
      function s(e) {
        ...
        switch ((0, o.mapKeyCodeToDirection)(t)) {
          case 'inlinePrev':
            if (!u.length) return;
            e.preventDefault(), f(0 === p ? a[s] : g ? m(u, p, -1) : u[u.length - 1]);
            break;
          case 'inlineNext':
            if (!u.length) return;
            e.preventDefault(), p === u.length - 1 ? f(a[s]) : f(g ? m(u, p, 1) : u[0]);
            break;
          case 'blockPrev': {
            e.preventDefault();
            const t = m(a, s, -1);
    ...
    19365: (e, t, n) => {
      ...
      function r(e, t) {
        ...
        return (
          o.default.parse(
            e,
            e => ((n = o.default.base + ('svg' === t ? `svg/${e}.svg` : `72x72/${e}.png`)), !1),
          ),
          n
        );
      }
