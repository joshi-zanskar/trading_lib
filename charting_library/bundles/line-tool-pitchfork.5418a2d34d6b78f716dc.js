  ...
  [5055],
  {
      ...
      class P extends o.DefaultProperty {
        ...
        state(e, t, i) {
          ...
          return i
            ...
            : ((n = s),
              (r = this._map),
              (0, this._levelsIterator)(n, { tpl: d, fill: c, typecheck: r.typecheck.pack }, r));
          var n, r;
        }
        preferences() {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, o.extractState)(
              (0, n.default)((0, s.default)(t), f(e, this._map, this._levelsIterator)),
              this._allStateKeys,
    ...
    64002: (e, t, i) => {
      ...
      var s = i(50151),
        ...
        d = i(44672),
        p = i(96333);
      const u = new n.TranslatedString('erase level line', r.t(null, void 0, i(77114))),
        f = new n.TranslatedString('change {title} style', r.t(null, void 0, i(98463)));
      var P;
      !(function (e) {
      ...
      class v extends c.LineDataSource {
        constructor(e, t, i, s) {
          super(e, t ?? v.createProperties(e.backgroundTheme().spawnOwnership()), i, s),
              ...
              options: {
                ...
                onExecute: () => {
                  e.setProperty(
                    ...
                    i,
                    f.format({
                      title: new n.TranslatedString(this.name(), this.translatedType()),
                    }),
        ...
        processErase(e, t) {
          const i = 'level' + t,
            n = (0, s.ensureDefined)(this.properties().child(i)).childs().visible;
