  ...
  [7539],
  {
    83943: (e, t, s) => {
      ...
      class p extends n.CustomSourceBase {
        constructor(e, t, s, i) {
          super(e, t),
            ...
            t
              .timeScale()
              .logicalRangeChanged()
              .subscribe(this, this.updateAllViews.bind(this, (0, c.viewportChangeEvent)())),
            t.mainSeries().properties().childs().interval.subscribe(this, this._processHibernate);
        }
        start() {
          (this._isStarted = !0), this._processHibernate();
        }
        restart() {
          this._clearData(), h.enabled('stop_study_on_restart') && this.stop(), this.start();
        }
        isStarted() {
            ...
            (null === this._loadedGraphics &&
              ...
              null !== this._metaInfo &&
                ...
                this._studySource
                  ...
                  .subscribe(
                    this,
                    this.updateAllViews.bind(this, (0, c.sourceChangeEvent)(this.id())),
                  ),
                this._studySource
                  .dataUpdated()
                  .subscribe(
        ...
        _onPropertiesChanged() {
          this._processHibernate(), this.updateAllViews((0, c.sourceChangeEvent)(this.id()));
        }
        _processHibernate() {
          if (null !== this._studySource) {
            ...
            !t && e && s ? this._studySource.stop() : !t || e || s || this._studySource.start();
          }
        }
        _canBeHibernated() {
          ...
          return e.isDWM() || (!i && !t.vertlines.childs().sessBreaks.childs().visible.value());
        }
        _isHibernated() {
    ...
    93378: (e, t, s) => {
      ...
      class a {
        constructor(e, t, s, i) {
          (this._priceAxisFontSize = 11),
            ...
            this._recreateCanvasAndContext((0, l.size)({ width: 0, height: 0 })),
        ...
        setPrices(e) {
          ...
          const s = (e, t) => {
            ...
            return (
              ((!s && !r) || s === r) &&
              (0, i.ensureDefined)(e).formatted === (0, i.ensureDefined)(t).formatted
            );
          };
          ...
          if (t) {
            ...
            this._recreateCanvasAndContext((0, l.size)({ width: t, height: i })),
              (this._prices = e),
              this._cache.save(),
              (0, o.drawScaled)(
                this._cache,
                ...
                () => {
                  this._cache.translate(0.5, 0.5),
                    (this._cache.font =
                      this._renderParams.fontSize + 'px ' + this._renderParams.font),
        ...
        _recreateCanvasAndContext(e) {
          (this._canvas = document.createElement('canvas')),
            (this._canvas.width = e.width * this._pixelRatioParams.horizontalPixelRatio),
            (this._canvas.height = e.height * this._pixelRatioParams.verticalPixelRatio),
      ...
      var n = s(15938),
        h = s(98558),
        c = s(19063);
      const u = ['P', 'S1', 'R1', 'S2', 'R2', 'S3', 'R3', 'S4', 'R4', 'S5', 'R5'];
      class d extends h.PriceAxisView {
        constructor(e, t) {
          super(), (this._source = e), (this._data = t);
          const s = t.name;
          this._completeName = 'P' === s.toUpperCase() ? 'P' : `S${s[1]}/R${s[1]}`;
        }
        _updateRendererData(e, t, s) {
          ...
          if (o.isEmpty() || null === o.visibleBarsStrictRange() || (null !== a && a.isEmpty()))
            return;
          const n = this._source.customData();
          if (!n || !n.pivots) return;
          const h = this._source.pricesView().prices()[u.indexOf(this._data.name.toUpperCase())];
          if (!h) return;
          ...
          d.showStudyLastValue.value() && ((e.text = h.formatted), (e.visible = !0)),
            d.showStudyPlotLabels.value() &&
              ((t.text = this._source.priceLabelText(this._data.name)), (t.visible = !0));
        }
      }
      var p = s(65458),
        _ = s(22839),
        y = s(49936),
        v = s(8025);
      const S = ['p', 's1', 'r1', 's2', 'r2', 's3', 'r3', 's4', 'r4', 's5', 'r5'],
        m = {
          P: 'P',
          S1: 'S1/R1',
          S2: 'S2/R2',
      ...
      class b {
        ...
        _updateImpl() {
          ...
          const i = e.mainSeries().bars().search(s.lastBar(), v.PlotRowSearchMode.NearestLeft);
          if (null === i) return;
      ...
      class R extends x.BitmapCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          for (const t of this._drawRects)
            if (e.x >= t.left && e.x <= t.left + t.width && e.y >= t.top && e.y <= t.top + t.height)
        ...
        _drawImpl(e) {
          ...
          let a = 0;
          for (let e = 0; e < o.length; e++) {
            const t = ['P', 'S1', 'R1', 'S2', 'R2', 'S3', 'R3', 'S4', 'R4', 'S5', 'R5'].indexOf(
              o[e],
            );
          ...
          for (let e = 0; e < this._pivots.length; e++) {
            ...
            r.setData(i),
              ...
              s.levelsStyle.childs().showLabels.value() &&
                this._renderer.append(new R(this._cacheProvider, new g.Point(t.x1, t.y), t.label));
          }
        }
      }
      var A = s(93280);
      class L extends r.NonSeriesStudy {
        constructor(e, t, s, i, r) {
          super(e, t, s, i, r), (this._cache = null), (this._cachedPixelRatioParams = null);
        ...
        getCache(e) {
          if (
            ...
            (this._cache = new a(s, t.font, t.fontSize, t.backColors)),
              this._cache.setPrices((0, i.ensureNotNull)(this._pricesView).prices()),
        ...
        isVisible() {
          ...
          for (let s = 0; s < e.length; s++) if (t.childs()[e[s]].value()) return !0;
          return !1;
        }
        stop() {
        ...
        priceRange(e, t, s) {
          ...
          for (let s = 0; s < r.length; s++) {
            ...
            const a = [],
              n = this.properties().childs().levelsStyle.childs().visibility.childs();
            ...
            for (let e = 0; e < a.length; e++)
              a[e] && (null === o ? (o = new A.PriceRange(a[e], a[e])) : o.apply(a[e], a[e]));
          }
          const a = this.priceScale();
          return a && a.isLog() && o
            ? new A.PriceRange(a.priceToLogical(o.minValue()), a.priceToLogical(o.maxValue()))
            : o;
        }
        _createViews() {
          ...
          for (let t = 0; t < e.length; t++) {
            ...
            this._priceAxisViews.push(s),
              this._labelPaneViews.push(new p.PanePriceAxisView(s, this, this._model));
          }
          this._dataWindowView ||
            (this._dataWindowView = new _.StudyDataWindowView(this, this._model)),
            this._statusView || (this._statusView = new y.StudyStatusView(this)),
    ...
    31257: (e, t, s) => {
        ...
        _mergeData(e) {
          ...
          if (null !== i && null !== o)
            for (const e of this._underlyingData.rangeIterator(i, o))
              null === s && (s = e), this._data.add(e.index, (0, r.clone)(e.value));
        ...
        _plotsForStrategyProcessing() {
          ...
          return (
            this._metaInfo.plots.forEach((t, s) => {
              ...
              (0, i.assert)(r >= 0, `target plot not found for strategy plot ${t.id}`),
      ...
      class h {
        constructor(e, t, s) {
          (this._strategyPlotIndex = e), (this._targetPlotIndex = t), (this._startIndex = s);
        }
        rebuildData(e) {
    ...
    34425: (e, t, s) => {
      ...
      class n extends o.PriceAxisView {
        ...
        _updateRendererData(e, t, s) {
          ...
          if (
            !(l && l.visible && l.visible.value() && this._isLabelVisibleAccordinglyToProperties())
          )
            return;
          ...
          for (const e of c) {
            ...
            (t === o.contains(e.endIndex, !0) && 0 !== t) ||
              (h.time < e.endIndex && ((h.time = e.endIndex), (h.price = e.level)));
          }
          ...
          (s.background = u),
            ...
            (e.text = i.formatPrice(h.price, n, { signPositive: i.isPercentage() })),
            (e.visible = !0);
        }
      ...
      class d extends h.Study {
        ...
        async _createGraphicsPaneViews() {
          ...
          if (e.hhists) {
            const { HHistPaneView: e } = await s.e(507).then(s.bind(s, 56208)),
              l = this.properties().childs().graphics.childs().polygons?.childs();
            i.regularPaneViews.push(new e(this, t, void 0, l?.histBoxBg, r));
          }
          if (e.horizlines) {
            const { HorizLinePaneView: e } = await s.e(507).then(s.bind(s, 95258));
            i.regularPaneViews.push(new e(this, t, void 0, r));
          }
          return i;
        }
        _createGraphicsPriceAxisViews() {
          return Object.keys(this.metaInfo().graphics.horizlines ?? {}).map(e => new n(this, e));
        }
        ...
        _needExtendToBarsEnding() {
          return void 0 !== this.metaInfo().defaults.inputs?.mapRightBoundaryToBarStartTime;
        }
      }
      class p extends d {
        constructor(e, t, s, i, r) {
      ...
      class _ extends p {
        priceRange(e, t, s) {
          ...
          this.graphics()
            ...
            .forEach((e, t) => {
              r =
                r ||
                (0, i.ensureDefined)(
                  this.properties().childs().graphics.childs().hhists?.childs()[t],
                ).value();
            });
          const o = (function (e, t, s, i) {
            ...
            return (
              e.forEach(e => {
                e.forEach(e => {
                  ...
                  null !== i &&
                    ...
                    e.lastBarTime >= t &&
                    (null === r
                      ? (r = { low: { l: e.priceLow, h: e.priceHigh }, high: { h: e.priceHigh } })
                      : (e.priceLow < r.low.l && ((r.low.l = e.priceLow), (r.low.h = e.priceHigh)),
              ...
              null === r
                ? null
                : i
                  ? new l.PriceRange(r.low.l - 0.8 * (r.low.h - r.low.l), r.high.h)
          ...
          return a.isLog()
            ? new l.PriceRange(a.priceToLogical(o.minValue()), a.priceToLogical(o.maxValue()))
            : o;
        }
      }
      class y extends _ {
    ...
    47988: (e, t, s) => {
      ...
      function p(e) {
        ...
        return (
          e && i.push({ path: 'graphics.polygons.histBoxBg.color', colors: d.histogramBoxColor }), i
        );
      }
    },
    7021: (e, t, s) => {
        ...
        _getVolumeUnit() {
          ...
          return e
            ? (function (e) {
              ...
              })({ ...e, currency: e.original_currency_code || e.currency_code })
            : void 0;
        }
      }
    },
    38496: (e, t, s) => {
      s.r(t), s.d(t, { study_Overlay: () => ke });
      var i = s(50151),
        r = s(49483),
        l = s(9343),
        o = s(46806),
        ...
        I = s(49256),
        T = s(19063);
      const A = p.enabled('force_exchange_as_title');
        ...
        _updateRendererData(e, t, s) {
          ...
          if (n <= a.lastBar())
            ...
            const o = l.backgroundColorAtYPercentFromTop(
              r.coordinate / (0, i.ensureNotNull)(l.paneForSource(this._source)).height(),
            );
            (s.background = o),
          ...
          (s.coordinate = r.coordinate), (s.floatCoordinate = r.floatCoordinate);
          const h = this._source.model().properties().childs().scalesProperties.childs();
          h.showSeriesLastValue.value() &&
            ((e.text = (0, I.getCurrentModePriceText)(o, r)),
            h.seriesLastValueMode.value() !== V.PriceAxisLastValueMode.LastPriceAndPercentageValue
              ? (e.secondLine = '')
              : (e.secondLine = (0, I.getOppositeModePriceText)(o, r)),
            (e.visible = !0)),
            (t.text = ''),
          ...
          return (
            A
              ...
              : this._source
                  ...
                  .childs()
                  .scalesProperties.childs()
                  .showSymbolLabels.value() && (e = (0, c.displayedSymbolName)(t)),
            e
          );
        }
      }
      ...
      class F {
        constructor(e) {
          (this._lineRenderer = new E.HorizontalLineRenderer()),
            (this._visible = !1),
            (this._source = e);
        }
        update() {
          if (((this._visible = !1), !this._source.properties().childs().showPriceLine.value()))
            return;
      ...
      var N = s(15764),
        ...
        j = s(41991),
        Q = s(82587);
      const Y = G.lastDayChangeAvailable || G.alwaysShowLastPriceAndLastDayChange,
        K = r.CheckMobile.any(),
        Z = (0, W.getPercentageFormatter)();
      var J;
      !(function (e) {
        (e[(e.Open = 0)] = 'Open'),
          (e[(e.High = 1)] = 'High'),
      ...
      class te {
        constructor(e, t) {
          (this._study = e),
            (this._model = t),
            (this._emptyValues = [
              { title: z.t(null, void 0, s(16610)), visible: !1, value: '', index: 0, id: '' },
              { title: z.t(null, void 0, s(78254)), visible: !1, value: '', index: 1, id: '' },
              { title: z.t(null, void 0, s(65318)), visible: !1, value: '', index: 2, id: '' },
              { title: z.t(null, void 0, s(62578)), visible: !1, value: '', index: 3, id: '' },
              { title: '', visible: !1, value: '', index: 4, id: '' },
              { title: '', visible: !1, value: '', index: 5, id: '' },
              { title: z.t(null, void 0, s(37276)), visible: !1, value: '', index: 6, id: '' },
              { title: z.t(null, void 0, s(63815)), visible: !1, value: '', index: 7, id: '' },
            ]);
        }
        getItems() {
        ...
        getValues(e) {
          ...
          const r = s.search(i, b.PlotRowSearchMode.NearestLeft, 1);
          if (null === r) return t;
          ...
          if (
            ...
            return t;
          const o = s.search(e, b.PlotRowSearchMode.NearestLeft, 1),
          ...
          const _ = t[4];
          _.visible = !1;
          const { barChange: y, lastDayChange: v } = (0, $.changesData)(
              s,
              this._study.quotes(),
              o.value,
              o.index,
            ...
            S = (0, j.getPriceValueFormatterForSource)(this._study);
          if (
            ...
            if (void 0 !== y) {
              ...
              t[6].value = (0, U.forceLTRStr)(`${o} (${Z.format(y.percentChange, s)})`);
            }
            if (void 0 !== v) {
              const { currentPrice: i, prevPrice: r, change: l, percentChange: o } = v,
                a = e.formatChange?.(i, r, s) ?? e.format(l, s);
              t[7].value = (0, U.forceLTRStr)(`${a} (${Z.format(o, s)})`);
            }
          }
          let m = null;
          if (l)
            (t[5].value = null == p ? X : S(p)),
              (t[5].visible = !0),
              (m = this._getChangeColor(y?.change)),
              (t[6].visible = void 0 !== y),
              (t[7].visible = void 0 !== v || Y);
          else {
            (t[0].value = null == c ? X : S(c)),
              (t[1].value = null == u ? X : S(u)),
              (t[2].value = null == d ? X : S(d)),
              (t[3].value = null == p ? X : S(p)),
              (_.value = S(this._study.barFunction()(h))),
              (t[5].visible = !1);
            ...
            (t[0].visible = !e),
              ...
              (t[7].visible = void 0 !== v || Y),
              (t[6].visible = void 0 !== y);
            const s = this._study.barColorer().barStyle(n, !1),
              i = s.barBorderColor ?? s.barColor;
            m = (0, $.calculateColor)(a, i);
          }
          m = (0, T.resetTransparency)((0, $.calculateColor)(a, m));
          for (const e of t) e.color || (e.color = m);
          return (
            t[7].visible &&
              (t[7].color = (0, T.resetTransparency)(
                (0, $.calculateColor)(a, this._getChangeColor(v?.change)),
              )),
            t
          );
        }
        _mobileNonTrackingMode() {
          return (
            ...
            (null === this._model.crosshairSource().pane ||
              (0, N.isLineToolName)(M.tool.value()) ||
              null !== this._model.lineBeingEdited())
          );
        }
        _showLastPriceAndChangeOnly() {
          return G.alwaysShowLastPriceAndLastDayChange || this._mobileNonTrackingMode();
        }
        _getChangeColor(e) {
          const t =
            void 0 === e || e >= 0
            ...
            : ((e = this._model.crosshairSource().appliedIndex()),
              (null === e || isNaN(e)) &&
                ...
                p.enabled('use_last_visible_bar_value_in_legend') &&
                  (e = this._model.timeScale().visibleBarsStrictRange()?.lastBar() ?? NaN)));
      ...
      class ne extends re {
        constructor(e, t) {
          ...
          const s = t.properties().childs().paneProperties.childs().legendProperties.childs();
          (this._visibilityProperty = (0, ae.combineProperty)(
            (e, t) => e || t,
      ...
      class fe extends ge.StudyStatusProvider {
        getSplitTitle() {
          return this._source.titleInParts(O.TitleDisplayTarget.StatusLine, !0, void 0, !1, !1);
        }
        text() {
          return this._source.isActualInterval()
            ? this._source.isFailed()
              ...
              : `${this._source.title(O.TitleDisplayTarget.StatusLine, !0, void 0, !1, !1)} ${this.sourceStatusText()}`
            : this._source.title(O.TitleDisplayTarget.StatusLine, !0, void 0, !1, !1);
        }
      }
      const we =
        ...
        Pe = p.enabled('legend_last_day_change'),
        Ce = (r.CheckMobile.any() || we || Pe) && !1,
        xe = p.enabled('study_overlay_compare_legend_option'),
        Re = p.enabled('secondary_series_extend_time_scale'),
        Ve = p.enabled('hide_unresolved_symbols_in_legend'),
        Ie = !p.enabled('hide_study_overlay_legend_item'),
        Te = p.enabled('symbol_info_price_source'),
        Ae = (0, l.getLogger)('Chart.StudyOverlay');
      var Le;
      function Be(e, t) {
        return null == e[t];
      }
      ...
      class ke extends o.Study {
        constructor(e, t, s, i, r) {
          super(
            e,
            (function (e) {
              e.hasChild('currencyId') || e.addChild('currencyId', new u.Property(null)),
                e.hasChild('unitId') || e.addChild('unitId', new u.Property(null)),
                (0, be.allChartStyles)().includes(e.childs().style.value()) ||
              ...
              if (t.lineStyle.hasChild('styleType')) {
                ...
                0 === s && ((r = 14), (i = t.lineWithMarkersStyle.childs())),
                  ...
                  void 0 !== r && 2 === t.style.value() && t.style.setValueSilently(r),
                  t.lineStyle.removeProperty('styleType');
              }
              return e.addExcludedKey('currencyId', 1), e.addExcludedKey('unitId', 1), e;
            })(t),
            s,
            i,
            r,
            ...
            (this._symbolResolvingActive = new w.WatchedValue(!1)),
            (this._symbolHibernated = new w.WatchedValue(!1)),
            (this._styleToRecover = null),
            (this._isActingAsSymbolSource = new w.WatchedValue(!0)),
            (this._realignToolsLastParams = null),
            (this._precomputedBarStyles = new WeakMap()),
            (this._lastResolvedSymbolSource = ''),
            (this._data = new m.PlotList((0, h.seriesPlotFunctionMap)(), Be)),
            (this._quotesProvider = new _.QuotesProvider(void 0, e.collapsed().spawnOwnership())),
            Ce && this._quotesProvider.quotesUpdate().subscribe(this, this._onQuotesUpdate);
          ...
          l.currencyId.subscribe(this, this._onCurrencyChanged),
            ...
            l.allowExtendTimeScale.subscribe(this, this._onAllowExtendTimeScaleChanged),
            this._onAllowExtendTimeScaleChanged(),
            l.style.subscribe(this, this._onChartStyleChanged),
            l.lineStyle.childs().priceSource.subscribe(this, this._updateBarFunction),
            l.lineWithMarkersStyle.childs().priceSource.subscribe(this, this._updateBarFunction),
        ...
        compareSymbolParams(e) {
          return (0, y.compareSymbolParams)(this, e, this._model.unitConversionEnabled());
        }
        ...
        symbolSameAsResolved(e) {
          return (0, v.symbolSameAsResolved)(e, this._lastResolvedSymbolSource, this.symbol());
        }
        priceSource() {
          const e = this.properties().childs();
        ...
        state(e, t) {
          ...
          return (
            (s.state.inputs.symbol = (0, c.symbolToSaveInState)(
              this.symbolInfo() ?? this._model.chartApi().lastSymbolResolveInfo(r),
              r,
            )),
            e &&
              ((0, i.ensureDefined)(s.data).symbols = { ___snapshot: this.symbolInfo() || void 0 }),
            s
          );
        }
        symbolTitle(e, t, s) {
        ...
        sourceId() {
          return null === this._seriesSource
            ? super.sourceId()
            : (0, i.ensureNotNull)(this._seriesSource.instanceId());
        }
        moveData(e) {
        ...
        firstValue() {
          ...
          const s = this.data().search(t, b.PlotRowSearchMode.NearestRight, 1);
          return (
            (this._ownFirstValue = null !== s ? this._barFunction(s.value, 0) : null),
            this._ownFirstValue
          );
        }
        lineColorAtYPercentFromTop(e) {
          switch (this.style()) {
            ...
            case 14:
              return this.properties().childs().lineWithMarkersStyle.childs().color.value();
            case 15:
              return this.properties().childs().steplineStyle.childs().color.value();
          }
          return null;
        }
        lastValueData(e, t, s) {
          ...
          const a = this.nearestIndex(l.lastBar(), b.PlotRowSearchMode.NearestLeft, 1);
          ...
          switch (o.style.value()) {
            ...
            case 10: {
              ...
              y =
                _ < Math.round(r.height() * (Math.abs(100 - e.baseLevelPercentage.value()) / 100))
        ...
        priceRange(e, t, s) {
          ...
          if (!(0, g.isInteger)(e)) return Ae.logDebug('priceRange: incorrect startBar'), null;
          if (!(0, g.isInteger)(t)) return Ae.logDebug('priceRange: incorrect endBar'), null;
          ...
          const l = null !== r ? new f.PriceRange(r.min, r.max) : null;
        ...
        formatter() {
          return (
            this._formatter || this._recreateFormatter(), (0, i.ensureNotNull)(this._formatter)
          );
        }
        statusView() {
        ...
        moveItem(e, t, s) {
          if (10 === this.style() && 0 === t) {
            ...
            s.childs().baseLevelPercentage.setValue(Math.max(Math.min(o, 100), 0));
          }
        }
        measureUnitId() {
        ...
        alertCreationAvailable() {
          return new w.WatchedValue(
            !this.priceScale()?.isPercentage() && super.alertCreationAvailable().value(),
          ).readonly();
        }
        legendValuesProvider() {
          return new oe(this, this.model());
        }
        ...
        _onUnitChanged() {
          'alwaysOff' !== (0, n.currencyUnitVisibilityProperty)().value() &&
            ...
            this._model.unitConversionEnabled() && this.isStarted() && this._tryChangeInputs(),
        ...
        _getSymbolObject(e) {
          ...
          const i = this.unit();
          return this._model.unitConversionEnabled() && null !== i && (t['unit-id'] = i), t;
        }
        ...
        _onSymbolResolved(e, t, s) {
          super._onSymbolResolved(e, t, s), this._recreatePriceFormattingDependencies();
          const i =
              t === this.symbol() ? (0, c.extractSymbolNameFromSymbolInfo)(s, this.symbol()) : null,
            r = (0, c.symbolCurrency)(s),
            l = (0, c.symbolUnit)(s, this._model.unitConversionEnabled());
          this._setSymbolParamsInternal({ symbol: i ?? void 0, currency: r, unit: l }, s),
            Ce &&
              this._setQuotesSymbol(
                (0, d.encodeExtendedSymbolOrGetSimpleSymbolString)(
                  this._getSymbolObject(this.symbol()),
        ...
        async _changeInputsImpl(e, t) {
          await super._changeInputsImpl(e, t), this._realignLineToolsIfParamsChanged();
        }
        _getPropertyDefinitionsViewModelClass() {
          return Promise.all([s.e(1190), s.e(3889), s.e(8009), s.e(4482), s.e(607)])
            .then(s.bind(s, 15306))
        ...
        _onQuotesUpdate(e, t) {
          !this._legendView ||
            (void 0 === t.values.change && void 0 === t.values.change_percent) ||
        ...
        _createViews() {
          ...
          switch (this.properties().childs().style.value()) {
            ...
            case 9:
              ...
              break;
            case 13:
              r = new Se.SeriesColumnsPaneView(this, this._model);
              break;
            case 2:
            case 14:
            case 15:
              ...
              break;
            case 3:
              r = new pe.SeriesAreaPaneView(this, this._model);
              break;
            case 16:
              r = new _e.SeriesHLCAreaPaneView(this, this._model);
              break;
            case 10: {
              ...
              s = new x.SeriesWaterlinePaneView({
                paneHeight: () => (0, i.ensureNotNull)(this.priceScale()).height(),
          ...
          r && this._paneViews.push(r),
            ...
            this._paneViews.push(new F(this)),
            this._dataWindowView || (this._dataWindowView = new re(this, this._model)),
            this._legendView || (this._legendView = new ne(this, this._model)),
            this._statusView || (this._statusView = new C.StudyStatusView(this)),
            (this._priceAxisViews = [...this._priceAxisViewsBase]),
            this._labelPaneViews.push(new he.PanePriceAxisView(e, this, this._model));
        }
        _createStudyOnServer() {
          let e;
          return (
            null === this._seriesSource
              ? (e = super._createStudyOnServer())
              : (this._modifyStudyOnServer((0, i.ensureDefined)(this._inputs)), (e = !0)),
        ...
        _modifyStudyOnServer(e) {
          null === this._seriesSource
            ...
            : (this._seriesSource.modifySeries(
                (0, d.decodeExtendedSymbol)(e.symbol),
                (0, S.getServerInterval)(this._series.properties().childs().interval.value()),
              ),
              this._seriesSource.isStarted() || this._seriesSource.start());
        }
        _stopStudyOnServer() {
        ...
        _titleInParts(e, t, s, i, r) {
          ...
          return [
            ...
            [this._getExchangeTitlePart(l, r), this._getPriceSourceTitlePart(l)].filter(
              e => null !== e,
            ),
          ];
        }
        _getSymbolTitlePart(e) {
          if (null === e)
            return Ve ? '' : this.properties().childs().inputs.childs().symbol.value();
          if (xe)
        ...
        _getPriceSourceTitlePart(e) {
          return Te &&
            ...
            ? (this._model
                .availablePriceSources(this.getSymbolString(this._getSymbolForApi(this.symbol())))
        ...
        _onAllowExtendTimeScaleChanged() {
          ...
          this.properties().childs().inputs.childs().extendTimeScale.setValue(t),
            e && this.start(!0);
        }
        _setSymbolParamsInternal(e, t) {
          ...
          if (
            ...
            null !== e &&
              ...
              o.unitId.setValueSilently((0, c.symbolUnit)(e, this._model.unitConversionEnabled())));
          }
          o.inputs.childs().symbol.value() !== a && o.inputs.childs().symbol.fireChanged(),
        ...
        _onChartStyleChanged() {
          this._updateBarFunction(),
            this._styleToRecover?.originalStyle !== this.style() && (this._styleToRecover = null);
        }
        _checkStyle() {
          const e = this.style();
          ...
          this.model().mainSeries().intervalObj().is1Tick()
            ? (0, c.isSingleValueBasedStyle)(e) ||
              (this.setStyle(2),
              (this._styleToRecover = { correctedStyle: this.style(), originalStyle: e }))
            : null !== this._styleToRecover &&
              (this.setStyle(this._styleToRecover.originalStyle), (this._styleToRecover = null));
        }
