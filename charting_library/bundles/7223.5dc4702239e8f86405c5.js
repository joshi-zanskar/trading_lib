(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7223],
  {
    ...
    15499: (e, t, n) => {
      ...
      function y(e, t) {
        switch (e) {
          case c.Month: {
            const e = new Date(t);
            return e.setMonth(e.getMonth() - 1), u.setMonth.format({ month: o()[e.getMonth()] });
          }
          case c.Year:
    ...
    44313: (e, t, n) => {
      ...
      class g extends s.PureComponent {
        ...
        _isOnHighlightedEdge() {
          ...
          return !(!t || !n) && ((0, d.isSameDay)(e, t) || (0, d.isSameDay)(e, n));
        }
        ...
        _isCurrentDay() {
          return (0, d.isSameDay)(this.props.todayDate ?? new Date(), this.props.day);
        }
        ...
        const {
          ...
          M = (0, s.useCallback)(
            e => {
              if (!e) return null;
              let t = null;
              return a.find(({ days: n }) => ((t = n.find(t => (0, d.isSameDay)(t, e))), t)), t;
            },
            [a],
          ),
          ...
          x = (0, s.useCallback)(
            e => w || (0, d.isDayDisabled)({ day: e, minDate: h, maxDate: c, disableWeekends: g }),
            [h, c, g, w],
          ),
          {
            itemsRefs: T,
        ...
        return (
          ...
          s.createElement(
            ...
            s.createElement(
              ...
              (0, p.getWeekDaysMin)().map(e => s.createElement('span', { key: e }, e)),
            ),
            s.createElement(
              'div',
      ...
      function F(e) {
        const {
          ...
          v = (0, s.useCallback)(e => c || !(0, d.isInRange)(e, a, r, 'month'), [a, r, c]),
          D = (0, s.useCallback)(
            e => {
              if (!e) return null;
              let n = null;
              return t.find(({ date: t }) => ((n = (0, d.isSameMonth)(e, t) ? t : null), n)), n;
            },
            [t],
          ),
      ...
      function E(e) {
        const {
          ...
          D = (0, s.useCallback)(e => h || !(0, d.isInRange)(e, l, i, 'year'), [l, i, h]),
          w = (0, s.useCallback)(e => (e && t.find(t => (0, d.isSameYear)(e, t))) || null, [t]),
                ...
                e.map(e => {
                  ...
                  return s.createElement(
                    o.LightButton,
                    {
                      ...
                      disabled: i,
                      isSelected: r,
                      className: a()(u['decade-button'], !c && u['hide-focus-ring']),
                      onClick: () => f(e),
                      reference: k(e),
            ...
            () =>
              (function (e) {
                return (0, p.getMonthsShort)().map((t, n) => {
                  ...
                  return s.setMonth(n), { title: t, ariaLabel: (0, p.getMonths)()[n], date: s };
                });
              })(g),
            [g],
          ),
          ...
          P = (0, s.useMemo)(() => {
            switch (m) {
              ...
              case p.CalendarViewType.Year: {
                ...
                return e.setMonth(e.getMonth() + 1), !(0, d.isInRange)(e, r, a, 'month');
              }
              case p.CalendarViewType.Decades: {
                const e = new Date(I[I.length - 1]);
                return e.setFullYear(e.getFullYear() + 1), !(0, d.isInRange)(e, r, a, 'year');
              }
            }
          }, [m, r, a, T, R, I]),
          Y = (0, s.useMemo)(() => {
      ...
      function T({
        ...
        return {
          onPrevClick: (0, s.useCallback)(() => {
            u((0, p.getPrevLiveRegionConfirmation)(e, e === p.CalendarViewType.Decades ? t : n)),
              r(null);
          }, [r, u]),
          onNextClick: (0, s.useCallback)(() => {
            u((0, p.getNextLiveRegionConfirmation)(e, e === p.CalendarViewType.Decades ? t : n)),
              a(null);
          }, [a, u]),
          onSwitchViewType: (0, s.useCallback)(
            s => {
              u((0, p.getViewTypeLiveRegionConfirmation)(e, e === p.CalendarViewType.Year ? t : n)),
                o(s);
            },
            [o, u],
          ),
      ...
      function R(e) {
        ...
        return (
          ...
          s.createElement(
            'div',
            { className: r(u.calendar, g && u.popupStyle, o), tabIndex: -1, onKeyDown: O },
            s.createElement(c, {
              prevAriaLabel: (0, p.getPrevAriaLabel)(B, B === p.CalendarViewType.Decades ? ce : A),
              nextAriaLabel: (0, p.getNextAriaLabel)(B, B === p.CalendarViewType.Decades ? ce : A),
      ...
      class y extends r.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleFocus = e => {
              this.props.showOnFocus && this.props.onShowPicker(), this.props.onFocus?.(e);
            }),
            ...
            (this._handleDropdownKeydown = e => {
              27 === (0, v.hashFromEvent)(e) && (this._input?.focus(), this.props.onHidePicker());
            }),
      ...
      class E extends r.PureComponent {
        ...
        render() {
          const e = this.props.endSlotComponent,
            t = (0, F.mergeRefs)([this._pickerInpuRef, this.props.inputReference]);
    ...
    76056: (e, t, n) => {
      ...
      const p = n(38721);
      function g(e) {
        const { hasErrors: t, onClick: l, errors: u, className: c, theme: g = p, ...f } = e;
        return s.createElement(
          'div',
          ...
          t && s.createElement(d, { text: r.t(null, void 0, n(27254)), className: g.tooltip }),
        );
      }
    },
    23935: (e, t, n) => {
    ...
    36565: (e, t, n) => {
      ...
      function N(e) {
        ...
        const n = (0, r.useRef)(null),
          ...
          y = I(m) ? m : P(m),
          [w, b] = (0, r.useState)(y),
          C = c || $().some(e => null !== e && e.contains(document.activeElement));
        ...
        return r.createElement(
          ...
          r.createElement(F, {
            ...
            disabled: e.disabled,
            name: e.name,
            endSlot: r.createElement(u.EndSlot, { icon: !0 }, r.createElement(g, null)),
            reference: s,
            ...
            onKeyDown: function (t) {
              ...
              13 === n &&
                (t.preventDefault(),
                V(w),
                e.keepFocusOnKeyBoardNavigation || (0, i.ensureNotNull)(s.current).blur());
              27 === n &&
                (t.preventDefault(),
                e.keepFocusOnKeyBoardNavigation || (0, i.ensureNotNull)(s.current).blur());
            },
        ...
        function O(e) {
          return (e instanceof Node && $().find(t => null !== t && t.contains(e))) || null;
        }
        function $() {
    ...
    82665: (e, t, n) => {
      ...
      const l = function (e, t, n) {
        t = (n ? (0, r.default)(e, t, n) : void 0 === t) ? 1 : i((0, a.default)(t), 0);
