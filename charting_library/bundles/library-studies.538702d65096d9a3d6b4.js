      ...
      class a extends o.Study {
        constructor(e, s, t, i, o) {
          super(
            ...
            (function (e) {
              return (
                e.hasChild('currencyId') || e.addChild('currencyId', new r.Property(null)),
                e.hasChild('unitId') || e.addChild('unitId', new r.Property(null)),
            ...
            this._isActingAsSymbolSource.subscribe(this._onIsActingAsSymbolSourceChanged);
        ...
        compareSymbolParams(e) {
          return (0, n.compareSymbolParams)(this, e, this._model.unitConversionEnabled());
        }
        ...
        symbolInfo() {
          if (!this._isActingAsSymbolSource.value()) return super.symbolSource().symbolInfo();
        ...
        symbolSameAsResolved(e) {
          return (0, u.symbolSameAsResolved)(e, this._lastResolvedSymbolSource, this.symbol());
        }
        setCurrency(e) {
        ...
        _getSymbolObject(e) {
          ...
          const l = this.unit();
          return this._model.unitConversionEnabled() && null !== l && (s['unit-id'] = l), s;
        }
        _onSymbolResolved(e, s, t) {
          super._onSymbolResolved(e, s, t), this._recreatePriceFormattingDependencies();
          const l =
            s === this.symbol() ? (0, i.extractSymbolNameFromSymbolInfo)(t, this.symbol()) : null;
          null !== l && (this._previousSymbolInputValue = l);
          const r = (0, i.symbolCurrency)(t),
            o = (0, i.symbolUnit)(t, this._model.unitConversionEnabled());
          this._setSymbolParamsInternal({ symbol: l ?? void 0, currency: r, unit: o }, t),
        ...
        _onCurrencyMayChange() {
          this.isActingAsSymbolSource() ? super._onCurrencyMayChange() : this._onCurrencyChanged();
        }
        _recalculateIsActingAsSymbolSource() {
          const e = '' !== this._currencySourceSymbolInputProperty?.value() ?? !1;
        ...
        _setSymbolParamsInternal(e, s) {
          ...
          if (
            ...
            (this._resolvedSymbolsByInput[this.symbol()] = s),
              (this._resolvedSymbols[this._getSymbolForResolve(this.symbol())] = s),
              (this._realignToolsLastParams = null);
          else {
            const e = this.symbolInfo();
            null !== e &&
              (o.currencyId.setValueSilently((0, i.symbolCurrency)(e)),
              o.unitId.setValueSilently((0, i.symbolUnit)(e, this._model.unitConversionEnabled())));
          }
          o.inputs.childs().symbol.value() !== n && o.inputs.childs().symbol.fireChanged(),
        ...
        _realignLineToolsIfParamsChanged() {
          ...
          if (null !== this._realignToolsLastParams) {
            ...
            e = s.symbolChanged || s.intervalChanged || s.currencyChanged || s.unitChanged;
          }
          e &&
