  ...
  [1314],
  {
    ...
    40265: (e, t, r) => {
      ...
      class d {
        ...
        setDirection(e) {
          return (
            (this._direction = e), this._line.updateAllViewsAndRedraw(a(this._line.id())), this
          );
        }
        setProfitState(e) {
          return (
            (this._profitState = e), this._line.updateAllViewsAndRedraw(a(this._line.id())), this
          );
        }
        getPrice() {
        ...
        setLineColor(e) {
          return (
            'buy' === this._direction ? this.setLineBuyColor(e) : this.setLineSellColor(e), this
          );
        }
        setLineBuyColor(e) {
        ...
        getQuantityBorderColor() {
          var e = this._line.properties();
          return (
            'buy' === this._direction ? e.quantityBorderBuyColor : e.quantityBorderSellColor
          ).value();
        }
        ...
        getReverseButtonIconColor() {
          var e = this._line.properties();
          return (
            'buy' === this._direction ? e.reverseButtonIconBuyColor : e.reverseButtonIconSellColor
          ).value();
        }
        ...
        getCloseButtonBorderColor() {
          var e = this._line.properties();
          return (
            'buy' === this._direction ? e.closeButtonBorderBuyColor : e.closeButtonBorderSellColor
          ).value();
        }
        ...
        getCloseButtonIconColor() {
          var e = this._line.properties();
          return (
            'buy' === this._direction ? e.closeButtonIconBuyColor : e.closeButtonIconSellColor
          ).value();
        }
        ...
        block() {
          (this._blocked = !0), this._line.updateAllViewsAndRedraw(a(this._line.id()));
        }
        unblock() {
          (this._blocked = !1), this._line.updateAllViewsAndRedraw(a(this._line.id()));
        }
        isFunction(e) {
        ...
        onReverse(e, t) {
          return (
            t
              ? this.isFunction(t) && ((this._onReverseData = e), (this._onReverseCallback = t))
        ...
        onClose(e, t) {
          return (
            t
              ? this.isFunction(t) && ((this._onCloseData = e), (this._onCloseCallback = t))
        ...
        setCloseEnabled(e) {
          return (
            this._closeEnabled === e ||
              ((this._closeEnabled = e),
              this._onCloseCallback && this._line.updateAllViewsAndRedraw(a(this._line.id()))),
            this
          );
        }
        isCloseEnabled() {
        ...
        onModify(e, t) {
          return (
            t
              ? this.isFunction(t) && ((this._onModifyData = e), (this._onModifyCallback = t))
        ...
        onContextMenu(e, t) {
          return (
            t
              ? this.isFunction(t) &&
                ((this._onContextMenuData = e), (this._onContextMenuCallback = t))
