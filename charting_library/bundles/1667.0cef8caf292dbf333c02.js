  ...
  [1667],
  {
    11667: (e, t, i) => {
      ...
      class v extends P {
        ...
        setValue(e) {
          const t = Math.round(
            Math.abs(e - this._lineSource.entryPrice()) * this._lineSource.ownerSourceBase(),
          );
      ...
      const z = new k.TranslatedString('reverse {tool}', n.t(null, void 0, i(66643)));
      class N extends l.LineDataSource {
        constructor(e, t, s, n) {
          ...
          const o = this._metaInfo?.inputs.find(e => 'account_currency' === e.id),
          ...
          o && !o.options.includes(a) && t.childs().currency.setValue(o.defval),
              ...
              this.ownerSourceChanged().subscribe(
                ...
                () => {
                  ...
                  if (a) {
                    ...
                    if (e && !e.isEmpty()) {
                      const i = Math.round(0.2 * e.length() * this.ownerSourceBase());
            ...
            t.hasChild('entryPointCurrencyRate') || t.addProperty('entryPointCurrencyRate', 1),
            t.hasChild('closePointCurrencyRate') || t.addProperty('closePointCurrencyRate', 1);
          const l = t.childs();
          l.stopLevel.subscribe(this, this.recalculate),
            ...
            t.hasChild('amountTarget') || t.addProperty('amountTarget', l.accountSize.value()),
            t.hasChild('amountStop') || t.addProperty('amountStop', l.accountSize.value()),
            [
              'riskSize',
              'qty',
              'amountTarget',
            ...
            this.ownerSourceChanged().subscribe(null, (e, t) => {
              e && e.barsProvider().dataUpdated().unsubscribeAll(this),
                t && t.barsProvider().dataUpdated().subscribe(this, this._onSeriesUpdated);
            }),
            ...
            [l.entryPointCurrencyRate, l.closePointCurrencyRate].forEach(e => {
              e.subscribe(this, () => {
                this._recalculateAmount(), this._recalculateRiskSize(), this._recalculateQty();
              });
            }),
        ...
        restoreExternalState(e) {
          if (!(0, g.isNumber)(e.entryPrice)) return void super.restoreExternalState(e);
          let t;
        ...
        addPoint(e, t, i) {
          ...
          return (this._lastPoint = null), this._normalizePoints(), this.createServerPoints(), !0;
        }
        setPoint(e, t, i, s) {
          ...
          switch ((this._muteSyncLineStyle(), e)) {
            case 0:
              this._changeEntryPoint({ ...t, interval: this._model.mainSeries().interval() });
              break;
            case 2:
            ...
            case 3:
              ...
              break;
            case 1:
              (t.price = this._points[0].price), super.setPoint(1, t), this.recalculate();
          }
          this._unmuteSyncLineStyleWithoutApplyingChanges(), s || this.syncPriceLevels();
        }
        getPoint(e) {
          ...
          switch (e) {
            ...
            case 1:
              return { index: this._points[1].index, price: this._points[0].price };
            case 2:
        ...
        axisPoints() {
          ...
          let t = null;
          if (4 === this._points.length) t = this._points[h.RiskRewardPointIndex.ActualClose];
          else {
        ...
        lastBarData() {
          ...
          if (4 === s.length) {
            ...
            return e.index < t ? null : { closePrice: e.price, index: Math.min(i, e.index) };
          }
          ...
          return null === a ? null : { closePrice: (0, r.ensure)(a.value[4]), index: a.index };
        }
        ownerSourceBase() {
        ...
        _ignoreSourceEvent(e) {
          return super._ignoreSourceEvent(e) && e.sourceId !== this._model.mainSeries().id();
        }
        ...
        _propertiesStateExclusions() {
          return [...super._propertiesStateExclusions(), 'entryPrice', 'stopPrice', 'targetPrice'];
        }
        _correctPoints(e, t) {
        ...
        _ownerSourcePointValue() {
          return this.ownerSource()?.symbolSource().symbolInfo()?.pointvalue ?? 1;
        }
        ...
        _onSeriesUpdated(e, t, i) {
          this.isSourceHidden() ||
            ...
            (null !== i && i.index > Math.max(this._points[0].index, this._points[1].index)) ||
        ...
        _recalculateRisk() {
          const e = this.properties().childs(),
            ...
            s = e.accountSize.value();
          let r = e.risk.value();
          (r = t === u.RiskDisplayMode.Percentage ? M((i / s) * 100) : M((s / 100) * r)),
            (this._riskInChange = !0),
            e.risk.setValue(
              parseFloat(this._riskFormatter(t).format(r, { ignoreLocaleNumberFormat: !0 })),
            ),
            (this._riskInChange = !1);
        }
        _recalculateAmount() {
        ...
        _recalculateQty() {
          ...
          const e = this.properties().childs(),
            ...
            n = null === r ? NaN : s / (Math.abs(t - i) * this._ownerSourcePointValue() * r);
          e.qty.setValue(n);
        }
        _calculateActualEntry(e, t) {
          ...
          for (const e of s.rangeIterator(o, l + 1)) {
            const t = e.value;
            if (null !== t && (0, r.ensure)(t[2]) >= c && (0, r.ensure)(t[3]) <= c)
        ...
        _updateStudySource() {
          ...
          if (
            (!i && this._studySource
              ...
              : i &&
                ...
                this._studySource.nonSeriesData().subscribe(e => {
                  e &&
                    (this._properties.childs().entryPointCurrencyRate.setValue(e.currency_ratio[0]),
                    this._properties
                      .childs()
                      .closePointCurrencyRate.setValue(e.currency_ratio[1] ?? e.currency_ratio[0]));
                })),
            ...
            if (null !== a && null !== l) {
              ...
              (0, s.default)(t, this._studySource.inputs()) || this._studySource.setInputs(t),
