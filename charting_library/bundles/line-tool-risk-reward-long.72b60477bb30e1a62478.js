  ...
  [2277],
  {
    21986: (e, r, t) => {
      ...
      class n extends o.LineToolRiskRewardBase {
        constructor(e, r, t, i) {
          super(e, r ?? n.createProperties(e.backgroundTheme().spawnOwnership()), t, i);
        }
        name() {
        ...
        stopPrice() {
          return (
            this.entryPrice() -
            this.properties().childs().stopLevel.value() / this.ownerSourceBase()
          );
        }
        profitPrice() {
          return (
            this.entryPrice() +
            this.properties().childs().profitLevel.value() / this.ownerSourceBase()
          );
        }
        calculatePL(e) {
        ...
        _amountTarget(e, r, t, i, s) {
          ...
          return null === n ? NaN : (0, o.roundValue)(e + ((r - t) * i * s) / n);
        }
        _amountStop(e, r, t, i, s) {
          const n = this._closePointCurrencyRate();
          return null === n ? NaN : (0, o.roundValue)(e - ((t - r) * i * s) / n);
        }
        _checkStopPrice(e) {
