...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3723],
  {
      ...
      class x extends o.DefaultProperty {
        ...
        state(e, t, i) {
          ...
          return i
            ...
            : ((r = s),
              (n = this._map),
              (0, this._levelsIterator)(r, { tpl: h, fill: d, typecheck: n.typecheck.pack }, n));
          var r, n;
        }
        preferences() {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, o.extractState)(
              (0, r.default)((0, s.default)(t), _(e, this._map, this._levelsIterator)),
              this._allStateKeys,
      ...
      class d extends n.InplaceTextLineDataSource {
        ...
        setInplaceEditLevelIndex(e) {
          ...
          i.setValue(o.value()),
            ...
            (this._destroyEditableTextSubscriptions = () => {
              i.unsubscribeAll(d), o.unsubscribeAll(d), r.unsubscribeAll(d), l.unsubscribeAll(d);
            }),
    ...
    33168: (e, t, i) => {
      ...
      const h = new o.TranslatedString('erase level line', n.t(null, void 0, i(77114)));
      class u extends c.LineToolFibWithInplaceTextBase {
        constructor(e, t, s, r) {
          super(e, t ?? u.createProperties(e.backgroundTheme().spawnOwnership()), s, r),
            (this.version = 2),
        ...
        static createProperties(e, t) {
          const i = new a.LevelsProperty({
            ...
            state: t,
            map: { range: [1, 24], names: ['coeff', 'color', 'visible', 'text'] },
            theme: e,
          });
    ...
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => g, InplaceTextUndoCommand: () => m });
      var s = i(50279),
        r = i(50151),
        n = i(86441),
        o = i(19625),
      ...
      class m extends u.UndoCommand {
        ...
        _source() {
          return (0, r.ensureNotNull)(this._model.dataSourceForId(this._sourceId));
        }
      }
