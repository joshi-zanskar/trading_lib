  ...
  [7260],
  {
    59142: function (e, t) {
      ...
      (s = [t]),
                ...
                (o = [].concat(t(o), [h])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !u(n.target) &&
                        ((s && 0 === s.scrollTop && 0 < o) ||
                        ((i = s) && i.scrollHeight - i.scrollTop <= i.clientHeight && o < 0)
                          ? d(n)
                          : n.stopPropagation()));
                  }),
                  a ||
        ...
        void 0 === (i = 'function' == typeof n ? n.apply(t, s) : n) || (e.exports = i);
    },
    97754: (e, t) => {
      var n;
      !(function () {
          ...
          for (var e = [], t = 0; t < arguments.length; t++) {
            ...
            if (n) {
              ...
              if ('string' === o || 'number' === o) e.push(n);
                ...
                a && e.push(a);
              } else if ('object' === o) for (var r in n) s.call(n, r) && n[r] && e.push(r);
            }
          }
          return e.join(' ');
        }
    ...
    53885: (e, t, n) => {
      ...
      function r(e, t = 2, n) {
        return s(
          ...
          a()[e],
          n,
          0 === t || 1 === t ? s(i.skeletonTheme.wrapper, a().skeleton) : a().letter,
      ...
      function p(e) {
        ...
        return i
          ...
          : s.createElement(
              ...
              !B && x && s.createElement(c.Hint, { className: m.shortcut, text: x }),
        ...
        return s.createElement(
          Y,
          {
            ...
            onContextMenu: function (e) {
              q && Q && (0, o.trackEvent)(q.category, q.event, `${q.label}_rightClick`);
            },
            onMouseUp: function (e) {
              if (1 === e.button && M && q) {
                let e = q.label;
                G && (e += '_mouseWheelClick'), (0, o.trackEvent)(q.category, q.event, e);
              }
            },
            onMouseOver: W,
            onMouseOut: N,
          ...
          X &&
            s.createElement(r.CircleLogo, {
              ...
              size: 'xxxsmall',
              logoUrl: X.logoUrl,
              placeholderLetter: 'placeholderLetter' in X ? X.placeholderLetter : void 0,
            }),
          f &&
          ...
          void 0 !== A &&
            s.createElement(
              'span',
              {
                role: B,
                onClick: F ? d : void 0,
                className: i(g, L.toolbox, { [L.showOnHover]: k, [L.showOnFocus]: w }),
              },
              A,
            ),
        );
    ...
    20243: (e, t, n) => {
      ...
      function c(e) {
        ...
        switch ((0, s.mapKeyCodeToDirection)(t)) {
          case 'inlinePrev':
            if (!u.length) return;
            e.preventDefault(), b(0 === g ? a[c] : v ? d(u, g, -1) : u[u.length - 1]);
            break;
          case 'inlineNext':
            if (!u.length) return;
            e.preventDefault(), g === u.length - 1 ? b(a[c]) : b(v ? d(u, g, 1) : u[0]);
            break;
          case 'blockPrev': {
            e.preventDefault();
            const t = d(a, c, -1);
    ...
    68426: (e, t, n) => {
      ...
      var s = n(50959),
        ...
        C = n(85049);
      const x = e =>
          o.t(null, { plural: '{str} minutes', count: e, replace: { str: `${e}` } }, n(5926)),
        y = e => o.t(null, { plural: '{str} hours', count: e, replace: { str: `${e}` } }, n(64963)),
        E = e =>
          o.t(null, { plural: '{str} months', count: e, replace: { str: `${e}` } }, n(20062)),
        S = e => e,
        M = {
          ...
          [S('1D')]: {
            ...
            text:
              ((R = 1),
              o.t(null, { plural: '{str} days', count: R, replace: { str: `${R}` } }, n(62368))),
          },
          [S('1W')]: {
            resolution: '1W',
            text:
              ((w = 1),
              o.t(null, { plural: '{str} weeks', count: w, replace: { str: `${w}` } }, n(49306))),
          },
          ...
          [S('12M')]: {
            ...
            text:
              ((k = 1),
              o.t(null, { plural: '{str} years', count: k, replace: { str: `${k}` } }, n(91549))),
          },
        };
      var k, w, R;
      function T(e) {
        const t = (function (e) {
            ...
            if (!s.isValid()) {
              if ('YTD' === t) return o.t(null, { context: 'timeframe_title' }, n(19273));
              if ('ALL' === t) return o.t(null, { context: 'timeframe_title' }, n(58221));
        ...
        return o.t(
          null,
          { replace: { timePeriod: t, timeInterval: s }, context: 'timeframe_title' },
          n(58426),
        );
      }
      const A = e =>
        ...
        return (
          ((t = class extends s.PureComponent {
            constructor(e, t) {
              ...
              const n = (this._binding = (0, v.ensureDefined)(V.get(t.chartWidget)));
              this.state = n.state();
            }
            componentDidMount() {
      ...
      class ne extends s.PureComponent {
            ...
            (this._renderChildren = e => {
              ...
              return e
                ? s.createElement(
                    ...
                    i && s.createElement(Y, { onGoToDateClick: this._handleGoToDateClick }),
                  )
                : s.createElement(
                    s.Fragment,
                    null,
        ...
        render() {
          return s.createElement(m.MatchMedia, { rule: '(max-width: 440px)' }, e =>
            s.createElement(
              u.ToolbarMenuButton,
              {
      ...
      function ae(e) {
        return class extends s.PureComponent {
          ...
          render() {
            ...
            return s.createElement(
              'div',
              { className: r(t, ie.tabs), 'data-name': this.props['data-name'] },
              n,
              s.createElement(e, {
                reference: e => {
                  this._slider = e;
      ...
      ae(function (e) {
        return s.createElement('div', { className: ie.slider, ref: e.reference });
      });
      var re = n(40173),
        le = n(20792),
        ce = n(40337);
      ...
      class Fe extends s.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._timeFormatter = new we.TimeFormatter(
              (0, Ae.getHourMinuteSecondFormat)(Be.timeHoursFormatProperty.value()),
            )),
            ...
            (this._showMenu = e => {
              if (this._preventShowingMenu) return void De.ContextMenuManager.hideAll();
        ...
        updateTimezonesButton() {
          ...
          const t = (0, v.ensureNotNull)(e.model().model().timezoneExceptExchange().value());
      ...
      var Le = n(83580);
      function ze(e) {
        return s.createElement('span', { className: r(Le.separator, e.className) });
      }
      var Oe = n(6190),
        He = n(45126),
        Ie = n(49483);
      ...
      const Xe = (0, f.registryContextType)(),
        Ue = new He.TranslatedString('toggle log scale', o.t(null, void 0, n(49403)));
      const Ve = (0, f.registryContextType)(),
        Je = new He.TranslatedString('toggle auto scale', o.t(null, void 0, n(42240)));
      const qe = (0, f.registryContextType)(),
        Ge = new He.TranslatedString('toggle percentage scale', o.t(null, void 0, n(98994)));
      const Qe = (0, f.registryContextType)();
      var $e = n(42142),
        Ze = n(14729),
        Ke = n(3343),
        ...
        et = n(95700),
        tt = n(28580);
      const nt = new He.TranslatedString('change session', o.t(null, void 0, n(87041))),
        st = { hint: o.t(null, void 0, n(94031)), headerMenuText: o.t(null, void 0, n(27665)) },
      ...
      class at extends s.PureComponent {
        ...
        updateSessionButton() {
          ...
          this.setState({
            sessionId: n,
            sessionName: (0, et.translateSessionShortDescription)(i?.description || ''),
            sessionDescription: (0, et.translateSessionDescription)(i?.description || ''),
            availableSessions: s,
          });
        }
        _menuItems() {
          ...
          for (const o of t) {
            const t = { category: 'SetSession', event: o.id },
              a = () => {
                e.model().setProperty(n.properties().childs().sessionId, o.id, nt);
              };
            i.push(
              s.createElement(p.AccessibleMenuItem, {
                key: o.id,
            ...
            super(e, t),
              ...
              (this._handleSelect = () => {
                const e = this.context.chartWidget.model(),
                  ...
                  n = t.priceScale(),
                  s = n.mode();
                t.priceScale().isLockScale() || e.setPriceScaleMode({ log: !s.log }, n, Ue);
              }),
              (0, f.validateRegistry)(t, { chartWidget: a.any.isRequired }),
      ...
      const Ct = (0, ve.hotKeySerialize)({
        ...
        xt = (function (e) {
          ...
          s.createElement(le.ToolbarButton, {
            ...
            tooltip: e.isFullscreen ? ht.restoreChartHint : ht.maximizeChartHint,
            className: e.className,
      ...
      class Tt extends s.PureComponent {
          ...
          super(e, t),
            ...
            (this._updateButtonsVisibilityImp = e => {
              ...
              if (s.symbolResolvingActive().value())
                return void this._setStateWithResize({ intervalAllowsSessionButton: o }, e);
              const a = (i?.subsessions || []).filter(e => !e.private).length > 1;
              this._setStateWithResize(
                { intervalAllowsSessionButton: o, symbolAllowsSessionButton: a },
                e,
              );
            }),
            (this._resizeByRaf = () => {
            ...
            (this._resizeHandler = () => {
              ...
              if ((Object.assign(e, { dateRangeMode: u, noRanges: c }), 'expanded' !== u)) {
            ...
            s.createElement(
              ...
              n &&
                s.createElement(
                  ...
                  s.createElement(
                    'div',
                    { className: dt.inline, onClick: this._trackTimezonesButtonClick },
                    s.createElement(Fe, {
                      className: dt.item,
        ...
        _applyResizing() {
          ...
          this._rangeExpanded &&
            (this._rangeExpanded.classList.toggle(dt.collapsed, 'expanded' !== e),
            this._rangeExpanded.classList.toggle(dt.noranges, t)),
            this._rangeCollapsed &&
              this._rangeCollapsed.classList.toggle(dt.collapsed, 'collapsed' !== e);
          let s = !1,
            i = !1;
          Object.keys(n).forEach(e => {
            ...
            if ('separator' !== t) {
              const e = this._seriesComponents[t],
                o = !0 === n[t];
              e &&
                ('timeZones' === t || 'session' === t ? (s = s || !o) : (i = i || !o),
