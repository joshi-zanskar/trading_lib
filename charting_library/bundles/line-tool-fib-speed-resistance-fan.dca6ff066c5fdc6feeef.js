...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [906],
  {
    73174: (e, t, i) => {
      ...
      const u = -5e4,
        f = 15e3,
        _ = new o.TranslatedString('change price Y coordinate', r.t(null, void 0, i(11737))),
        g = new o.TranslatedString('change bar X coordinate', r.t(null, void 0, i(2066))),
      ...
      class _ extends s.DefaultProperty {
        ...
        state(e, t, i) {
          ...
          return i
            ...
            : ((r = n),
              (o = this._map),
              (0, this._levelsIterator)(r, { tpl: h, fill: c, typecheck: o.typecheck.pack }, o));
          var r, o;
        }
        preferences() {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, s.extractState)(
              (0, r.default)((0, n.default)(t), f(e, this._map, this._levelsIterator)),
              this._allStateKeys,
        ...
        merge(e, t) {
          return super.merge(this._map ? f(e, this._map, this._levelsIterator) : e, t);
        }
        _options() {
          return {
            ...super._options(),
    ...
    2662: (e, t, i) => {
      ...
      const f = new o.TranslatedString(
        ...
        v = new o.TranslatedString('change {title} all lines color', r.t(null, void 0, i(59577))),
        ...
        w = new o.TranslatedString('change {title} reverse', r.t(null, void 0, i(50762))),
        S = new o.TranslatedString('change {title} grid visibility', r.t(null, void 0, i(20664))),
        L = new o.TranslatedString('change {title} grid line color', r.t(null, void 0, i(36467))),
        A = new o.TranslatedString('change {title} grid line width', r.t(null, void 0, i(30127))),
        R = new o.TranslatedString('change {title} grid line style', r.t(null, void 0, i(54244))),
      ...
      class B extends h.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const c = (0, d.createPropertyDefinitionsLeveledLinesGroup)(l, `${r}HLeveledLinesGroup`),
            ...
            $ = (0, d.createPropertyDefinitionsGeneralGroup)([c, h, B], `${r}HLevelGroup`, k);
          e.push($);
          const z = [],
          ...
          const Y = (0, d.createPropertyDefinitionsLeveledLinesGroup)(z, `${r}VLeveledLinesGroup`),
            ...
            G = (0, d.createPropertyDefinitionsGeneralGroup)([Y, O, X], `${r}VLevelGroup`, I);
          e.push(G);
      ...
      class J extends j.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          for (let e = 1; e <= this._source.hLevelsCount(); e++) {
            const r = 'hlevel' + e,
              o = (0, n.ensureDefined)(this._source.properties().child(r)).childs();
          ...
          for (let e = 0; e < a.length; e++) {
            ...
            if (s.showLeftLabels.value()) {
              ...
              this._leftTextRenderers[e].setData(i), f.append(this._leftTextRenderers[e]);
            }
            if (s.showRightLabels.value()) {
              ...
              this._rightTextRenderers[e].setData(t), f.append(this._rightTextRenderers[e]);
            }
          }
          for (let e = 0; e < h.length; e++) {
            ...
            if (s.showTopLabels.value()) {
              ...
              this._topTextRenderers[e].setData(i), f.append(this._topTextRenderers[e]);
            }
            if (s.showBottomLabels.value()) {
              ...
              this._bottomTextRenderers[e].setData(t), f.append(this._bottomTextRenderers[e]);
            }
          }
          ...
          for (let e = 0; e < h.length; e++) {
            ...
            }
            {
              ...
              n.setHitTest(new O.HitTestResult(O.HitTarget.MovePoint, void 0, r)), f.append(n);
            }
          }
          this.addAnchors(f), (this._renderer = f);
        }
      }
      const Q = new o.TranslatedString('erase level line', r.t(null, void 0, i(77114)));
      var Z;
      !(function (e) {
        (e[(e.HLevelsCount = 7)] = 'HLevelsCount'), (e[(e.VLevelsCount = 7)] = 'VLevelsCount');
      })(Z || (Z = {}));
      class ee extends s.LineDataSource {
        constructor(e, t, i, n) {
          super(e, t ?? ee.createProperties(e.backgroundTheme().spawnOwnership()), i, n),
        ...
        processErase(e, t) {
          const i = `${t.type}level${t.index}`,
            r = (0, n.ensureDefined)(this.properties().child(i)).childs().visible;
        ...
        static createProperties(e, t) {
          ...
          const i = new l.LevelsProperty({
            ...
            state: t,
            map: { range: [1, 7], prefixes: ['h', 'v'], names: ['coeff', 'color', 'visible'] },
            theme: e,
          });
      ...
      class _ {
        ...
        addAnchors(e, t = {}) {
          ...
          const n = this._source.points(),
            r = i.map((e, t) => {
              ...
              return i && ((r.snappingPrice = i.price), (r.snappingIndex = i.index)), r;
            });
        ...
        createLineAnchor(e, t) {
          ...
          const n = (0, o.lastMouseOrTouchEventInfo)().isTouch,
            ...
            l = this.isHoveredSource() ? (this._model.lastHittestData()?.pointIndex ?? null) : null;
          return (
            r.setData({
              ...e,
              ...
              selectedStrokeWidth: n ? p.TouchSelectedStrokeWidth : p.RegularSelectedStrokeWidth,
              visible: this.areAnchorsVisible(),
      ...
      class h extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (null !== i) {
            ...
            (t.fillStyle = (0, c.generateColor)(this._data.color, this._data.transparency, !0)),
              t.fill();
          }
        }
        _visiblePolygon(e) {
    ...
    36036: (e, t, i) => {
      ...
      class v extends h.BitmapCoordinatesPaneRenderer {
        ...
        doesIntersectWithBox(e) {
          return null !== this._data && this._data.points.some(t => (0, r.pointInBox)(t.point, e));
        }
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, i, f, u), n.length && this._drawPoints(e, n, r, g, _);
        }
          ...
          for (let e = 0; e < t.length; ++e) {
            ...
            if (!((0, l.isInteger)(o.pointIndex) && h.linePointBeingEdited === o.pointIndex)) {
              ...
              if (
                ...
                if (null !== h.hoveredPointIndex && o.pointIndex === h.hoveredPointIndex) {
