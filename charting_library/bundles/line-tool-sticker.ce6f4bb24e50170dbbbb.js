  ...
  [8949],
  {
    ...
    86915: (e, t, i) => {
      ...
      var s = i(928),
        ...
        h = i(32679),
        d = i(6590);
      const g = { intervalsVisibilities: { ...u.intervalsVisibilitiesDefaults }, size: 110 },
      ...
      class S extends r.LineToolSvgIconBase {
        ...
        async _loadViews() {
          const [{ getSvgContentForSticker: e, getSvgRenderer: t }, { StickerPaneView: s }] =
            await Promise.all([
              i.e(5598).then(i.bind(i, 47992)),
              Promise.all([i.e(6290), i.e(9116), i.e(1200), i.e(1583)]).then(i.bind(i, 44386)),
            ]);
          if (!this._isDestroyed) {
            const i = this._properties.childs().sticker.value();
            (this._svgContent = e(i)), this._onIconChanged.fire();
            const r = t(n.svgRenderer, i);
            null === r && y.logWarn(`Couldn't create svg renderer for sticker ${i}`),
    ...
    22329: (e, t, i) => {
      ...
      class u extends l.LineDataSource {
        ...
        startChanging(e, t) {
          const i = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[0])),
