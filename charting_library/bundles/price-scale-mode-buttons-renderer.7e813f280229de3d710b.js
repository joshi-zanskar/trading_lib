  ...
  [3555],
  {
          ...
          for (var t = [], e = 0; e < arguments.length; e++) {
            ...
            if (o) {
              ...
              if ('string' === a || 'number' === a) t.push(o);
                ...
                i && t.push(i);
              } else if ('object' === a) for (var c in o) r.call(o, c) && o[c] && t.push(c);
            }
          }
          return t.join(' ');
        }
    ...
    32262: t => {
      t.exports = {
        ...
        priceScaleModeButton_activated: 'priceScaleModeButton_activated-okRV4Kjm',
      };
    },
    87896: (t, e, o) => {
      'use strict';
      ...
      var c = o(84015),
        l = o(63273);
      const s = { iOs: 'old', android: 'new', old: 'old', new: 'new', any: 'any' };
      function d(t) {
    ...
    87615: t => {
      t.exports = {
        ...
        priceScaleModeButtons__buttonWrapper: 'priceScaleModeButtons__buttonWrapper-PEm49B2T',
    ...
    49976: (t, e, o) => {
      ...
      var r = o(50959),
        ...
        s = o(32262);
      function d(t) {
        const { activated: e, onClick: o, content: n, tooltip: a, ariaLabel: i, className: c } = t;
      ...
      class p {
        constructor({ setMode: t, getMode: e, className: o = '' }) {
          ...
          r.classList.add(o),
            r.addEventListener('dblclick', this._stopPropagation, { capture: !0 }),
            r.addEventListener('touchstart', this._stopPropagation, { capture: !0 }),
            this._render();
        }
        destroy() {
          this._reactRoot?.unmount(),
            this._wrapper.removeEventListener('dblclick', this._stopPropagation),
            this._wrapper.removeEventListener('touchstart', this._stopPropagation),
        ...
        _render() {
          const t = a.CheckMobile.any(),
            ...
            l = r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(d, {
                  activated: e,
                  content: n.t(null, { context: 'The first letter of the "auto" word' }, o(94073)),
          ...
          this._reactRoot
            ...
            : (this._reactRoot = (0, i.createReactRoot)(l, this._wrapper, 'modern'));
        }
        _stopPropagation(t) {
          t.stopPropagation();
        }
