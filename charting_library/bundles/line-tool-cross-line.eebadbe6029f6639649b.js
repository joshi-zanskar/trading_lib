  ...
  [7203],
  {
    92007: (e, i, r) => {
      ...
      class l extends o.LineDataSource {
        constructor(e, i, t, o) {
          super(e, i ?? l.createProperties(e.backgroundTheme().spawnOwnership()), t, o),
        ...
        static createProperties(e, i) {
          const r = new t.DefaultProperty({ defaultName: 'linetoolcrossline', state: i, theme: e });
          return this._configureProperties(r), r;
        }
        _normalizePoint(e, i) {
          return super._normalizePointWithoutOffset(e) ?? super._normalizePoint(e, i);
        }
        _getPropertyDefinitionsViewModelClass() {
          return Promise.all([r.e(6406), r.e(3889), r.e(8009), r.e(8056), r.e(8537)])
            .then(r.bind(r, 9805))
    ...
    36590: (e, i, r) => {
      ...
      class n extends t.PriceAxisView {
        ...
        _updateRendererData(e, i, r) {
          ...
          if (null === u) return;
          const c = (0, s.resetTransparency)(this._source.properties().linecolor.value());
          (r.background = c),
