  ...
  [9418],
  {
    ...
    64388: (e, t, i) => {
      ...
      function l(e) {
        ...
        return s.createElement(
          ...
          s.createElement(o.Icon, { icon: i, className: r.icon, 'aria-hidden': !0 }),
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            s.createElement(
              ...
              s.createElement('div', { className: r()(o ? w.textWrap : w.ellipsis) }, n),
              a && s.createElement('div', { className: r()(w.ellipsis, w.subtitle) }, a),
            ),
            u,
            l &&
              !b &&
      ...
      class M extends s.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._embedResizerOverridesEnabled = S.enabled('embed_resizer_overrides')),
              ...
              if (!e.defaultPrevented) {
                if (
                  ...
                  if (null !== i) {
                    ...
                    if (null !== s && (0, c.isTextEditingField)(i)) return void s.focus();
                    if (s?.contains(i))
                      return (
                        this.props.onKeyboardClose && this.props.onKeyboardClose(),
                        void this._handleClose()
                ...
                (function (e) {
                  ...
                  ((i = e),
                  [9, a.Modifiers.Shift + 9].includes((0, a.hashFromEvent)(i)) &&
                    i.stopPropagation());
              }
            }),
            (this._requestResize = () => {
            ...
            (this._calculatePositionWithOffsets = (e, t) => {
              const i = (0, n.ensureDefined)(this.props.fullScreenViewOffsets).value();
              return {
                top: i.top,
        ...
        componentDidMount() {
          this.props.ignoreClosePopupsAndDialog ||
            _.subscribe(m.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
          ...
          const { backdrop: e, draggable: t = !e, centerOnResize: i = !t } = this.props;
          i && window.addEventListener('resize', this._centerAndFit);
        }
        componentWillUnmount() {
          this.props.ignoreClosePopupsAndDialog ||
            _.unsubscribe(m.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
        ...
        render() {
          ...
          return s.createElement(p.MatchMedia, { rule: u.DialogBreakpoints.SmallHeight }, m =>
            s.createElement(p.MatchMedia, { rule: u.DialogBreakpoints.TabletSmall }, u =>
              s.createElement(
                d.PopupDialog,
                {
                  rounded: !(u || k) && B,
                  ...
                  containerAriaLabel: H,
                  containerTabIndex: K,
                  calculateDialogPosition: k && U ? this._calculatePositionWithOffsets : void 0,
                  shadowed: q,
                  fixedBody: Y,
                  onClick: G,
                  ...j,
                ...
                s.createElement(
                  ...
                  {
                    role: 'dialog',
                    'aria-labelledby': void 0 !== o ? this._titleId : void 0,
                  ...
                  D && s.createElement(h.Separator, { className: C.separator }),
    ...
    82206: (e, t, i) => {
      ...
      class d extends s.PureComponent {
        ...
        render() {
          const {
            ...
            u = n(a, c.dialog, e && c.rounded, t && c.shadowed, i && c.fullscreen, o && c.darker),
        ...
        _createStyles() {
          ...
          return { bottom: e, left: t, right: s, top: n, zIndex: o, maxWidth: i, height: r };
        }
      }
      var h,
        u = i(86431),
      ...
      const B = class {
        ...
        updateOptions(e) {
          (this._guard = e.guard || x), (this._calculateDialogPosition = e.calculateDialogPosition);
        }
        setFullscreen(e) {
      ...
      class N extends s.PureComponent {
        ...
        componentDidMount() {
          ...
          if ((this._eventDispatcher.dispatch('dialog-open'), e)) {
            ...
            if (e && e instanceof HTMLElement) {
              const n = new w(s, e, { boundByScreen: Boolean(t), onDragStart: i });
        ...
        _moveToTop() {
          this.props.isZIndexFixed || (null !== this.context && this.context.moveToTop());
        }
    ...
    1109: (e, t, i) => {
      ...
      var s = i(50959),
        ...
        o = i(36204);
      function r(e) {
        return s.createElement('div', { className: n(o.separator, e.className) });
      }
    },
    86431: (e, t, i) => {
      'use strict';
      ...
      function o(e, t) {
        return class extends s.PureComponent {
          render() {
            ...
            return 'parent' === o ? r : s.createElement(n.Portal, { shouldTrapFocus: t }, r);
          }
        };
      }
    },
