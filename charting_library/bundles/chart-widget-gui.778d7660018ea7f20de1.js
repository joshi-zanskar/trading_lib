  ...
  [5093],
  {
    ...
    53885: (e, t, s) => {
      ...
      function n(e, t = 2, s) {
        return i(
          ...
          a()[e],
          s,
          0 === t || 1 === t ? i(l.skeletonTheme.wrapper, a().skeleton) : a().letter,
          1 === t && l.skeletonTheme.animated,
        );
      }
      function r(e) {
        return (
          'logoUrl' in e && null !== e.logoUrl && void 0 !== e.logoUrl && 0 !== e.logoUrl.length
        );
      }
    },
    26996: (e, t, s) => {
      ...
      var i,
        ...
        n = s.n(a);
      function r(e) {
        const { className: t, size: s = 'medium', staticPosition: i, color: a = 'black' } = e,
          r = o(n().item, n()[a], n()[s]);
    ...
    37850: e => {
      e.exports = {
        ...
        statusesWrapper__statusesWithToggle: 'statusesWrapper__statusesWithToggle-l31H9iuA',
    ...
    22136: (e, t, s) => {
      ...
      const L = (0, p.humanReadableModifiers)(p.Modifiers.Alt, !1),
        ...
        D = (0, c.hotKeySerialize)({ keys: [L, W, C], text: '{0} + {1} + {2}' }),
      ...
      class X {
          ...
          (this._widget = (0, i.ensureNotNull)(
            ...
            (this._onVisibilityTypeChange = e => {
              'alwaysOn' === e || 'alwaysOff' === e
                ...
                : ((this._controlBarVisible = !1),
                  this._parent.addEventListener('mousemove', this._controlsBarVisibilityHandler),
                  this._parent.addEventListener('mouseleave', this._controlsBarVisibilityHandler)),
                this._configureBackButtonVisibility(e),
                this._updateControlBarVisibility();
            }),
            (this._visibilityBackButtonHandler = e => {
              const t = this._checkIsPointerNearBox(e, this._back.getBoundingClientRect());
              void 0 !== t &&
                this._backButtonCanBeVisible !== t &&
                ((this._backButtonCanBeVisible = t), this._setRAF());
            }),
            (this._controlsBarVisibilityHandler = e => {
              const t = this._checkIsPointerNearBox(e, this._controlBar.getBoundingClientRect());
              void 0 !== t &&
          ...
          (this._buttons = {
            ...
            this._chart.withModel(this, () => {
              ...
              e.fullscreenable.subscribe(this._boundUpdateMaximizeButtonsVisibility),
                ...
                this._back.querySelector('.control-bar__btn')?.addEventListener('click', () => {
        ...
        _checkBackButtonVisibility() {
          ...
          const e = this._backButtonCanBeVisible && this._chartModel.timeScale().rightOffset() < 0;
        ...
        _initVisibility() {
          (this._visibilityTypeProperty = (0, n.combine)(
            ...
            this._visibilityTypeProperty.subscribe(this._onVisibilityTypeChange, {
              callWithLast: !0,
            });
        }
        _configureBackButtonVisibility(e) {
          'alwaysOff' === e
            ? (clearInterval(this._checkIntervalId), (this._checkIntervalId = void 0))
            : (this._checkIntervalId =
                this._checkIntervalId ?? setInterval(() => this._checkBackButtonVisibility(), 1e3)),
            _.CheckMobile.any()
              ...
              : 'alwaysOn' === e || 'alwaysOff' === e
                ...
                : ((this._backButtonCanBeVisible = !1),
                  this._parent.addEventListener('mousemove', this._visibilityBackButtonHandler),
                  this._parent.addEventListener('mouseleave', this._visibilityBackButtonHandler)),
            this._checkBackButtonVisibility();
        }
        _checkIsPointerNearBox(e, t) {
          if (!(e.buttons || (null !== this._chartModel && this._chartModel.lineBeingCreated()))) {
            if ('mousemove' === e.type) {
              const s =
                100 - (this._targetPaneWidget ? this._bottomMargin(this._targetPaneWidget) : 0);
              return (
        ...
        _setRAF() {
          null === this._rafId &&
            (this._rafId = this._widget.ownerDocument.defaultView.requestAnimationFrame(() => {
              this._checkBackButtonVisibility(),
                this._updateControlBarVisibility(),
                (this._rafId = null);
            }));
    ...
    60786: (e, t, s) => {
      ...
      class D {
        constructor(e, t, s) {
          (this._el = null),
            ...
            (this._updateLoadingState = (e = this._loading.value()) => {
              if (null !== this._el) {
                this._el.classList.toggle(k.eyeLoading, e && !this._disabled.value()),
                  I(this._el, e);
              }
          ...
          (this._withActions = s.withActions),
            ...
            (this._loader = W((0, o.ensureNotNull)(this._valuesParentEl), { className: k.loader })),
        ...
        accessibleButtons() {
          return this._isRowHidden.value()
            ? []
            : this._accessibleButtons.filter(e => !e.classList.contains(L.blockHidden));
        }
        showActions() {
          null === this._el || this._el.classList.contains(k.withAction) || this._showActions();
        }
        hideActions() {
          null !== this._el && this._el.classList.contains(k.withAction) && this._hideActions();
        }
        ...
        _renderTitles() {
          ...
          for (let e = 0; e < this._titlesSpawns.length; e++) {
            const { wrapper: t, title: s } = this._renderTitle(this._titlesSpawns[e]);
        ...
        _renderTitle(e) {
          ...
          r.classList.add(k.titleWrapper, t, k.withDot),
            (r.dataset.name = i),
            void 0 !== l && (r.classList.add('apply-common-tooltip'), r.setAttribute('title', l));
          ...
          return (
            n.length > 0
              ...
              : (r.classList.add(L.blockHidden), d.classList.add(L.blockHidden)),
            r.appendChild(d),
            { wrapper: r, title: d }
          );
        }
        ...
        _initWrappersIfNotInitialized() {
          return (
            null === this._valuesParentEl &&
              ...
              this._valuesAdditionalWrapperEl.classList.add(k.valuesAdditionalWrapper),
        ...
        _updateValueVisibleHandler(e, t) {
          const s = (0, o.ensure)(this._valuesElements[e].value).closest(`.${k.valueItem}`);
          null !== s && s.classList.toggle(L.blockHidden, !t), this._updateShowValues();
        }
        _updateShowLine() {
          null !== this._el && this._el.classList.toggle(L.blockHidden, this._isRowHidden.value());
        }
        _createValuesSpawns() {
        ...
        _updateShowValues() {
          function e(e) {
            if (!e) return;
            const t = Array.from(e.children).every(e => e.classList.contains(L.blockHidden));
        ...
        _addStatusesWidget(e, t, s) {
          (this._statusesWrapper = document.createElement('div')),
            ...
            this._hideInvisibleHover.subscribe(this._updateHideInvisibleHoverMode.bind(this), {
              callWithLast: !0,
            }),
            (this._hideValues = s),
        ...
        _updateAllButtonsWidth() {
          (this._allButtonsWidth = this._getButtonsCount() * y + 1), this._updateTitleMaxWidth();
        }
        _updateHideInvisibleHoverMode(e) {
          null !== this._el && this._el.classList.toggle(k.hideInvisibleHover, e);
        }
        ...
        _showActions() {
          ...
          const e = this._valuesParentEl?.offsetTop === this._titlesWrapperEl?.offsetTop;
        ...
        _hideActions() {
          null !== this._el &&
            ...
            null !== this._valuesParentEl && this._valuesParentEl.classList.remove(k.withTail),
            this._updateTitleMaxWidth());
        }
        ...
        _updateDisabledOnIntervalState() {
          this._el?.classList.toggle(k.disabledOnInterval, this._disabledOnInterval.value());
        }
        ...
        _updateShowTitles() {
          null !== this._titlesWrapperEl &&
            (this._titlesWrapperEl.classList.toggle(L.blockHidden, this._isTitleHidden.value()),
            null !== this._actionsParentEl &&
              this._actionsParentEl.classList.toggle(L.blockHidden, this._isTitleHidden.value()));
        }
        _updateValues() {
          this._removeValuesSpawnsSubscriptions(),
            this._createValuesSpawns(),
        ...
        _updateActionVisibilities(e) {
          null !== this._actionsParentEl &&
            this._actionsParentEl
              ...
              [e].classList.toggle(L.blockHidden, !this._actionsSpawnArray[e].visible.value());
        }
        _updateActionTitle(e) {
          ...
          s.setAttribute('title', t.value()),
            s.hasAttribute('aria-label') && s.setAttribute('aria-label', t.value()),
        ...
        _updateCustomTextColor() {
          ...
          const t = (0, o.ensureNotNull)(this._valuesParentEl).querySelectorAll(`.${k.valueTitle}`);
          for (let s = 0; s < t.length; s++) t[s].style.color = e;
          (0, o.ensureNotNull)(this._el).classList.toggle(k.withCustomTextColor, Boolean(e));
        }
      ...
      class Z {
        constructor(e, t) {
          (this._lastDrawnLogos = []),
            ...
            (this._updateLogoVisibility = e => {
              this._logoWrapper && this._logoWrapper.classList.toggle(k.hidden, !e);
            }),
            (this._updateSymbolLogo = async e => {
              ...
              const t = await ((s = e),
              Promise.all(
                s.map(e => (0, U.getImage)(`symbol_logo_${e}`, e, $).then(e => e.cloneNode())),
              )).catch(() => []);
              var s;
              switch (t.length) {
                case 0:
                  this._pairContainer?.classList.add(k.hidden),
                    ...
                    this._symbolLetterContainer?.classList.remove(G.hiddenCircleLogoClass),
                    (this._lastDrawnLogos = e);
                  break;
                case 1:
                  j(this._logoContainer, t[0]),
                    this._pairContainer?.classList.add(k.hidden),
                    this._logoContainer?.classList.remove(G.hiddenCircleLogoClass),
                    this._symbolLetterContainer?.classList.add(G.hiddenCircleLogoClass),
                    (this._lastDrawnLogos = e);
                  break;
                case 2:
        ...
        _renderSymbolLogo() {
          if (!this._logoWrapper) {
            ...
            (this._secondaryLogo = s.appendChild(document.createElement('span'))).className = N()(
              (0, R.getLogoStyleClasses)('xxxsmall'),
              k.logo,
            );
            (this._primaryLogo = s.appendChild(document.createElement('span'))).className = N()(
              (0, R.getLogoStyleClasses)('xxxsmall'),
              k.logo,
            );
            (this._logoContainer = e.appendChild(document.createElement('span'))).className = N()(
      ...
      class K extends D {
        constructor(e, t, s) {
          super(e, t, s),
            ...
            s.statusWidgetEl &&
              this._addStatusesWidget(s.statusWidgetEl, s.hideInvisibleHover, s.hideValues),
            this._selected.subscribe(this._updateTitleMaxWidth.bind(this)),
            s.withActions &&
              ((this._wheelClickHandler = this._onWheelClicked.bind(this)),
              null !== this._titlesWrapperEl &&
                this._titlesWrapperEl.addEventListener(Q, this._wheelClickHandler));
        ...
        destroy() {
          this._model.symbolLogoViewModel().unsubscribe(this._updateSymbolLogoRenderer),
            ...
            null !== this._wheelClickHandler &&
              null !== this._titlesWrapperEl &&
              this._titlesWrapperEl.removeEventListener(Q, this._wheelClickHandler),
            super.destroy();
        }
        accessibleButtons() {
        ...
        _updateActionsVisibilitiesByMode() {
          ...
          if (2 === this._rowMode || 1 === this._rowMode)
            e[0].visible.value() && t.push(this._actionElements[0]),
              ...
              (s = this._actionElements.slice(1, this._actionElements.length - 1));
          else
        ...
        _updateShowLine() {
          ...
          e ? this._el.classList.toggle(L.blockHidden, e) : super._updateShowLine();
        }
        _getButtonsCount() {
        ...
        _renderValues() {
          ...
          for (const s of t) {
            ...
            t.classList.add(k.valueItem), t.classList.toggle(L.blockHidden, !s.visible.value());
        ...
        _update5ButtonsStyles(e) {
          null !== this._el &&
            (this._el.classList.toggle(k.has5Buttons, e), this._updateAllButtonsWidth());
        }
        _onWheelClicked(e) {
      ...
      class q extends D {
        constructor(e, t, s) {
          ...
          const i = e.symbolLogoViewModel().value();
          i &&
            (this._symbolLogoRenderer = new Z(i, (0, o.ensureNotNull)(this._titleContainers[0])));
        }
        destroy() {
          super.destroy(), this._flagged?.destroy(), this._symbolLogoRenderer?.destroy();
        }
        getHeight() {
        ...
        _hideTitleAndItsContainerIfRequired(e) {
          ...
          i?.classList.toggle(L.blockHidden, o), l?.classList.toggle(L.blockHidden, o);
        }
        _getButtonsCount() {
        ...
        _updateValuesTitleHTMLElHandler(e, t = '') {
          ...
          p(s, t), s.classList.toggle(L.blockHidden, 0 === t.length), this._updateShowValues();
        }
        _isWidthButtonsMode() {
          return (
            null !== this._el &&
      ...
      class ae {
        constructor(e, t, s) {
          (this._wrapperTogger = null),
            ...
            (this._showCollapserWithOneIndicator = s.showCollapserWithOneIndicator.spawn()),
            this._showCollapserWithOneIndicator.subscribe(this._updateVisibility.bind(this)),
            ...
            this._isMainPane.subscribe(this._updateObjectTreeVisibility.bind(this)),
            (this._isPaneCollapsed = s.isPaneCollapsed.spawn()),
            this._isPaneCollapsed.subscribe(this._updateVisibility.bind(this)),
            (this._combinedStatusWidgetEl = s.combinedStatusWidget.getElement()),
            (this._combinedStatusWidgetVisibility = s.combinedStatusWidget.visibility().spawn()),
            this._combinedStatusWidgetVisibility.subscribe(this._updateVisibility.bind(this)),
            this._render(),
            this._updateState(),
            ...
            (this._toggleStateHandler = e => {
              null !== this._el &&
                ...
                1 !== this._mode ? s.onCollapseDataSources() : s.onShowObjectsTreeDialog());
            }),
            null !== this._el &&
        ...
        accessibleButtons() {
          return null === this._el ||
            (this._el.classList.contains(k.onlyOneSourceShown) && 1 !== this._mode)
            ? []
            : this._accessibleButtons;
        }
        setMode(e) {
        ...
        _render() {
          ...
          e.addEventListener('roving-tabindex:main-element', t),
            ...
            (this._objectTreeEl.innerHTML = b.trackingModeIsAvailable ? oe : le),
          ...
          s.classList.add(k.statusesWrapper),
            this._combinedStatusWidgetEl.classList.add(k.statusesWrapper__statusesWithToggle),
        ...
        _updateVisibility() {
          const e = this._sourceCount.value(),
            ...
            s =
              ...
              (this._isStateOpen.value() || !this._combinedStatusWidgetVisibility.value()),
            i =
              e < 1 ||
          ...
          t.classList.toggle(L.blockHidden, !!i),
            ...
            (0, o.ensureNotNull)(this._wrapperTogger).classList.toggle(L.blockHidden, s),
        ...
        _tooltip() {
          ...
          const e = this._sourceCount.value(),
            t = J.t(null, { plural: 'Hide indicators legend', count: e }, s(46960)),
            i = J.t(null, { plural: 'Show indicators legend', count: e }, s(36553));
        ...
        _updateObjectTreeVisibility(e) {
          (0, o.ensureNotNull)(this._el).classList.toggle(k.objectsTreeCanBeShown, e);
        }
      }
      !(function (e) {
      ...
      class de {
          ...
          (this._mode = 4),
            ...
            (this._toggleHiddenActions = e => {
              this._toggleHiddenActionsTimoutID &&
                ...
                (this._toggleHiddenActionsTimoutID = null)),
                e
                  ? this._parentEl.classList.toggle(k.legend_withHiddenActions, e)
            ...
            (this._collapsedDataSourcesStatusWidgetElement = e.combinedStatusWidget.getElement()),
            ...
            this._parentEl.classList.toggle(k.noWrap, !b.trackingModeIsAvailable),
            this._parentEl.classList.toggle(k.noActions, !this._options.withActions),
            this._parentEl.classList.toggle(k.touchMode, b.trackingModeIsAvailable),
            this._parentEl.classList.toggle(k.wrappable, !this._hideAllExceptFirstLine.value()),
            (this._parentEl.dataset.name = 'legend'),
            this._parentEl.setAttribute('data-tooltip-show-on-focus', 'true'),
            this._parentEl.style.setProperty('--legend-source-item-button-width', `${y}px`);
          const s = t => {
        ...
        destroy() {
          ...
          let t = -1;
          if (de._wasKeyboardNavigationActivated && e instanceof HTMLButtonElement) {
        ...
        updateMode(e) {
          const t = ne && e < 133 ? 1 : e < 205 ? 2 : e < 222 ? 3 : 4,
            s = e < 192 ? 1 : e < 442 ? 2 : 3;
          (this._mode = t),
            null !== this._mainDataSourceRenderer && this._mainDataSourceRenderer.updateMode(t, s);
          ...
          const i = !this._hideAllExceptFirstLine.value() && (b.trackingModeIsAvailable || e < 542);
        ...
        _renderToggle(e) {
          this._options.showToggleButton &&
            (this._renderToggler = new ae(e, this._options.themedColor, this._togglerOptions));
        }
        _onIsDataSourcesCollapsed(e) {
          ...
          if (
            0 !==
            (this._mainDataSourceRenderer?.accessibleButtons() || []).filter(e => e.tabIndex >= 0)
              .length
          )
            return;
          const t = [];
          this._dataSourceRenderers.forEach(e => t.push(...e.accessibleButtons()));
        ...
        _updateCollapsedSourcesCount(e) {
          if (null === this._collapsedDataSourcesWrapperEl || null === this._collapsedDataSourcesEl)
            return;
          const t = 0 === e;
          this._collapsedDataSourcesWrapperEl.classList.toggle(L.blockHidden, t),
            t ||
        ...
        _updateLegendVisibility() {
          ...
          if (
            (this._parentEl.classList.toggle(L.blockHidden, this._isAllLegendHidden.value()),
            null !== this._dataSourcesEl &&
        ...
        _setCustomBg() {
          ...
          if (e) {
            ...
            i = (0, d.rgbaToString)([e, l, o, (0, d.normalizeAlphaComponent)(1 - s / 100)]);
          }
        ...
        _onLayoutChanged(e) {
          ...
          let a = -1,
            n = -1;
          const r = null === this._mainDataSourceRenderer && 0 === this._dataSourceRenderers.length;
          if (de._wasKeyboardNavigationActivated && o instanceof HTMLButtonElement) {
            const e = this._getRowRenderers(),
              l = e.find(e => e.accessibleButtons().includes(o));
            if (void 0 !== l) {
              const r = l === this._mainDataSourceRenderer && null === t,
                d = l instanceof K && s.includes(this._dataSourceRenderers.indexOf(l));
              if (r || d) {
                a = e.indexOf(l);
                const r = (0, g.queryTabbableElements)(document.body).indexOf(o);
                n =
                  0 !== i.length ||
                  ((void 0 !== t || null !== this._mainDataSourceRenderer) && null !== t) ||
          ...
          if (
            (l.forEach(e => {
              d.push({ renderer: this._dataSourceRenderers[e.oldIndex], newIndex: e.newIndex });
            }),
          ...
          if (null !== a) {
            ...
            void 0 !== e
              ...
              : ((e = this._dataSourceRenderers[s - 1]),
                void 0 !== e &&
                  i.insertBefore(a, (0, o.ensureNotNull)(e.getElement()).nextSibling));
          }
          this._dataSourceRenderers.splice(s, 0, l), this._updateLegendVisibility();
        }
        _moveDataSource(e, t) {
          ...
          void 0 !== a
            ...
            : ((a = this._dataSourceRenderers[t - 1]),
              void 0 !== a && i.insertBefore(l, (0, o.ensureNotNull)(a.getElement()).nextSibling)),
        ...
        _handleKeyDown(e) {
          ...
          switch (n) {
            case 'inlinePrev':
              e.preventDefault(), this._changeFocusElement(0 !== o ? l[o - 1] : l[l.length - 1], i);
              break;
            case 'inlineNext':
              e.preventDefault(), this._changeFocusElement(o !== l.length - 1 ? l[o + 1] : l[0], i);
              break;
            case 'blockPrev':
            case 'blockNext':
              a(n);
        ...
        _changeFocusElement(e, t) {
          document.activeElement && (0, m.becomeSecondaryElement)(document.activeElement),
        ...
        _getRowRendererByChild(e) {
          return this._getRowRenderers().find(t => t.accessibleButtons().includes(e)) ?? null;
        }
      }
      ...
      const fe = new ve.TranslatedString('show {title}', J.t(null, void 0, s(51382))),
        Ce = new ve.TranslatedString('hide {title}', J.t(null, void 0, s(13017))),
      ...
      class Le {
        ...
        _calcNewPosition(e) {
          ...
          if (Me(e) && e.touches.length > 0)
            ...
            t = { clientX: (0, we.isRtl)() ? s.right : s.left, clientY: s.top + s.height + 3 };
          } else {
            const s = e;
        ...
        constructor(e, t) {
          (this._symbolLogoUrls = new n.WatchedValue([])),
            ...
            (this._logoDataUpdated = () => {
              ...
              t && e && He.set(e, t);
              const s = He.get(e);
              (this._quoteDataForLogos = (0, r.merge)(s ?? {}, this._logoData.value() ?? {})),
                this._symbolLogoUrls.setValue(
                  (0, We.removeUsdFromCryptoPairLogos)(
                    (0, We.resolveLogoUrls)(this._quoteDataForLogos, Ae.LogoSize.Medium),
                  ),
                );
            }),
            (this._logoModel = e),
      ...
      class Re {
        ...
        async _onSourceSymbolChange() {
          ...
          try {
            ...
            this.symbol() === e &&
              (null === t ? this._logoData.setValue(null, !0) : this._logoData.setValue(Ne(t)));
          }
        }
      ...
      class Ye extends Le {
        constructor(e, t, s, i, l) {
          ...
          this._symbolLogoViewModel.setValue(Ie(new Re(t), o)),
            ...
            (this._isPriceSourceHidden = (0, ce.createWVFromGetterAndSubscription)(
            ...
            this._valuesVisibleProperty.subscribe(null, () => {
              this.update(), this._isValuesHidden.setValue(this._getValuesHiddenValue());
            }),
            this.update(),
        ...
        _updateTitles() {
          ...
          this._titles.title.setValue((0, he.clean)(e.title, !0)),
            ...
            this._titles.priceSource.setValue(
              (0, he.clean)(this._isPriceSourceHidden.value() ? '' : e.priceSource, !0),
            );
        }
        _updateValues() {
        ...
        _initializeTitleActions() {
          ...
          const e = async () => {
            ...
            (0, me.showDialog)({
              defaultValue: o,
              enableOptionsChain: c.enabled('symbol_search_option_chain_selector'),
            });
          };
          ...
          if (Je) {
            const e = (0, _e.convertPropertyToWatchedValue)(
              ...
              t = {
                ...
                action: (0, f.wrapHandlerWithPreventEvent)(this.onToggleDisabled.bind(this)),
                visible: e,
                className: k.eye,
        ...
        _getMarkerTitle() {
          return null !== this._symbolMarker ? (this._symbolMarker.isMarked() ? $e : je) : '';
        }
      ...
      const ct = J.t(null, void 0, s(32514)),
        ...
        gt =
          (J.t(null, void 0, s(57335)), J.t(null, void 0, s(43206)), J.t(null, void 0, s(74759))),
      ...
      class ft extends Le {
        ...
        _getDisabledOnIntervalState() {
          return (
            !(!(0, et.isStudy)(this._source) && !(0, et.isStudyStub)(this._source)) &&
          ...
          this._titleActions.title = {
            onClick: () => {
              ...
              const s = (t = (0, lt.loadNewSymbolSearch)().then(async i => {
                ...
                let d = a ? l : o || l || '';
                if (c.enabled('symbol_search_option_chain_selector') && n && r) {
        ...
        _updateVisibilityPineAction(e) {
          null !== this._pineActionVisible &&
            (this._pineActionVisible.setValue(e), this._isAbleShowSourceCode.setValue(e));
        }
        _createActions() {
          if (!this._options.readOnlyMode) {
            ...
            if (
              ...
              (!(0, et.isStudy)(this._source) ||
                new st.MetaInfoHelper(this._source.metaInfo()).hasUserEditableOptions())
            ) {
              const e = new n.WatchedValue(this._getIsEditable()),
                t = {
                  ...
                  action: (0, f.wrapHandlerWithPreventEvent)(() => this.onShowSettings()),
                  visible: e.readonly(),
            ...
            if (yt) {
              const e = new n.WatchedValue(this._getIsEditable()),
                t = {
                  ...
                  action: (0, f.wrapHandlerWithPreventEvent)(this.onRemoveSource.bind(this)),
                  visible: e.readonly(),
      ...
      const Tt = new ve.TranslatedString(
        ...
        Bt = new ve.TranslatedString('change chart values visibility', J.t(null, void 0, s(79637))),
        It = new ve.TranslatedString(
          'change last day change visibility',
          J.t(null, void 0, s(66307)),
        ),
        Dt = new ve.TranslatedString('change bar change visibility', J.t(null, void 0, s(27426))),
        ...
        Ot = new ve.TranslatedString('change symbol field visibility', J.t(null, void 0, s(12050))),
      ...
      class is {
        constructor(e) {
          (this._source = e),
            (this._fullSessionScheduleViewModel = new ts.FullSessionScheduleViewModel(e));
        }
        destroy() {
      ...
      class oi extends rs {
        ...
        destroy() {
          this._dataUpdatedInfo.destroy(),
            ...
            this._options.marketStatus?.unsubscribe(this._onMarketStatusChanged),
        ...
        async _getHtmls() {
          ...
          try {
            ...
            Ys.logError(`Can't get exchange description, reason: ${(0, Xs.errorToString)(e)}`);
          }
          for (const a of e) {
            const e = a.mode;
            if (
              ((t[e] = []),
              ['DelayToRealtime', 'DelayNoRealtime', 'DelayWithoutMarketAgreement', ...ei].includes(
                e,
              ) &&
                ...
                'DelayWithoutMarketAgreement' === e &&
                  t[e].push(Ns.format({ listedExchange: this._model.listedExchange() })),
                this._options.subscriptionFullInfo &&
                  ei.includes(e) &&
                  t[e].push(Ts.format({ listedExchange: this._model.listedExchange() }))),
              'EOD' === e && (t[e] = [Is]),
              'TickByTick' === e)
            ) {
              const i =
                    ...
                    : (0, os.htmlEscape)(
                        J.t(
                          null,
                          {
                            ...
                            replace: { amount: (a.updatePeriod ?? 1).toString() },
                            plural:
            ...
            if (null !== o && 'BATSToRealtime' === e) {
              ...
              const l = (0, Gs.isAmexToCboeMigratedSymbol)(s, this._model.proPerm());
              0,
                Gs.CRUCIAL_REALTIME_BATS.includes(this._model.listedExchange()) || l
        ...
        _getShortTexts() {
          ...
          for (const i of e) {
            ...
            if ('BATSToRealtime' === e) {
              ...
              0, (t[e] = '' !== s ? xs.format({ exchange: s, originalExchange: As }) : As);
            }
          }
          return Object.keys(t).length > 0 ? t : null;
        }
      ...
      class ci extends rs {
        ...
        _getTooltip(e) {
          return (e ? this._getDataSourceErrorStatusCustomTitle() : null) ?? super._getTooltip(e);
        }
        _getTitle(e) {
          return (e ? this._getDataSourceErrorStatusCustomTitle() : null) ?? super._getTitle(e);
        }
        async _updateFullTooltip() {
          const e = this._status.value(),
      ...
      class Ai {
        ...
        _syncModel() {
          this._visible.setValue(this._symbolModel?.visible().value() ?? !1),
            ...
            this._tooltip.setValue(this._symbolModel?.tooltip().value() ?? null),
            this._updateFullInfo(this._symbolModel?.tooltipContent().value() ?? null),
            this._symbolModel &&
      ...
      const pl = {
          ...
          post_market: e => Xi.format({ remainingTime: _l(e.remainingSeconds) }),
          out_of_session: e =>
            ('pre_market' === e.status ? el : qi).format({ remainingTime: _l(e.remainingSeconds) }),
          holiday: e =>
            ('pre_market' === e.status ? el : qi).format({ remainingTime: _l(e.remainingSeconds) }),
          delisted: e => '',
          expired: e => '',
      ...
      class gl extends rs {
        ...
        async _updateFullTooltip() {
          ...
          if (null !== this._model && null !== i && 'expired' !== i && 'delisted' !== i) {
      ...
      class Ml {
        ...
        async _updateDropdownMenu() {
          ...
          await Promise.all([...this._statusWidgetInfos.map(e => e.preliminaryJob), e]),
            e.then(e => {
              e.render({
      ...
      class fl extends Ml {
        constructor(e, t, s) {
          ...
          (this._lastRecreateWidgetAbortController = i),
            this._recreateWidgets().then(() => {
              i.signal.aborted ||
                (this._symbol &&
                  this._symbol.subscribe(this._recreateAndUpdateWidgetState.bind(this)),
        ...
        _isForceStatusActive() {
          return this._isPrimaryWidgetShown() || (this._isDataProblemCritical?.value() ?? !1);
        }
            ...
            if (null !== e)
              if (null === this._symbolInvalidViewModel) {
                ...
                this._visibilitySpawns.push(t),
                  ...
                  this._addStatusWidgetInfos({ visible: t, model: this._symbolInvalidViewModel });
              } else
          ...
          if (this._options.dataUpdateModeEnabled) {
            ...
            if (null === this._dataUpdatedModeViewModel) {
              const t = {
                ...
                marketStatus: this._source.marketStatusModel()?.status().spawnOwnership(),
              };
              ...
              this._visibilitySpawns.push(s),
                ...
                this._addStatusWidgetInfos({ visible: s, model: this._dataUpdatedModeViewModel });
          ...
          if (this._options.dataProblemEnabled) {
            ...
            if (null === this._dataProblemViewModel) {
              ...
              this._visibilitySpawns.push(t),
                ...
                this._addStatusWidgetInfos({ visible: t, model: this._dataProblemViewModel });
            }
          }
          if (this._source.isMainSeries?.() ?? !1) {
            ...
            if (null === this._customStatusViewModel) {
              ...
              this._visibilitySpawns.push(s),
                ...
                this._addStatusWidgetInfos({ visible: s, model: this._customStatusViewModel });
            } else
        ...
        _addSubscriptionForSymbolInvalid() {
          ...
          this._options.sourceStatusesEnabled &&
            ...
            e.subscribe(this._updateIsSymbolInvalidStatusShown.bind(this), { callWithLast: !0 }));
        }
        ...
        constructor(e, t) {
          ...
          if ((0, Vl.isStudyLineTool)(e)) s.push(e.onStatusChanged());
            ...
            s.push(e.onStatusChanged(), e.onIsActualIntervalChange()),
              ...
              (0, et.isStudy)(e) &&
                ((this._isIntervalActual = (0, ce.createWVFromGetterAndSubscription)(
                  () => e.isActualInterval(),
          ...
          this._dataSourceErrorStatus = (0, ce.createWVFromGetterAndSubscriptions)(
      ...
      class eo extends Ml {
        ...
        destroy() {
          this._hasErrorViewModel?.destroy(), this._hasUpdateViewModel?.destroy(), super.destroy();
        }
        addStatusWidget(e) {
          ...
          if (null !== e)
            if (null === this._hasErrorViewModel) {
              ...
              t.subscribe(this._updateVisibility),
                this._addStatusWidgetInfos({ visible: t, model: this._hasErrorViewModel });
          ...
          if (null !== t)
            if (null === this._hasUpdateViewModel) {
              (this._hasUpdateViewModel = new wi(t, {
                ...
                this._addTooltipSpawn(this._hasUpdateViewModel.tooltip().spawn());
              const e = this._hasUpdateViewModel.visible().spawn();
              e.subscribe(this._updateVisibility),
                this._addStatusWidgetInfos({ visible: e, model: this._hasUpdateViewModel });
        ...
        _recreateHasErrorStatus() {
          ...
          const e = (0, w.combine)(
            e =>
              this._dataSourceStatusWidgets.map(e => e.dataSourceErrorStatusShown.weakReference()),
            new n.WatchedValue(this._dataSourceStatusWidgets).weakReference(),
          );
          this._hasErrorStatus = (0, w.accumulate)(e => e.some(e => e), e.ownership());
        }
        _recreateHasUpdateStatus() {
          this._hasUpdateStatus?.destroy();
          const e = (0, w.combine)(
            e => this._dataSourceStatusWidgets.map(e => e.dataUpdatedModeShown.weakReference()),
            new n.WatchedValue(this._dataSourceStatusWidgets).weakReference(),
          );
          this._hasUpdateStatus = (0, w.accumulate)(e => e.some(e => e), e.ownership());
        }
      }
      var to = s(85662);
      const so = {
      ...
      class no {
        constructor(e, t, s, i, o, d, u, h) {
          ...
          const b = p.paneProperties.childs().legendProperties.childs().backgroundTransparency,
          ...
          b.subscribe(this, () => {
            ...
            (this._collapsedDataSourcesStatusWidget = new eo(1, this._options.statusesWidgets)),
            (this._toggledDataSourcesStatusWidget = new eo(0, this._options.statusesWidgets)),
        ...
        onShowLegendWidgetContextMenu(e, t) {
          ...
          return (function (e, t, s, i, l, o) {
                ...
                a.push(
                  new Ct.Action({
                    ...
                    options: {
                      ...
                      onExecute: () => kt(e, Lt.showMarketOpenStatusProperty, Ht),
                    },
                  }),
                ),
              a.push(
            ...
            if (
              ...
              h && (At.lastDayChangeAvailable || At.alwaysShowLastPriceAndLastDayChange))
            ) {
            ...
            if (
              (e
                .model()
                .priceDataSources()
                .some(e => !(0, it.isActingAsSymbolSource)(e) && e.showInObjectTree()) &&
                (a.push(
                  new Ct.Action({
        ...
        updateLayout() {
          ...
          (this._dataSourceViewModels = p),
            ...
            0 === this._dataSourceViewModels.length && this._destroyCustomWidgetFromLayerBlock(1),
          ...
          if (
            ...
            this._updateCollapsedSourcesMode(), this._toggledDataSourcesStatusWidget.clear();
        ...
        _updateCollapsedSourcesMode() {
          ...
          if (
            (this._collapsedDataSourcesStatusWidget.clear(), this._availableHeight > 0 && e > 2)
          ) {
            ...
            if (null !== l) {
              ...
              if (e > n + 1) {
                ...
                for (let l = 0; l < e; l++) {
                  const e = l < n;
                  this._dataSourceViewModels[l].setGlobalVisibility(e && (!t || (0 === l && !s))),
                    e ||
          ...
          for (let e = 0; e < this._dataSourceViewModels.length; ++e)
            this._dataSourceViewModels[e].setGlobalVisibility(!t || (0 === e && !s));
        ...
        _getCustomTextColorValue() {
          ...
          for (const t of (0, to.getStdThemeNames)())
            if ((0, to.isStdThemedDefaultValue)('chartProperties.scalesProperties.textColor', e, t))
              return null;
          return e;
        }
        _clearSubscriptions() {
        ...
        _addCustomWidgetForLayerBlock(e) {
          ...
          for (const l of Array.from(t.keys())) {
            ...
            for (let t = o.length; t < a.length; t++) {
              ...
              o.push(s), this._renderer.addCustomWidget(s, { block: e, position: l }), (i = !0);
            }
            i && s.set(l, o);
          }
        ...
        _availableWidth() {
          return null === this._size ? 0 : Math.max(0, this._size.width - this._margin - ao);
        }
      }
    },
    61560: (e, t, s) => {
      ...
      class b {
        constructor(e, t, s) {
          (this._parentEl = document.createElement('div')),
            ...
            this._separatorSelected.subscribe(this._updatePaneControlsWidgetVisibility.bind(this)),
            (this._maximized = s.maximized.spawn()),
            this._maximized.subscribe(this._updatePaneControlsWidgetVisibility.bind(this)),
          ...
          this._render(),
            ...
            this._updateThemedColor(this._themedColor.value()),
            this._parentEl.classList.toggle(m.touchMode, p.trackingModeIsAvailable),
            this._parentEl.addEventListener('contextmenu', e => e.preventDefault()),
            this._parentEl.setAttribute('aria-hidden', 'true'),
            this._wrapEl.matches(':hover') && this._onMouseEnterLeaveEvent({ type: 'mouseenter' });
        }
        destroy() {
        ...
        updateWidgetModeByWidth(e) {
          ...
          i.classList.toggle(g.blockHidden, t || s),
            l.classList.toggle(g.blockHidden, t || !s || !this._actions.more.visible.value());
        }
        _render() {
          this._renderActions(),
        ...
        _renderActions() {
          ...
          for (const e of Object.keys(this._listActionsElements))
            (0, h.ensureNotNull)(this._listActionsElements[e]).classList.add(m.newButton);
          this._parentEl.append(this._listActionsElements.more);
        }
        _updateActionVisibilities(e, t) {
          (0, h.ensureNotNull)(this._listActionsElements[e]).classList.toggle(g.blockHidden, !t);
        }
        _updateActionTitle(e, t) {
          (0, h.ensureNotNull)(this._listActionsElements[e]).setAttribute('title', t);
        }
        ...
        _updatePaneControlsWidgetVisibility() {
          ...
          this._separatorSelected.value() && this._visibilityType.value(),
            ...
            this._parentEl.classList.toggle(m.forceHidden, !this._globalVisibility.value() || t);
        }
        _updateThemedColor(e) {
          if (e.length > 0) {
      ...
      class J {
        constructor(e, t, s, i) {
          (this._actions = {}),
            ...
            (this._model = e),
            (this._pane = t),
            (this._closeButtonVisibility = new A.WatchedValue(this._getCloseButtonVisibility())),
            (this._upButtonVisibility = new A.WatchedValue(this._getUpButtonVisibility())),
            (this._downButtonVisibility = new A.WatchedValue(this._getDownButtonVisibility())),
            ...
            (this._visibilityType = new A.WatchedValue(this._visibilityTypeProperty.value())),
            (this._isPaneMaximize = new A.WatchedValue(this._getIsPaneMaximizeValue())),
        ...
        _getDownButtonVisibility() {
          ...
          return e.indexOf(this._pane) < e.length - 1 && !this._pane.maximized().value() && !N;
        }
        _onUpDownButton(e) {
        ...
        _getMaximizeButtonVisibility() {
          return this._model.model().panes().length > 1 && !this._pane.maximized().value() && !N;
        }
        _getMinimizeButtonVisibility() {
          return this._model.model().panes().length > 1 && this._pane.maximized().value();
        }
      ...
      function n(e, t) {
        ...
        (h.className = s),
          ...
          void 0 !== e.title &&
            ...
            void 0 !== e.hotKeyTitle && (h.dataset.tooltipHotkey = e.hotKeyTitle)),
          h.addEventListener('touchend', (0, a.wrapHandlerWithPreventEvent)(e.action)),
        ...
        return (
          c.classList.add(n),
          (_ = (0, i.default)(e.icon) ? e.icon.get((0, l.ensureDefined)(d)) || '' : e.icon),
