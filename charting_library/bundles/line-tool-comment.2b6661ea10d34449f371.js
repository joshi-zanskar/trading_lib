    ...
    84738: (e, t, r) => {
      ...
      class R extends p.InplaceTextLineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          this._labelRenderer.setData(r), this._labelRenderer.setCursorType(this._textCursorType());
          ...
          const o = this._labelRenderer.measure(),
            s = {
              ...
              borderRadius:
                Math.min(
                  o.width,
                  this._labelRenderer.lineHeight() + 2 * Math.round(t.fontsize.value() / 1.3),
                ) / 2,
            };
            ...
            1 === s.points.length &&
              this._renderer.append(
                this.createLineAnchor(
                  { points: s.points.map(_.mapLineSourcePaneViewPointToLineAnchorPoint) },
                  0,
                ),
              ),
      ...
      class w extends l.LineToolBalloon {
        constructor(e, t, r, n) {
          super(e, t ?? w.createProperties(e.backgroundTheme().spawnOwnership()), r, n);
        }
        name() {
          return 'Comment';
        }
        ...
        static createProperties(e, t) {
          const r = new a.DefaultProperty({ defaultName: 'linetoolcomment', state: t, theme: e });
