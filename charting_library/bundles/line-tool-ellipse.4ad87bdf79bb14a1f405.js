  ...
  [7660],
  {
    59002: (t, e, i) => {
      ...
      class _ extends d.InplaceTextLineDataSource {
        constructor(t, e, s, n) {
          super(t, e ?? _.createProperties(t.backgroundTheme().spawnOwnership()), s, n),
          ...
          switch (t) {
            ...
            case 1:
              ...
              e && this.snapPoint45Degree(a, this._points[0 === t ? 1 : 0]),
                ...
                this._setPoint(2, {
                  ...this._calcPoint2(void 0, void 0, e ? void 0 : this._radius2),
                  interval: l,
                }),
                e &&
        ...
        migrateVersion(t, e, i) {
          if (1 === t && 2 === this._points.length) {
            ...
            (this._points[0] = { price: i, index: this._points[0].index, interval: t }),
              (this._points[1] = { price: i, index: this._points[1].index, interval: t }),
              this._points.push({ price: e, index: this._points[0].index, interval: t });
          }
        ...
        editableTextProperties() {
          ...
          return { text: t.text, textColor: t.textColor, textVisible: t.showLabel };
        }
        static createProperties(t, e) {
          const i = new a.DefaultProperty({ defaultName: 'linetoolellipse', state: e, theme: t });
        ...
        _applyTemplateImpl(t) {
          super._applyTemplateImpl(t), this.properties().childs().text.setValue(t.text);
        }
        _createDataSourceBackgroundColorWV() {
          const { fillBackground: t, backgroundColor: e } = this.properties().childs();
          return (0, l.combine)(
        ...
        static _configureProperties(t) {
          super._configureProperties(t),
            ...
            t.addChild('linesColors', new c.LineToolColorsProperty([t.childs().color])),
            t.addChild(
              'textsColors',
              new c.LineToolColorsProperty([t.childs().textColor], t.childs().showLabel),
            ),
    ...
    24362: (t, e, i) => {
      i.d(e, { InplaceTextLineDataSource: () => m, InplaceTextUndoCommand: () => T });
      var s = i(50279),
        n = i(50151),
        o = i(86441),
        r = i(19625),
      ...
      class T extends u.UndoCommand {
        constructor(t, e, s, n) {
          super(
            new h.TranslatedString('change {title} text', l.t(null, void 0, i(57122))).format({
            ...
            (this._oldValue = s),
            (this._newValue = n),
            (this._changeVisibility = !1 === e.editableTextProperties().textVisible?.value());
        }
        redo() {
          const t = this._source();
          this._textProperty(t).setValue(this._newValue),
            this._changeVisibility && this._textVisibilityProperty(t)?.setValue(!0);
        }
        undo() {
          const t = this._source();
          this._textProperty(t).setValue(this._oldValue),
            this._changeVisibility && this._textVisibilityProperty(t)?.setValue(!1);
        }
        _textProperty(t) {
      ...
      class m extends _.LineDataSource {
          ...
          super(t, e, s, n),
            ...
            (this._isDarkBackground = (0, c.combine)(
              (t, e) => {
                ...
                const i = (0, a.blendRgba)((0, a.parseRgba)(t), (0, a.parseRgba)(e));
            ...
            Promise.all([i.e(6290), i.e(9116), i.e(1200), i.e(1583)])
              .then(i.bind(i, 15852))
              .then(e => {
                (this._cursorPaneView = new e.InplaceTextCursorPaneView(this, t)),
        ...
        topPaneViews(t) {
          return t.hasDataSource(this) && !window.TradingView.printing && this._cursorPaneView
        ...
        onSelectionChange(t) {
          ...
          (0, s.default)(e, this._selectionData) ||
            ...
            this._paneViews.forEach(t => {
              t.forEach(t => {
                'setSelectionRange' in t && t.setSelectionRange(e.selectionRange);
              });
            }),
            this._cursorPaneView
        ...
        async _openTextEditor(t, e, s, r, a) {
          ...
          const { updateChartEditorText: l, closeChartEditorText: h } = await Promise.all([
            i.e(4556),
            i.e(2227),
            i.e(5592),
          ]).then(i.bind(i, 99514));
          ...
          const { text: c, textColor: d, wordWrap: u } = this.editableTextProperties(),
          ...
          l(this._container, g), this.updateAllViewsAndRedraw((0, p.sourceChangeEvent)(this.id()));
        }
        _closeTextEditor() {
