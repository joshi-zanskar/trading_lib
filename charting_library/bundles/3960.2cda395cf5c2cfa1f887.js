...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3960],
  {
    73174: (e, t, o) => {
      ...
      const p = -5e4,
        m = 15e3,
        g = new r.TranslatedString('change price Y coordinate', n.t(null, void 0, o(11737))),
        f = new r.TranslatedString('change bar X coordinate', n.t(null, void 0, o(2066))),
      ...
      function x(e, t, o, i, n, r) {
        ...
        return (0, d.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, h.removeSpaces)(`${r}Coordinates${n}`), title: n, ...a.info, ...l.info },
        );
      }
      const _ = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/;
      function y(e, t, o) {
                ...
                e.filter(e => !e.isSourceHidden()).forEach(e => {
                  ...
                  switch (a) {
                    case '': {
                      ...
                      (r -= e.price),
                        (t -= e.index),
                        (n = o.map(e => ({ ...e, index: e.index + t, price: e.price + r })));
                      break;
                    }
                    case '-':
                    case '+': {
                      ...
                      '-' === a && ((e *= -1), (t *= -1)),
                        (n = o.map(o => ({ ...o, index: o.index + e, price: o.price + t })));
                      break;
                    }
                    case '*': {
                  ...
                  t.undoHistory().pushUndoCommand(
                    new s({ lineToolId: e.id(), chartModel: t.model(), newPositionPoints: n }),
                  );
                });
              });
            } finally {
    ...
    91335: (e, t, o) => {
      ...
      const l = new n.TranslatedString(
        ...
        s = new n.TranslatedString('change {toolName} text color', i.t(null, void 0, o(64500))),
        d = new n.TranslatedString('change {toolName} text font size', i.t(null, void 0, o(21781))),
        c = new n.TranslatedString('change {toolName} text font bold', i.t(null, void 0, o(24701))),
        u = new n.TranslatedString(
          'change {toolName} text font italic',
          i.t(null, void 0, o(42694)),
        ),
        h = new n.TranslatedString('change {toolName} text', i.t(null, void 0, o(66668))),
        ...
        _ = new n.TranslatedString('change {toolName} text wrap', i.t(null, void 0, o(39587))),
      ...
      function P(e, t, o, i) {
        ...
        if (
          ...
          void 0 !== t.fontSize &&
            (n.size = (0, r.convertToDefinitionProperty)(e, t.fontSize, d.format({ toolName: o }))),
          void 0 !== t.bold &&
            (n.bold = (0, r.convertToDefinitionProperty)(e, t.bold, c.format({ toolName: o }))),
          void 0 !== t.italic &&
            (n.italic = (0, r.convertToDefinitionProperty)(e, t.italic, u.format({ toolName: o }))),
          void 0 !== t.text &&
            ((n.text = (0, r.convertToDefinitionProperty)(e, t.text, h.format({ toolName: o }))),
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (P.backgroundTitle = (i.customTitles && i.customTitles.backgroundTitle) || y),
          ...
          void 0 !== t.wrap &&
            ((n.wrap = (0, r.convertToDefinitionProperty)(e, t.wrap, _.format({ toolName: o }))),
    ...
    69113: (e, t, o) => {
          ...
          return {
            definitions: [
              (0, c.createTextStyleDefinition)(
                ...
                new d.TranslatedString(this._source.name(), this._source.translatedType()),
      ...
      class k extends N.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          const t = this._data.points[0].x - (this._geometryCache.paddingLeft + 20),
            ...
            i = (0, C.box)(
              new C.Point(t, o),
              new C.Point(t + this._geometryCache.innerWidth, o + this._geometryCache.innerHeight),
            );
          return (0, w.pointInBox)(e, i)
            ? new y.HitTestResult(y.HitTarget.MovePoint, { areaName: y.AreaName.Text })
            : null;
        }
        _drawImpl(e) {
          ...
          const o = this._measureInfo(t, this._data.label, this._data.fontSize),
            { paddingLeft: i, innerHeight: n, innerWidth: r, textHorizontalPadding: a } = o;
      ...
      class D extends T.LineSourcePaneView {
        constructor(e, t) {
          super(e, t), (this._balloonRenderer = new k()), (this._renderer = null);
        }
        renderer(e) {
            ...
            return (
              ...
              e.append(
                new _.SelectionRenderer({
                  points: o.points.map(b.mapLineSourcePaneViewPointToLineAnchorPoint),
      ...
      class V extends a.InplaceTextLineDataSource {
        constructor(e, t, o, i) {
          super(e, t ?? V.createProperties(e.backgroundTheme().spawnOwnership()), o, i),
        ...
        static createProperties(e, t) {
          const o = new r.DefaultProperty({ defaultName: 'linetoolballoon', state: t, theme: e });
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            e.hasChild('text') || e.addChild('text', new l.Property(this._defaultText)),
            e.addExcludedKey('text', 1),
            e.addChild('linesColors', new s.LineToolColorsProperty([e.childs().borderColor])),
            e.addChild('textsColors', new s.LineToolColorsProperty([e.childs().color]));
        }
      }
      V._defaultText = I;
    },
