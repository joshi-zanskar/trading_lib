...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    25422: (t, i, e) => {
      i.transformPoint = i.translationMatrix = i.scalingMatrix = i.rotationMatrix = void 0;
      var n = e(86441);
    ...
    87654: (t, i, e) => {
      ...
      class d extends c.LineDataSource {
        constructor(t, i, n, s) {
          super(t, i ?? d.createProperties(t.backgroundTheme().spawnOwnership()), n, s),
          ...
          switch (t) {
            ...
            case 2: {
              ...
              (w = (0, a.rotationMatrix)(-N)),
                ...
                (t = (0, a.transformPoint)(w, t)),
                (g = (0, a.transformPoint)(w, g));
              const T = t.y * g.y >= 0 ? new r.Point(P.x, P.y) : new r.Point(p.x, p.y);
              this._points[2] = {
        ...
        migrateVersion(t, i, e) {
          if (1 === t && 2 === this._points.length) {
            ...
            this._points.push({ price: i, index: this._points[1].index, interval: t });
          }
        ...
        static createProperties(t, i) {
          const e = new l.DefaultProperty({ defaultName: 'linetoolarc', state: i, theme: t });
          return this._configureProperties(e), e;
        }
        async _getPropertyDefinitionsViewModelClass() {
          return (
            await Promise.all([e.e(6406), e.e(3889), e.e(8009), e.e(8056), e.e(8537)]).then(
              e.bind(e, 90490),
            )
        ...
        static _configureProperties(t) {
          super._configureProperties(t),
            t.addChild('linesColors', new h.LineToolColorsProperty([t.childs().color]));
        }
      }
    },
  },
