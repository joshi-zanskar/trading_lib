...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => m, InplaceTextUndoCommand: () => C });
      var n = i(50279),
        o = i(50151),
        s = i(86441),
        r = i(19625),
      ...
      class m extends p.LineDataSource {
        ...
        async _openTextEditor(e, t, n, r, a) {
          ...
          const { text: d, textColor: h, wordWrap: u } = this.editableTextProperties(),
    ...
    15511: (e, t, i) => {
      ...
      function p(e, t) {
        ...
        return null === s ? null : { index: s.index, price: l(e, s, c(t.position())) };
      }
      function _(e, t, i, n) {
        const o = u(e, t, n);
        ...
        if (i)
          switch (e.style()) {
            ...
            case 7:
              ...
              break;
            case 0:
              l = c.barStyle.childs().thinBars.value() ? 3 : Math.max(3, 0.25 * r.barSpacing());
              break;
            case 11:
              l = c.rangeStyle.childs().thinBars.value() ? 3 : Math.max(3, 0.25 * r.barSpacing());
              break;
            case 5:
      ...
      class P extends a.InplaceTextLineDataSource {
        ...
        move(e, t, i, n) {
          const o = (0, s.ensureDefined)((0, s.ensureNotNull)(this.startMovingPoint()).logical),
          ...
          if (!n && 0 === t) {
            const e = this._points[0],
              ...
              a = i.priceToCoordinate(r.price, n) - i.priceToCoordinate(o.price, n),
              l = this._startMovingAnchorY + a,
              c = i.coordinateToPrice(l, n);
            this._updatePositionAndCorrectPoint({ index: e.index + t, price: c });
          }
        ...
        _anchorYCoordinate() {
          ...
          if (null === o) return null;
          let s = null;
          if ((e === n && (s = p(n, o)), null === s && (s = u(o, t, i)), null === s)) return null;
          const r = o.position(),
    ...
    28820: (e, t, i) => {
      ...
      class c extends s.Property {
        ...
        setValue(e) {
          this._source.properties().childs().position.setValue(e),
            ...
            this.fireChanged(),
            this._source.syncMultichartState({ pricesChanged: !1, indexesChanged: !1 });
        }
      }
      var d = i(20834);
      ...
      class u extends l.LineToolWithRelativePriceCoordinate {
        constructor(e, t = u.createProperties(e.backgroundTheme().spawnOwnership()), o, r) {
          super(e, t, o, r),
        ...
        destroy() {
          this._model.dark().unsubscribe(this._setTextColorByTheme), super.destroy();
        }
        pointsCount() {
          return 1;
        }
        ...
        editableTextProperties() {
          return { text: this.properties().childs().text, textColor: this._textColorProperty };
        }
        activateEditingOnCreation() {
          return !0;
        }
        static createProperties(e, t) {
          const i = new o.DefaultProperty({ defaultName: 'linetoolsignpost', state: t, theme: e });
        ...
        static _configureProperties(e) {
          r.LineDataSource._configureProperties(e),
            ...
            e.hasChild('position') || e.addChild('position', new s.Property(50)),
            e.addExcludedKey('text', 1),
            e.addExcludedKey('position', 1),
            e.addChild('backgroundsColors', new a.LineToolColorsProperty([e.childs().plateColor]));
        }
      }
