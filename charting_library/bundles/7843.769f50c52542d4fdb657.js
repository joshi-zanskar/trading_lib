  ...
  [7843],
  {
    ...
    53885: (e, o, t) => {
      ...
      function a(e, o = 2, t) {
        return l(
          ...
          r()[e],
          t,
          0 === o || 1 === o ? l(i.skeletonTheme.wrapper, r().skeleton) : r().letter,
      ...
      function n(e) {
        ...
        return (
          ...
          (0, i.useIsomorphicLayoutEffect)(() => {
            if (null !== o.current) return a.current(o.current), () => a.current(null);
          }, [e]),
          o
        );
      }
        ...
        return l.createElement(
          Y,
          {
            ...
            onContextMenu: function (e) {
              U && G && (0, n.trackEvent)(U.category, U.event, `${U.label}_rightClick`);
            },
            onMouseUp: function (e) {
              if (1 === e.button && A && U) {
                let e = U.label;
                W && (e += '_mouseWheelClick'), (0, n.trackEvent)(U.category, U.event, e);
              }
            },
            onMouseOver: K,
            onMouseOut: D,
          ...
          void 0 !== E &&
            l.createElement(
              'span',
              {
                role: F,
                onClick: N ? v : void 0,
                className: i(m, R.toolbox, { [R.showOnHover]: y, [R.showOnFocus]: C }),
              },
              E,
            ),
        );
    ...
    2627: (e, o, t) => {
      ...
      const d = (0, h.humanReadableModifiers)(h.Modifiers.Shift, !1).trim(),
        ...
        p = {
          ...
          LineToolGannFan: {},
          LineToolGannSquare: {
            hotKey: (0, n.hotKeySerialize)({ keys: [d], text: i.t(null, void 0, t(83042)) }),
          },
          LineToolHeadAndShoulders: {},
          LineToolHorzLine: {
            hotKey: (0, n.hotKeySerialize)({ keys: [u, 'H'], text: '{0} + {1}' }),
          },
          LineToolHorzRay: {},
          LineToolIcon: {},
          LineToolImage: {},
          ...
          LineToolRay: {},
          LineToolRectangle: {
            hotKey: (0, n.hotKeySerialize)({ keys: [d], text: i.t(null, void 0, t(10539)) }),
          },
          LineToolCircle: {},
          ...
          LineToolVertLine: {
            hotKey: (0, n.hotKeySerialize)({ keys: [u, 'V'], text: '{0} + {1}' }),
          },
          LineToolCrossLine: {},
          LineToolHighlighter: {},
          LineToolGhostFeed: {},
          ...
          dot: {},
          demonstration: {
            hotKey: (0, n.hotKeySerialize)({ keys: [u], text: i.t(null, void 0, t(42633)) }),
          },
          ...
          hideAllDrawings: {
            ...
            hotKey: (0, n.hotKeySerialize)({ keys: [g, u, 'H'], text: '{0} + {1} + {2}' }),
          },
          lockAllDrawings: { iconActive: a.drawingToolsIcons.lockAllDrawingsActive },
          magnet: { hotKey: (0, n.hotKeySerialize)({ keys: [g], text: '{0}' }) },
          measure: {
            hotKey: (0, n.hotKeySerialize)({ keys: [d], text: i.t(null, void 0, t(92949)) }),
          },
      ...
      Object.entries(p)
        .map(([e, o]) => {
          ...
          (0, l.assert)(!!i, `Localized name is not defined for drawing "${e}"`);
          return {
            ...o,
            name: e,
            icon: t,
    ...
    26744: (e, o, t) => {
      ...
      var l = t(52033),
        i = t(37265),
        n = t(56840);
      const r = ['LineToolBalloon', 'LineToolNoteAbsolute', null, null].filter(i.isExistent),
        a = !1;
      var s, c;
      !(function (e) {
        function o() {
          e.favorites = [];
          let o = !1;
          const l = Boolean(void 0 === (0, n.getValue)('chart.favoriteDrawings')),
          ...
          (e.favoriteAdded = new l.Delegate()),
            ...
            (e.addFavorite = function (t, l) {
              return (
                ...
                (s.favorites.push(t), s.saveFavorites(l), e.favoriteAdded.fire(t), !0)
              );
            }),
