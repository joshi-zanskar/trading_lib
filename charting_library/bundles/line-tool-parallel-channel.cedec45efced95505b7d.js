  ...
  [2050],
  {
    ...
    56621: (e, t, i) => {
      ...
      class p extends l.LineDataSource {
        constructor(e, t, s, n) {
          super(e, t ?? p.createProperties(e.backgroundTheme().spawnOwnership()), s, n),
            (this.version = 2),
        ...
        paneViews(e) {
          return (
            null !== this._pendingPriceOffset && this._applyPendingPriceOffset(), super.paneViews(e)
          );
        }
        ...
        restoreExternalPoints(e, t) {
          if (
            ...
            for (let t = 0; t < e.points.length; t++) this._points[t].price = e.points[t].price;
        }
        restorePoints(e, t, i) {
        ...
        setPoint(e, t, i, s) {
          ...
          const o = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[0])),
          ...
          u &&
            !s &&
            e < 4 &&
            this._syncLineStyleChanges(u, { prices: this._points.map(e => e.price) });
        }
        state(e) {
        ...
        addPoint(e, t, i) {
          return (
            ...
            2 === this._points.length &&
              (e = this._convertLastPointTo3rdPoint((0, n.ensureNotNull)(this._lastPoint))),
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            e.hasChild('labelText') || e.addChild('labelText', new a.Property('')),
    ...
    14267: (e, t, i) => {
      i.d(t, { LineToolParallelChannelPropertiesImpl: () => V, coeffs: () => g });
      var s = i(90054),
        n = i(16738),
        o = i(50151),
        r = i(49156),
      ...
      const m = {
          ...(function () {
            const e = {};
            for (let t = 0; t < g.length; t++) e[`level${t + 1}`] = { color: '#2962ff' };
            return e;
          })(),
        ...
        b = (0, u.extractAllPropertiesKeys)((0, o.ensureDefined)(y.get(l.StdTheme.Light))),
      ...
      function A(e) {
        ...
        return {
          ...
          ...p,
          level4: { visible: r, color: a, lineStyle: c, lineWidth: h, coeff: 0.5 },
          level2: { color: t, lineStyle: i, lineWidth: o, visible: !0, coeff: 0 },
          level6: { color: t, lineStyle: i, lineWidth: o, visible: !0, coeff: 1 },
        };
      }
      class V extends d.LineDataSourceProperty {
        constructor(e) {
          1 === (e.state && 'version' in e.state ? e.state.version : 1) &&
            e.state &&
            ((e.state = A(e.state)), (e.state = (0, u.extractState)(e.state, e.allStateKeys))),
            super(e),
            this.addChild(
              'linesColors',
              new f.LineToolColorsProperty(
                g.map((e, t) => (0, o.ensureDefined)(this.child(`level${t + 1}`)).childs().color),
              ),
            ),
            this.addChild(
              'linesWidths',
              new f.LineToolWidthsProperty(
                g.map(
                  (e, t) => (0, o.ensureDefined)(this.child(`level${t + 1}`)).childs().lineWidth,
                ),
              ),
            );
        }
        ...
        static create(e, t) {
          return new this({
            defaultName: v,
            factoryDefaultsSupplier: () => (0, P.factoryDefaultsForCurrentTheme)(T, y),
