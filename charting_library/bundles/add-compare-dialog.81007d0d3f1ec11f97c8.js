    ...
    14283: (e, t, o) => {
      ...
      function M(e) {
        ...
        return n.createElement(
          ...
          {
            type: 'button',
            className: c()(s, t.button, r && t.selected, l && !r && !i && t.bordersVisible),
            name: u,
            value: d,
            onClick: a,
          },
      ...
      function B(e) {
        ...
        return [(0, n.useMemo)(() => i[r]?.compareOption ?? i[0].compareOption, [i, r]), i];
      }
      var L = o(13079);
      function O(e) {
        const { fullSymbolName: t, isSelected: r, className: l, isYield: s } = e,
          {
            isMobile: d,
            searchRef: u,
            setMode: m,
        ...
        return d
          ...
          : n.createElement(
              'div',
              { className: c()(L.wrap, l), 'data-name': 'compare-buttons-group' },
              x.map(({ label: e, compareOption: t }) =>
                n.createElement(
                  N,
                  {
      ...
      function Y(e) {
        ...
        return (
          ...
          n.createElement(W.AdaptivePopupDialog, {
            ...e,
            className: s(X.dialog, !h && (v ? X.tabletDialog : X.desktopDialog)),
            onKeyDown: function (e) {
              ...
              switch (n) {
                case 13: {
                  if (A)
                    return void (function () {
                      if (-1 === D) return;
                      const e = O[D];
                      e.checked ? x.removeStudy(e) : x.applyStudy(e.symbol, P, L);
                      M(-1);
                    })();
                  const t = U();
                  ...
                  const n = (function () {
                    0;
                    const e = e =>
                        'string' == typeof e?.fullSymbolName ? e.fullSymbolName : e?.symbol,
                      t = -1 !== r;
                    if (t) return e(V);
                    const n = l.enabled('allow_arbitrary_symbol_search_input'),
                      a = 'empty' !== S;
                    if (n) return a && H.length ? e(H[0]) : o?.current?.value.trim();
                    if (!a && !t && !n) return;
                ...
                case 27:
                  return e.preventDefault(), R ? void u('symbolSearch') : void f();
              }
              if (!A && 'good' !== S) return;
      ...
      class Q extends U.DialogRenderer {
        ...
        hide() {
          this._rootInstance?.unmount(), this._visibility.setValue(!1), this._props.onClose?.();
        }
      }
      var $ = o(81319),
        q = o(69654),
        ...
        function r() {
          t.current &&
            ...
            ('compare' !== a.current || '' === t?.current?.value?.trim()
              ? 'symbolSearch' === a.current && '' === t?.current?.value?.trim() && o('compare')
              : o('symbolSearch'));
        }
      }
      var te = o(70673),
        ...
        ne = o(69849);
      function ae(e) {
        const { allowExtendTimeScale: t, toggleAllowExtendTimeScale: r } = (0, d.ensureNotNull)(
          (0, n.useContext)(y),
        );
        return n.createElement(
              ...
              return (
                ...
                null !== c.current &&
                  (i
                    ...
                    : (0, a.disableBodyScroll)(c.current, { allowTouchMove: d(c) })),
                () => {
                  s--,
                    null !== c.current &&
                      (i
