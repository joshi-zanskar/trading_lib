  ...
  [5122],
  {
    28462: (e, r, s) => {
      ...
      class n extends i.LineToolBrushBase {
        constructor(e, r, s, t) {
          super(e, r ?? n.createProperties(e.backgroundTheme().spawnOwnership()), s, t),
        ...
        static createProperties(e, r) {
          const s = new t.DefaultProperty({ defaultName: 'linetoolbrush', state: r, theme: e });
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            e.addChild(
              'backgroundsColors',
              new o.LineToolColorsProperty([e.childs().backgroundColor], e.childs().fillBackground),
            ),
