  ...
  [7127],
  {
      ...
      class m extends l.DefaultProperty {
        ...
        state(e, t, s) {
          ...
          return s
            ...
            : ((i = r),
              (n = this._map),
              (0, this._levelsIterator)(i, { tpl: p, fill: c, typecheck: n.typecheck.pack }, n));
          var i, n;
        }
        preferences() {
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, l.extractState)(
              (0, i.default)((0, r.default)(t), f(e, this._map, this._levelsIterator)),
              this._allStateKeys,
    ...
    27172: (e, t, s) => {
      ...
      var r = s(11542),
        ...
        o = s(73305),
        a = s(85719);
      const c = new i.TranslatedString('erase level line', r.t(null, void 0, s(77114)));
      var u, p, h;
      !(function (e) {
        (e[(e.InitVersion = 1)] = 'InitVersion'), (e[(e.CurrentVersion = 1)] = 'CurrentVersion');
      })(u || (u = {})),
        (function (e) {
          (e[(e.LevelsCount = 11)] = 'LevelsCount'), (e[(e.PointsCount = 3)] = 'PointsCount');
        })(p || (p = {})),
        (function (e) {
      ...
      class d extends n.LineDataSource {
        constructor(e, t, r, i) {
          super(e, t ?? d.createProperties(e.backgroundTheme().spawnOwnership()), r, i),
            (this.version = 1),
        ...
        static _configureProperties(e) {
          ...
          for (let e = 1; e <= 11; e++)
            s.push(t['level' + e].childs().linewidth), r.push(t['level' + e].childs().color);
