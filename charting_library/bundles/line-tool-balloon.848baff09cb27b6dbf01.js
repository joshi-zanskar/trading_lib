    ...
    36036: (e, t, i) => {
      ...
      class P extends d.BitmapCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, i, p, _), n.length && this._drawPoints(e, n, o, x, g);
        }
        _drawPoints(e, t, i, o, r) {
          const { context: l, horizontalPixelRatio: h, verticalPixelRatio: c } = e,
          ...
          for (let e = 0; e < t.length; ++e) {
            const s = t[e];
            if (!((0, a.isInteger)(s.pointIndex) && d.linePointBeingEdited === s.pointIndex)) {
              l.fillStyle = i[e];
              if (
                (o(
                  l,
                ...
                if (null !== d.hoveredPointIndex && s.pointIndex === d.hoveredPointIndex) {
