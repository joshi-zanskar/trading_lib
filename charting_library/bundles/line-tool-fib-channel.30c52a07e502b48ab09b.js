...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2283],
  {
      ...
      class x extends o.DefaultProperty {
        ...
        state(e, t, i) {
          ...
          return i
            ...
            : ((n = s),
              (r = this._map),
              (0, this._levelsIterator)(n, { tpl: u, fill: h, typecheck: r.typecheck.pack }, r));
          var n, r;
        }
        preferences() {
    ...
    42851: (e, t, i) => {
      ...
      const d = new a.TranslatedString('erase level line', o.t(null, void 0, i(77114)));
      class _ extends u.InplaceTextLineDataSource {
        constructor(e, t, s, n) {
          super(e, t ?? _.createProperties(e.backgroundTheme().spawnOwnership()), s, n),
            (this.version = 2),
        ...
        processErase(e, t) {
          const i = 'level' + t,
            s = (0, r.ensureDefined)(this.properties().child(i)).childs().visible;
    ...
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => w, InplaceTextUndoCommand: () => m });
      var s = i(50279),
        n = i(50151),
        r = i(86441),
        o = i(19625),
      ...
      class w extends _.LineDataSource {
        ...
        async _openTextEditor(e, t, s, o, a) {
          ...
          const { text: c, textColor: u, wordWrap: d } = this.editableTextProperties(),
