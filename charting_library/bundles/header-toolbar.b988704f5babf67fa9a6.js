  ...
  [3005],
  {
      ...
      function a(e, t = []) {
        ...
        const c = (0, i.useFunctionalRefObject)(a),
          u = (0, r.useCallback)(
            e => {
              c(e),
                null !== o.current && (o.current.disconnect(), null !== e && o.current.observe(e));
            },
            [c, o],
          );
        return (
    ...
    39214: (e, t, n) => {
      ...
      var r = n(50959),
        ...
        S = n(32169);
      function b(e) {
        return r.createElement('div', { className: o()(S.separator, e.className) });
      }
      var y = n(13818);
      function C(e) {
        const {
      ...
      var V = n(61119),
        ...
        W = n(61380),
        L = n(46913);
      const N = { isVisibleScrollbar: !0, shouldMeasure: !0, hideButtonsFrom: 1 };
      function T(e) {
      ...
      function B(e) {
        return r.createElement('div', {
          className: a(L.fadeRight, e.className, { [L.isVisible]: e.isVisible }),
        });
      }
      function A(e) {
      ...
      function x(e) {
        return r.createElement(
          'div',
          { className: a(e.className, { [L.isVisible]: e.isVisible }), onClick: e.onClick },
          r.createElement(
            'div',
            ...
            constructor(e) {
              super(e),
                ...
                (this._handleResizeContent = ([e]) => {
                  ...
                  const { shouldDecreaseWidthContent: n, buttonsWidthIfDecreasedWidthContent: r } =
                    this.props;
                  n && r
            ...
            render() {
              ...
              return r.createElement(
                ...
                d =>
                  r.createElement(
                    'div',
                    { className: L.wrapOverflow, onMouseOver: m, onMouseOut: p, ref: d },
                    r.createElement(
                      'div',
                      ...
                      r.createElement(
                        'div',
                        {
                          className: a(L.scrollWrap, v, { [L.noScrollBar]: !o }),
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              c =>
                r.createElement(
                  ...
                  r.createElement(E.Measure, { onResize: h ? this._handleInnerResize : null }, c =>
                    r.createElement(
                      'div',
                          ...
                          r.Children.toArray([
                            ...
                            !o &&
                              ...
                              r.createElement(
                                C,
                                { key: 'undo-redo' },
                                r.createElement(e.UndoRedo, { id: h ? void 0 : H.UndoRedo }),
                              ),
                            r.createElement(C, {
                              removeSeparator: !0,
                              key: 'gap-1',
                            ...
                            (e.Layout || e.SaveLoad) &&
                              r.createElement(
                                ...
                                !o &&
                                  e.Layout &&
                                  r.createElement(e.Layout, { id: h ? void 0 : H.Layouts }),
                                e.SaveLoad &&
                            ...
                            !o &&
                              (e.Properties || e.Fullscreen || (!Y && e.Screenshot)) &&
                              r.createElement(
                                C,
                                { key: 'properties' },
                                !o &&
                            ...
                            Y &&
                              ...
                              r.createElement(
                                ...
                                r.createElement(e.Fullscreen, { id: h ? void 0 : H.Fullscreen }),
                              ),
                            Y &&
                              e.Screenshot &&
                              r.createElement(
                            ...
                            !o &&
                              ...
                              r.createElement(
                                C,
                                { key: 'publish', className: U.mobilePublish, removeSeparator: !0 },
                                r.createElement(e.Publish, { id: h ? void 0 : H.PublishMobile }),
                              ),
                            ...S,
                          ]),
                        ),
            ...
            e.Publish &&
              ...
              !h &&
              !m.enabled('hide_publish_button') &&
              r.createElement(e.Publish, { id: H.PublishDesktop, className: U.desktopPublish }),
          );
        }
      ...
      class ue {
        constructor(e) {
          (this._customIntervalsService = le),
            ...
            re.linking.supportedResolutions.subscribe(this._fireSupportedIntervalsMayChange),
            ...
            re.linking.intraday.subscribe(this._fireSupportedIntervalsMayChange),
            re.linking.dataFrequencyResolution.subscribe(this._fireSupportedIntervalsMayChange);
        }
        destroy() {
          re.linking.supportedResolutions.unsubscribe(this._fireSupportedIntervalsMayChange),
            re.linking.range.unsubscribe(this._fireSupportedIntervalsMayChange),
            re.linking.seconds.unsubscribe(this._fireSupportedIntervalsMayChange),
            re.linking.ticks.unsubscribe(this._fireSupportedIntervalsMayChange),
            re.linking.intraday.unsubscribe(this._fireSupportedIntervalsMayChange),
            re.linking.dataFrequencyResolution.unsubscribe(this._fireSupportedIntervalsMayChange);
        }
        getDefaultIntervals() {
        ...
        add(e, t, n) {
          ...
          return this._isIntervalDefault(r) || s.includes(r)
            ? null
            : (this._customIntervalsService.set((0, ee.sortResolutions)([...s, r])), r);
        }
        remove(e) {
      ...
      class ve {
        ...
        addFavorite(e) {
          const t = this.favId(e);
          this._favorites.push(ge(t)), this._favoritesChanged.fire(t), this._saveFavs();
        }
        removeFavorite(e) {
          const t = this.favId(e),
            n = this._findFavIndex(t);
          -1 !== n && (this._favorites.splice(n, 1), this._favoritesChanged.fire(t)),
            this._saveFavs();
        }
        favId(e) {
          return he(e);
        ...
        _saveFavs() {
          ...
          this._settings.setJSON('studyMarket.favorites', e, { forceFlush: !0 }),
            ae.TVXWindowEvents.emit('StudyFavoritesChanged', JSON.stringify({ favorites: e }));
        }
        _stateToSave() {
      ...
      function we(e = []) {
        return (0, ee.mergeResolutions)(e, m.enabled('star_some_intervals_by_default') ? Ee : []);
      }
      ...
      class Ve extends r.PureComponent {
        constructor(e) {
          ...
          this._favoriteChartStylesService = d || new Z(ae.TVXWindowEvents, ie, C);
          const E = we(this.props.defaultFavoriteIntervals);
          (this._favoriteIntervalsService = l || new ne(ae.TVXWindowEvents, ie, E)),
            (this._intervalsMenuViewStateService = new ye(ae.TVXWindowEvents, ie)),
            ...
            (this._features = {
              ...
              allowSymbolSearchSpread:
                m.enabled('header_symbol_search') && m.enabled('show_spread_operators'),
        ...
        componentDidUpdate(e, t) {
          ...
          n !== t.isVisible && (p.emit('toggle_header', n), this._negotiateResizer()),
        ...
        _addCustomHTMLButton(e, t = 'left') {
          const n = new J.WatchedValue(0),
            r = (0, Re.parseHtmlElement)(`<div class="apply-common-tooltip ${ke.customButton}">`),
            s = {
              type: 'Button',
              id: e,
        ...
        _removeCustomElementToState(e) {
          this.setState({
            leftCustomElements: this.state.leftCustomElements.filter(t => t.id !== e),
            rightCustomElements: this.state.rightCustomElements.filter(t => t.id !== e),
          });
        }
      }
      ...
      class Fe {
        constructor(e, t) {
          (this._component = null),
            ...
            (this._container = e),
            s.render(r.createElement(Ve, { ...t, ref: this._handleRef }), this._container);
        }
        destroy() {
