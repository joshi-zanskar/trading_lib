  ...
  [8643],
  {
            ...
            if (r) {
              ...
              if (
                ...
                (l = [].concat(t(l), [p])),
                  ...
                  a ||
                    (document.addEventListener('touchmove', d, o ? { passive: !1 } : void 0),
                    (a = !0));
              }
            } else {
              (h = n),
            ...
            (e.clearAllBodyScrollLocks = function () {
              r
                ? (l.forEach(function (e) {
                  ...
                  a &&
                    (document.removeEventListener('touchmove', d, o ? { passive: !1 } : void 0),
                    (a = !1)),
                  (l = []),
                  (i = -1))
                : (p(), (l = []));
    ...
    66860: (e, t, o) => {
      ...
      var n = o(50959),
        ...
        u = o.n(c);
      const d = e =>
        n.createElement(i.Icon, { className: r(u().caret, e && u().activeCaret), icon: s });
      function p(e) {
        const {
          showCaret: t,
          iconOnly: o,
    ...
    12048: (e, t, o) => {
            ...
            void 0 !== e.additionalWidgets &&
              (w = e.additionalWidgets.map(
                t => (
                  ...
                  t.renderer((0, d.ensureDefined)(x.get(t)), y.additionalWidget, e.onClose)
                ),
              )),
            n.createElement(
              'div',
              { key: f.get(t), className: u(y.popupWidget, y[h], e.isMobile && y.mobile) },
              ...
              n.createElement(
                ...
                n.createElement(
                  'span',
                  { style: { color: r || void 0 }, className: u(y.title, y[h]) },
          ...
          n.createElement(a.MatchMedia, { rule: o }, o =>
            o
              ? n.createElement(
                  ...
                  n.createElement(E, { widgetInfo: t, onClose: e.onClose, isMobile: !o }),
                )
              : n.createElement(
                  i.Drawer,
      ...
      function S(e) {
        ...
        t ? r.render(n.createElement(C, { ...l }), o) : r.unmountComponentAtNode(o);
      }
    },
    2948: e => {
      e.exports =
