  ...
  [4602],
  {
    46660: (e, r, t) => {
      ...
      class n extends i.LineDataSource {
        constructor(e, r, o, i) {
          super(e, r ?? n.createProperties(e.backgroundTheme().spawnOwnership()), o, i),
        ...
        static _configureProperties(e) {
          super._configureProperties(e),
            e.addChild('linesColors', new s.LineToolColorsProperty([e.childs().color])),
            e.addChild('textsColors', new s.LineToolColorsProperty([e.childs().textcolor])),
            e.addChild('linesWidths', new s.LineToolWidthsProperty([e.childs().linewidth])),
            e.hasChild('backgroundsColors') && e.removeProperty('backgroundsColors');
        }
      }
    },
  },
