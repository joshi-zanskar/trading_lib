  ...
  [1754],
  {
          ...
          u = {
            ...
            onSearchComplete: (e, t) => {
              o(e[0].symbol, e[0].result).then(e => {
                a.linking.setSymbolAndLogInitiator(e.symbol, 'symbol search'), h?.(e.symbol);
              });
            },
    ...
    1861: (e, o, t) => {
      ...
      function i(e) {
        ...
        function x() {
          _.unmount(), s.dialogsOpenerManager.setAsClosed('SymbolSearch'), C && C();
        }
        return s.dialogsOpenerManager.setAsOpened('SymbolSearch'), O && O(), { close: x };
      }
    },
    51826: (e, o, t) => {
