(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2157],
  {
      ...
      class x extends o.PureComponent {
        ...
        componentDidUpdate(e, t) {
          t.loading !== this.state.loading && this.props.onRequestUpdate?.(),
            ...
            t.subItems.length > 0 && 0 === this.state.subItems.length && this._unsubscribe?.(),
        ...
        _setCurrentContextValue() {
          this.state.subItems.length && this.context?.setCurrent(this.props.action.id);
        }
        _hasSubItems() {
    ...
    5304: (e, t, n) => {
      'use strict';
      n.d(t, { ContextMenuItem: () => w, DEFAUL_CONTEXT_MENU_ITEM_THEME: () => E });
      var o = n(50959),
        s = n(97754),
        r = n(70673),
        a = n(49483),
          ...
          o.createElement(
            ...
            l &&
              o.createElement(
                b.Drawer,
                { onClose: c },
                o.createElement(x, { items: n.subItems, parentAction: t, closeNested: c }),
              ),
          )
        );
        function c(e) {
          ...
          super(e),
            ...
            (this._handleFocusOnOpen = () => {
              this.props.menuElementReference?.current &&
                ...
                this.props.menuElementReference?.current.focus({ preventScroll: !0 });
            }),
            (this._handleFocus = e => {
        ...
        render() {
          ...
          return e
            ? o.createElement(
                ...
                o.createElement(h.MatchMedia, { rule: '(max-width: 440px)' }, t =>
                  this._isDrawer(t)
                    ? o.createElement(
                        k.Provider,
                        { value: { type: 'drawer' } },
    ...
    71402: (e, t, n) => {
      ...
      const r = { [o.Add]: s.t(null, void 0, n(69207)), [o.Remove]: s.t(null, void 0, n(85106)) };
    },
    36189: (e, t, n) => {
      'use strict';
      ...
      var o = n(50959),
        ...
        d = n(22413);
      function h(e) {
        const { className: t, isFilled: n, isActive: s, onClick: h, title: m, ...p } = e,
    ...
    20243: (e, t, n) => {
      ...
      function c(e) {
        ...
        const u = p(l),
          ...
          b = -1 !== v,
          f = e => {
            n && (0, s.becomeSecondaryElement)(n), (0, s.becomeMainElement)(e), e.focus();
          };
        switch ((0, o.mapKeyCodeToDirection)(t)) {
          case 'inlinePrev':
            if (!u.length) return;
            e.preventDefault(), f(0 === v ? a[c] : b ? d(u, v, -1) : u[u.length - 1]);
            break;
          case 'inlineNext':
            if (!u.length) return;
            e.preventDefault(), v === u.length - 1 ? f(a[c]) : f(b ? d(u, v, 1) : u[0]);
            break;
          case 'blockPrev': {
            e.preventDefault();
            const t = d(a, c, -1);
