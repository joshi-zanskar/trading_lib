...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8090],
  {
    73174: (e, t, i) => {
      ...
      const p = -5e4,
        _ = 15e3,
        m = new o.TranslatedString('change price Y coordinate', r.t(null, void 0, i(11737))),
    ...
    22717: (e, t, i) => {
      ...
      const _ = {
        ...
        S = (0, d.extractAllPropertiesKeys)((0, o.ensureDefined)(g.get(s.StdTheme.Light))),
      ...
      class v extends u.LineDataSourceProperty {
        constructor(e) {
          super(e),
            this.addChild(
              'linesColors',
              new p.LineToolColorsProperty([(0, o.ensureDefined)(this.child('linecolor'))]),
            ),
            this.addChild(
              'linesWidths',
              new p.LineToolWidthsProperty([(0, o.ensureDefined)(this.child('linewidth'))]),
            );
        }
        static create(e, t) {
          return new this({
            defaultName: 'linetoolfibspiral',
            factoryDefaultsSupplier: () => (0, h.factoryDefaultsForCurrentTheme)(_, g),
      ...
      var L = i(11542),
        ...
        E = i(18009),
        F = i(91682);
      const H = new V.TranslatedString('change {title} line color', L.t(null, void 0, i(7455))),
        N = new V.TranslatedString('change {title} line width', L.t(null, void 0, i(46040))),
        B = new V.TranslatedString('change {title} line style', L.t(null, void 0, i(30843))),
        K = new V.TranslatedString('change {title} counterclockwise', L.t(null, void 0, i(60003))),
    ...
    38039: (e, t, i) => {
      ...
      class l extends s.DefaultProperty {
        ...
        applyTemplate(e) {
          this.mergeAndFire(
            (0, s.extractState)(
              (0, r.default)((0, n.default)(this._factoryDefaultsSupplier()), e),
              this._templateKeys,
            ),
          );
        }
    ...
    36036: (e, t, i) => {
      ...
      class f extends h.BitmapCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, i, _, p), n.length && this._drawPoints(e, n, r, g, m);
        }
