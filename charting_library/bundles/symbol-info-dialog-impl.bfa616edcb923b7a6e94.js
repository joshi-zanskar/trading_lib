  ...
  [9374],
  {
    ...
    9745: (e, t, n) => {
      ...
      const i = o.forwardRef((e, t) => {
        const { icon: n = '', title: i, ariaLabel: r, ariaLabelledby: s, ariaHidden: a, ...l } = e,
          c = !!(i || r || s);
    ...
    87896: (e, t, n) => {
      ...
      var o = n(50959),
        i = n(32227),
        r = n(4237);
      const s = (0, o.createContext)({ isOnMobileAppPage: () => !1, isRtl: !1, locale: 'en' });
      var a = n(84015),
        l = n(63273);
    ...
    29562: (e, t, n) => {
      ...
      var v = n(6963);
      function g(e) {
        const { country: t, tooltip: n, providerId: i, sourceId: s, className: l } = e,
          ...
          [g, y] = (0, o.useState)(
            (function ({ country: e, providerId: t, sourceId: n }) {
              ...
              return i => {
                ...
                return void 0 !== s ? s.resolve((0, p.ensureDefined)(s.value)) : u(i);
              };
      ...
      class c extends o.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            i.createPortal(o.createElement(u.Provider, { value: this }, this.props.children), e)
          );
        }
        moveToTop() {
          ...
          const {
            ...
            A =
              ...
              ('string' == typeof a
                ...
                : o.cloneElement(a, { className: i(b.icon, a.props.className) }));
          return 'button' === n
            ? o.createElement(
                'button',
                {
                ...
                y && g && o.createElement('div', { className: i('js-button-text', b.text) }, g),
                A,
                !y && g && o.createElement('div', { className: i('js-button-text', b.text) }, g),
              )
            : o.createElement(
    ...
    30995: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        u = n(95074),
        d = n.n(u);
      const m = { small: 'regular14px', medium: 'semibold16px', large: 'semibold18px' },
        p = e => {
      ...
      function h(e) {
        return o.createElement(
          ...
          o.createElement('span', {
            className: i(d().background, e.statesWithoutBg && d()['states-without-bg']),
          }),
          e.startIcon &&
      ...
      class b extends o.PureComponent {
        constructor(e) {
          super(e),
            (this._fullSessionScheduleViewModel = new y.FullSessionScheduleViewModel(e.source));
        }
        componentWillUnmount() {
          this._fullSessionScheduleViewModel.destroy();
        }
        render() {
          const { className: e, showAllDays: t, timeZoneClassName: n } = this.props;
            ...
            render: function ({ requestResize: e }) {
              return (
                ...
                o.createElement(
                  ...
                  a.flat().length &&
                    l &&
                    o.createElement('div', { className: i(T.separator, T.widgetSeparator) }),
                  l &&
                    o.createElement(
                      o.Fragment,
                      null,
                  ...
                  ? o.createElement(
                      ...
                      o.createElement(
                        ...
                        (function (e) {
                          ...
                          return t.map((e, t) => o.createElement(D, { key: t, fields: e }));
                        })(e),
                      ),
                      t !== a.length - 1 &&
                        o.createElement('div', { className: i(T.separator, T.groupSeparator) }),
                    )
                  : null,
              )
            : null;
        ...
        return o.createElement(
          ...
          e.fields.map((e, t) => {
            const n = (function (e) {
              ...
              return !1 === e.capitalize || Array.isArray(t) ? t : (0, B.capitalizeFirstLetter)(t);
            })(e);
              ...
              ? o.createElement(
                  ...
                  s.map(e =>
                    o.createElement(PopupMenuItem, {
                      ...
                      label: U(e),
                      key: e.href,
                      toolbox: o.createElement(a.Icon, { className: T.icon, icon: H }),
                    }),
                  ),
                )
              : null,
      ...
      class z {
        constructor(e) {
          (this._symbolInfo = new P.WatchedValue(null)),
            ...
            (this._marketStatusModel = new R.MarketStatusModel(this._quotesProvider)),
      ...
      const de = new Set(['stock', 'fund', 'dr', 'right', 'warrant', 'structured']);
      var me = n(92315),
        pe = n(72041);
      function he(e) {
        const { className: t } = e;
        return o.createElement(
          ...
          o.createElement('span', { className: pe.text }, s.t(null, void 0, n(54602))),
        );
      }
      var ve = n(88145);
      var ge = n(87896);
      ...
      class fe {
          ...
          (this._container = null),
            ...
            (this._renderDialog = e => {
              ...
              this._rootInstance
                ...
                : (this._rootInstance = (0, ge.createReactRoot)(t, this._container));
            }),
            (this._close = () => {
            ...
            return [
              {
                ...
                propName: 'name',
                getEndSlot: e => {
                  if ((0, ve.isSymbolDelisted)(e.typespecs)) return o.createElement(he, null);
                },
              },
              { title: s.t(null, void 0, n(78734)), group: 1, propName: 'description' },
              {
              ...
              },
              {
                ...
                canCopy: !0,
                getter: (e, t) =>
                  e.figi && e.figi['exchange-level'] ? e.figi['exchange-level'] : null,
                visibility: (e, t) => !1,
              },
              {
              ...
              { title: s.t(null, void 0, n(98413)), group: 2, propName: 'type', getter: ae },
              {
              ...
              { title: s.t(null, void 0, n(81314)), group: 2, propName: 'pointvalue' },
              {
                ...
                getStartSlot: (e, n) => {
                  const i = n?.country_code ?? e.country,
                    r = e.exchange_logo;
                  return t
                    ? o.createElement(Y, { country: i, providerId: e.provider_id, sourceId: r })
                    : void 0;
                },
              },
              {
              ...
              },
              {
                ...
                visibility: (e, t) => Boolean((0, J.getSourceForEconomySymbol)(e)),
              },
              {
                ...
                visibility: (e, t) => Boolean((0, J.symbolOriginalCurrency)(e, !0)),
                formatter: e => e ?? '',
                defValue: '',
              },
              {
                ...
                visibility: (t, n) =>
                  Boolean((0, J.measureUnitId)(t) && (0, J.isMeasureUnitSymbol)(t) && e.showUnit),
                formatter: e => e ?? '',
                defValue: '',
              },
              {
                ...
                group: 2,
                propName: 'unit_id',
                getter: (t, n) => e.unitDescription((0, J.symbolOriginalUnit)(t, !!e.showUnit)),
                visibility: (t, n) => Boolean((0, J.symbolOriginalUnit)(t, !!e.showUnit)),
                formatter: e => e ?? '',
                defValue: '',
              },
              {
              ...
              { title: s.t(null, void 0, n(24431)), group: 2, propName: 'tick_size', getter: se },
            ];
          })(e);
        ...
        _retrieveValues(e, t, n) {
          ...
          for (let i = 0; i < e.length; i++) {
            ...
            if (void 0 !== c) {
              const t = o[c];
              this._setFieldValue(e[i], (e[i].formatter || this._defaultFormatter)(t));
            }
          }
        ...
        _removeHiddenFields(e, t, n) {
          for (let o = 0; o < t.length; o++) {
            const i = t[o];
            void 0 === i.visibility || i.visibility(e, n) || (t.splice(o, 1), o--);
          }
        }
        _separateByGroups(e) {
          const t = {};
