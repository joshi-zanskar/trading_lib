...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4731],
  {
      ...
      class x extends o.DefaultProperty {
        ...
        state(e, t, i) {
          ...
          return i
            ...
            : ((n = s),
              (r = this._map),
              (0, this._levelsIterator)(n, { tpl: h, fill: d, typecheck: r.typecheck.pack }, r));
          var n, r;
        }
        preferences() {
    ...
    96851: (e, t, i) => {
      i.d(t, { LineToolFibWithInplaceTextBase: () => d, getLevelProps: () => a });
      var s = i(50151),
        n = i(12988),
        r = i(24362);
      ...
      class d extends r.InplaceTextLineDataSource {
        ...
        editableTextStyle() {
          return { ...super.editableTextStyle(), forbidLineBreaks: !0, maxLength: 50 };
        }
        editableTextProperties() {
          const e = this.properties().childs();
          return { text: e.editableText, textColor: e.editableTextColor, wordWrap: o };
        }
        setInplaceEditLevelIndex(e) {
          ...
          i.setValue(o.value()),
            ...
            (this._destroyEditableTextSubscriptions = () => {
              i.unsubscribeAll(d), o.unsubscribeAll(d), n.unsubscribeAll(d), l.unsubscribeAll(d);
            }),
    ...
    24362: (e, t, i) => {
      i.d(t, { InplaceTextLineDataSource: () => g, InplaceTextUndoCommand: () => T });
      var s = i(50279),
        n = i(50151),
        r = i(86441),
        o = i(19625),
      ...
      class g extends p.LineDataSource {
        ...
        async _openTextEditor(e, t, s, o, a) {
          ...
          const { text: c, textColor: h, wordWrap: u } = this.editableTextProperties(),
          ...
          l(this._container, v), this.updateAllViewsAndRedraw((0, _.sourceChangeEvent)(this.id()));
        }
        _closeTextEditor() {
    ...
    68554: (e, t, i) => {
      i.r(t), i.d(t, { Constants: () => c, LineToolTrendBasedFibExtension: () => h });
      var s = i(11542),
        n = i(45126),
        r = i(15399),
        o = i(73305),
        a = i(85719),
        l = i(96851);
      const d = new n.TranslatedString('erase level line', s.t(null, void 0, i(77114)));
      var c;
      !(function (e) {
      ...
      class h extends l.LineToolFibWithInplaceTextBase {
        constructor(e, t, s, n) {
          super(e, t ?? h.createProperties(e.backgroundTheme().spawnOwnership()), s, n),
            (this.version = 2),
            Promise.all([i.e(6290), i.e(9116), i.e(1200), i.e(1583)])
              .then(i.bind(i, 90413))
        ...
        static createProperties(e, t) {
          const i = new r.LevelsProperty({
            ...
            state: t,
            map: {
              names: ['coeff', 'color', 'visible', 'linestyle', 'linewidth', 'text'],
              range: [0, 24],
            },
            theme: e,
          });
        ...
        static _configureProperties(e) {
          ...
          const s = [t.trendline.childs().linewidth, t.levelsStyle.childs().linewidth];
