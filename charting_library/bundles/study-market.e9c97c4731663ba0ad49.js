  ...
  [6456, 9790],
  {
          ...
          for (var e = [], t = 0; t < arguments.length; t++) {
            ...
            if (i) {
              ...
              if ('string' === s || 'number' === s) e.push(i);
                ...
                o && e.push(o);
              } else if ('object' === s) for (var a in i) n.call(i, a) && i[a] && e.push(a);
            }
          }
          return e.join(' ');
        }
    ...
    36383: (e, t, i) => {
      ...
      var n = i(50959),
        ...
        s = i(27267);
      function o(e) {
        const { click: t, mouseDown: i, touchEnd: o, touchStart: a, handler: l, reference: c } = e,
          d = (0, n.useRef)(null),
          u = (0, n.useRef)(
    ...
    9745: (e, t, i) => {
      ...
      const r = n.forwardRef((e, t) => {
        const { icon: i = '', title: r, ariaLabel: s, ariaLabelledby: o, ariaHidden: a, ...l } = e,
          c = !!(r || s || o);
      ...
      function c(e) {
        ...
        if (e && 1 == ++a) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (r(i, 'right', `${n()}px`), (t.style.paddingRight = `${a + n()}px`), (l = !0)),
        ...
        return r.createElement(
          ...
          !w &&
            r.createElement(
              ...
              r.createElement('span', { className: o()(d.titleText, 'apply-overflow-tooltip') }, i),
              y && !b && r.createElement(a.Icon, { className: d.nested, icon: c }),
            ),
        );
      }
      !(function (e) {
    ...
    37020: (e, t, i) => {
      ...
      function D(e) {
        ...
        return n.createElement('span', { className: E()(k.title, r && k.disabled, i) }, t);
      }
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(L.HighlightedText, { queryString: d, rules: u, text: c.title }),
            ),
            !1,
            h && n.createElement(BadgeStatus, { type: 'beta', className: M.badge }),
            p && n.createElement(BadgeStatus, { type: 'new', className: M.badge }),
            m && n.createElement(BadgeStatus, { type: 'updated', className: M.badge }),
            Boolean(N && !x) &&
          ...
          R &&
            n.createElement(
              'a',
              { href: R.authorLink, className: M.author, target: '_blank', onClick: W },
              R.authorName,
            ),
          !l &&
            R &&
            n.createElement('span', { className: M.likes }, compactNumberFormat(R.likesCount)),
          !1,
        );
      }
      function j(e, t) {
      ...
      function q(e) {
        ...
        return n.createElement('div', { style: t, className: E()(H.container, r && H.mobile) }, i);
      }
      var G = i(92164);
      function Y(e) {
          ...
          function () {
            i(
              (function () {
                const i = r(e),
                  n = i === e.length - 1;
                return null === t || -1 === i ? (e[0] ?? null) : n ? e[i] : e[i + 1];
              })(),
            );
          },
          function () {
            i(
              (function () {
                const i = r(e);
                return null === t || 0 === i || -1 === i ? (e[0] ?? null) : e[i - 1];
              })(),
            );
          },
        ];
            ...
            return (
              ...
              ),
              {
                ...
                handleKeyDown: function (e) {
                  ...
                  if (
                    (40 === (0, P.hashFromEvent)(e) && (e.preventDefault(), h(), f(n)),
                    38 === (0, P.hashFromEvent)(e) && (e.preventDefault(), p(), f(t)),
                    ...
                    : m.length
                      ? n.createElement(
                          ...
                          n.createElement(
                            q,
                            null,
                            n.createElement(U, { title: r.t(null, void 0, i(7378)) }),
                          ),
                          m.map(e =>
                            n.createElement(W, {
                              key: e.id,
                              ...
                              favoriteClickHandler: t => {
                                t.stopPropagation(), (0, X.toggleFavorite)(e.title);
                              },
                            }),
                          ),
                        )
      ...
      class de {
        ...
        show(e) {
          this._wrap &&
            ...
            ne.render(
              n.createElement(ce, { text: r.t(null, { replace: { studyTitle: e } }, i(33673)) }),
              this._wrap,
            ),
            this._debouncedHide());
        }
        hide() {
          this._wrap &&
            ((this._showed = !1), ne.unmountComponentAtNode(this._wrap), this._wrap.remove());
        }
        destroy() {
      ...
      class he {
        ...
        open(e, t, i, n, r) {
          (this._parentSources = e),
            this._updateSymbol(),
            this._setProps({ isOpened: !0, shouldReturnFocus: r?.shouldReturnFocus }),
        ...
        _applyStudy(e, t) {
          e.isGrayed
            ? Q.emit('onGrayedObjectClicked', { type: 'study', name: e.shortDescription })
            : (x.CheckMobile.any() || this._searchInputRef.current?.select(),
              (async function (e, t, i, n, r, o) {
                ...
                if ('java' === c.type) {
                  ...
                  if (null !== e) return await (0, v.initLineTool)(e), s.tool.setValue(e), null;
                }
    ...
    71402: (e, t, i) => {
      ...
      const s = { [n.Add]: r.t(null, void 0, i(69207)), [n.Remove]: r.t(null, void 0, i(85106)) };
    },
    36189: (e, t, i) => {
      'use strict';
      ...
      var n = i(50959),
        ...
        u = i(22413);
      function h(e) {
        const { className: t, isFilled: i, isActive: r, onClick: h, title: p, ...m } = e,
      ...
      class c extends n.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            r.createPortal(n.createElement(d.Provider, { value: this }, this.props.children), e)
          );
        }
        moveToTop() {
    ...
    23390: (e, t, i) => {
      ...
      function h() {
        l = [];
        const e = Boolean(void 0 === (0, r.getValue)('chart.favoriteLibraryIndicators')),
          t = (0, r.getJSON)('chart.favoriteLibraryIndicators', []);
        if ((l.push(...t), 0 === l.length && e && 'undefined' != typeof window)) {
