(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5516, 9685],
  {
      ...
      const r = (0, i.forwardRef)(function (e, t) {
        ...
        return i.createElement(
          ...
          i.createElement(
            ...
            n,
            i.createElement(o.ToolWidgetCaret, { className: l.caret, dropped: Boolean(a) }),
          ),
          a && r,
        );
      });
      ...
      function c(e) {
        ...
        return (
          ...
          i.createElement(
            ...
            i.createElement(l.FavoriteButton, { ...c, isFilled: a, isActive: n, title: '' }),
          )
        );
      }
    },
    10428: (e, t, a) => {
      'use strict';
      a.d(t, { DEFAULT_MENU_ITEM_SWITCHER_THEME: () => C, MenuItemSwitcher: () => _ });
      var i,
        n = a(50959),
        s = a(97754),
        o = a.n(s),
      ...
      function _(e) {
        const {
          ...
          T = o()(s, _.wrapper, a && _.wrapperWithOnLabel, h && _.wrapperWithDescription);
        return n.createElement(
          'label',
          {
            role: t,
            ...
            onKeyDown: function (e) {
              ...
              (13 !== t && 32 !== t) ||
                (e.preventDefault(), k.current instanceof HTMLElement && k.current.click());
            },
            tabIndex: E,
            'data-role': 'menuitem',
          ...
          void 0 !== f && n.createElement(p.Icon, { className: _.icon, icon: f }),
          n.createElement(
            'div',
    ...
    38068: (e, t, a) => {
      ...
      function d(e) {
        ...
        return i.createElement(
          ...
          i.createElement(r.RemoveButton, { ...u, isActive: n, title: '', icon: h }),
        );
      }
    },
    95230: (e, t, a) => {
      ...
      const p = n.forwardRef((e, t) => {
        ...
        return n.createElement('div', { className: u(i, v.wrap), ref: t, ...s }, a);
      });
      var g = a(20792),
        b = a(82316);
      ...
      function R(e) {
        ...
        return n.createElement('div', {
          ...
          onKeyDown: (0, M.createSafeMulticastEventHandler)(function (e) {
            ...
            Array.from(
              n.querySelectorAll('[role="radio"]:not([disabled]):not([aria-disabled])'),
            ).filter((0, I.createScopedVisibleElementFilter)(n))).sort(x.navigationOrderComparator);
            var n;
            ...
            const o = () => {
                ...
                i[s].dispatchEvent(new CustomEvent('roving-tabindex:secondary-element')),
      ...
      class W extends n.PureComponent {
        ...
        render() {
          const { isShownQuicks: e, displayMode: t = 'full', id: i } = this.props,
            { activeStyle: s, favorites: r, styles: u, lastSelectedNotFavorite: m } = this.state,
          ...
          return n.createElement(_.MatchMedia, { rule: y.DialogBreakpoints.TabletSmall }, e => {
            const t = u.map((t, a) =>
              t === D
                ? n.createElement(C.PopupMenuSeparator, { key: `separator-${a}` })
            ...
            return n.createElement(
              ...
              n.createElement(
                d.ToolbarMenuButton,
                {
                  ...
                  tooltip: b ? l.t(null, void 0, a(89911)) : (0, E.getTranslatedChartStyleName)(s),
                  className: F.menu,
                  isDrawer: e,
      ...
      const B = ['medium', 'small'],
        z = (0, n.forwardRef)(function (e, t) {
          const { text: a, className: i, displayMode: s, collapseWhen: o = B, ...l } = e,
            r = !o.includes(s);
          ...
          super(e, t),
            ...
            (this._handleClick = e => {
              (0, K.trackEvent)('GUI', 'Chart Header Toolbar', 'compare'),
                this._compareDialogRenderer?.show({ shouldReturnFocus: (0, q.isKeyboardClick)(e) });
            }),
            (0, f.validateRegistry)(t, { chartWidgetCollection: s.any.isRequired }),
          ...
          e.forEach(e => {
            switch (e.type) {
              ...
              case 'pine':
                ...
                break;
              default:
                (0, se.assert)(!1, `unknown favorite type ${JSON.stringify(e)}`);
            }
          }),
          0 !== n.size &&
            t.push(
      ...
      class we extends n.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (this._handleSelectIndicator = e => {
              ...
              (async () => {
                ...
                if ('java' === e.type) {
                  ...
                  if (null !== t) return await (0, de.initLineTool)(t), void ue.tool.setValue(t);
                }
            ...
            (this._handleFavoriteFundamentalsChange = () => {
              const e = new Set(this._favoriteFundamentalsModel?.favorites() || []);
        ...
        render() {
          const { isActive: e, favorites: t, favoriteFundamentals: i, isLoading: s } = this.state,
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              Boolean(t.length > 0 || i?.size) &&
                n.createElement(_.MatchMedia, { rule: '(max-width: 440px)' }, e =>
                  n.createElement(
                    d.ToolbarMenuButton,
                    {
                    ...
                    n.createElement(
                      'div',
                      { className: m()(Ce.dropdown, e && Ce.smallWidthWrapper) },
                      n.createElement(
        ...
        _prefetchFavorites() {
          ...
          const t = (this._promise = Promise.all([ce(this.state.favorites), void 0]).then(e => {
            if (t !== this._promise) return;
            const [a, i] = e;
            let n = [...a];
            if (i) {
              const e = i
                .filter(e => this.state.favoriteFundamentals?.has(e.scriptIdPart))
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(A.AccessibleMenuItem, {
              ...b,
              role: t,
              className: m()(Ae.menuItem, p && Ae.smallWidthMenuItem, c && Ae.signal),
      ...
      const Fe = {
        [Ee.ResolutionKind.Ticks]: l.t(null, { context: 'interval_group_name' }, a(49512)),
        [Ee.ResolutionKind.Seconds]: l.t(null, { context: 'interval_group_name' }, a(32116)),
        [Ee.ResolutionKind.Minutes]: l.t(null, { context: 'interval_group_name' }, a(21551)),
        [Ee.SpecialResolutionKind.Hours]: l.t(null, { context: 'interval_group_name' }, a(18817)),
        [Ee.ResolutionKind.Days]: l.t(null, { context: 'interval_group_name' }, a(57252)),
        [Ee.ResolutionKind.Weeks]: l.t(null, { context: 'interval_group_name' }, a(41815)),
        [Ee.ResolutionKind.Months]: l.t(null, { context: 'interval_group_name' }, a(89506)),
        [Ee.ResolutionKind.Range]: l.t(null, { context: 'interval_group_name' }, a(22163)),
      ...
      const Ze = {
        ...
        Ke = (0, $.hotKeySerialize)({ keys: [','], text: l.t(null, void 0, a(92969)) }),
      ...
      class Xe extends n.PureComponent {
          ...
          super(e, t),
            ...
            (this._renderChildren = (e, t) => {
              const a = this._customIntervals ? 1 : 0,
                ...
                n = i.length + a;
              return [...this._createIntervalItem(t, n), ...this._createMenuItems(i, t, a, n)];
            }),
            ...
            (this._handleAddInterval = (e, t) => {
              ...
              if (s) {
                ...
                if (e.interval.isMinuteHours())
                  return void i.set({ ...n, [Ee.SpecialResolutionKind.Hours]: !1 });
            ...
            (this._handleRemoveInterval = (e, t) => {
              ...
              if (e) {
                if (t && (0, q.isKeyboardClick)(t) && this._menuItemsContainerRef.current) {
        ...
        render() {
          ...
          (void 0 !== a ? m.concat(a) : m).filter(ke.isAvailable).forEach(e => (c[e] = !0));
          const v = void 0 !== a ? (0, ke.getTranslatedResolutionModel)(a) : null;
          return n.createElement(
            p,
            { id: t },
            h &&
              n.createElement(
                ...
                r.map((e, t) => {
                  ...
                  return n.createElement(S, {
                    key: t,
                    role: 'radio',
                    className: u(Be.button, { [Be.first]: 0 === t, [Be.last]: t === r.length - 1 }),
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  n.createElement(
                    ...
                    n.createElement('div', { className: Be.dropdown }, this._renderChildren(m, e)),
                  ),
                ),
                o &&
                  n.createElement(
        ...
        _createIntervalItem(e, t) {
          return this._customIntervals
            ? [
                ...
                n.createElement(C.PopupMenuSeparator, { key: 'custom-interval-separator' }),
              ]
            : [];
        }
        _renderResolutionsGroup(e, t = !1, a, i, s) {
          const o = [],
            l = t ? 1 : 2,
            r = e.items.map((t, i) => this._renderPopupMenuItem(t, a, i + 1, e.items.length, l));
          if (t) o.push(...r);
          else if (a) {
          ...
          return (
            (!e.mayOmitSeparator || e.items.length > 1) &&
              (o.unshift(n.createElement(C.PopupMenuSeparator, { key: `begin-${e.name}` })),
              o.push(n.createElement(C.PopupMenuSeparator, { key: `end-${e.name}` }))),
            o
          );
        }
      ...
      class nt extends n.PureComponent {
        ...
        componentWillUnmount() {
          this._propertiesDialogRenderer?.visible().unsubscribe(this._updateState);
        }
        render() {
      ...
      const Ct = i.enabled('widget'),
        ...
        ft =
          ((0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, { toolbox: bt.toolbox }),
          (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, { toolbox: bt.toolboxSmall }),
      ...
      class xt extends n.PureComponent {
        ...
        render() {
          ...
          vt.showFavoriteLayouts &&
            S &&
            C &&
            (k = S.filter(e => C[e.id]).sort((e, t) => e.name.localeCompare(t.name)));
          const E = !(h || !r || this.state.isSaving),
            M = n.createElement(
              ...
              n.createElement(
                'span',
                { className: bt.text },
                n.createElement(ht.LeadingEmojiText, { text: r || l.t(null, void 0, a(64e3)) }),
              ),
              n.createElement(mt, { isSaving: this.state.isSaving, wasChanges: h }),
            );
          return n.createElement(
            p,
            null,
            t
              ...
              : n.createElement(
                  ...
                  n.createElement(Z, {
                    ...
                    collapseWhen: Et,
                    isOpened: b,
                    tooltip: E ? l.t(null, void 0, a(89771)) : l.t(null, void 0, a(15356)),
        ...
        _renderMenuItems(e) {
          ...
          return (
            ...
            T.push(
              n.createElement(C.PopupMenuSeparator, { key: 'all-layouts-separator' }),
              n.createElement(A.AccessibleMenuItem, {
                key: 'all-layouts',
                role: 'row',
      ...
      class Rt extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(_.MatchMedia, { rule: y.DialogBreakpoints.TabletSmall }, e =>
            n.createElement(xt, { ...g, isTabletSmall: e }),
          );
        }
        _onLoginStateChange() {
      ...
      var At = a(7986),
        Nt = a(52388),
        Ft = a(13665);
      const Ht = new Nt.DateTimeFormatter({ dateTimeSeparator: '_', timeFormat: '%h-%m-%s' }),
      ...
      function Vt(e) {
        ...
        return n.createElement(
          ...
          n.createElement('span', { className: a }, n.createElement(me.Loader, null)),
        );
      }
      var Bt = a(76974),
        zt = a(67487),
      ...
      function Gt(e) {
          ...
          f =
            ((0, n.useCallback)(async () => {
              ...
              try {
                const t = 720,
                  a = e.then(async e => {
                    const a = await snapshoter().getSnapshot(e.symbol, new Set(['description'])),
                      i = 'error' !== a.status ? a.values.description : e.symbol,
        ...
        return n.createElement(
          n.Fragment,
          null,
          n.createElement(ge.ToolWidgetMenuSummary, null, l.t(null, void 0, a(58425))),
          n.createElement(A.AccessibleMenuItem, {
            role: 'row',
          ...
          !(0, lt.onWidget)() &&
            n.createElement(A.AccessibleMenuItem, {
              ...
              label: n.createElement(Vt, { isLoading: o }, l.t(null, void 0, a(81939))),
              icon: qt,
              onClick: () => {
                r(!0), w(!1);
              },
          ...
          !(0, lt.onWidget)() &&
            ...
            n.createElement(A.AccessibleMenuItem, {
              ...
              label: n.createElement(Vt, { isLoading: h }, l.t(null, void 0, a(19159))),
              icon: jt,
              onClick: () => {
                c(!0), w(!0);
              },
          ...
          !(0, lt.onWidget)() &&
            ...
            n.createElement(A.AccessibleMenuItem, {
              ...
              label: n.createElement(Vt, { isLoading: v }, l.t(null, void 0, a(28239))),
              icon: zt,
              onClick: f,
              dontClosePopup: !0,
              isDisabled: v,
            ...
            super(e, t),
              ...
              (this._serverSnapshot = async () => {
                const e = this.context.chartWidgetCollection.activeChartWidget
                  ...
                  a = void 0 !== this.context.snapshotUrl ? t : (0, At.convertImageNameToUrl)(t);
      ...
      (oa._currentShowingInstance = null), (oa._provider = null), (oa._implementation = null);
      var la = a(29142),
        ra = a(92876);
            ...
            (this._openSymbolSearchDialog = async e => {
              ...
              try {
                ...
                if (i.enabled('symbol_search_option_chain_selector') && r) {
                  ...
                  e && (t = { type: 'option', value: this.state.symbol, underlying: e });
                }
                await new oa().show({
                  trackResultsOptions: {
                    trackResults: !1,
                  ...
                  shouldReturnFocus: (0, q.isKeyboardClick)(e),
                  defaultValue: t,
                  showSpreadActions: (0, ia.canShowSpreadActions)() && this.props.isActionsVisible,
                  source: 'searchBar',
                  enableOptionsChain: i.enabled('symbol_search_option_chain_selector'),
      ...
      var ma = a(75313);
      function va(e) {
        return n.createElement('div', { className: u(ma.description, e.className) }, e.children);
      }
      var pa = a(6917);
      const ga = (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, {
        ...
        Sa = (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, { item: pa.item }),
        Ca = (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, { item: pa.itemTabletSmall });
      function _a(e) {
        const {
            role: t,
            className: a,
        ...
        return n.createElement(
          ...
          s &&
            n.createElement(oe.PopupMenuItem, {
              ...
              label: n.createElement(
                va,
                { className: m()(pa.description, r && pa.descriptionTabletSmall) },
                s,
              ),
              onClick: y,
              isHovered: b,
      ...
      function wa(e) {
        const { item: t } = e,
          ...
          i = { 'data-name': t.name, 'data-id': t.id, 'data-is-default': Boolean(t.is_default) },
          s = t.meta_info,
      ...
      function Ea(e) {
        const { onClick: t, isTabletSmall: a, className: i, icon: s, title: l, ...r } = e;
        return n.createElement(A.AccessibleMenuItem, {
          ...r,
          theme: ka,
      ...
      function Na(e) {
        ...
        return n.createElement(
          'div',
          { role: 'treegrid', className: m()(Aa.menu, c && Aa.menuSmallTablet) },
          n.createElement(Ea, {
            role: 'row',
            onClick: s,
            isTabletSmall: c,
          ...
          !d &&
            (c
              ? n.createElement(Fa, { defaults: v, customs: p, recents: i, render: _ })
              : n.createElement(Ha, { defaults: v, customs: p, recents: i, render: _, state: g })),
          Ia,
        );
      }
      function Fa(e) {
      ...
      class Ua {
        constructor(e, t) {
          (this._isFavoriteEnabled = i.enabled('items_favoriting')),
            ...
            (this.handleApplyTemplate = e => {
              this._studyTemplates.applyTemplate(e.name),
                this._recentStudyTemplatesService && this._recentStudyTemplatesService.add(e.id);
            }),
          ...
          (this._state = new Oa.WatchedValue({ isLoading: !1, studyTemplatesList: n, recents: a })),
        ...
        _handleRecentsChange() {
          this._setState({ recents: this._recentStudyTemplatesService?.get() || [] });
        }
        _removeFavoriteTemplate(e, t) {
          const a = t ? Da.backend.favorStandardStudyTemplate : Da.backend.favorStudyTemplate;
        ...
        _addFavoriteTemplate(e, t) {
          const a = this.getSortedFavoritesStudyTemplates(this._state.value().studyTemplatesList),
            ...
            s = t ? Da.backend.favorStandardStudyTemplate : Da.backend.favorStudyTemplate;
      ...
      function La(e) {
        ...
        return n.createElement(
          m,
          {
            ...
            className: u(t, Pa.item, Pa.accessible, 'apply-common-tooltip', 'common-tooltip-html'),
            onClick: function (e) {
              if ((e.stopPropagation(), s && l)) {
                if ((0, T.modifiersFromEvent)(e) !== T.Modifiers.None || 1 === e.button) return;
                e.preventDefault();
              }
              s?.(i);
            },
            onKeyDown:
              'a' === m
                ? function (e) {
                    32 === (0, T.hashFromEvent)(e) && (e.preventDefault(), c.current?.click());
                  }
                : void 0,
            'data-tooltip': p,
            'aria-label': v,
          ...
          n.createElement(
            ...
            a || n.createElement(ht.LeadingEmojiText, { text: h, firstSegmentOnly: !0 }),
          ),
        );
      }
      var Va = a(21233),
      ...
      class Za extends n.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (this._handleOpenTemplatesDialog = () => {
              isNewTemplatesViewEnabled && showIndicatorTemplatesDialog(this._model);
            }),
            (0, f.validateRegistry)(t, {
        ...
        render() {
          const { studyTemplatesList: e } = this.state,
            { isShownQuicks: t, className: a, displayMode: i, id: s } = this.props,
      ...
      function Ka(e) {
        const {
          ...
          C = (0, n.useRef)(null),
          w = (0, n.useRef)(null),
          f = m()(i, Ba.wrap, { [Ba.full]: 'full' === s, [Ba.medium]: 'medium' === s }),
        ...
        function E(e, t) {
          if (t && (0, q.isKeyboardClick)(t) && w.current) {
            ...
            b(e, null, () => {
              if (-1 !== a && w.current) {
                const e = t[a + 1] ?? t[a - 1];
                e ? e.focus() : (0, le.focusFirstMenuItem)(w.current), C.current?.update();
              }
            });
          } else b(e);
        }
        ...
        return n.createElement(
          ...
          e.favorites.map((t, a, i) =>
            n.createElement(La, {
              ...
              className: m()({ [Ba.first]: 0 === a, [Ba.last]: a === i.length - 1 }),
            }),
          ),
        );
      }
      ...
      class Ja extends n.PureComponent {
        ...
        render() {
          const { id: e } = this.props,
            { isEnabledRedo: t, isEnabledUndo: i, redoStack: s, undoStack: o } = this.state;
          return n.createElement(
            p,
            { id: e },
            n.createElement(g.ToolbarButton, {
              ...
              theme: $a,
              tooltip: i ? l.t(null, { replace: { hint: o } }, a(66020)) : void 0,
            ...
            n.createElement(g.ToolbarButton, {
              ...
              theme: $a,
              tooltip: t ? l.t(null, { replace: { hint: s } }, a(11304)) : void 0,
      ...
      function di() {
        return {
          ...
          OpenPopup: tt,
          Properties:
            i.enabled('header_settings') && i.enabled('show_chart_property_page') ? nt : void 0,
    ...
    23076: (e, t, a) => {
      ...
      var i = a(94670),
        ...
        m = a(71705),
        v = a(9450);
      const p = { 3: i, 16: n, 0: s, 1: o, 8: l, 9: r, 2: h, 14: c, 15: d, 10: u, 12: m, 13: v };
    },
    7986: (e, t, a) => {
      'use strict';
      function i(e) {
