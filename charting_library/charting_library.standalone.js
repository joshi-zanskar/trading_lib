var TradingView = (function (e) {
  ...
  (e.ActionId = void 0),
    ...
    (t.ChartDialogsShowGeneralSettingsEventsTab = 'Chart.Dialogs.ShowGeneralSettings.EventsTab'),
    (t.ChartDialogsShowGeneralSettingsAlertsTab = 'Chart.Dialogs.ShowGeneralSettings.AlertsTab'),
    ...
    (t.ChartDialogsShowInsertEconomyIndicators = 'Chart.Dialogs.ShowInsertEconomyIndicators'),
    ...
    (t.ChartSelectedObjectInsertColumnTable = 'Chart.SelectedObject.InsertColumnTable'),
    (t.ChartSelectedObjectRemoveRowTable = 'Chart.SelectedObject.RemoveRowTable'),
    (t.ChartSelectedObjectRemoveColumnTable = 'Chart.SelectedObject.RemoveColumnTable'),
    ...
    ((k = e.ConnectionStatus || (e.ConnectionStatus = {}))[(k.Connected = 1)] = 'Connected'),
    ...
    ((N = e.OrderStatus || (e.OrderStatus = {}))[(N.Canceled = 1)] = 'Canceled'),
    (N[(N.Filled = 2)] = 'Filled'),
    ...
    ((U = e.OrderStatusFilter || (e.OrderStatusFilter = {}))[(U.All = 0)] = 'All'),
    ...
    (($ = e.OrderTicketFocusControl || (e.OrderTicketFocusControl = {}))[($.LimitPrice = 1)] =
      'LimitPrice'),
    ...
    ((K = e.NotificationType || (e.NotificationType = {}))[(K.Error = 0)] = 'Error'),
    (K[(K.Success = 1)] = 'Success'),
    (function (e) {
      (e[(e.Demo = 1)] = 'Demo'), (e[(e.Real = 0)] = 'Real');
    })(q || (q = {})),
    (e.OrderOrPositionMessageType = void 0),
    ((Z = e.OrderOrPositionMessageType || (e.OrderOrPositionMessageType = {})).Information =
      'information'),
    (Z.Warning = 'warning'),
    (Z.Error = 'error'),
    (function (e) {
    ...
    ((re = e.StandardFormatterName || (e.StandardFormatterName = {})).Date = 'date'),
    ...
    ((ne = e.OverridePriceAxisLastValueMode || (e.OverridePriceAxisLastValueMode = {}))[
    ...
    ((ae = e.OverrideLineStyle || (e.OverrideLineStyle = {}))[(ae.Solid = 0)] = 'Solid'),
    ...
    ((ce = e.TimeHoursFormat || (e.TimeHoursFormat = {})).TwentyFourHours = '24-hours'),
    ...
    ((ue = e.TradedGroupHorizontalAlignment || (e.TradedGroupHorizontalAlignment = {}))[
      (ue.Left = 0)
    ] = 'Left'),
    ...
    ((Te = e.PriceScaleMode || (e.PriceScaleMode = {}))[(Te.Normal = 0)] = 'Normal'),
    (Te[(Te.Log = 1)] = 'Log'),
    ...
    ((Le = e.HHistDirection || (e.HHistDirection = {})).LeftToRight = 'left_to_right'),
    ...
    ((ve = e.MarkLocation || (e.MarkLocation = {})).AboveBar = 'AboveBar'),
    (ve.BelowBar = 'BelowBar'),
    (ve.Top = 'Top'),
    (ve.Bottom = 'Bottom'),
    (ve.Right = 'Right'),
    (ve.Left = 'Left'),
    (ve.Absolute = 'Absolute'),
    (ve.AbsoluteUp = 'AbsoluteUp'),
    (ve.AbsoluteDown = 'AbsoluteDown'),
    (function (e) {
  ...
  const Ee = class {
    ...
    async _create() {
      const e = this._options.enabled_features?.includes('iframe_loading_same_origin') ?? !1,
        t =
          e ||
          (this._options.enabled_features?.includes('iframe_loading_compatibility_mode') ?? !1),
  ...
  'undefined' != typeof window &&
    ((window.TradingView = window.TradingView || {}), (window.TradingView.version = Fe));
  const We =
