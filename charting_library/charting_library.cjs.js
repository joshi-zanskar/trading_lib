...
(exports.ActionId = void 0),
  ...
  (e.ChartDialogsShowGeneralSettingsEventsTab = 'Chart.Dialogs.ShowGeneralSettings.EventsTab'),
  (e.ChartDialogsShowGeneralSettingsAlertsTab = 'Chart.Dialogs.ShowGeneralSettings.AlertsTab'),
  ...
  (e.ChartDialogsShowInsertEconomyIndicators = 'Chart.Dialogs.ShowInsertEconomyIndicators'),
  ...
  (e.ChartSelectedObjectInsertColumnTable = 'Chart.SelectedObject.InsertColumnTable'),
  (e.ChartSelectedObjectRemoveRowTable = 'Chart.SelectedObject.RemoveRowTable'),
  (e.ChartSelectedObjectRemoveColumnTable = 'Chart.SelectedObject.RemoveColumnTable'),
  ...
  (e.ChartToggleVisibilityKeyFactsToday = 'Chart.ToggleVisibility.KeyFactsToday'),
  ...
  ((h = exports.StudyPlotDisplayTarget || (exports.StudyPlotDisplayTarget = {}))[(h.None = 0)] =
    'None'),
  (h[(h.Pane = 1)] = 'Pane'),
  ...
  ((P = exports.StudyTargetPriceScale || (exports.StudyTargetPriceScale = {}))[(P.Right = 0)] =
    'Right'),
  (P[(P.Left = 1)] = 'Left'),
  ...
  ((w = exports.FilledAreaType || (exports.FilledAreaType = {})).TypePlots = 'plot_plot'),
  ...
  ((D = exports.ConnectionStatus || (exports.ConnectionStatus = {}))[(D.Connected = 1)] =
    'Connected'),
  ...
  ((k = exports.OrderType || (exports.OrderType = {}))[(k.Limit = 1)] = 'Limit'),
  (k[(k.Market = 2)] = 'Market'),
  (k[(k.Stop = 3)] = 'Stop'),
  ...
  ((M = exports.OrderStatus || (exports.OrderStatus = {}))[(M.Canceled = 1)] = 'Canceled'),
  (M[(M.Filled = 2)] = 'Filled'),
  ...
  ((B = exports.OrderStatusFilter || (exports.OrderStatusFilter = {}))[(B.All = 0)] = 'All'),
  ...
  ((H = exports.ParentType || (exports.ParentType = {}))[(H.Order = 1)] = 'Order'),
  ...
  ((z = exports.OrderTicketFocusControl || (exports.OrderTicketFocusControl = {}))[
    (z.LimitPrice = 1)
  ] = 'LimitPrice'),
  ...
  ((J = exports.NotificationType || (exports.NotificationType = {}))[(J.Error = 0)] = 'Error'),
  ...
  ((q =
    exports.OrderOrPositionMessageType || (exports.OrderOrPositionMessageType = {})).Information =
    'information'),
  (q.Warning = 'warning'),
  (q.Error = 'error'),
  (function (e) {
  ...
  ((oe = exports.StandardFormatterName || (exports.StandardFormatterName = {})).Date = 'date'),
  ...
  ((re = exports.OverridePriceAxisLastValueMode || (exports.OverridePriceAxisLastValueMode = {}))[
  ...
  ((ne = exports.OverrideLineStyle || (exports.OverrideLineStyle = {}))[(ne.Solid = 0)] = 'Solid'),
  ...
  ((le = exports.ChartStyle || (exports.ChartStyle = {}))[(le.Bar = 0)] = 'Bar'),
  ...
  ((de = exports.TimeHoursFormat || (exports.TimeHoursFormat = {})).TwentyFourHours = '24-hours'),
  ...
  ((he = exports.PlDisplay || (exports.PlDisplay = {}))[(he.Money = 0)] = 'Money'),
  (he[(he.Pips = 1)] = 'Pips'),
  (he[(he.Percentage = 2)] = 'Percentage'),
  (exports.TradedGroupHorizontalAlignment = void 0),
  ((ge = exports.TradedGroupHorizontalAlignment || (exports.TradedGroupHorizontalAlignment = {}))[
    (ge.Left = 0)
  ] = 'Left'),
  ...
  ((me = exports.VisibilityType || (exports.VisibilityType = {})).AlwaysOn = 'alwaysOn'),
  (me.VisibleOnMouseOver = 'visibleOnMouseOver'),
  (me.AlwaysOff = 'alwaysOff'),
  (exports.PriceScaleMode = void 0),
  ((ye = exports.PriceScaleMode || (exports.PriceScaleMode = {}))[(ye.Normal = 0)] = 'Normal'),
  (ye[(ye.Log = 1)] = 'Log'),
  (ye[(ye.Percentage = 2)] = 'Percentage'),
  (ye[(ye.IndexedTo100 = 3)] = 'IndexedTo100'),
  (exports.SeriesType = void 0),
  ((Te = exports.SeriesType || (exports.SeriesType = {}))[(Te.Bars = 0)] = 'Bars'),
  ...
  ((Pe = exports.HHistDirection || (exports.HHistDirection = {})).LeftToRight = 'left_to_right'),
  ...
  ((Ae = exports.MarkLocation || (exports.MarkLocation = {})).AboveBar = 'AboveBar'),
  ...
  ((Ie = exports.LineStyle || (exports.LineStyle = {}))[(Ie.Solid = 0)] = 'Solid'),
...
let xe = !1;
function ke() {
  return 'CL v29.2.0 (internal id 92e59637d61b6a77468d0026d24a07296d63e896 @ 2025-04-07T16:45:22.953Z)';
}
const Ve = class {
  constructor(e) {
    if (
    ...
    'dark' === (this._options.theme ?? 'light').toLowerCase() &&
      ...
      (this._options.debug || this._options.debug_broker) &&
        (xe ||
          ((xe = !0),
          console.log(
            'Using CL v29.2.0 (internal id 92e59637d61b6a77468d0026d24a07296d63e896 @ 2025-04-07T16:45:22.953Z)',
          ))),
  ...
  async _create() {
    const e = this._options.enabled_features?.includes('iframe_loading_same_origin') ?? !1,
      t =
        e || (this._options.enabled_features?.includes('iframe_loading_compatibility_mode') ?? !1),
  ...
  _render(e, t) {
    ...
    if (
      ...
      (i[this._id].chartContent = { json: this._options.saved_data }),
        this._options.saved_data_meta_info &&
          (i[this._id].chartContentExtendedData = this._options.saved_data_meta_info);
    ...
    const o = (function (e, t) {
      const i = new URL(`${e || ''}`, location.href).href,
        o = JSON.parse(
          '["bundles/runtime.c00713034eff4e77f7da.js","bundles/__LANG__.3786.99bfb372318533e2d1c4.js","bundles/1996.25e6f30e7a095ec239f4.css","bundles/207.2e06ffb7ce05936178f2.js","bundles/library.63b10f79ae60d2266de0.js"]',
        ),
    ...
    const n =
      ...
      (this._options.time_scale
        ...
        : '');
    return [
      `<iframe\n\t\tversion="CL v29.2.0 (internal id 92e59637d61b6a77468d0026d24a07296d63e896 @ 2025-04-07T16:45:22.953Z)" id="${this._id}" name="${this._id}" src="${r.href}" data-widget-options="${n}"\n\t\t${this._options.autosize || this._options.fullscreen ? '' : `width="${this._options.width}" height="${this._options.height}"`} title="Financial Chart" frameborder="0" allowTransparency="true" scrolling="no" allowfullscreen style="display:block;">\n\t</iframe>`,
      o,
    ];
  }
};
'undefined' != typeof window &&
  ((window.TradingView = window.TradingView || {}), (window.TradingView.version = ke));
const Fe =
